...
<div class="modal" id="changePasswordPop" data-backdrop="static">
	<div class="modal-content">
		...
		<div class="modalCon">
			<div class="modalTop">
				<h3><s:message code="auditLog.oper.CHG_PWD"/></h3>
				<p>
...
<div id="header">
	...
	<div class="headerArea">
		<h1><a  id="menuMainBtn" onclick="goMainPage();"><img
		...
		<div class="ipinfo_right">
			...
			<p class="ntp" style="margin-left: 8px;">
				...
				<%if (!ntpInfo.isEmpty() && ntpInfo != null && ntpInfo.getString("ntpServer") != "") {%>
...
<script type="text/javascript">
    ...
    function goMainPage() {
       var goMain = mainContext + '/ems/dashboard.do';
