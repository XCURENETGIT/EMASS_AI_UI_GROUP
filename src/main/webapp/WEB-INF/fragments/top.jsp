...
<%--            <a class="navbar-brand" href="javascript:;" id="menuMainBtn" onclick="goMainPage();">EMASS AI</a>--%>
<%--        </div>--%>
<%--        <div id="navbar">--%>
...
<%--    document.title = "EMASS AI - <%=menuName%>";--%>
...
<%--    &lt;%&ndash;function changeNTP(ntpServer, lv) {&ndash;%&gt;--%>
<%--    &lt;%&ndash;    var ntpStr = 'NTP - ' + ntpServer;&ndash;%&gt;--%>
<%--    &lt;%&ndash;    var titleStr = '';&ndash;%&gt;--%>

<%--    &lt;%&ndash;    if(lv=='info') {&ndash;%&gt;--%>
<%--    &lt;%&ndash;        ntpStr += '&nbsp;<span class="fa fa-soild fa-circle fa-lg" style="color:lightgreen;"></span>';&ndash;%&gt;--%>
<%--    &lt;%&ndash;        titleStr = '<s:message code="trap.message.ntp.sync"/>';&ndash;%&gt;--%>
<%--    &lt;%&ndash;    } else if(lv=='warning') {&ndash;%&gt;--%>
<%--    &lt;%&ndash;        ntpStr += '&nbsp;<span class="fa fa-soild fa-circle fa-lg" style="color:orange;"></span>';&ndash;%&gt;--%>
<%--    &lt;%&ndash;        titleStr = '<s:message code="trap.message.ntp.unsync"/>';&ndash;%&gt;--%>
<%--    &lt;%&ndash;    } else {&ndash;%&gt;--%>
<%--    &lt;%&ndash;        ntpStr += '&nbsp;<span class="fa fa-soild fa-circle fa-lg" style="color:red;"></span>';&ndash;%&gt;--%>
<%--    &lt;%&ndash;        titleStr = '<s:message code="trap.message.ntp.unconnect"/>';&ndash;%&gt;--%>
<%--    &lt;%&ndash;    }&ndash;%&gt;--%>

<%--    &lt;%&ndash;    $('#ntpStatus').html(ntpStr);&ndash;%&gt;--%>
<%--    &lt;%&ndash;    $('#ntpStatus').parent().attr('title', titleStr);&ndash;%&gt;--%>
<%--    &lt;%&ndash;}&ndash;%&gt;--%>
<%--</script>--%>
