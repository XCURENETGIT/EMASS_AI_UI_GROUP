			...
			plotOptions: {
				...
				series : {
					...
					point : {
						events : {
							click : function( ) {
								p_ctime = this.category;
								$('#total_span2').text(this.y);
								getSearchHistoryDetailList();
							}
						}
					}
...
<div class="searchArea w100">
	<div class="searchSub w100">
		...
		<div>
			<%--<select id="busiSelect" class="w100 mat8" data-style="btn-default btn-sm" multiple data-show-subtext="true" data-live-search="true" data-actions-box="true"></select>--%>
		</div>
		<div>
			<input type="text" id="userName" style="width: 150px;" placeholder="사용자이름"/>
		</div>
		<div>
...
<script type="text/javascript">
	...
	var grid1 = new Xgrid('keywordGrid', contextRoot);
	grid1.autoNumber();
	...
	var grid2 = new Xgrid('detailGrid', contextRoot);
	grid2.autoNumber();
