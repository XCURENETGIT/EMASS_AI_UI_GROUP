...
$(document).ready(function(){
	...
	<div id="messageListDiv" class="messageList" style="display:none">
		<div class="panel panel-default" style=min-height:350px;margin:0px;">
			<div class="panel-heading">
				<i class="fa fa-file-text-o fa-fw"></i> <span><s:message code="analysis.freedom.ui.msglist"/><span class="resultCnt"></span> - <span class="selectChartData"></span></span>
				<span class="btn--message-popover">
					<a tabindex="0" class="btn btn-xs" role="button" onclick="javascript:messageListClose();"><span class="glyphicon glyphicon-remove" style="font-size:20px;"></span></a>
				</span>
			</div>
			<div class="panel-body" style="height: 100%;padding:0px;">
...
<%-- 			        	if(this.key.length == 1 && this.key != lvl1) {
		...
		var grid = new Xgrid('messageListGrid', contextRoot, 26, {commonId:'selectTotalList', status_cnt_id:'#messageCnt', more_btn:'slick_grid_more_btn'});
