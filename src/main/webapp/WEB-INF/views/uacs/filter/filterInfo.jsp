...
<div class="modal" id="idPop" data-backdrop="static">
	<div class="modal-content">
		<form method="post" id="idPopForm" onsubmit="return false;">
			<div class="modalHead">
				<h2><s:message code="filterInfo.idpop.title"/></h2>
			...
			<div class="modalCon">
				...
				<div class="modalbody">
					...
					<div class="row">
						<div class="col-35">
							<label for="idServiceCd" class="fname"><s:message code="filterInfo.service"/></label>
							<span class="red_dot"></span>
						</div>
						<div class="col-65">
...
<div class="modal" id="ipPop" data-backdrop="static">
	<div class="modal-content">
		<form method="post" id="ipPopForm">
			<div class="modalHead">
				<h2><s:message code="filterInfo.ippop.title"/></h2>
				<span class="close" data-dismiss="modal">&times;</span>
			</div>
			<div class="modalCon">
				<div class="modalTop">
				...
				<div class="modalbody">
					...
					<div class="row">
						<div class="col-35">
							<label for="ipVer" class="fname">IP <s:message code="didBlock.version"/></label>
							<span class="red_dot"></span>
						</div>
						<div class="col-65">
							<div class="radio">
					...
					<div class="row">
						<div class="col-35">
							<label for="userSIp" class="fname"><s:message code="filterInfo.userip"/></label>
							<span class="red_dot"></span>
						</div>
						<div class="col-65">
							<div class="checkbox nologCheck" style="padding-left: 0px;">
								<input type="checkbox" name="userIpAll" id="userIpAll" value="Y" class="checkbox">
							...
							~
							<input type="text" class="w100" name="userEIp" id="userEIp" placeholder="<s:message code="filterInfo.eip"/>" style="width: 120px;">
					...
					<div class="row">
						<div class="col-35">
							<label for="userSPort" class="fname"><s:message code="filterInfo.userport"/></label>
							<span class="red_dot"></span>
						</div>
						<div class="col-65">
							<div class="checkbox nologCheck" style="padding-left: 0px;">
								<input type="checkbox" name="userPortAll" id="userPortAll" value="Y" class="checkbox">
								<span><s:message code="common.msg.all"/></span>
							</div>
							...
							&nbsp;~&nbsp;
							<input type="text" class="w100" name="userEPort" id="userEPort" placeholder="<s:message code="filterInfo.eport"/>" maxlength="5" style="width: 62px">
							<span style="font-weight: 130; font-size: 13px;"><s:message
									code="filterInfo.portrange"/></span>
						</div>
					</div>

					<div class="row">
						<div class="col-35">
							<label for="serverSIp" class="fname"><s:message code="filterInfo.serverip"/></label>
							<span class="red_dot"></span>
						</div>
						<div class="col-65">
							<div class="checkbox nologCheck" style="padding-left: 0px;">
							...
							~
							<input type="text" class="w100" name="serverEIp" id="serverEIp" placeholder="<s:message code="filterInfo.eip"/>" style="width: 120px;">
							<p style="padding-left:205px; margin-bottom: 0px;">
								<span style="color:grey;">[example: IPv4 - 192.168.0.12 / IPv6 - 2002:9b3d:1a32:4:208:74ff:fe39:6c43]</span>
							</p>
					...
					<div class="row">
						<div class="col-35">
							<label for="serverSPort" class="fname"><s:message code="filterInfo.serverport"/></label>
							<span class="red_dot"></span>
						</div>
						<div class="col-65">
							<div class="checkbox nologCheck" style="padding-left: 0px;">
							...
							&nbsp;~&nbsp;
							<input type="text" class="w100" name="serverEPort" id="serverEPort" placeholder="<s:message code="filterInfo.eport"/>" maxlength="5" style="width: 62px">
							<span style="font-weight: 130; font-size: 13px;"><s:message code="filterInfo.portrange"/></span>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-65">
							<div style="text-align: right;">
								<button type="button" class="pop_btn02 selBtn" accesskey="A" id="selDeviceBtn"><s:message code="common.msg.select"/></button>
							</div>
						</div>
					</div>
...
<div class="modal" id="domainPop" data-backdrop="static">
	<div class="modal-content">
		<form method="post" id="domainPopForm" onsubmit="return false;">
			<div class="modalHead">
				<h2><s:message code="filterInfo.domainpop.title"/></h2>
				<span class="close" data-dismiss="modal">&times;</span>
			</div>
			<div class="modalCon">
				<div class="modalTop">
				...
				<div class="modalbody">
					<div class="row">
						<div class="col-35">
							<label for="domain" class="fname">Domain</label>
							<span class="red_dot"></span>
						</div>
						<div class="col-65">
							<input type="text" class="w100" name="domain" id="domain" placeholder="Domain" maxlength="128">
							<input type="hidden" id="domainLogSeq" name="domainLogSeq">
						</div>
					</div>
					<div class="row">
						<div class="col-35">
							<label for="domainServiceCd" class="fname"><s:message code="filterInfo.service"/></label>
							<span class="red_dot"></span>
						</div>
						<div class="col-65">
							<select class="w100" id="domainServiceCd" name="serviceCd">
								<option value="">-<s:message code="filterInfo.select.service"/>-</option>
							</select>
...
<div class="modal" id="urlPop" data-backdrop="static">
	<div class="modal-content">
		<form method="post" id="urlPopForm" onsubmit="return false;">
			<div class="modalHead">
				<h2><s:message code="filterInfo.urlPop.title"/></h2>
				<span class="close" data-dismiss="modal">&times;</span>
			</div>
			<div class="modalCon">
				<div class="modalTop">
		...
		<form method="post" id="subjectPopForm" onsubmit="return false;">
			...
			<div class="modalCon">
				...
				<div class="modalbody">
					<div class="row">
						<div class="col-35">
							<label for="subject" class="fname"><s:message code="filterInfo.subject"/></label>
							<span class="red_dot"></span>
						</div>
						<div class="col-65">
							<input type="text" class="w100" name="subject" id="subject" placeholder="<s:message code="filterInfo.subject"/>" style="width: 350px;" maxlength="255">
					...
					<div class="row">
						...
						<div class="col-65">
							<select class="w100" id="subjectServiceCd" name="serviceCd">
								<option value="">-<s:message code="filterInfo.select.service"/>-</option>
							</select>
							<input type="hidden" name="serviceNm"/>
							<input type="hidden" name="tab"/>
				...
				<div class="info">
					...
					<div class="form-inline" style="padding-left: 10px;">4) <s:message code="filterInfo.exam.text4"/></div>
					<div class="form-inline" style="padding-left: 10px;">5) <s:message code="filterInfo.exam.text5"/></div>
					<div class="form-inline" style="padding-left: 10px;">6) <s:message code="filterInfo.exam.text6"/></div>
				</div>
				<div class="modalfooter">
					<button type="button" class="pop_btn01" accesskey="C" data-dismiss="modal"><s:message code="common.msg.close"/></button>
					<button type="button" class="pop_btn02 savePopBtn" accesskey="S"><s:message code="common.msg.save"/></button>
...
<div class="modal" id="sizePop" data-backdrop="static">
	<div class="modal-content">
		<form method="post" id="sizePopForm" onsubmit="return false;">
			<div class="modalHead">
				<h2><s:message code="filterInfo.sizePop.title"/></h2>
				<span class="close" data-dismiss="modal">&times;</span>
			</div>
			<div class="modalCon">
				<div class="modalTop">
				...
				<div class="modalbody">
					<div class="row">
						<div class="col-35">
							...
							<label for="sizeServiceCd" class="fname"><s:message code="filterInfo.service"/></label>
							<span class="red_dot"></span>
						</div>
						<div class="col-65">
					...
					<div class="row">
						<div class="col-35">
							<label for="lowSize" class="fname"><s:message code="filterInfo.msgSize"/></label>
							<span class="red_dot"></span>
						</div>
						<div class="col-65">
							<input type="text" class="w100" name="lowSize" id="lowSize" style="width: 120px;" pattern="[0-9]+([\,])?" step="1" min="1" max="1073741824">
							<select class="w100" id="sizeCondition" name="sizeCondition" style="width: 78px;">
							...
							<input type="text" class="w100" name="highSize" id="highSize" style="width: 120px;">
						</div>
					</div>
				</div>
				<div class="info">
...
<div class="modal" id="attachPop" data-backdrop="static">
	<div class="modal-content">
		<form method="post" id="attachPopForm" onsubmit="return false;">
			<div class="modalHead">
				<h2 class="modal-title"><s:message code="filterInfo.attachPop.title"/></h2>
				<span class="close" data-dismiss="modal">&times;</span>
			</div>
			<div class="modalCon">
				<div class="modalTop">
				...
				<div class="modalbody">
					<div class="row">
						<div class="col-35">
							<label for="attach" class="fname"><s:message code="filterInfo.attach"/></label>
							<span class="red_dot"></span>
						</div>
						<div class="col-65">
							<input type="text" class="w100" name="attach" id="attach" disabled="disabled" placeholder="<s:message code="filterInfo.attach"/>" style="width: 350px;" maxlength="255">
							<input type="hidden" id="attachLogSeq" name="attachLogSeq">
							<button type="button" class="btn btn-primary" accesskey="C" data-dismiss="modal"><s:message
									code="common.msg.select"/></button>
						</div>
					</div>
					<div class="row">
						<div class="col-35">
							<label for="attach" class="fname"><s:message code="didBlock.code.input"/></label>
							<span class="red_dot"></span>
						</div>
						<div class="col-65">
							<input type="text" class="w100" name="attach" id="attach" disabled="disabled" placeholder="<s:message code="filterInfo.attach"/>" style="" maxlength="255">
							<input type="hidden" id="attachLogSeq" name="attachLogSeq">
						</div>
					</div>
					<div class="row">
						<div class="col-35">
							<label for="attachServiceCd" class="fname"><s:message code="filterInfo.service"/></label>
							<span class="red_dot"></span>
						</div>
						<div class="col-65">
							<select class="w100" id="attachServiceCd" name="serviceCd">
								<option value="">-<s:message code="filterInfo.select.service"/>-</option>
							</select>
							<input type="hidden" name="serviceNm"/>
							<input type="hidden" name="tab"/>
...
<div>
	...
	<div class="content xcn_full">
		<div class="contentSub">
			...
			<div id="idList" class="tab-content active" style="height:100%;">
				<div id="idListGrid" class="slickGrid gridArea"></div>
			</div>
			<div id="ipList" class="tab-content" style="height:100%;">
				<div id="ipListGrid" class="slickGrid gridArea"></div>
			</div>
			<div id="domainList" class="tab-content" style="height:100%;">
				<div id="domainListGrid" class="slickGrid gridArea"></div>
			</div>
			<div id="urlList" class="tab-content" style="height:100%;">
				<div id="urlListGrid" class="slickGrid gridArea"></div>
			</div>
			<div id="subjectList" class="tab-content" style="height:100%;">
				<div id="subjectListGrid" class="slickGrid gridArea"></div>
			</div>
			<div id="sizeList" class="tab-content" style="height:100%;">
