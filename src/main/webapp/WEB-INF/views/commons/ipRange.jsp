	...
	<script type="text/javascript">
		...
		$(document).ready(function () {
			...
			$('.savePopBtn').click(function () {
				...
				if (country == '') {
					ui.alertMsg('<s:message code="common.iprange.country"/>');
					return;
				}
				if (startIp == '') {
		...
		function getCountryOptions() {
			var result = '<option value="">-<s:message code="common.admin.country"/>-</option>';
			for (var i = 0; i < countryList.length; i++) {
				result += '<option value="' + countryList[i].nationCd + '">' + countryList[i].nation + '</option>';
			}

			var countrystr = '<select class="form-control input-sm" id="userCountry_inUser" name="country" style=" min-width: 197px;">';
			countrystr += result;
			countrystr += '</select>';
		...
		function getNationByCode(nationCd) {
			var nation = countryList.find(function (item) {
				return item.nationCd === nationCd;
			});
			return nation ? nation.nation : null;
		}
...
<div class="modal" id="ipRangePop" tabindex="-1" role="dialog" aria-labelledby="ipRangeModal">
	<div class="modal-content">
		<form method="post" id="ipRangePopForm">
			<div class="modalHead">
				<h2>
					<s:message code="ipRange.iprangepop.title"/>
			...
			<div class="modalCon">
				...
				<div class="modalbody">
					...
					<div class="row">
						<div class="col-35">
							<label for="country" class="fname"><s:message code="common.admin.country"/></label>
							<span class="red_dot"></span>
						</div>
						<div class="col-65">
							<div id="country"></div>
		...
		<form method="post" id="uploadForm" enctype="multipart/form-data" target="upload_file">
			...
			<div class="modalCon">
					...
					<div class="row">
						...
						<div class="col-65">
							<div>
								...
								<span style="font-family: Pretendard !important;  color:#333; background: #FFF; width:40%; height:26px; line-height: 1.8;  padding:0 8px; vertical-align:middle;  font-size:14px; position: absolute;"
								      id="attachFileName"> <s:message code="keyword.msg.upload.file"/></span>
							</div>
				...
				<div class="info"><s:message code="common.guidance"/>
					...
					<div class="form-inline" style="padding-left: 10px;"> 6) <s:message code="keyword.message.upload.info5"/></div>
				</div>
				<div class="modalfooter">
...
<script type="text/javascript">
	...
	grid.colAdd('country', '<s:message code="common.admin.country"/>', 140, 'center', false, 'nomal', function(row, cell, value, columnDef, dataContext){
		return getNationByCode(value);
	});
	...
	grid.onClick = function () {
		if (grid.Col == grid.ColIndex('busiNm')) {
			...
			$('#userCountry_inUser').val(grid.getValue(grid.Row, 'country'));
			$('#user').val(grid.getValue(grid.Row, 'country'));
