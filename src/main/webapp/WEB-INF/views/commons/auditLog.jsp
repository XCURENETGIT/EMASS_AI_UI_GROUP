...
menuArr.push({id:'ORG_MGMT', 			name:'<s:message code="OPERATION_MGMT.ORG_MGMT"/>',  			p_id:'OPERATION_MGMT'}); //조직 관리
menuArr.push({id:'USER_MGMT', 			name:'<s:message code="OPERATION_MGMT.USER_MGMT"/>',  			p_id:'OPERATION_MGMT'}); //사용자 관리
menuArr.push({id:'USER_GROUP_MGMT', 	name:'<s:message code="OPERATION_MGMT.USER_GROUP_MGMT"/>',  	p_id:'OPERATION_MGMT'}); //사용자 그룹
menuArr.push({id:'BUSI_IPRANGE', 		name:'<s:message code="OPERATION_MGMT.BUSI_IPRANGE"/>',  		p_id:'OPERATION_MGMT'}); //사업장 내부 IP 설정
menuArr.push({id:'DEPT_IPRANGE', 		name:'<s:message code="OPERATION_MGMT.DEPT_IPRANGE"/>',  		p_id:'OPERATION_MGMT'}); //사업장 내부 IP 설정
