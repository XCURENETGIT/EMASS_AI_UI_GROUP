...
.c-checkbox span, .c-radio span { position: relative; top: 4px; }
			...
			<div class="modal-content">
				<form method="post" id="holidayPopForm">
					<div class="modal-header">
						...
						<h3 class="modal-title"><s:message code="holidayBusiness.busiholiday"/></h3>
					</div>
					<div class="modal-body">
						...
						<div class="form-inline">
							...
							<input type="text" class="form-control" name="comment" id="comment" placeholder="<s:message code="common.msg.comment"/>" style="width: 350px;" maxlength="150">
						</div>
					</div>
		...
		<div class="boxArea">
			<div class="content_body" style="padding-top: 0px;">
				<div class="row" style="height: 100%;">
					<div style="height: 100%; position: absolute; width: 575px; left: 10px;">
						<div class="row">
							<div class="col-xs-12 text-left">
								<div class="form-group form-inline not-dashed">
									<label for="busiCd"><s:message code="common.org.busi"/></label>
									<span>
										<select class="form-control input-sm" id="busiCd" name="busiCd" style="min-width: 150px;">
						...
						<div class="row top_space">
							<div class="col-xs-12 text-right">
								<div class="form-group form-inline not-dashed">
									<button type="button" class="btn btn-sm btn-primary" accesskey="S" id="saveBtn"><span class="glyphicon glyphicon-floppy-disk"></span>&nbsp;<s:message code="common.msg.save"/></button>
								</div>
							</div>
						</div>
							...
							<div class="col-xs-12" style="height: 100%;">
								<div class="row">
									<div style="width: 150px; float: left; margin-right: 10px;">
										<div style="background-color: #f8f8f8; border-top: 2px solid #7a7a7a; border-bottom: 1px solid #cdc9c4; margin-bottom: 5px; height: 35px; line-height: 35px; font-weight: bold; text-align: center;"><s:message code="holidayBusiness.select.workday"/></div>
										<div class="form-group">
											<label class="checkbox-inline c-checkbox" style="font-weight: bold">
												...
												<span class="fa fa-check"></span><s:message code="common.msg.selectUnselect"/>
											</label>
										</div>
										<div class="form-group">
											<label class="checkbox-inline c-checkbox">
												<input type="checkbox" class="holidayCheck" name="holidayCheck">
												<span class="fa fa-check"></span><s:message code="common.sunday"/>
											</label>
										</div>
										<div class="form-group">
											<label class="checkbox-inline c-checkbox">
												<input type="checkbox" class="holidayCheck" name="holidayCheck" value="0">
												<span class="fa fa-check"></span><s:message code="common.monday"/>
											</label>
										</div>
										<div class="form-group">
											<label class="checkbox-inline c-checkbox">
												<input type="checkbox" class="holidayCheck" name="holidayCheck" value="0">
												<span class="fa fa-check"></span><s:message code="common.tuesday"/>
											</label>
										</div>
										<div class="form-group">
											<label class="checkbox-inline c-checkbox">
												<input type="checkbox" class="holidayCheck" name="holidayCheck" value="0">
												<span class="fa fa-check"></span><s:message code="common.wednesday"/>
											</label>
										</div>
										<div class="form-group">
											<label class="checkbox-inline c-checkbox">
												<input type="checkbox" class="holidayCheck" name="holidayCheck" value="0">
												<span class="fa fa-check"></span><s:message code="common.thursday"/>
											</label>
										</div>
										<div class="form-group">
											<label class="checkbox-inline c-checkbox">
												<input type="checkbox" class="holidayCheck" name="holidayCheck" value="0">
												<span class="fa fa-check"></span><s:message code="common.friday"/>
											</label>
										</div>
										<div class="form-group">
											<label class="checkbox-inline c-checkbox">
												<input type="checkbox" class="holidayCheck" name="holidayCheck" value="0">
												<span class="fa fa-check"></span><s:message code="common.saturday"/>
											</label>
										</div>
									</div>
									<div style="width: 200px; float: left; margin-right: 10px;">
										<div style="background-color: #f8f8f8; border-top: 2px solid #7a7a7a; border-bottom: 1px solid #cdc9c4; margin-bottom: 5px; height: 35px; line-height: 35px; font-weight: bold; text-align: center;"><s:message code="holidayBusiness.select.worktimeam"/></div>
										<div class="form-group">
											<label class="checkbox-inline c-checkbox" style="font-weight: bold">
										...
										<%for(int i=0 ; i <= 11 ; i++){%>
											<div class="form-group">
												<label class="checkbox-inline c-checkbox amTime">
													...
													<span class="fa fa-check"></span><%=Common.lPad(i, 2, "0")%>:00  ~ <%=Common.lPad(i, 2, "0")%>:59:59
												</label>
											</div>
										<%}%>
									</div>
									<div style="width: 200px; float: left;">
										<div style="background-color: #f8f8f8; border-top: 2px solid #7a7a7a; border-bottom: 1px solid #cdc9c4; margin-bottom: 5px; height: 35px; line-height: 35px; font-weight: bold; text-align: center;"><s:message code="holidayBusiness.select.worktimepm"/></div>
										<div class="form-group">
											<label class="checkbox-inline c-checkbox" style="font-weight: bold">
								...
								<div class="row" style="padding:0px 5px;">
									<table style="border-top: 2px solid #7a7a7a; border-bottom: 1px solid #cdc9c4; width: 100%;">
										<tr>
											...
											<td style="padding: 5px; text-align: center;"><span id="hourNameSpan" style="word-break:break-all; font-weight:normal;"></span></td>
										</tr>
									</table>
								</div>
							</div>
					...
					<div style="height: 100%; position: absolute; left: 600px; right: 0px;">
