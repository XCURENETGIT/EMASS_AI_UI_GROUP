...
$(document).ready(function(){
	...
	/* if(isCC) { */
		...
		$('#interestLabel').text('<s:message code="audit.mail.notice"/>');
		$('#cautionLabel').text('<s:message code="audit.mail.saturation"/>');
		$('#dangerLabel').text('<s:message code="common.msg.delete"/>');
	/* } */
...
<body class="mini-navbar" id="body">
	...
	<div class="container" style="position: absolute; top: 50px; left: 0px; right: 0px; bottom:0px; min-width: 1000px;">
		<div class="content mainBodyArea">
			<div style="background-image: url('<c:url value="/img/title/n_bg.gif"/>');">
