...
function setSelectedData() {
	...
	for( var i=0, total=selectData.length; i < total; i++ ) {
		...
		if(flag) {
			data.push({'adminId':selectData[i].adminId,
...
<body class="mini-navbar msgBody">
	...
	<header class="header">
		<div class="naviBack">
			...
			<span class="navi"><span id="code_title"></span><s:message code="selectAdmin.title"/></span>
		</div>
	</header>
									...
									<div class="resultHeader">
										<div class="form-inline">
											...
											<div class="input-group">
												<input type="text" class="form-control input-sm" placeholder="<s:message code="admin.msg.idname"/>" id="searchStr" style="width: 180px;">
								...
								<div class="tab-pane fade in active" id="result1">
									<div class="resultHeader">
										<div class="form-inline text-right">
											...
											<div class="input-group">
												<button type="button" class="btn btn-sm btn-default" accesskey="N" id="noSelectBtn"><span class="glyphicon glyphicon-minus"></span>&nbsp;<s:message code="selectCodeAll.noselect"/></button>
											</div>
											<div class="input-group">
												<button type="button" class="btn btn-sm btn-default" accesskey="C" id="closeSelectBtn"><span class="glyphicon glyphicon-remove"></span>&nbsp;<s:message code="common.msg.close"/></button>
											</div>
										</div>
									</div>
									<div class="resultBody top_space" style="height: 100%;">
