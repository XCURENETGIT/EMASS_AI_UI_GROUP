...
function setSelectedData() {
	...
	for( var i=0, total=selectData.length; i < total; i++ ) {
		...
		if(flag) {
			if( codeType == 'regexp') data.push({'code':selectData[i].code,'codeName':selectData[i].codeName,'count':'L@1','tempNm1':selectData[i].tempNm1,'tempNm2':selectData[i].tempNm2});
			else data.push({'code':selectData[i].code,'codeName':selectData[i].codeName,'tempNm1':selectData[i].tempNm1,'tempNm2':selectData[i].tempNm2});
		}
	}
			...
			<div class="modal-content" style="width: 520px;">
				<form method="post" id="countPopForm">
					<div class="modal-header">
						...
						<h3 class="modal-title"><s:message code="common.msg.regexp_count_setting"/></h3>
					</div>
					<div class="modal-body">
						<div class="form-inline">
							<input type="text" class="form-control" name="lowcount" id="lowcount" />
							<select class="form-control input-sm" id="count_condition" name="count_condition">
							...
							<input type="text" class="form-control" name="highcount" id="highcount" />
						</div>
					</div>
				</form>
				<div class="modal-footer">
					<button type="button" class="btn btn-default" accesskey="C" data-dismiss="modal"><s:message code="common.msg.close"/></button>
					<button type="button" class="btn btn-primary saveCountBtn" id="saveCountBtn" accesskey="S"><s:message code="common.msg.save"/></button>
				</div>
			</div>
		</div>
	</div>
