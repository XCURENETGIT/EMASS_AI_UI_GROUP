			...
			<div class="modalCon">
				...
				<div class="modalbody">
					<div class="row">
						...
						<div class="col-65">
							<input type="text" name="coCd" class="w100" id="coCdPopInput" placeholder="<s:message code="common.org.cocd"/>" required maxlength="20">
						</div>
					</div>
					<div class="row">
						<div class="col-35">
						...
						<div class="col-65">
							<input type="text" name="coNm" class="w100"  id="coNmPopInput" placeholder="<s:message code="common.org.conm"/>" required maxlength="20">
						</div>
					</div>
				</div>
			...
			<div class="modalCon">
				...
				<div class="modalbody">
					...
					<div class="row">
						...
						<div class="col-65">
							<input type="text" name="busiCd" class="w100" id="busiCdPopInput" placeholder="<s:message code="common.org.busicd"/>" required maxlength="20">
						</div>
					</div>
					<div class="row">
						<div class="col-35">
...
<div class="modal" id="generalPop" tabindex="-1" role="dialog" aria-labelledby="generalModal">
	<div class="modal-content">
...
<div class="modal" id="deptPop" tabindex="-1" role="dialog" aria-labelledby="deptModal">
	<div class="modal-content">
...
<div class="modal" id="jikgubPop" tabindex="-1" role="dialog" aria-labelledby="jikgubModal">
	<div class="modal-content">
...
<div class="modal" id="jikinPop" tabindex="-1" role="dialog" aria-labelledby="jikinModal">
	<div class="modal-content">
...
<div class="container">
	<div class="searchArea">
		<div class="searchSub">
			<div>
				<input type="text" class="w300p"  placeholder="<s:message code="ipRange.msg.enter.busicomment"/>" id="searchStrInput">
				<button class="form_btn01" type="button" wi accesskey="Q" id="searchBtn"><s:message
