...
$(document).ready(function(){
	...
	$('#setUserPopBtn').click(function(){
		...
		if($('input:radio[name="insa\\.auto"]:checked').val() == 'Y'){
			if( $('#insa\\.path').val() == '' ){
	...
	$('#addSelectBox').click(function(){
		...
		var options = makeInsaOptions;
		var str = '';
		str += '<li style="padding-bottom:2px;font-weight: 700;"><select class="insaSelctClass"id="COL'+current_select_count+'" name="insa.select" style=" min-width: 197px;">';
		str += options;
		str += '</select></li>';
