...
<head>
	...
	<style type="text/css">
		.bootstrap-select .inner { -moz-transform : none; }
	...
	<script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            /* if(isCC) { */
            $('#filesystemCCSpan').show();
            $('#filesystemSpan').hide();
            $('#alarmUsed').attr('disabled', 'disabled');
            $('#interestLabel').text('알림');
            $('#cautionLabel').text('포화');
            $('#dangerLabel').text('삭제');
            /* } */
            ...
            $('.saveAlarmPopBtn').click(function(){
                ...
                if ( Number( lv1 ) > Number( lv2 ) ) {
                    alert('관심 임계치를 주의 임계치 보다 작게 설정 하십시오.')
                    return;
                }
				...
				<div class="modal-body">
					<div style="padding-bottom: 50px;">
						<div class="form-inline col-xs-6">
							<label class="checkbox c-checkbox"><input type="checkbox" id="alarmUsed"><s:message code="deviceInfo.use.critical"/></label>
						</div>
					</div>
	...
	<div>
		<div>
			<div class="col-xs-9 text-left">
				<div style="display: none"> <select id="deviceSelect" class="selectpicker" data-style="btn-default"></select></div>
				<button type="button" class="btn btn-sm btn-primary" accesskey="" id="returnListBtn" style="margin-left: 20px;"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp;<s:message code="deviceInfo.returnList"/></button>
				...
				<button type="button" class="btn btn-sm btn-warning" accesskey="R" id="reflashBtn"><span class="glyphicon glyphicon-refresh"></span>&nbsp;<s:message code="deviceInfo.refresh"/></button>
			</div>
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<div class="form-inline not-dashed">
									...
									<span id="filesystemCCSpan" style="color: #1A73F9;display:none;">※ 임계치 설정은 "/users" 파티션에 알림 임계치 80%, 포화 임계치 90%, 삭제 임계치 85%로 설정되어 있습니다.</span>
									<span id="filesystemSpan">
													<label class="checkbox c-checkbox" style="color: #be7533;"><input type="checkbox" id="sms_file">SMS</label>
													<label class="checkbox c-checkbox" style="color: #be7533;"><input type="checkbox" id="notify_file"><s:message code="deviceInfo.alarm"/></label>
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<div class="form-inline not-dashed">
									...
									<label for="sms_inter"><input class="checkbox" type="checkbox" id="sms_inter"><span  class=" checktit">SMS</span></label>
									<label class="notify_inter"><input class="checkbox"  type="checkbox" id="notify_inter"><span  class=" checktit"><s:message code="deviceInfo.alarm"/></span></label>
