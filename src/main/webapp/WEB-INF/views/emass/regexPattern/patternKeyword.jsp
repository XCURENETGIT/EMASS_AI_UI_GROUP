...
<div class="modal" id="PatternPop" aria-labelledby="PatternPop" data-backdrop="static">
	<div class="modal-content">
		<form method="post" id="PatternPopForm">
			<div class="modalHead">
				<h2><s:message code="DATA_MONITOR.PATTERN_KEYWORD"/> - <s:message code="common.msg.addmodify"/></h2>
				<span class="close" data-dismiss="modal">&times;</span>
			</div>
			<div class="modalCon">
				<div class="modalTop">
					<h3><s:message code="DATA_MONITOR.PATTERN_KEYWORD"/> - <s:message code="common.msg.addmodify"/></h3>
					<p>
...
<div>
	...
	<div class="content xcn_full">
		<div class="contentSub">
			<div class="subtab">
				<button class="active">
					<s:message code="DATA_MONITOR.PATTERN_KEYWORD"/>
...
<script type="text/javascript">
    ...
    grid.loadExportMenu('<s:message code="DATA_MONITOR.PATTERN_KEYWOR"/>');
