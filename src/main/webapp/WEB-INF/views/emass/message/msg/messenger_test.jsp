						...
						<div>
							...
							<div class="optiotab w100 mat8" data-toggle="buttons">
								<label class="btn btn-sm btn-default active" style="width: 147px;"><input type="radio" name="attachYn" id="attachAll"
										...
										code="condition.isattached.all"/>&nbsp;&nbsp;</label>
								<label class="btn btn-sm btn-default" style="width: 147px;"><input type="radio" name="attachYn" id="attachY"
								                                                                   value="Y">&nbsp; <s:message
										code="eikon.attach.exist"/>&nbsp;&nbsp;</label>
							</div>
							...
							<p class="mat8 formText btnform" data-toggle="buttons">
								...
								<%--								<span id="deptSelectedArea" class="tit codeSelectedBtn">--%>
								<%--										<button type="button" class="num_add btn" style="z-index: 2">0</button>--%>
								<%--									</span>--%>
