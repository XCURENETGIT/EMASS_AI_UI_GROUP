...
<html lang="ko">
<head>
<title>EMASS LTH - <s:message code="consent.attach"/> Text Viewer</title>
							...
							<div class="col-sm-6 text-right">
								...
								<div class="btn-group">
									<select id="textSize" class="form-control btn-success btn-sm" >
										...
										<option value="16px">&nbsp;<s:message code="message.msg.font_size"/> (<s:message code="message.msg.big"/>) </option>
										<option value="18px">&nbsp;<s:message code="message.msg.font_size"/> <s:message code="message.msg.bigger"/>) </option>
									</select>
								</div>
							</div>
						</div>
				...
				<div class="col-sm-12">
					<div class="panel panel-default" style="height:180px;">
						<div class="panel-heading" style="font-weight: bold;height:40px;">
							<div class="pull-left" style="cursor:default;width:calc(100% - 200px);overflow:hidden;text-overflow:ellipsis;white-space:nowrap;word-wrap:normal">
