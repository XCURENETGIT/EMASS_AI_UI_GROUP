...
<body class="mini-navbar">
	<header class="header">
		<div class="naviBack">
			...
			<span class="navi"><span id="code_title"></span><s:message code="condition.select.condition.search"/></span>
		</div>
	</header>
					...
					<div class="col-sm-12">
						<div class="smartfilter">
							<div style="text-align: right;">
								<button type="button" class="btn btn-sm btn-warning" accesskey="R" id="conditionResetBtn"><i class="glyphicon glyphicon-refresh"></i>&nbsp;<s:message code="condition.reset"/></button>
								<button type="button" class="btn btn-sm btn-primary" accesskey="S" id="conditionSaveBtn"><i class="glyphicon glyphicon-saved"></i>&nbsp;<s:message code="condition.select"/></button>
							</div>
						</div>
						...
						<div class="form-group form-inline" id="epmsgList">
							<label for="epmsgTypeSelect" class="control-label col-xs-3"><s:message code="condition.epmsgType.list"/></label>
							<select id="epmsgTypeSelect" class="selectpicker col-xs" data-style="btn-default btn-sm" multiple data-show-subtext="true" data-live-search="true" data-actions-box="true"></select>
						</div>						
						...
						<div class="form-group form-inline">
							...
							<div id="day_msg" style="display:inline-flex;">
								<div class="selecBtnArea" style="width:auto;float: left;">
									<select class="selectpicker col-xs" data-style="btn-primary" id="startDateSelect" style="width: 100px;">
								...
								<div class="selecBtnArea" style="width:auto; padding-left: 3px;float: left;">
									<select class="selectpicker col-xs" data-style="btn-primary" id="startTimeSelect">
										<option value="00" selected><s:message code="condition.clock" arguments="0" /></option>
								...
								<div class="selecBtnArea" style="width:auto; padding-left:3px;">
									<select class="selectpicker col-xs" data-style="btn-primary" id="endTimeSelect">
										...
										<option value="23" selected><s:message code="condition.time" arguments="23,59,59" /></option>
									</select>
								</div>
							</div>
						...
						<div id="infoFeedbackDiv" style="display: none;">
							<div class="form-group form-inline">
								<label for="infoTypeSelect" class="control-label col-xs-3"><s:message code="condition.infotype"/></label>
								<select id="infoTypeSelect" class="selectpicker col-xs" data-style="btn-default btn-sm" multiple data-show-subtext="true" data-live-search="true" data-actions-box="true">
							...
							<div class="form-group form-inline">
								<label for="feedbackTypeSelect" class="control-label col-xs-3"><s:message code="condition.feedback"/></label>
								<select id="feedbackTypeSelect" class="selectpicker col-xs" data-style="btn-default btn-sm" multiple data-show-subtext="true" data-live-search="true" data-actions-box="true">
							...
							<div class="form-group form-inline">
								<label for="probTypeSelect" class="control-label col-xs-3"><s:message code="condition.prob"/></label>
								<select id="probTypeSelect" class="selectpicker col-xs" data-style="btn-default btn-sm" multiple data-show-subtext="true" data-live-search="true" data-actions-box="true">
						...
						<div class="form-group form-inline">
							<label for="senders" class="control-label col-xs-3"><s:message code="condition.sender"/></label>
							<div class="input-group">
								<input type="text" class="form-control input-sm condition_input_text" id="senders" placeholder="<s:message code="condition.sender"/>" style="width: 290px;" />
						...
						<div class="form-inline">
							<label for="" class="control-label col-xs-3"><s:message code="condition.detail.recvs"/></label>
							<label class="radio-inline c-radio"><input type="radio" name="receive_option" id="receive_option_all" value="" checked><span class="fa fa-check"></span><s:message code="common.msg.all"/></label>
							<label class="radio-inline c-radio"><input type="radio" name="receive_option" id="receive_option_more" value="detail"><span class="fa fa-check"></span><s:message code="condition.info.detail"/></label>
							<input type="hidden" name="receiveSend" id="receiveSend">
						</div>
						<div class="form-group form-inline receivers_default">
							<label for="receivers" class="control-label col-xs-3"><s:message code="condition.recv"/></label>
							<div class="input-group">
								<input type="text" class="form-control input-sm condition_input_text" id="receivers" placeholder="<s:message code="condition.recv"/>" style="width: 290px;" />
								<label class="checkbox-inline c-checkbox exceptOption">
						...
						<div class="receivers_detail" style="display: none;">
							<div class="form-group form-inline">
								<label for="rcvTo" class="control-label col-xs-3"> ><s:message code="condition.recv"/>(<s:message code="condition.to"/>)</label>
								<div class="input-group">
									<input type="text" class="form-control input-sm condition_input_text" id="rcvTo" placeholder="<s:message code="condition.to"/>" style="width: 412px;" />
									<label class="checkbox-inline c-checkbox exceptOption">
							...
							<div class="form-group form-inline">
								<label for="rcvCc" class="control-label col-xs-3"> ><s:message code="condition.recv"/> (<s:message code="condition.cc"/>)</label>
								<div class="input-group">
									<input type="text" class="form-control input-sm condition_input_text" id="rcvCc" placeholder="<s:message code="condition.cc"/>" style="width: 412px;" />
									<label class="checkbox-inline c-checkbox exceptOption">
							...
							<div class="form-group form-inline">
								<label for="rcvBcc" class="control-label col-xs-3"> ><s:message code="condition.recv"/> (<s:message code="condition.bcc"/>)</label>
								<div class="input-group">
									<input type="text" class="form-control input-sm condition_input_text" id="rcvBcc" placeholder="<s:message code="condition.bcc"/>" style="width: 412px;" />
									<label class="checkbox-inline c-checkbox exceptOption">
						...
						<div class="form-group form-inline">
							...
							<div class="btn-group filterBtn" data-toggle="buttons" style="margin-top:3px;">
								<select class="selectpicker col-xs" id="allOfus" style="width:100%;" data-style="btn-default btn-sm">
						...
						<div class="form-group form-inline">
							<label for="busiSelect" class="control-label col-xs-3"><s:message code="condition.organization"/></label>
							<div class="btn-group filterBtn" data-toggle="buttons" style="margin-top:3px;">
						...
						<div class="form-group form-inline">
							...
							http://
							<div class="input-group">
								<input type="text" class="form-control input-sm condition_input_text" id="url" placeholder="URL" style="width: 372px;" />
								<label class="checkbox-inline c-checkbox exceptOption">
						...
						<!-- 첨부여부 -->
						<div class="form-inline" style="height:90px;">
							...
							<div class="col-xs-9" style="padding-left:0px;">
								<div style="height:35px;line-height:35px;">
									...
									<span id="attachBtnArea" style="display:none;">
										<button type="button" class="btn btn-sm btn-default btn-open filterAddBtn" accesskey="A" id="attachBtn"><span class="glyphicon glyphicon-plus-sign"><s:message code="condition.select"/></span></button>
									</span>
								...
								<div style="padding-top:5px;">
									<label for="" class="control-label" style="width:100px;"><s:message code="condition.actual.attachment"/></label>
									<label class="radio-inline c-radio"><input type="radio" name="realAttYnVal" value="" checked disabled="disabled"><span class="fa fa-check"></span><s:message code="common.msg.all"/></label>
									<label class="radio-inline c-radio"><input type="radio" name="realAttYnVal" value="Y" disabled="disabled"><span class="fa fa-check"></span><s:message code="condition.onemore"/></label>
									<label class="radio-inline c-radio"><input type="radio" name="realAttYnVal" value="N" disabled="disabled"><span class="fa fa-check"></span><s:message code="condition.none"/></label>	
								</div>
								<div>
									<label for="" class="control-label" style="width:100px;">DRM</label>
									<label class="radio-inline c-radio"><input type="radio" name="regexp_drmYnVal" value="" checked disabled="disabled"><span class="fa fa-check"></span><s:message code="common.msg.all"/></label>
									<label class="radio-inline c-radio"><input type="radio" name="regexp_drmYnVal" value="Y" disabled="disabled"><span class="fa fa-check"></span><s:message code="condition.exist"/></label>
									<label class="radio-inline c-radio"><input type="radio" name="regexp_drmYnVal" value="N" disabled="disabled"><span class="fa fa-check"></span><s:message code="condition.none"/></label>
								</div>
							</div>
						</div>
						
						<!-- 예약어 -->
						<div class="form-inline" style="line-height:35px;">
							...
							<span id="keywordBtnArea" style="display:none;">
								<button type="button" class="btn btn-sm btn-default btn-open filterAddBtn" accesskey="K" id="keywordBtn"><span class="glyphicon glyphicon-plus-sign"><s:message code="condition.select"/></span></button>
							</span>
						...
						<div class="form-inline" style="line-height:35px;">
							...
							<span id="regexpBtnArea" style="display:none;">
								<button type="button" class="btn btn-sm btn-default btn-open filterAddBtn" accesskey="P" id="regexpBtn"><span class="glyphicon glyphicon-plus-sign"><s:message code="condition.select"/></span></button>
							</span>
						...
						<div class="filterDiv">
							...
							<div style="clear:both;height:60px;padding:1px 5px 0px 5px;">
								...
								<div style="padding-left:5px;">
									<span id="sizeStartValStr" style="line-height:30px;"></span><input type="text" id="sizeStartVal" style="width: 90px; display: none;">
									<span id="sizeRangeValStr" style="display:none;"> ~ </span>
									<span id="sizeEndValStr" style="display:none;"></span><input type="text" id="sizeEndVal" style="width:90px; display: none;">
								</div>
							</div>
						</div>
					</div>
