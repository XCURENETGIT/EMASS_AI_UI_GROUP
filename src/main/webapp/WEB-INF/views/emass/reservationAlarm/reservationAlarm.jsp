...
function alarmCycleChange( alarmCycle ){
	var str = "";
	if(alarmCycle=="W") {
		str += "<select class='form-control input-sm' name='alarmWeek' id='alarmWeek'>";
	...
	if(alarmCycle=="W" || alarmCycle=="D") {
		str += "<select class='form-control input-sm' name='alarmTime' id='alarmTime'>";
		for ( var i=0 ; i <= 23 ; i++ )
		{
		...
		str += "<p><s:message code='mail.message.excute.oclock'/></p>";
			...
			<div class="modal-content">
				<form method="post" id="alarmPopForm">
					<div class="modal-header">
						...
						<h3 class="modal-title"><s:message code="mail.reservation.setting"/> - <s:message code="common.msg.addmodify"/></h3>
					</div>
								...
								<div id="rootwizard">
									<div class="navbar">
										<div class="navbar-inner">
											<div class="tabDiv">
												<ul>
													<li><a href="#tab1" data-toggle="tab"><s:message code="mail.reservation_alarm.setting"/></a></li>
													<li><a href="#tab2" data-toggle="tab"><s:message code="mail.select.form"/></a></li>
													<li><a href="#tab3" data-toggle="tab"><s:message code="condition.select.condition"/></a></li>
												</ul>
											</div>
										</div>
									</div>
									<div class="tab-content">
										<div class="tab-pane" id="tab1">
											...
											<div class="form-group form-inline">
												<label for="alarmName" class="control-label col-xs-4">*<s:message code="mail.reservation.name"/></label>
												<input type="text" class="form-control" style="width: 60%;" name="alarmName" id="alarmName" placeholder="<s:message code="mail.reservation.name"/>" maxlength="256">
												<input type="hidden" class="form-control" name="alarmSeq" id="alarmSeq" />
											</div>
											<div class="form-inline" id="useYnGroup">
												<label for="useYnVal" class="control-label col-xs-4"><s:message code="common.msg.useyn"/></label>
												<label class="radio-inline c-radio"><input type="radio" name="useYnVal" value="Y" checked><span class="fa fa-check"></span><s:message code="common.msg.use"/></label>
												<label class="radio-inline c-radio"><input type="radio" name="useYnVal" value="N"><span class="fa fa-check"></span><s:message code="common.msg.unuse"/></label>	
												<input type="hidden" name="useYn" id="useYn">
											</div>
											<div class="form-inline">
												<label for="alarmType" class="control-label col-xs-4">*<s:message code="mail.alarm_type"/></label>
												<label class="checkbox-inline c-checkbox" style="padding-left: 0px;">
													<input type="checkbox" name="alarmType" value="E">
													<span class="fa fa-check"></span><s:message code="mail.msg"/>
												</label>
												<label class="checkbox-inline c-checkbox" style="padding-left: 0px;">
												...
												<label class="checkbox-inline c-checkbox" style="padding-left: 0px;">
													...
													<span class="fa fa-check"></span><s:message code="mail.alert_message"/>
												</label>
												<input type="hidden" class="form-control" name="alarmMailYn" id="alarmMailYn" />
												<input type="hidden" class="form-control" name="alarmSmsYn" id="alarmSmsYn" />
												<input type="hidden" class="form-control" name="alarmMonitorYn" id="alarmMonitorYn" />
											</div>
											<div class="form-inline" id="alarmCycleGroup">
												<label for="alarmCycleVal" class="control-label col-xs-4"><s:message code="mail.execute_cycle"/></label>
												<label class="radio-inline c-radio"><input type="radio" name="alarmCycleVal" value="W"><span class="fa fa-check"></span><s:message code="common.msg.everyweek"/></label>
												<label class="radio-inline c-radio"><input type="radio" name="alarmCycleVal" value="D" checked><span class="fa fa-check"></span><s:message code="common.msg.everyday"/></label>
												<label class="radio-inline c-radio"><input type="radio" name="alarmCycleVal" value="H"><span class="fa fa-check"></span><s:message code="common.msg.everyhour"/></label>	
												<input type="hidden" name="alarmCycle" id="alarmCycle">
											</div>
											<div class="form-group form-inline" style="height: 44px;">
												<label for="alarmTime" class="control-label col-xs-4"><s:message code="mail.execute_time"/></label>
												<div id="alarmTimeDiv"></div>
											</div>
											<div class="form-group form-inline" style="text-align: right; font-weight: bold; font-size: 13px;">
										...
										<div class="tab-pane" id="tab2">
											...
											<div id="alertField">
												<div class="form-group form-inline">
													<div class="col-xs-4">
														<label class="control-label"><s:message code="mail.alarm_type"/></label>
													</div>
													<div>
														<p><s:message code="mail.message.selectform"/></p>
													</div>
												</div>
											</div>
											<div style="display: none;" id="mailField">
												<div class="form-inline">
													<label for="alarmTo" class="control-label col-xs-4">*<s:message code="mail.recv"/></label>
													<div class="input-group col-xs-8">
														...
														<input type="text" class="form-control input-sm" name="alarmTo" id="alarmTo" readonly="readonly"/>
													</div>
												</div>
												<div class="form-inline">
													<label for="alarmCCMail" class="control-label col-xs-4"><s:message code="mail.recv.cc"/></label>
													<div class="input-group col-xs-8">
														<span class="input-group-btn" style="width: 25px;">
															<button class="btn btn-primary btn-sm" type="button" accesskey="B" id="alarmCCBtn"><s:message code="consent.select"/></button>
														</span>
														<input type="text" class="form-control input-sm" name="alarmCC" id="alarmCC" readonly="readonly"/>
													</div>
												</div>
												<div class="form-inline">
													<label for="mailFormSelBtn" class="control-label col-xs-4">*<s:message code="mail.form.mail"/></label>
													<div class="input-group col-xs-8">
														<span class="input-group-btn" style="width: 25px;">
															<button class="btn btn-primary btn-sm" type="button" accesskey="M" id="mailFormSelBtn"><s:message code="consent.select"/></button>
														</span>
														<input type="text" class="form-control input-sm" name="formSubject" id="formSubject" readonly="readonly"/>
														<input type="hidden" class="form-control" name="alarmFormSeq" id="alarmFormSeq" />
													</div>
												</div>
												<div class="form-inline" id="csvYnGroup">
													<label for=csvYnVal class="control-label col-xs-4"><s:message code="mail.file_type.attach"/></label>
													<label class="radio-inline c-radio"><input type="radio" name="csvYn" value="N" checked><span class="fa fa-check"></span>XLSX</label>
													<label class="radio-inline c-radio"><input type="radio" name="csvYn" value="Y"><span class="fa fa-check"></span>CSV</label>
													<span style="margin-left:30px;"> <s:message code="mail.max.cnt"/> <input type="text" class="input-sm" style="width:80px; margin-left:10px;" id="excelMaxCnt" name="excelMaxCnt"></span>	
												</div>
											...
											<div style="display: none;" id="smsField">
												<div class="form-inline">
													<div class="col-xs-4">
														<label class="control-label">SMS <s:message code="mail.msg.form"/></label>
													</div>
													<div>
											...
											<div style="display: none;" id="monitorField">
												<div class="form-inline">
													<label for="smsFormatBtn" class="control-label col-xs-4"><s:message code="mail.alert_message"/></label>
										...
										<div class="tab-pane" id="tab3">
											<div class="progress">
												<div class="progress-bar" role="progressbar" aria-valuenow="100" aria-valuemin="" aria-valuemax="100" style="width: 100%;">
													3<s:message code="mail.step"/>
												</div>
											</div>
											<button type="button" class="btn btn-primary btn-sm" id="alarmValBtn" accesskey="L"><s:message code="condition.select.condition"/></button>
											<textarea class="form-control" style="display:none" name="alarmVal" id="alarmVal"></textarea>
											<textarea class="form-control" style="height: 230px; margin-top: 1px;" name="alarmValStr" id="alarmValStr" readonly></textarea>
											<div class="form-inline" style="text-align: right; font-weight: bold; font-size: 13px;">
												<s:message code="mail.set.item"/>
											</div>
										</div>
										<ul class="pager wizard">
											<li class="previous"><a href="#"><s:message code="common.msg.prev"/></a></li>
											<li class="next"><a href="#"><s:message code="common.msg.next"/></a></li>
											<li class="next finish" style="display:none;"><a href="javascript:;" id="finish"><s:message code="mail.complete"/></a></li>
										</ul>
									</div>	
								</div>
							</div>
					...
					<div class="col-xs-8 text-left">
						<div class="form-group form-inline not-dashed">
							<div class="input-group">
								<input type="text" class="form-control input-sm" placeholder="<s:message code="mail.message.input.alarm_name"/>" id="searchStr" style="width: 250px;">
							...
							<button type="button" class="btn btn-sm btn-warning" accesskey="M" id="mailFormBtn"><span class="glyphicon glyphicon-edit"></span>&nbsp;<s:message code="mail.mgnt.form"/></button>
						</div>
					</div>
				</div>
