...
<html lang="ko">
<head>
<title>EMASS LTH - <s:message code="DATA_MONITOR.CONSENT_MGMT"/></title>
...
$(document).ready(function(){
			...
			if(rs){
				...
				$("#consentPopForm").ajaxForm({
					...
					beforeSubmit: function() {
						...
						$('#attachSpan').html('<input type="file" class="form-control" name="attach" id="attach" style="width: 350px; border: 0px; padding: 0px;">');
					},
	...
	$("#consentPop").on('show.bs.modal', function() {
		...
		if( $("#consentPop").attr('mode') == 'insert' ) {
			$('#attachSpan').html('<input type="file" class="form-control" name="attach" id="attach" style="width: 350px; border: 0px; padding: 0px;">').show();
			$('#attachNameSpan').hide();
			ui.get({
	...
	$('#approveBtn').click(function(){ updateApproval('A'); });
	$('#returnBtn').click(function(){ updateApproval('R'); });
	$('#cancelApproveBtn').click(function(){ updateApproval('C'); });
	...
	$('#attachModifyBtn').click(function(){
		$('#fileDeleteYn').val('Y');
		$('#attachNameA').hide();
		$('#attachNameB').html('<input type="file" class="form-control" name="attach" id="attach" style="width: 350px; border: 0px; padding: 0px;">');
	...
	$('.selBtn').click(function(){ openWindow('user') });
...
<body class="mini-navbar">
	<div id="return"></div>
	<div class="modal fade" id="consentPop" tabindex="-1" role="dialog" aria-labelledby="consentPop">
			...
			<div class="modal-content">
				<form method="post" id="consentPopForm" enctype="multipart/form-data" target="upload_file">
					<div class="modal-header">
						...
						<h3 class="modal-title"><s:message code="consent.consent"/> - <s:message code="common.msg.addmodify"/></h3>
					</div>
					<div class="modal-body">
						<div class="form-group form-inline">
							<label for="no" class="control-label col-xs-4"><s:message code="consent.number"/></label>
							<input type="text" class="form-control" name="no" id="no" disabled="disabled">
						</div>
						<div class="form-group form-inline">
							<label for="type" class="control-label col-xs-4"><s:message code="consent.type"/></label>
						...
						<div class="form-group form-inline">
							<label for="name" class="control-label col-xs-4"><s:message code="consent.user"/></label>
							<input type="text" class="form-control" name="name" id="name" disabled="disabled">
							<button type="button" class="btn btn-primary selBtn" accesskey="U" id="user"><s:message code="consent.select"/></button>
						</div>
						<div class="form-group form-inline">
							<label for="userId" class="control-label col-xs-4"><s:message code="common.msg.id"/></label>
							<input type="text" class="form-control" name="userId" id="userId" disabled="disabled">
						</div>
						<div class="form-group form-inline">
							<label for="deptNm" class="control-label col-xs-4"><s:message code="common.org.dept"/></label>
							<input type="text" class="form-control" name="deptNm" id="deptNm" disabled="disabled">
						</div>
						<div class="form-group form-inline">
							<label for="generalSelect_inUser" class="control-label col-xs-4"><s:message code="consent.expiration.date"/></label>
							<div class='input-group date' id="sdateDiv">
								<input type='text' class="input-sm form-control" id="sdate" />
								<span class="input-group-addon"> <span class="glyphicon glyphicon-calendar"></span>
								</span>
							</div>
							~
							<div class='input-group date' id="edateDiv">
								<input type='text' class="input-sm form-control" id="edate" name="edate" />
								<span class="input-group-addon"> <span class="glyphicon glyphicon-calendar"></span>
								</span>
							</div>
						</div>
						<div class="form-group form-inline">
							<label for="createNm" class="control-label col-xs-4"><s:message code="consent.registrant"/></label>
							<input type="text" class="form-control" name="createNm" id="createNm" disabled="disabled">
							<input type="hidden" name="createId" id="createId">
							<input type="hidden" id="userIp" name="userIp" />
						</div>
						<div class="form-group form-inline">
							<label for="createDt" class="control-label col-xs-4"><s:message code="consent.registered.date"/></label>
							<input type="text" class="form-control" name="createDt" id="createDt" disabled="disabled">
						</div>
						<div class="form-inline">
							<label for="purpose" class="control-label col-xs-4"><s:message code="consent.purpose.search"/></label>
						...
						<div class="form-group form-inline">
							<label for="attach" class="control-label col-xs-4"><s:message code="consent.attach"/></label>
						...
						<div class="form-inline">
							<div class="checkbox c-checkbox">
								<label class="col-sm-12" style="font-weight: 700;"><input type="checkbox" id="alarmSetup"><span class="fa fa-check"></span><s:message code="consent.alarm.setup"/></label>
								<input type="hidden" class="form-control" name="alarmYn" id="alarmYn" value="N"/>
							</div>
						</div>
						<div class="form-inline">
							<label for="registrantYn" class="control-label col-xs-4"><s:message code="consent.alarm.to"/></label>
							<label class="radio-inline c-radio" style="padding-left: 0px;">
								<input type="radio" name="registrantYn" value="Y" checked>
								<span class="fa fa-check"></span><s:message code="consent.registrant.only"/>
							</label>
							<label class="radio-inline c-radio">
								<input type="radio" name="registrantYn" value="N">
								<span class="fa fa-check"></span><s:message code="consent.approbator.all"/>
							</label>
						</div>
						<div class="form-inline">
							<label for="alarmType" class="control-label col-xs-4"><s:message code="consent.alarm.type"/></label>
							...
							<input type="hidden" class="form-control" name="alarmMailYn" id="alarmMailYn" value="N"/>
							<input type="hidden" class="form-control" name="alarmSmsYn" id="alarmSmsYn" value="N"/>
							<input type="hidden" class="form-control" name="alarmMonitorYn" id="alarmMonitorYn" value="N"/>
						</div>
					</div>
				</form>
				<div class="modal-footer">
					<div class="col-xs-5 text-left">
						<button type="button" class="btn btn-default" accesskey="N" id="returnBtn" style="display: none;"><s:message code="consent.rejected"/></button>
						<button type="button" class="btn btn-default" accesskey="R" id="cancelApproveBtn" style="display: none;"><s:message code="consent.approved.canceled"/></button>
						<button type="button" class="btn btn-default" accesskey="A" id="approveBtn" style="display: none;"><s:message code="consent.approved"/></button>
					</div>
					...
					<div class="col-xs-9 text-left">
						<div class="form-group form-inline not-dashed">
							...
							<div class="input-group">
								<select class="form-control input-sm" id="consentType" style="float: left;">
							...
							<div class="input-group">
								<select class="form-control input-sm" id="consentStatus" style="float: left;">
							...
							<div class="input-group">
								<input type="text" class="form-control input-sm" placeholder="<s:message code="consent.name.input"/>" id="searchStr" style="width: 130px;">
