...
$(document).ready(function() {
	...
	$('#dashShareSaveBtn').click(function(){ saveDashboard(); });
	$('#searchStrDashboardBtn').click(function(){ getDashBoardContent(); });
	$('#searchStrDashboard').enter(function(e){ getDashBoardContent (); });
...
<body class="mini-navbar">
	<div class="modal bootstrap-dialog type-primary fade size-normal" role="dialog" aria-hidden="true" id="deleteDashBatchPop" aria-labelledby="bootstrap_confirm_title" tabindex="-1">
			...
			<div class="modal-content">
				<div class="modal-header bootstrap-dialog-draggable">
					<div class="bootstrap-dialog-header">
						...
						<div class="bootstrap-dialog-title" id="deleteDashBatchPop_title">
						Venus - Confirm
						</div>
					</div>
				</div>
				<div class="modal-body">
					<div class="bootstrap-dialog-body">
						<div class="bootstrap-dialog-message" id="deleteDashBatchPop_msg">
				...
				<div class="modal-footer" style="display: block;">
					<div class="bootstrap-dialog-footer">
						<div class="bootstrap-dialog-footer-buttons">
							<button class="btn btn-primary deleteBtn conentBatchBtn" id="deleteBatchBtn"><s:message code="selectAdmin.share.delete.batch"/></button>
							<button class="btn btn-primary deleteBtn" id="deleteOneBtn"><s:message code="selectAdmin.share.delete"/></button>
							<button class="btn btn-default" id="deleteBatchCloseBtn"><s:message code="common.msg.cancel"/></button>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="modal-content">
				<form method="post" id="setupDashboardContentPopForm">
						...
						<div class="row">
							<div class="col-md-6" style="border-right: 1px solid #e5e5e5;">
								...
								<div class="form-group form-inline">
									...
									<button type="button" class="btn btn-default dashIcon" data-value="fa fa-download"><i class="fa fa-download"></i></button>
									...
									<button type="button" class="btn btn-default dashIcon" data-value="fa fa-pie-chart"><i class="fa fa-pie-chart"></i></button>
									<button type="button" class="btn btn-default dashIcon" data-value="fa fa-area-chart"><i class="fa fa-area-chart"></i></button>
									<button type="button" class="btn btn-default dashIcon" data-value="fa fa-bar-chart"><i class="fa fa-bar-chart"></i></button>
								...
								<div class="form-inline not-dashed">
									<button type="button" class="btn btn-primary btn-sm" accesskey="S" id="dashConditionBtn"><s:message code="condition.filter_setting"/></button>
								</div>
								<div>
									<textarea class="form-control" style="display:none" name="dashCondition" id="alarmVal"></textarea>
									<textarea class="form-control" style="height: 130px; margin-top: 1px;resize:none;" name="alarmValStr" id="alarmValStr" readonly></textarea>
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-primary savePopBtn" accesskey="S" id="dashSaveBtn"><s:message code="common.msg.save"/></button>
						<button type="button" class="btn btn-primary savePopBtn conentBatchBtn" accesskey="D" id="dashShareSaveBtn"><s:message code="selectAdmin.share.save"/></button>
					</div>
				</form>
			</div>
		</div>
					...
					<div class="col-xs-12 text-left">
						<div class="form-group form-inline not-dashed">
							<div class="input-group">
								<input type="text" class="form-control input-sm" placeholder="<s:message code="dashboardSetup.titleSearch"/>" id="searchStrDashboard" style="width: 200px;">
								<div class="input-group-btn">
									<button class="btn btn-sm btn-success" type="button" accesskey="K" id="searchStrDashboardBtn"><i class="glyphicon glyphicon-search"></i></button>
								</div>
							</div>
							<button type="button" class="btn btn-sm btn-primary" accesskey="A" id="dashboardInsertBtn"><span class="glyphicon glyphicon-plus"></span>&nbsp;<s:message code="common.msg.add"/></button>
							<button type="button" class="btn btn-sm btn-default" accesskey="E" id="dashboardDeleteBtn"><span class="glyphicon glyphicon-minus"></span>&nbsp;<s:message code="common.msg.delete"/></button>
							<c:if test="${_USERCREDENTIAL_.adminId eq 'sysadmin'}">
							<button type="button" class="btn btn-sm btn-default" accesskey="S" id="dashboardShareBtn"><span class="glyphicon glyphicon-share"></span>&nbsp;<s:message code="common.msg.share"/></button>
							</c:if>
						</div>
					</div>
				</div>
	...
	<script type="text/javascript">
		...
		gridDashboard.loadHeader(false);
