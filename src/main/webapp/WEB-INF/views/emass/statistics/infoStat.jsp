    ...
    <div class="chartArea">
      <div>
        ...
        <div class="inner_personaldata ">
          <div class="personaldataBox h400">
            <div id="infoStatListGrid" class="slickGrid gridArea"></div>
          </div>
      ...
      <div>
        <h3>
          <s:message code="analysis.infostat.chart"/>
        </h3>
        <div class="chartBox h429">
