				...
				<div>
					<h3>
						...
						<div id="totalViewDiv" class="totalView" style="display:none;">
							<div class="subtab">
							<button type="button" title="<s:message code="stat.view.all"/>"><s:message
									code="stat.view.all"/></button>
							</div>
						</div>
			...
			<div class="subtab">
				<div>
					<ul class="nav nav-tabs codeTab listChart">
						<li class="active"><a data-toggle="tab" href="#basicStatList" id="listTab"><s:message code="stat.display.attachname.title"/></a></li>
					</ul>
				</div>
			</div>
			<div class="xcn_full">
    ...
    function getData(flag) {
        ...
        ui.get({
            ...
            success: function (data, total) {
                grid1.colInit();
                grid1.autoNumber();
                grid1.colAdd('rowKey', '<s:message code="condition.attach_name"/>', 230, 'left', false, 'link', function ( row, cell, value, columnDef, dataContext ) {
