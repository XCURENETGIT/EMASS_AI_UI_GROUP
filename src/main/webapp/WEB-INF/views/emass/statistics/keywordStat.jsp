			...
			<div class="subtab">
				<div>
					<ul class="nav nav-tabs codeTab listChart">
						<li class="active"><a data-toggle="tab" href="#basicStatList" id="listTab" ><s:message code="stat.display.keyword.title"/></a></li>
					</ul>
				</div>
			</div>
			<div class="xcn_full">
    ...
    function getData( flag ) {
        ...
        ui.get({
            ...
            success : function(data, total) {
                grid1.colInit();
                grid1.autoNumber();
                grid1.colAdd('rowKey', '<s:message code="condition.keyword"/>', 230, 'left', false, 'link', function ( row, cell, value, columnDef, dataContext ) {
