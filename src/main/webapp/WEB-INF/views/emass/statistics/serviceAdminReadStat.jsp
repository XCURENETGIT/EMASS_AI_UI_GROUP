...
<script type="text/javascript">
    ...
    grid1.onClick = function () {
        ...
        var displayName = rowKey.replaceAll("\\\"", "\"").replaceAll(",","");
    ...
    function getData(flag) {
        ...
        getReadTimeData(sDate, eDate, xAxis, xAxis_str, adminId);
    }



    function getReadTimeData(sDate, eDate, xAxis, xAxis_str, adminId) {
        searchFlag = true;
        grid1.on();
        ...
        ui.get({
            url : 'getServiceCheckedStatList.xcn',
            ...
            success: function (data, total) {
                ...
                grid1.autoNumber();
                var str = '';
                if (xAxis == 'checked.readTime_yyyymmdd') str = '<s:message code="stat.ctime.yyyymmdd"/>';
                else if( xAxis == 'svc1') str = '<s:message code="common.msg.admin"/>';
    ...
    function getDetailData(lastRow) {
        ...
        ui.get({
            url: 'getServiceStatCheckedDetailList.xcn',
            rowKey : rowKey,
            colKey : colKey,
