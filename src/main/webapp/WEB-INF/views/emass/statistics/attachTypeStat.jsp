        ...
        $(document).ready(function(){
            ...
            $('.print_stat').click(function() {
                ...
                if(gridDetail != undefined) {
                    ...
                    gridDetail.print('<s:message code="stat.detail.attach.list"/>', pMenuId, menuId);
                } else {
                    if (grid1.Rows == 0) {
                        alert('<s:message code="common.msg.nodata"/>');
                        return;
                    }
                    grid1.print('<s:message code="DATA_MONITOR.STAT_ATTACHTYPE"/>', pMenuId, menuId);
                }
            });
            ...
            $('.excel_stat').click(function() {
                var gridDetail = getCurrentGrid();
                if(gridDetail != undefined) {
                    excelDownLoad(gridDetail,'<s:message code="stat.detail.attach.list"/>');
                } else {
                    chart = $('#chartArea1').highcharts();
                    var svg = chart.getSVG();
                    excelDownLoad(grid1,'<s:message code="DATA_MONITOR.STAT_ATTACHTYPE"/>', svg);
                }
            });
            ...
            $('.cell_stat').click(function() {
                var gridDetail = getCurrentGrid();
                if(gridDetail != undefined) {
                    cellDownLoad(gridDetail,'<s:message code="stat.detail.attach.list"/>');
                } else {
                    cellDownLoad(grid1,'<s:message code="DATA_MONITOR.STAT_ATTACHTYPE"/>');
                }
            });
            ...
            $('.pdf_stat').click(function() {
                var gridDetail = getCurrentGrid();
                if(gridDetail != undefined) {
                    pdfDownLoad(gridDetail,'<s:message code="stat.detail.attach.list"/>');
                } else {
                    pdfDownLoad(grid1,'<s:message code="DATA_MONITOR.STAT_ATTACHTYPE"/>');
                }
            });
            ...
            $('.csv_stat').click(function() {
                var gridDetail = getCurrentGrid();
                if(gridDetail != undefined) {
                    csvDownLoad(gridDetail,'<s:message code="stat.detail.attach.list"/>');
                } else {
                    csvDownLoad(grid1,'<s:message code="DATA_MONITOR.STAT_ATTACHTYPE"/>');
                }
            });
 ...
 */
        function queryMakePop(  ){
            var url    = '<c:url value="/commons/queryMake.do?statType=attachType"/>';
...
<script type="text/javascript">
    ...
    grid1.loadExportMenu('<s:message code="DATA_ANALYSIS.STAT_ATTACHTYPE"/>');
    grid1.loadPageSize();
    ...
    function getData( flag ) {
        ...
        //var selAttach = $('#attachHidden').val();
