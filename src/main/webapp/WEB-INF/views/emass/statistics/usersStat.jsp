...
<!-- Back to top -->
<%--<a href="#0" class="back-to-top cd-top"><span class="[ fa fa-chevron-up ]"></span> <span--%>
<%--		class="[ ]">Back to the Top</span></a>--%>
...
<script type="text/javascript">
    ...
    var grid1 = new Xgrid('basicStatListGrid', contextRoot, 22);
    grid1.autoNumber();
