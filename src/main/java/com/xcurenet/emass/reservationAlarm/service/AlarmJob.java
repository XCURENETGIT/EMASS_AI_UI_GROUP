...
//			if (startDateSelect.equals("Y")) result = String.format("%s%02d0000", yyyyMMdd.print(_dt.minusDays(1)), startTimeSelect);
...
//		} else if (alarm_cycle.equals("H")) result = String.format("%s0000", yyyyMMddHH.print(_dt.minusHours(1)));
//
//		return result;
//	}
//
