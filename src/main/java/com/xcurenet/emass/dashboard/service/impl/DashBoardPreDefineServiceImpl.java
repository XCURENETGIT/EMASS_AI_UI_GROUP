...
public class DashBoardPreDefineServiceImpl implements DashBoardPreDefineService {
	...
	@Override
	public InterestUserMailVO getInterestUserMail(InterestUserMailVO interestUserMailVO) throws IOException, SolrServerException {
	...
	@Override
	public InterestUserServiceVO getInterestUserService(InterestUserServiceVO interestUserServiceVO) throws IOException, SolrServerException {
