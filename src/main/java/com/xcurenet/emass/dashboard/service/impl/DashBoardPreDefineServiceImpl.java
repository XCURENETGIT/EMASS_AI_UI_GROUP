...
//	}
    ...
    @Override
    public PatternPrivacyVO getTodayPatternPrivacy(PatternPrivacyVO patternPrivacyVO) throws IOException {
        return null;
    }

    @Override
    public RiskBehaviorVO getTodayRiskBehavior(RiskBehaviorVO riskBehaviorVO) throws IOException {
        return null;
    }

    @Override
    public KeywordDetectionVO getTodayKeywordDetection(KeywordDetectionVO keywordDetectionVO) throws IOException {
        return null;
    }

    @Override
    public ServiceDataLoggingVO getServiceDataLogging(ServiceDataLoggingVO serviceDataLoggingVO) throws IOException {
        return null;
    }
