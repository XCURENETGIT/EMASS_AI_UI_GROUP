...
//	}
//
//	private PdfWriterEMASS createPdfZipFile(File exportDir, PdfWriterEMASS pdfWriter, List<Emass> emass, JSONArray header, long total, int queryCnt, int solrCnt, String title, int dataLength) throws Exception {
//		int totalQueryCnt = (int) Math.ceil(total / (PAGE_BREAK * 1.0)); // 쿼리 실행 횟수
//		FileOutputStream os = null;
//		String fileName = "";
//
...
////		vo.setDownVal(solrEdcControllerLog.getListAudit(param)); 		/*############## Solr 관련 임시주석 ###############*/
