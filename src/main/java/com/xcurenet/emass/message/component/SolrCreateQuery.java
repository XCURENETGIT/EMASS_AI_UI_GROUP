...
//				query += String.format("%s:(%s) ", field, getSearchQuery(searchStr));
//			}
...
//						queryType = EXCEPT_QUERY;
//						str = str.substring(1, str.length());
//					}
//					query += String.format("%s{!edismax qf=%s pf=%s}%s ", queryType, field, field, str.trim());
//				}
//			}
//			//{!edismax qf=srcip pf=srcip}fec:0:0:0:0:0:1:68
//			return addQuery(String.format("%s(%s)", AND_QUERY, query));
//		}*/
//	}
//
