...
//		try {
//			log.info("Scheduler 데이터 가공 시작({}건) : {}", edcList.size(), Common.getDateTime(System.currentTimeMillis()));
//		} catch (Exception e) {}
...
//		try {
//			log.info("{}", list);
//			log.info("Scheduler 데이터 가공 종료 : {}", Common.getDateTime(System.currentTimeMillis()));
//		} catch (Exception e) {}
		return list;
	}
