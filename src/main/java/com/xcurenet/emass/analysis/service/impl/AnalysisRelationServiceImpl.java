...
import com.xcurenet.emass.analysis.service.UsageChart;
import com.xcurenet.emass.analysis.service.UsageChartSchedulerVO;
import com.xcurenet.emass.analysis.service.UsageChartVO;
import com.xcurenet.emass.analysis.service.UsageColumnChartVO;
...
public class AnalysisRelationServiceImpl extends XcnAbstractDAO implements AnalysisRelationService {
	...
	public AnalysisRelationListVO dataRelationList(SearchVO searchVO) throws IOException, SolrServerException {
		...
		//json.facet={result:{type : terms,limit:20, field : attachname_str,sort:"size desc", facet:{size : "sum(size)"}} }
