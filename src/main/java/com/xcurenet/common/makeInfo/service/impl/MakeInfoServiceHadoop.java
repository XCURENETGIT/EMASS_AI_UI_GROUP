...
public class MakeInfoServiceHadoop extends XcnAbstractDAO {
	...
	public String getTableCurrentVersion(String tableName) {
		String version = selectOne("com.xcurenet.sqlmap.mappers." + Config.DBMS_NAME + ".makeInfo.getTableCurrentVersion", tableName);
		if( version == null || version.equals("") ) return "0";
		else return Common.nvl ( version );
	}
	
	public int addVersion(String tableName, String version) {
		Map<String, Object> param = new HashMap<>();
		param.put("TABLENAME", tableName);
		param.put("VERSION", Common.nvn(version) + 1);
		param.put("ID", "system");
		param.put("COMMENTS", "");
	...
	public int addInfoUser() {
		...
		String version = getTableCurrentVersion("INFO_USER");
		appendData( version, "getInfoUser", "addInfoUser" );
		addVersion("INFO_USER", version);
		
		version = getTableCurrentVersion("INFO_IP");
		appendData( version, "getInfoIp", "addInfoIp" );
		...
		appendData( param, "getInfoEmailAddr", "addInfoEmailAddr" );
	...
	public int addInfoDevice() {
		...
		String version = getTableCurrentVersion("INFO_DEVICE");
		appendData( version, "getInfoDevice", "addInfoDevice" );
	...
	public int addInfoHoliday() {
		...
		String version = getTableCurrentVersion("INFO_HOLIDAY");
		appendData( version, "getInfoHoliDay", "addInfoHoliDay" );
	...
	public int addInfoWorkDay() {
		...
		String version = getTableCurrentVersion("INFO_WORKDAY");
		appendData( version, "getInfoWorkDay", "addInfoWorkDay" );
	...
	public int addInfoIpRange() {
		...
		String version = getTableCurrentVersion("INFO_IPRANGE");
		appendData( version, "getInfoIpRange", "addInfoIpRange" );
	...
	public int addInfoIpRangeDept() {
		...
		String version = getTableCurrentVersion("INFO_IPRANGE_DEPT");
		appendData( version, "getInfoIpRangeDept", "addInfoIpRangeDept" );
	...
	public int addInfoKeyword() {
		...
		String version = getTableCurrentVersion("INFO_KEYWORD");
		appendData( version, "getInfoKeyword", "addInfoKeyword" );
	...
	public int addInfoRegExp() {
		...
		String version = getTableCurrentVersion("INFO_PRIVATE");
		appendData( version, "getInfoRegExp", "addInfoRegExp" );
	...
	public int addInfoNoLog() {
		...
		String version = getTableCurrentVersion("INFO_NOLOG_URL");
		appendData( version, "getInfoNoLogUrl", "addInfoNoLogUrl" );
	...
	public void appendData ( String currentVersion, String select, String insert )
	{
		long pageSize = 10000;
		JSONObject param = new JSONObject ( );
