...
//            log.info("runCreateTable.sql 실행");
...
//
//        if (Common.isEquals(runPatchData, "true")) log.info("patch_data.sql 실행");
//        execute(patchDataPath, false);
//        if (Common.isEquals(runEnUpdate, "true")) log.info("Update_Query_en.sql 실행");
//        execute(enUpdatePath, false);
//        if (Common.isEquals(runKoUpdate, "true")) log.info("Update_Query_ko.sql 실행");
