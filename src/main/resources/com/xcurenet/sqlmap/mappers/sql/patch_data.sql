...
INSERT IGNORE INTO UI_SERVICE (`SERVICECD`, `SERVICENM_LV1`, `SERVICENM_LV2`, `SERVICENM_LV3`, `IN_OUT`, `SORT`, `USE_YN`, `MSGGRPCD`)  VALUES ('MP3-', '메일', 'POP3', '-', 'I', 1, 'Y', ''),
    ...
    ('NUKS', '노트', '기타', '발신', 'O', 329, 'Y', ''),
    ('AGCR', '일정', '구글캘린더일정', '수신', 'I', 330, 'N', ''),
    ('AGCS', '일정', '구글캘린더일정', '발신', 'O', 331, 'Y', ''),
    ('AGLR', '일정', '구글캘린더메일', '수신', 'I', 332, 'N', ''),
    ('AGLS', '일정', '구글캘린더메일', '발신', 'O', 333, 'Y', ''),
    ('ANCS', '일정', '네이버 캘린더', '발신', 'O', 334, 'Y', ''),
    ('ZTN-', '기타 서비스', 'Telnet', '-', 'O', 335, 'Y', ''),
    ('ZXT-', '기타 서비스', 'Xterm', '-', 'O', 336, 'Y', ''),
    ('ZRL-', '기타 서비스', 'R-Login', '-', 'O', 337, 'Y', ''),
    ('ZNP-', '기타 서비스', 'NNTP', '-', 'O', 338, 'Y', ''),
    ('ZPC-', '기타 서비스', 'PC 보안', '-', 'O', 339, 'N', ''),
    ('ZSH-', '기타 서비스', 'SSH', 'SSH 세션 정보', 'O', 340, 'Y', ''),
    ('XX1R', '모니터링_제외', '미분류_타입1', '수신', 'I', 341, 'Y', ''),
    ('XX1S', '모니터링_제외', '미분류_타입1', '발신', 'O', 342, 'Y', ''),
    ('XX2R', '모니터링_제외', '미분류_타입2', '수신', 'I', 343, 'Y', ''),
    ('XX2S', '모니터링_제외', '미분류_타입2', '발신', 'O', 344, 'Y', ''),
    ('XX3R', '모니터링_제외', '미분류_타입3', '수신', 'I', 345, 'Y', ''),
    ('XX3S', '모니터링_제외', '미분류_타입3', '발신', 'O', 346, 'Y', ''),
    ('XU1R', '모니터링_제외', '웹서비스(미분류)_타입1', '수신', 'I', 347, 'Y', ''),
    ('XU1S', '모니터링_제외', '웹서비스(미분류)_타입1', '발신', 'O', 348, 'Y', ''),
    ('XU2R', '모니터링_제외', '웹서비스(미분류)_타입2', '수신', 'I', 349, 'Y', ''),
    ('XU2S', '모니터링_제외', '웹서비스(미분류)_타입2', '발신', 'O', 350, 'Y', ''),
    ('XU3R', '모니터링_제외', '웹서비스(미분류)_타입3', '수신', 'I', 351, 'Y', ''),
    ('XU3S', '모니터링_제외', '웹서비스(미분류)_타입3', '발신', 'O', 352, 'Y', ''),
    ('UWSD', '웹서비스(미분류)', '웹 발신', '첨부 - 문서타입', 'O', 353, 'Y', ''),
    ('UWSE', '웹서비스(미분류)', '웹 발신', '첨부 - 문서아님', 'O', 354, 'Y', ''),
    ('UWSU', '웹서비스(미분류)', '웹 발신', '첨부 없음', 'O', 355, 'Y', ''),
    ('UWSH', '웹서비스(미분류)', '웹 발신', '중요도(상)', 'O', 356, 'Y', ''),
    ('UWSM', '웹서비스(미분류)', '웹 발신', '중요도(중)', 'O', 357, 'Y', ''),
    ('UWSL', '웹서비스(미분류)', '웹 발신', '중요도(하)', 'O', 358, 'Y', ''),
    ('UX1R', '웹서비스(미분류)', '미분류_타입1', '수신', 'I', 359, 'Y', ''),
    ('UX1S', '웹서비스(미분류)', '미분류_타입1', '발신', 'O', 360, 'Y', ''),
    ('UX2R', '웹서비스(미분류)', '미분류_타입2', '수신', 'I', 361, 'Y', ''),
    ('UX2S', '웹서비스(미분류)', '미분류_타입2', '발신', 'O', 362, 'Y', ''),
    ('UX3R', '웹서비스(미분류)', '미분류_타입3', '수신', 'I', 363, 'Y', ''),
    ('UX3S', '웹서비스(미분류)', '미분류_타입3', '발신', 'O', 364, 'Y', ''),
    ('UWRD', '웹서비스(미분류)', '웹 수신', '첨부 - 문서타입', 'I', 365, 'Y', ''),
    ('UWRE', '웹서비스(미분류)', '웹 수신', '첨부 - 문서아님', 'I', 366, 'Y', ''),
    ('UWRU', '웹서비스(미분류)', '웹 수신', '첨부 없음', 'I', 367, 'Y', ''),
    ('BWSD', '웹서비스(업무)', '업무 발신', '첨부 - 문서타입', 'O', 368, 'Y', ''),
    ('BWSE', '웹서비스(업무)', '업무 발신', '첨부 - 문서아님', 'O', 369, 'Y', ''),
    ('BWSU', '웹서비스(업무)', '업무 발신', '첨부 없음', 'O', 370, 'Y', ''),
    ('BWRD', '웹서비스(업무)', '업무 수신', '첨부 - 문서타입', 'I', 371, 'Y', ''),
    ('BWRE', '웹서비스(업무)', '업무 수신', '첨부 - 문서아님', 'I', 372, 'Y', ''),
    ('BWRU', '웹서비스(업무)', '업무 수신', '첨부 없음', 'I', 373, 'Y', ''),
    ('TWEC', '화상회의', 'Webex', '채팅', 'O', 374, 'Y', 'MSG'),
    ('TWEF', '화상회의', 'Webex', '파일전송', 'O', 375, 'Y', 'MSG'),
    ('TWEJ', '화상회의', 'Webex', '참여', 'O', 376, 'Y', 'MSG'),
    ('TWEL', '화상회의', 'Webex', '떠남', 'O', 377, 'Y', 'MSG'),
    ('TZOC', '화상회의', 'Zoom', '채팅', 'O', 378, 'Y', 'MSG'),
    ('TZOF', '화상회의', 'Zoom', '파일전송', 'O', 379, 'Y', 'MSG'),
    ('TZOJ', '화상회의', 'Zoom', '참여', 'O', 380, 'Y', 'MSG'),
    ('TZOL', '화상회의', 'Zoom', '떠남', 'O', 381, 'Y', 'MSG'),
    ('TTMC', '화상회의', 'Teams', '채팅', 'O', 382, 'Y', 'MSG'),
    ('TTMF', '화상회의', 'Teams', '파일전송', 'O', 383, 'Y', 'MSG'),
    ('TTMJ', '화상회의', 'Teams', '참여', 'O', 384, 'Y', 'MSG'),
    ('TTML', '화상회의', 'Teams', '떠남', 'O', 385, 'Y', 'MSG'),
    ('TSKC', '화상회의', 'Skype', '채팅', 'O', 386, 'Y', 'MSG'),
    ('TSKF', '화상회의', 'Skype', '파일전송', 'O', 387, 'Y', 'MSG'),
    ('TSKJ', '화상회의', 'Skype', '참여', 'O', 388, 'Y', 'MSG'),
    ('TSKL', '화상회의', 'Skype', '떠남', 'O', 389, 'Y', 'MSG'),
    ('TJMC', '화상회의', 'JoinME', '채팅', 'O', 390, 'Y', 'MSG'),
    ('TJMF', '화상회의', 'JoinME', '파일전송', 'O', 391, 'Y', 'MSG'),
    ('TAMC', '화상회의', 'Amazon Chime', '채팅', 'O', 392, 'Y', 'MSG'),
    ('TAMF', '화상회의', 'Amazon Chime', '파일전송', 'O', 393, 'Y', 'MSG'),
    ('TBJC', '화상회의', 'BlueJeans', '채팅', 'O', 394, 'Y', 'MSG'),
    ('TTDS', '화상회의', 'tl;dv', '채팅', 'O', 395, 'Y', 'MSG'),
    ('LNVS', '번역기', '파파고 번역', '발신', 'O', 396, 'Y', ''),
    ('LGGS', '번역기', '구글 번역', '발신', 'O', 397, 'Y', ''),
    ('LGPS', '번역기', '구글 번역 플러그인', '발신', 'O', 398, 'Y', ''),
    ('LDES', '번역기', 'Deepl', '발신', 'O', 399, 'Y', ''),
    ('LBIS', '번역기', 'Bing 번역', '발신', 'O', 400, 'Y', ''),
    ('LYMS', '번역기', 'Yandex 번역', '발신', 'O', 401, 'Y', ''),
    ('LUKS', '번역기', '기타', '발신', 'I', 402, 'Y', ''),
    ('IGBS', '생성형 AI', '구글 Gemini', '발신', 'O', 403, 'Y', ''),
    ('IBIS', '생성형 AI', 'Microsoft BingAI Chat', '발신', 'O', 404, 'Y', ''),
    ('IWTS', '생성형 AI', 'wrtn', '발신', 'O', 405, 'Y', ''),
    ('IGPS', '생성형 AI', 'chatGPT', '발신', 'O', 406, 'Y', ''),
    ('IDAS', '생성형 AI', 'Dall-E', '발신', 'O', 407, 'Y', ''),
    ('IGCS', '생성형 AI', 'Github Copilot', '발신', 'I', 408, 'Y', ''),
    ('IYCS', '생성형 AI', 'YouChat', '발신', 'I', 409, 'Y', ''),
    ('ICSS', '생성형 AI', 'Chatsonic', '발신', 'I', 410, 'Y', ''),
    ('IRPS', '생성형 AI', 'replika', '발신', 'I', 411, 'Y', ''),
    ('IPPS', '생성형 AI', 'Perplexity', '발신', 'I', 412, 'Y', ''),
    ('ITCS', '생성형 AI', 'TextCortex', '발신', 'I', 413, 'Y', ''),
    ('IPHS', '생성형 AI', 'Phind', '발신', 'I', 414, 'Y', ''),
    ('IPOS', '생성형 AI', 'Poe', '발신', 'I', 415, 'Y', ''),
    ...
    ('IADS', '생성형 AI', 'Adobe AI', '발신', 'I', 426, 'Y', ''),
    ('ICDS', '생성형 AI', 'ClipDrop', '발신', 'I', 427, 'Y', ''),
    ('ISBS', '생성형 AI', 'Stability.Ai', '발신', 'I', 428, 'Y', ''),
    ('IRMS', '생성형 AI', 'Runwayml', '발신', 'I', 429, 'Y', ''),
    ('IGVS', '생성형 AI', 'Google Vertex', '발신', 'I', 430, 'Y', ''),
    ('IGLS', '생성형 AI', 'Google Colab', '발신', 'I', 431, 'Y', ''),
    ('ICWS', '생성형 AI', 'CodeWhisperer', '발신', 'I', 432, 'Y', ''),
    ('IMSS', '생성형 AI', 'MakerSuite', '발신', 'I', 433, 'Y', ''),
    ('IOCS', '생성형 AI', 'Clova OCR', '발신', 'I', 434, 'Y', ''),
    ('IAOS', '생성형 AI', 'Azure OpenAI', '발신', 'I', 435, 'Y', ''),
    ('ICUS', '생성형 AI', '네이버 CUE:', '발신', 'I', 436, 'Y', ''),
    ('IMJS', '생성형 AI', 'Midjourney', '발신', 'I', 437, 'Y', ''),
    ('ISGR', '생성형 AI', 'slidesGPT', '수신', 'I', 438, 'Y', ''),
    ('ISGS', '생성형 AI', 'slidesGPT', '발신', 'I', 439, 'Y', ''),
    ('IDMS', '생성형 AI', 'AiDocmaker', '발신', 'I', 440, 'Y', ''),
    ('IRKS', '생성형 AI', 'Reka AI', '발신', 'I', 441, 'Y', ''),
    ('ICLS', '생성형 AI', 'claude', '발신', 'I', 442, 'Y', ''),
    ('IDMR', '생성형 AI', 'Ai Docker Attach', '수신', 'I', 443, 'Y', ''),
    ('IADR', '생성형 AI', 'Adobe firefly login', '수신', 'I', 444, 'Y', ''),
    ('IUKS', '생성형 AI', '기타', '발신', 'I', 445, 'Y', ''),
    ('PDOS', '프로젝트', 'dooray', '발신', 'O', 446, 'Y', ''),
    ('PGIS', '프로젝트', 'github', '발신', 'O', 447, 'Y', ''),
    ('EBDR', '그룹웨어', '게시', '수신', 'I', 448, 'Y', ''),
    ('EBD-', '그룹웨어', '게시', '발신', 'O', 449, 'Y', ''),
    ('EBBR', '그룹웨어', '게시판', '수신', 'I', 450, 'Y', ''),
    ('EBBS', '그룹웨어', '게시판', '발신', 'O', 451, 'Y', ''),
    ('EBBF', '그룹웨어', '게시판', '파일수신', 'I', 452, 'Y', ''),
    ('EAAR', '그룹웨어', '결재', '수신', 'I', 453, 'Y', ''),
    ('EAAS', '그룹웨어', '결재', '발신', 'O', 454, 'Y', ''),
    ('EAAG', '그룹웨어', '결재', '통보 - 수신', 'I', 455, 'Y', ''),
    ('EAAP', '그룹웨어', '결재', '통보 - 발신', 'O', 456, 'Y', ''),
    ('EAAF', '그룹웨어', '결재', '파일수신', 'I', 457, 'Y', ''),
    ('EMMR', '그룹웨어', '메일', '그룹웨어 수신', 'I', 458, 'Y', ''),
    ('EMMS', '그룹웨어', '메일', '그룹웨어 발신', 'O', 459, 'Y', ''),
    ('EMMG', '그룹웨어', '메일', 'OWA 수신', 'I', 460, 'Y', ''),
    ('EMMP', '그룹웨어', '메일', 'OWA 발신', 'O', 461, 'Y', ''),
    ('EMMD', '그룹웨어', '메일', 'RPC 수신', 'I', 462, 'Y', ''),
    ('EMMU', '그룹웨어', '메일', 'RPC 발신', 'O', 463, 'Y', ''),
    ('EMMC', '그룹웨어', '메일', '수신', 'I', 464, 'Y', ''),
    ('EMML', '그룹웨어', '메일', '발신', 'O', 465, 'Y', ''),
    ('EMM1', '그룹웨어', '메일', '보안등급1', 'O', 466, 'Y', ''),
    ('EMM2', '그룹웨어', '메일', '보안등급2', 'O', 467, 'Y', ''),
    ('EMM3', '그룹웨어', '메일', '보안등급3', 'O', 468, 'Y', ''),
    ('EMM4', '그룹웨어', '메일', '보안등급4', 'O', 469, 'Y', ''),
    ('EMMA', '그룹웨어', '메일', '임시(자동)', 'O', 470, 'Y', ''),
    ('EMMT', '그룹웨어', '메일', '임시(수동)', 'O', 471, 'Y', ''),
    ('EMMK', '그룹웨어', '메일', 'Outlook - 수신', 'I', 472, 'Y', ''),
    ('EMMO', '그룹웨어', '메일', 'Outlook - 발신', 'O', 473, 'Y', ''),
    ('EMMB', '그룹웨어', '메일', '그룹웨어 예약메일', 'O', 474, 'Y', ''),
    ('EMBR', '그룹웨어', '모바일', '수신', 'I', 475, 'Y', ''),
    ('EMB-', '그룹웨어', '모바일', '발신', 'O', 476, 'Y', ''),
    ('EWSR', '그룹웨어', '웹서비스', '수신', 'I', 477, 'Y', ''),
    ('EWS-', '그룹웨어', '웹서비스', '발신', 'O', 478, 'Y', ''),
    ('EPUR', '그룹웨어', '일반', '수신', 'I', 479, 'Y', ''),
    ('EPU-', '그룹웨어', '일반', '발신', 'O', 480, 'Y', ''),
    ('ESCR', '그룹웨어', '일정 명함', '수신', 'I', 481, 'Y', ''),
    ('ESC-', '그룹웨어', '일정 명함', '발신', 'O', 482, 'Y', ''),
    ('EMF-', '그룹웨어', '파일 다운로드', '-', 'I', 483, 'Y', ''),
    ('EMU-', '그룹웨어', '기타', '', 'O', 484, 'Y', ''),
    ('EMDR', '그룹웨어', '드라이브', '수신', 'I', 485, 'Y', ''),
    ('EMDS', '그룹웨어', '드라이브', '발신', 'O', 486, 'Y', ''),
    ('ECIS', '그룹웨어', 'Samsung cic', '발신', 'O', 487, 'Y', ''),
    ('DCCS', '편집기', 'Clip Champ', '발신', 'O', 488, 'Y', '');
