...
INSERT INTO UI_SERVICE (`SERVICECD`, `SERVICENM_LV1`, `SERVICENM_LV2`, `SERVICENM_LV3`, `IN_OUT`, `SORT`, `USE_YN`, `MSGGRPCD`) VALUES
   ('MP3-','메일','POP3','-','I',1,'Y',''),
       ...
       ('IUKS', '생성형 AI', '기타', '발신', 'I', 433, 'Y', ''),
       ('PDOS', '프로젝트', 'dooray', '발신', 'O', 434, 'Y', ''),
       ('PGIS', '프로젝트', 'github', '발신', 'O', 435, 'Y', ''),
       ('EBDR', '그룹웨어', '게시', '수신', 'I', 436, 'Y', ''),
       ('EBD-', '그룹웨어', '게시', '발신', 'O', 437, 'Y', ''),
       ('EBBR', '그룹웨어', '게시판', '수신', 'I', 438, 'Y', ''),
       ('EBBS', '그룹웨어', '게시판', '발신', 'O', 439, 'Y', ''),
       ('EBBF', '그룹웨어', '게시판', '파일수신', 'I', 440, 'Y', ''),
       ('EAAR', '그룹웨어', '결재', '수신', 'I', 441, 'Y', ''),
       ('EAAS', '그룹웨어', '결재', '발신', 'O', 442, 'Y', ''),
       ('EAAG', '그룹웨어', '결재', '통보 - 수신', 'I', 443, 'Y', ''),
       ('EAAP', '그룹웨어', '결재', '통보 - 발신', 'O', 444, 'Y', ''),
       ('EAAF', '그룹웨어', '결재', '파일수신', 'I', 445, 'Y', ''),
       ('EMMR', '그룹웨어', '메일', '그룹웨어 수신', 'I', 446, 'Y', ''),
       ('EMMS', '그룹웨어', '메일', '그룹웨어 발신', 'O', 447, 'Y', ''),
       ('EMMG', '그룹웨어', '메일', 'OWA 수신', 'I', 448, 'Y', ''),
       ('EMMP', '그룹웨어', '메일', 'OWA 발신', 'O', 449, 'Y', ''),
       ('EMMD', '그룹웨어', '메일', 'RPC 수신', 'I', 450, 'Y', ''),
       ('EMMU', '그룹웨어', '메일', 'RPC 발신', 'O', 451, 'Y', ''),
       ('EMMC', '그룹웨어', '메일', '수신', 'I', 452, 'Y', ''),
       ('EMML', '그룹웨어', '메일', '발신', 'O', 453, 'Y', ''),
       ('EMM1', '그룹웨어', '메일', '보안등급1', 'O', 454, 'Y', ''),
       ('EMM2', '그룹웨어', '메일', '보안등급2', 'O', 455, 'Y', ''),
       ('EMM3', '그룹웨어', '메일', '보안등급3', 'O', 456, 'Y', ''),
       ('EMM4', '그룹웨어', '메일', '보안등급4', 'O', 457, 'Y', ''),
       ('EMMA', '그룹웨어', '메일', '임시(자동)', 'O', 458, 'Y', ''),
       ('EMMT', '그룹웨어', '메일', '임시(수동)', 'O', 459, 'Y', ''),
       ('EMMK', '그룹웨어', '메일', 'Outlook - 수신', 'I', 460, 'Y', ''),
       ('EMMO', '그룹웨어', '메일', 'Outlook - 발신', 'O', 461, 'Y', ''),
       ('EMMB', '그룹웨어', '메일', '그룹웨어 예약메일', 'O', 462, 'Y', ''),
       ('EMBR', '그룹웨어', '모바일', '수신', 'I', 463, 'Y', ''),
       ('EMB-', '그룹웨어', '모바일', '발신', 'O', 464, 'Y', ''),
       ('EWSR', '그룹웨어', '웹서비스', '수신', 'I', 465, 'Y', ''),
       ('EWS-', '그룹웨어', '웹서비스', '발신', 'O', 466, 'Y', ''),
       ('EPUR', '그룹웨어', '일반', '수신', 'I', 467, 'Y', ''),
       ('EPU-', '그룹웨어', '일반', '발신', 'O', 468, 'Y', ''),
       ('ESCR', '그룹웨어', '일정 명함', '수신', 'I', 469, 'Y', ''),
       ('ESC-', '그룹웨어', '일정 명함', '발신', 'O', 470, 'Y', ''),
       ('EMF-', '그룹웨어', '파일 다운로드', '-', 'I', 471, 'Y', ''),
       ('EMU-', '그룹웨어', '기타', '', 'O', 472, 'Y', ''),
       ('EMDR', '그룹웨어', '드라이브', '수신', 'I', 473, 'Y', ''),
       ('EMDS', '그룹웨어', '드라이브', '발신', 'O', 474, 'Y', '');
...
SELECT @ROWNUM:=@ROWNUM+1 AS MENU_KEY,'Default Dashboard','fa fa-laptop',A.ADMIN_ID,'Y','N','Y',NOW()
