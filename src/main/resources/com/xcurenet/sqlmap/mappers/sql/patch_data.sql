...
-- 풀패킷 메뉴 숨김 처리
UPDATE UI_MENU SET MENU_USEYN='N' WHERE MENU_ID='ANALYSIS_SEARCH'
UPDATE UI_MENU SET MENU_USEYN='N' WHERE MENU_ID='ANALYSIS_UBA'
UPDATE UI_MENU SET MENU_USEYN='N' WHERE MENU_ID='STAT_DSTIPTOP'
UPDATE UI_MENU SET MENU_USEYN='N' WHERE MENU_ID='STAT_DSTPORTTOP'
UPDATE UI_MENU SET MENU_USEYN='N' WHERE MENU_ID='STAT_IPNONIP'
UPDATE UI_MENU SET MENU_USEYN='N' WHERE MENU_ID='STAT_SRCIPTOP'
UPDATE UI_MENU SET MENU_USEYN='N' WHERE MENU_ID='STAT_WEBTOP'
