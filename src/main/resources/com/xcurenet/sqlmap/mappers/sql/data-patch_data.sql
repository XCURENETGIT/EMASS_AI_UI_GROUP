...
('NCRS', '노트', 'Craft', '발신', 'O', 366, 'Y', ''),
('AGCR', '일정', '구글캘린더일정', '수신', 'I', 367, 'N', ''),
('AGCS', '일정', '구글캘린더일정', '발신', 'O', 368, 'Y', ''),
('AGLR', '일정', '구글캘린더메일', '수신', 'I', 369, 'N', ''),
('AGLS', '일정', '구글캘린더메일', '발신', 'O', 370, 'Y', ''),
('ANCS', '일정', '네이버 캘린더', '발신', 'O', 371, 'Y', ''),
('ZTN-', '기타 서비스', 'Telnet', '-', 'O', 372, 'Y', ''),
('ZXT-', '기타 서비스', 'Xterm', '-', 'O', 373, 'Y', ''),
('ZRL-', '기타 서비스', 'R-Login', '-', 'O', 374, 'Y', ''),
('ZNP-', '기타 서비스', 'NNTP', '-', 'O', 375, 'Y', ''),
('ZPC-', '기타 서비스', 'PC 보안', '-', 'O', 376, 'N', ''),
('ZSH-', '기타 서비스', 'SSH', 'SSH 세션 정보', 'O', 377, 'Y', ''),
('XX1R', '모니터링_제외', '미분류_타입1', '수신', 'I', 378, 'Y', ''),
('XX1S', '모니터링_제외', '미분류_타입1', '발신', 'O', 379, 'Y', ''),
('XX2R', '모니터링_제외', '미분류_타입2', '수신', 'I', 380, 'Y', ''),
('XX2S', '모니터링_제외', '미분류_타입2', '발신', 'O', 381, 'Y', ''),
('XX3R', '모니터링_제외', '미분류_타입3', '수신', 'I', 382, 'Y', ''),
('XX3S', '모니터링_제외', '미분류_타입3', '발신', 'O', 383, 'Y', ''),
('XU1R', '모니터링_제외', '웹서비스(미분류)_타입1', '수신', 'I', 384, 'Y', ''),
('XU1S', '모니터링_제외', '웹서비스(미분류)_타입1', '발신', 'O', 385, 'Y', ''),
('XU2R', '모니터링_제외', '웹서비스(미분류)_타입2', '수신', 'I', 386, 'Y', ''),
('XU2S', '모니터링_제외', '웹서비스(미분류)_타입2', '발신', 'O', 387, 'Y', ''),
('XU3R', '모니터링_제외', '웹서비스(미분류)_타입3', '수신', 'I', 388, 'Y', ''),
('XU3S', '모니터링_제외', '웹서비스(미분류)_타입3', '발신', 'O', 389, 'Y', ''),
('XU4R', '모니터링_제외', '필수 로깅', '수신', 'I', 390, 'Y', ''),
('XU4S', '모니터링_제외', '필수 로깅', '발신', 'O', 391, 'Y', ''),
('UWSD', '웹서비스(미분류)', '웹 발신', '첨부 - 문서타입', 'O', 392, 'Y', ''),
('UWSE', '웹서비스(미분류)', '웹 발신', '첨부 - 문서아님', 'O', 393, 'Y', ''),
('UWSU', '웹서비스(미분류)', '웹 발신', '첨부 없음', 'O', 394, 'Y', ''),
('UWSH', '웹서비스(미분류)', '웹 발신', '중요도(상)', 'O', 395, 'Y', ''),
('UWSM', '웹서비스(미분류)', '웹 발신', '중요도(중)', 'O', 396, 'Y', ''),
('UWSL', '웹서비스(미분류)', '웹 발신', '중요도(하)', 'O', 397, 'Y', ''),
('UX1R', '웹서비스(미분류)', '미분류_타입1', '수신', 'I', 398, 'Y', ''),
('UX1S', '웹서비스(미분류)', '미분류_타입1', '발신', 'O', 399, 'Y', ''),
('UX2R', '웹서비스(미분류)', '미분류_타입2', '수신', 'I', 400, 'Y', ''),
('UX2S', '웹서비스(미분류)', '미분류_타입2', '발신', 'O', 401, 'Y', ''),
('UX3R', '웹서비스(미분류)', '미분류_타입3', '수신', 'I', 402, 'Y', ''),
('UX3S', '웹서비스(미분류)', '미분류_타입3', '발신', 'O', 403, 'Y', ''),
('UWRD', '웹서비스(미분류)', '웹 수신', '첨부 - 문서타입', 'I', 404, 'Y', ''),
('UWRE', '웹서비스(미분류)', '웹 수신', '첨부 - 문서아님', 'I', 405, 'Y', ''),
('UWRU', '웹서비스(미분류)', '웹 수신', '첨부 없음', 'I', 406, 'Y', ''),
('BWSD', '웹서비스(업무)', '업무 발신', '첨부 - 문서타입', 'O', 407, 'Y', ''),
('BWSE', '웹서비스(업무)', '업무 발신', '첨부 - 문서아님', 'O', 408, 'Y', ''),
('BWSU', '웹서비스(업무)', '업무 발신', '첨부 없음', 'O', 409, 'Y', ''),
('BWRD', '웹서비스(업무)', '업무 수신', '첨부 - 문서타입', 'I', 410, 'Y', ''),
('BWRE', '웹서비스(업무)', '업무 수신', '첨부 - 문서아님', 'I', 411, 'Y', ''),
('BWRU', '웹서비스(업무)', '업무 수신', '첨부 없음', 'I', 412, 'Y', ''),
('TWEC', '화상회의', 'Webex', '채팅', 'O', 413, 'Y', 'MSG'),
('TWEF', '화상회의', 'Webex', '파일전송', 'O', 414, 'Y', 'MSG'),
('TWEJ', '화상회의', 'Webex', '참여', 'O', 415, 'Y', 'MSG'),
('TWEL', '화상회의', 'Webex', '떠남', 'O', 416, 'Y', 'MSG'),
('TZOC', '화상회의', 'Zoom', '채팅', 'O', 417, 'Y', 'MSG'),
('TZOF', '화상회의', 'Zoom', '파일전송', 'O', 418, 'Y', 'MSG'),
('TZOJ', '화상회의', 'Zoom', '참여', 'O', 419, 'Y', 'MSG'),
('TZOL', '화상회의', 'Zoom', '떠남', 'O', 420, 'Y', 'MSG'),
('TTMC', '화상회의', 'Teams', '채팅', 'O', 421, 'Y', 'MSG'),
('TTMF', '화상회의', 'Teams', '파일전송', 'O', 422, 'Y', 'MSG'),
('TTMJ', '화상회의', 'Teams', '참여', 'O', 423, 'Y', 'MSG'),
('TTML', '화상회의', 'Teams', '떠남', 'O', 424, 'Y', 'MSG'),
('TSKC', '화상회의', 'Skype', '채팅', 'O', 425, 'Y', 'MSG'),
('TSKF', '화상회의', 'Skype', '파일전송', 'O', 426, 'Y', 'MSG'),
('TSKJ', '화상회의', 'Skype', '참여', 'O', 427, 'Y', 'MSG'),
('TSKL', '화상회의', 'Skype', '떠남', 'O', 428, 'Y', 'MSG'),
('TJMC', '화상회의', 'JoinME', '채팅', 'O', 429, 'Y', 'MSG'),
('TJMF', '화상회의', 'JoinME', '파일전송', 'O', 430, 'Y', 'MSG'),
('TAMC', '화상회의', 'Amazon Chime', '채팅', 'O', 431, 'Y', 'MSG'),
('TAMF', '화상회의', 'Amazon Chime', '파일전송', 'O', 432, 'Y', 'MSG'),
('TBJC', '화상회의', 'BlueJeans', '채팅', 'O', 433, 'Y', 'MSG'),
('TTDS', '화상회의', 'Tl;dv', '채팅', 'O', 434, 'Y', 'MSG'),
('LNVS', '번역기', '파파고 번역', '발신', 'O', 435, 'Y', ''),
('LGGS', '번역기', '구글 번역', '발신', 'O', 436, 'Y', ''),
('LGPS', '번역기', '구글 번역 플러그인', '발신', 'O', 437, 'Y', ''),
('LDES', '번역기', 'Deepl', '발신', 'O', 438, 'Y', ''),
('LBIS', '번역기', 'Bing 번역', '발신', 'O', 439, 'Y', ''),
('LYMS', '번역기', 'Yandex 번역', '발신', 'O', 440, 'Y', ''),
('LGAS', '번역기', 'Google Cloud Translation Api', '발신', 'O', 441, 'Y', ''),
('LFTS', '번역기', 'Flitto', '발신', 'O', 442, 'Y', ''),
('LOTS', '번역기', 'O-Translator', '발신', 'O', 443, 'Y', ''),
('LUKS', '번역기', '기타', '발신', 'O', 444, 'Y', ''),
('IGBS', '생성형 AI', '구글 Gemini', '발신', 'O', 445, 'Y', ''),
('IBIS', '생성형 AI', ' Microsoft Copilot', '발신', 'O', 446, 'Y', ''),
('IWTS', '생성형 AI', 'Wrtn', '발신', 'O', 447, 'Y', ''),
('IGPS', '생성형 AI', 'ChatGPT', '발신', 'O', 448, 'Y', ''),
('IGPR', '생성형 AI', 'ChatGPT', '수신', 'I', 449, 'Y', ''),
('IDAS', '생성형 AI', 'Dall-E', '발신', 'O', 450, 'Y', ''),
('IGCS', '생성형 AI', 'Github Copilot', '발신', 'O', 451, 'Y', ''),
('IGCR', '생성형 AI', 'Github Copilot', '수신', 'I', 452, 'Y', ''),
('IYCS', '생성형 AI', 'YouChat', '발신', 'O', 453, 'Y', ''),
('ICSS', '생성형 AI', 'Chatsonic', '발신', 'O', 454, 'Y', ''),
('IRPS', '생성형 AI', 'Replika', '발신', 'O', 455, 'Y', ''),
('IPPS', '생성형 AI', 'Perplexity', '발신', 'O', 456, 'Y', ''),
('IPPR', '생성형 AI', 'Perplexity', '수신', 'I', 457, 'Y', ''),
('ITCS', '생성형 AI', 'TextCortex', '발신', 'O', 458, 'Y', ''),
('IPHS', '생성형 AI', 'Phind', '발신', 'O', 459, 'Y', ''),
('IPOS', '생성형 AI', 'Poe', '발신', 'O', 460, 'Y', ''),
('IHFS', '생성형 AI', 'Hugging Face', '발신', 'O', 461, 'Y', ''),
('ICPS', '생성형 AI', 'Copy.AI', '발신', 'O', 462, 'Y', ''),
('IHWS', '생성형 AI', 'HyperWrite', '발신', 'O', 463, 'Y', ''),
('IDPS', '생성형 AI', 'DeepAI', '발신', 'O', 464, 'Y', ''),
('IACS', '생성형 AI', 'AskCodi', '발신', 'O', 465, 'Y', ''),
('INAS', '생성형 AI', 'Native', '발신', 'O', 466, 'Y', ''),
('INFS', '생성형 AI', 'NeuroFlash', '발신', 'O', 467, 'Y', ''),
('INOS', '생성형 AI', 'Notion AI', '발신', 'O', 468, 'Y', ''),
('INOR', '생성형 AI', 'Notion AI', '수신', 'I', 469, 'Y', ''),
('IMES', '생성형 AI', 'Merlin', '발신', 'O', 470, 'Y', ''),
('ICXS', '생성형 AI', 'CLOVA-X', '발신', 'O', 471, 'Y', ''),
('IADS', '생성형 AI', 'Adobe AI', '발신', 'O', 472, 'Y', ''),
('ICDS', '생성형 AI', 'ClipDrop', '발신', 'O', 473, 'Y', ''),
('ISBS', '생성형 AI', 'Stability.Ai', '발신', 'O', 474, 'Y', ''),
('IRMS', '생성형 AI', 'Runwayml', '발신', 'O', 475, 'Y', ''),
('IGVS', '생성형 AI', 'Google Vertex', '발신', 'O', 476, 'Y', ''),
('IGLS', '생성형 AI', 'Google Colab', '발신', 'O', 477, 'Y', ''),
('ICWS', '생성형 AI', 'CodeWhisperer', '발신', 'O', 478, 'Y', ''),
('IMSS', '생성형 AI', 'Google AI Studio', '발신', 'O', 479, 'Y', ''),
('IOCS', '생성형 AI', 'Clova OCR', '발신', 'O', 480, 'Y', ''),
('IAOS', '생성형 AI', 'Azure OpenAI', '발신', 'O', 481, 'Y', ''),
('ICUS', '생성형 AI', '네이버 CUE:', '발신', 'O', 482, 'Y', ''),
('IMJS', '생성형 AI', 'Midjourney', '발신', 'O', 483, 'Y', ''),
('ISGR', '생성형 AI', 'slidesGPT', '수신', 'I', 484, 'Y', ''),
('ISGS', '생성형 AI', 'SlidesGPT', '발신', 'O', 485, 'Y', ''),
('IDMS', '생성형 AI', 'Ai Docmaker', '발신', 'O', 486, 'Y', ''),
('IRKS', '생성형 AI', 'Reka AI', '발신', 'O', 487, 'Y', ''),
('ICLS', '생성형 AI', 'Claude', '발신', 'O', 488, 'Y', ''),
('IDMR', '생성형 AI', 'AI Docmaker Attach', '수신', 'I', 489, 'Y', ''),
('IADR', '생성형 AI', 'Adobe firefly login', '수신', 'I', 490, 'Y', ''),
('IWDS', '생성형 AI', 'Dream by WOMBO', '발신', 'O', 491, 'Y', ''),
('IGAS', '생성형 AI', 'GetImg.AI', '발신', 'O', 492, 'Y', ''),
('IWKS', '생성형 AI', 'Wrks.ai', '발신', 'O', 493, 'Y', ''),
('IPSS', '생성형 AI', 'Polaris office ai', '발신', 'O', 494, 'Y', ''),
('IBGS', '생성형 AI', 'Goover AI', '발신', 'O', 495, 'Y', ''),
('IIAS', '생성형 AI', 'iAsk AI', '발신', 'O', 496, 'Y', ''),
('ISNS', '생성형 AI', 'Suno AI', '발신', 'O', 497, 'Y', ''),
('IPES', '생성형 AI', 'Perchance', '발신', 'O', 498, 'Y', ''),
('IPFS', '생성형 AI', 'ChatPDF', '발신', 'O', 499, 'Y', ''),
('IXOS', '생성형 AI', 'Exaone', '발신', 'O', 500, 'Y', ''),
('ISOR', '생성형 AI', 'Slidesgo', '수신', 'I', 501, 'Y', ''),
('ISOS', '생성형 AI', 'Slidesgo', '발신', 'O', 502, 'Y', ''),
('IKRS', '생성형 AI', 'KREA', '발신', 'O', 503, 'Y', ''),
('ILMS', '생성형 AI', 'GoogleNotebook LM', '발신', 'O', 504, 'Y', ''),
('ICCS', '생성형 AI', 'Capcut', '발신', 'O', 505, 'Y', ''),
('IMGS', '생성형 AI', 'Magictool', '발신', 'O', 506, 'Y', ''),
('IGSS', '생성형 AI', 'Genspark', '발신', 'O', 507, 'Y', ''),
('IFES', '생성형 AI', 'felo', '발신', 'O', 508, 'Y', ''),
('ITPS', '생성형 AI', 'Tripo3D', '발신', 'O', 509, 'Y', ''),
('ITPR', '생성형 AI', 'Tripo3D', '수신', 'I', 510, 'Y', ''),
('IELS', '생성형 AI', 'Elevenlabs', '발신', 'O', 511, 'Y', ''),
('IELR', '생성형 AI', 'Elevenlabs', '수신', 'I', 512, 'Y', ''),
('IGRS', '생성형 AI', 'Grammarly', '발신', 'O', 513, 'Y', ''),
('IVRS', '생성형 AI', 'Vrew', '발신', 'O', 514, 'Y', ''),
('INIS', '생성형 AI', 'NightCafe', '발신', 'O', 515, 'Y', ''),
('ICAS', '생성형 AI', 'CivitAI', '발신', 'O', 516, 'Y', ''),
('ILIS', '생성형 AI', 'Liner', '발신', 'O', 517, 'Y', ''),
('IBCS', '생성형 AI', 'Bing Image Creator', '발신', 'O', 518, 'Y', ''),
('IDSS', '생성형 AI', 'Deepseek', '발신', 'O', 519, 'Y', ''),
('IBDS', '생성형 AI', 'Baidu Ai', '발신', 'O', 520, 'Y', ''),
('IGIS', '생성형 AI', 'Gemini AI api', '발신', 'O', 521, 'Y', ''),
('IDTS', '생성형 AI', '에이닷', '발신', 'O', 522, 'Y', ''),
('IDTR', '생성형 AI', '에이닷', '수신', 'I', 523, 'Y', ''),
('IQBS', '생성형 AI', 'QuillBot', '발신', 'O', 524, 'Y', ''),
('ICHS', '생성형 AI', 'Character ai', '발신', 'O', 525, 'Y', ''),
('ISRS', '생성형 AI', 'Sora/Openai', '발신', 'O', 526, 'Y', ''),
('ISRR', '생성형 AI', 'Sora/Openai', '수신', 'I', 527, 'Y', ''),
('INNS', '생성형 AI', 'Nano AI', '발신', 'O', 528, 'Y', ''),
('IDBS', '생성형 AI', 'Doubao', '발신', 'O', 529, 'Y', ''),
('ITYS', '생성형 AI', 'Tongyi', '발신', 'O', 530, 'Y', ''),
('IYBS', '생성형 AI', 'Yuanbao', '발신', 'O', 531, 'Y', ''),
('IYYS', '생성형 AI', 'Yiyan', '발신', 'O', 532, 'Y', ''),
('IKMS', '생성형 AI', 'Kimi', '발신', 'O', 533, 'Y', ''),
('IBAS', '생성형 AI', 'Baichuan', '발신', 'O', 534, 'Y', ''),
('ITGS', '생성형 AI', 'Tiangong', '발신', 'O', 535, 'Y', ''),
('ISDS', '생성형 AI', 'Stable Diffusion', '발신', 'O', 536, 'Y', ''),
('IGOS', '생성형 AI', 'Grok', '발신', 'O', 537, 'Y', ''),
('ICGS', '생성형 AI', 'ChatGLM', '발신', 'O', 538, 'Y', ''),
('INKS', '생성형 AI', 'Napkin AI', '발신', 'O', 539, 'Y', ''),
('IBIR', '생성형 AI', 'Microsoft Copilot(Chat)', '수신', 'I', 540, 'Y', ''),
('IOOS', '생성형 AI', 'AI Goormee', '발신', 'O', 541, 'Y', ''),
('IABS', '생성형 AI', 'Allibee', '발신', 'O', 542, 'Y', ''),
('ILXS', '생성형 AI', 'Lexis+', '발신', 'O', 543, 'Y', ''),
('ILAS', '생성형 AI', 'SuperLawyer', '발신', 'O', 544, 'Y', ''),
('ICOS', '생성형 AI', 'CoCounsel', '발신', 'O', 545, 'Y', ''),
('IANS', '생성형 AI', 'Anthropic', '발신', 'O', 546, 'Y', ''),
('ISIS', '생성형 AI', 'Sider AI', '발신', 'O', 547, 'Y', ''),
('IGMS', '생성형 AI', 'Gamma', '발신', 'O', 548, 'Y', ''),
('IGMR', '생성형 AI', 'Gamma', '수신', 'I', 549, 'Y', ''),
('ICRS', '생성형 AI', 'Cursor', '발신', 'O', 550, 'Y', ''),
('IMAS', '생성형 AI', 'ManusAI', '발신', 'O', 551, 'Y', ''),
('IMTS', '생성형 AI', 'Mistral AI', '발신', 'O', 552, 'Y', ''),
('ICBS', '생성형 AI', 'Cline', '발신', 'O', 553, 'Y', ''),
('IWBS', '생성형 AI', 'Weight & Biases', '발신', 'O', 554, 'Y', ''),
('IWBR', '생성형 AI', 'Weight & Biases', '수신', 'I', 555, 'Y', ''),
('ILLS', '생성형 AI', 'Lilys AI', '발신', 'O', 556, 'Y', ''),
('IUKS', '생성형 AI', '기타', '발신', 'O', 557, 'Y', ''),
('IGES', '생성형 AI', 'Gemini Code Assist', '발신', 'O', 558, 'Y', ''),
('IOES', '생성형 AI', 'Codex/OpenAI', '발신', 'O', 559, 'Y', ''),
('IJLS', '생성형 AI', 'Jules', '발신', 'O', 560, 'Y', ''),
('IHVS', '생성형 AI', 'Harvey', '발신', 'O', 561, 'Y', ''),
('IXAS', '생성형 AI', 'x.AI', '발신', 'O', 562, 'Y', ''),
('ICES', '생성형 AI', 'Cohere', '발신', 'O', 563, 'Y', ''),
('IWTR', '생성형 AI', 'wrtn', '수신', 'I', 564, 'Y', ''),
('ICHR', '생성형 AI', 'Character ai', '수신', 'I', 565, 'Y', ''),
('IOWR', '생성형 AI', 'Open WebUi', '수신', 'I', 566, 'Y', ''),
('IOWS', '생성형 AI', 'Open WebUi', '발신', 'O', 567, 'Y', ''),
('ISKS', '생성형 AI', 'Skywork', '발신', 'O', 568, 'Y', ''),
('IVES', '생성형 AI', 'Veo3', '발신', 'O', 569, 'Y', ''),
('IGTS', '생성형 AI', 'Gptoss', '발신', 'O', 570, 'Y', ''),
('ILRS', '생성형 AI', 'LMArena', '발신', 'O', 571, 'Y', ''),
('ILRR', '생성형 AI', 'LMArena', '수신', 'I', 572, 'Y', ''),
('IASS', '생성형 AI', 'Chat & Ask AI', '발신', 'O', 573, 'Y', ''),
('IASR', '생성형 AI', 'Chat & Ask AI', '수신', 'I', 574, 'Y', ''),
('IARR', '생성형 AI', 'Android Studio', '수신', 'O', 575, 'Y', ''),
('IARS', '생성형 AI', 'Android Studio', '발신', 'O', 576, 'Y', ''),
('IORR', '생성형 AI', 'Open Router', '수신', 'O', 577, 'Y', ''),
('IORS', '생성형 AI', 'Open Router', '발신', 'O', 578, 'Y', ''),
('PDOS', '프로젝트', 'dooray', '발신', 'O', 579, 'Y', ''),
('PGIS', '프로젝트', 'github', '발신', 'O', 580, 'Y', ''),
('PGLS', '프로젝트', 'Glassdoor', '발신', 'O', 581, 'Y', ''),
('PJDS', '프로젝트', '잔디', '발신', 'O', 582, 'Y', ''),
('PITS', '프로젝트', 'Google Issue Tracker', '발신', 'O', 583, 'Y', ''),
('EBDR', '그룹웨어', '게시', '수신', 'I', 584, 'Y', ''),
('EBD-', '그룹웨어', '게시', '발신', 'O', 585, 'Y', ''),
('EBBR', '그룹웨어', '게시판', '수신', 'I', 586, 'Y', ''),
('EBBS', '그룹웨어', '게시판', '발신', 'O', 587, 'Y', ''),
('EBBF', '그룹웨어', '게시판', '파일수신', 'I', 588, 'Y', ''),
('EAAR', '그룹웨어', '결재', '수신', 'I', 589, 'Y', ''),
('EAAS', '그룹웨어', '결재', '발신', 'O', 590, 'Y', ''),
('EAAG', '그룹웨어', '결재', '통보 - 수신', 'I', 591, 'Y', ''),
('EAAP', '그룹웨어', '결재', '통보 - 발신', 'O', 592, 'Y', ''),
('EAAF', '그룹웨어', '결재', '파일수신', 'I', 593, 'Y', ''),
('EMMR', '그룹웨어', '메일', '그룹웨어 수신', 'I', 594, 'Y', ''),
('EMMS', '그룹웨어', '메일', '그룹웨어 발신', 'O', 595, 'Y', ''),
('EMMG', '그룹웨어', '메일', 'OWA 수신', 'I', 596, 'Y', ''),
('EMMP', '그룹웨어', '메일', 'OWA 발신', 'O', 597, 'Y', ''),
('EMMD', '그룹웨어', '메일', 'RPC 수신', 'I', 598, 'Y', ''),
('EMMU', '그룹웨어', '메일', 'RPC 발신', 'O', 599, 'Y', ''),
('EMMC', '그룹웨어', '메일', '수신', 'I', 600, 'Y', ''),
('EMML', '그룹웨어', '메일', '발신', 'O', 601, 'Y', ''),
('EMM1', '그룹웨어', '메일', '보안등급1', 'O', 602, 'Y', ''),
('EMM2', '그룹웨어', '메일', '보안등급2', 'O', 603, 'Y', ''),
('EMM3', '그룹웨어', '메일', '보안등급3', 'O', 604, 'Y', ''),
('EMM4', '그룹웨어', '메일', '보안등급4', 'O', 605, 'Y', ''),
('EMMA', '그룹웨어', '메일', '임시(자동)', 'O', 606, 'Y', ''),
('EMMT', '그룹웨어', '메일', '임시(수동)', 'O', 607, 'Y', ''),
('EMMK', '그룹웨어', '메일', 'Outlook - 수신', 'I', 608, 'Y', ''),
('EMMO', '그룹웨어', '메일', 'Outlook - 발신', 'O', 609, 'Y', ''),
('EMMB', '그룹웨어', '메일', '그룹웨어 예약메일', 'O', 610, 'Y', ''),
('EMBR', '그룹웨어', '모바일', '수신', 'I', 611, 'Y', ''),
('EMB-', '그룹웨어', '모바일', '발신', 'O', 612, 'Y', ''),
('EWSR', '그룹웨어', '웹서비스', '수신', 'I', 613, 'Y', ''),
('EWS-', '그룹웨어', '웹서비스', '발신', 'O', 614, 'Y', ''),
('EPUR', '그룹웨어', '일반', '수신', 'I', 615, 'Y', ''),
('EPU-', '그룹웨어', '일반', '발신', 'O', 616, 'Y', ''),
('EAU-', '그룹웨어', '일반(자동전달)', '자동전달', 'O', 617, 'Y', ''),
('ESCR', '그룹웨어', '일정 명함', '수신', 'I', 618, 'Y', ''),
('ESC-', '그룹웨어', '일정 명함', '발신', 'O', 619, 'Y', ''),
('EMF-', '그룹웨어', '파일 다운로드', '-', 'I', 620, 'Y', ''),
('EMU-', '그룹웨어', '기타', '', 'O', 621, 'Y', ''),
('EMDR', '그룹웨어', '드라이브', '수신', 'I', 622, 'Y', ''),
('EMDS', '그룹웨어', '드라이브', '발신', 'O', 623, 'Y', ''),
('ECIS', '그룹웨어', 'Samsung cic', '발신', 'O', 624, 'Y', ''),
('EMER', '그룹웨어', '메신저', '수신', 'I', 625, 'Y', ''),
('EMES', '그룹웨어', '메신저', '발신', 'O', 626, 'Y', ''),
('EZQC', '그룹웨어', 'Zohocliq', '채팅', 'O', 627, 'Y', ''),
('EZQS', '그룹웨어', 'Zohocliq', '캘린더', 'O', 628, 'Y', ''),
('EKWS', '그룹웨어', '카카오워크', '발신', 'O', 629, 'Y', ''),
('DCCS', '편집기', 'Clip Champ', '발신', 'O', 630, 'Y', ''),
('DFGS', '편집기', 'Figma', '발신', 'O', 631, 'Y', ''),
('DOVS', '편집기', 'Overleaf', '발신', 'O', 632, 'Y', ''),
('DOVR', '편집기', 'Overleaf', '수신', 'I', 633, 'Y', ''),
('DPKS', '편집기', 'Plunker', '발신', 'O', 634, 'Y', ''),
('DNWS', '편집기', 'Namu.wiki', '발신', 'O', 635, 'Y', ''),
('DWKS', '편집기', 'WikiPedia', '발신', 'O', 636, 'Y', ''),
('DAES', '편집기', 'Adobe Express', '발신', 'O', 637, 'Y', ''),
('DSMS', '편집기', 'Sketchmon', '발신', 'O', 638, 'Y', ''),
('DGSS', '편집기', 'Google Site', '발신', 'O', 639, 'Y', ''),
('DCVS', '편집기', 'Canva', '발신', 'O', 640, 'Y', ''),
('DMBS', '편집기', '망고보드', '발신', 'O', 641, 'Y', ''),
('DMTS', '편집기', '망고툰', '발신', 'O', 642, 'Y', ''),
('JBDS', '웹사이트', 'Baidu', '발신', 'O', 643, 'Y', ''),
('JANS', '웹사이트', 'Anthropic', '발신', 'O', 644, 'Y', ''),
('JKAS', '웹사이트', 'Kaggle', '발신', 'O', 645, 'Y', ''),
('RGUS', '원격접속', '아파치 과카몰리', '발신', 'O', 646, 'Y', ''),
('RGUR', '원격접속', '아파치 과카몰리', '수신', 'I', 647, 'Y', ''),
('KAAR', '웹서비스(분류)', '웹 수신', '수신', 'I', 648, 'Y', ''),
('KAAS', '웹서비스(분류)', '웹 발신', '발신', 'O', 649, 'Y', '');
