...
VALUES ('MP3-', '메일', 'POP3', '-', 'I', 1, 'Y', ''),
       ...
       ('CBRS', '커뮤니티', '브런치 스토리', '발신', 'O', 108, 'Y', ''),
       ('CUKR', '커뮤니티', '기타', '수신', 'I', 109, 'Y', ''),
       ('CUKS', '커뮤니티', '기타', '발신', 'O', 110, 'Y', ''),
       ('CUKD', '커뮤니티', '기타', '댓글', 'O', 111, 'Y', ''),
       ('SFBR', '소셜', '페이스북', '수신', 'I', 112, 'Y', ''),
       ('SFBS', '소셜', '페이스북', '발신', 'O', 113, 'Y', ''),
       ('SFBD', '소셜', '페이스북', '댓글', 'O', 114, 'Y', ''),
       ('STWR', '소셜', '트위터', '수신', 'I', 115, 'Y', ''),
       ('STWS', '소셜', '트위터', '발신', 'O', 116, 'Y', ''),
       ('STWD', '소셜', '트위터', '댓글', 'O', 117, 'Y', ''),
       ('SKAR', '소셜', '카카오스토리', '수신', 'I', 118, 'Y', ''),
       ('SKAS', '소셜', '카카오스토리', '발신', 'O', 119, 'Y', ''),
       ('SKAD', '소셜', '카카오스토리', '댓글', 'O', 120, 'Y', ''),
       ('SNVR', '소셜', '네이버 블로그', '수신', 'I', 121, 'Y', ''),
       ('SNVS', '소셜', '네이버 블로그', '발신', 'O', 122, 'Y', ''),
       ('SNVD', '소셜', '네이버 블로그', '댓글', 'O', 123, 'Y', ''),
       ('SNVT', '소셜', '네이버 블로그', '임시저장', 'O', 124, 'Y', ''),
       ('SNVU', '소셜', '네이버 블로그', '수정', 'O', 125, 'Y', ''),
       ('SDUR', '소셜', '다음 블로그', '수신', 'I', 126, 'Y', ''),
       ('SDUS', '소셜', '다음 블로그', '발신', 'O', 127, 'Y', ''),
       ('SDUD', '소셜', '다음 블로그', '댓글', 'O', 128, 'Y', ''),
       ('STSR', '소셜', '티스토리', '수신', 'I', 129, 'Y', ''),
       ('STSS', '소셜', '티스토리', '발신', 'O', 130, 'Y', ''),
       ('STSD', '소셜', '티스토리', '댓글', 'O', 131, 'Y', ''),
       ('STST', '소셜', '티스토리', '임시저장', 'O', 132, 'Y', ''),
       ('STBR', '소셜', '텀블러', '수신', 'I', 133, 'Y', ''),
       ('STBS', '소셜', '텀블러', '발신', 'O', 134, 'Y', ''),
       ('STBD', '소셜', '텀블러', '댓글', 'O', 135, 'Y', ''),
       ('SWBR', '소셜', '웨이보', '수신', 'I', 136, 'Y', ''),
       ('SWBS', '소셜', '웨이보', '발신', 'O', 137, 'Y', ''),
       ('SWBD', '소셜', '웨이보', '댓글', 'O', 138, 'Y', ''),
       ('SLKR', '소셜', '링크드인', '수신', 'I', 139, 'Y', ''),
       ('SLKS', '소셜', '링크드인', '발신', 'O', 140, 'Y', ''),
       ('SLKD', '소셜', '링크드인', '댓글', 'O', 141, 'Y', ''),
       ('SEGR', '소셜', '이글루', '수신', 'I', 142, 'Y', ''),
       ('SEGS', '소셜', '이글루', '발신', 'O', 143, 'Y', ''),
       ('SEGD', '소셜', '이글루', '댓글', 'O', 144, 'Y', ''),
       ('SYMR', '소셜', '야머', '수신', 'I', 145, 'Y', ''),
       ('SYMS', '소셜', '야머', '발신', 'O', 146, 'Y', ''),
       ('SYMD', '소셜', '야머', '댓글', 'O', 147, 'Y', ''),
       ('SYMF', '소셜', '야머', '파일전송', 'O', 148, 'Y', ''),
       ('SNBR', '소셜', '네이버 밴드', '수신', 'I', 149, 'Y', ''),
       ('SNBS', '소셜', '네이버 밴드', '발신', 'O', 150, 'Y', ''),
       ('SNBD', '소셜', '네이버 밴드', '댓글', 'O', 151, 'Y', ''),
       ('SLRR', '소셜', '라이브리', '수신', 'I', 152, 'Y', ''),
       ('SLRS', '소셜', '라이브리', '발신', 'O', 153, 'Y', ''),
       ('SLRD', '소셜', '라이브리', '댓글', 'O', 154, 'Y', ''),
       ('SMER', '소셜', 'Medium', '수신', 'I', 155, 'Y', ''),
       ('SMES', '소셜', 'Medium', '발신', 'O', 156, 'Y', ''),
       ('SMED', '소셜', 'Medium', '댓글', 'O', 157, 'Y', ''),
       ('SISR', '소셜', '인스타그램', '수신', 'I', 158, 'Y', ''),
       ('SISS', '소셜', '인스타그램', '발신', 'O', 159, 'Y', ''),
       ('SISD', '소셜', '인스타그램', '댓글', 'O', 160, 'Y', ''),
       ('SISF', '소셜', '인스타그램', '파일전송', 'O', 161, 'Y', ''),
       ('SSFS', '소셜', 'Salesforce', '발신', 'O', 162, 'Y', ''),
       ('SPIS', '소셜', 'Pinterest', '발신', 'O', 163, 'Y', ''),
       ('STHS', '소셜', 'Threads', '발신', 'O', 164, 'Y', ''),
       ('SBLS', '소셜', '블로거', '발신', 'O', 165, 'Y', ''),
       ('STTS', '소셜', 'Tiktok', '발신', 'O', 166, 'Y', ''),
       ('VDUR', '영상 스트리밍', '다음 TV', '수신', 'I', 167, 'Y', ''),
       ('VDUS', '영상 스트리밍', '다음 TV', '발신', 'O', 168, 'Y', ''),
       ('VPDR', '영상 스트리밍', '판도라 TV', '수신', 'I', 169, 'Y', ''),
       ('VPDS', '영상 스트리밍', '판도라 TV', '발신', 'O', 170, 'Y', ''),
       ('VGMR', '영상 스트리밍', '곰 TV', '수신', 'I', 171, 'Y', ''),
       ('VGMS', '영상 스트리밍', '곰 TV', '발신', 'O', 172, 'Y', ''),
       ('VYTR', '영상 스트리밍', '유튜브', '수신', 'I', 173, 'Y', ''),
       ('VYTS', '영상 스트리밍', '유튜브', '발신', 'O', 174, 'Y', ''),
       ('VYTD', '영상 스트리밍', '유튜브', '댓글', 'O', 175, 'Y', ''),
       ('VNVR', '영상 스트리밍', '네이버 TV캐스트', '수신', 'I', 176, 'Y', ''),
       ('VNVS', '영상 스트리밍', '네이버 TV캐스트', '발신', 'O', 177, 'Y', ''),
       ('QNVC', '메신저', '네이버', '채팅', 'O', 178, 'N', ''),
       ('QNVF', '메신저', '네이버', '파일전송', 'O', 179, 'N', ''),
       ('QNMR', '메신저', '네이버 쪽지', '수신', 'I', 180, 'N', ''),
       ('QNMS', '메신저', '네이버 쪽지', '발신', 'O', 181, 'N', ''),
       ('QDUC', '메신저', '다음', '채팅', 'O', 182, 'N', ''),
       ('QDUF', '메신저', '다음', '파일전송', 'O', 183, 'N', ''),
       ('QDUM', '메신저', '다음', '쪽지', 'O', 184, 'N', ''),
       ('QDSC', '메신저', '대신', '채팅', 'O', 185, 'N', ''),
       ('QDSF', '메신저', '대신', '파일전송', 'O', 186, 'N', ''),
       ('QDSM', '메신저', '대신', '쪽지', 'O', 187, 'N', ''),
       ('QSHC', '메신저', '삼홍사', '채팅', 'O', 188, 'Y', ''),
       ('QSHF', '메신저', '삼홍사', '파일전송', 'O', 189, 'Y', ''),
       ('QSHM', '메신저', '삼홍사', '쪽지', 'O', 190, 'Y', ''),
       ('QDIC', '메신저', '동부생명', '채팅', 'O', 191, 'Y', ''),
       ('QDIF', '메신저', '동부생명', '파일전송', 'O', 192, 'Y', ''),
       ('QDIM', '메신저', '동부생명', '쪽지', 'O', 193, 'Y', ''),
       ('QDFC', '메신저', '동부금융', '채팅', 'O', 194, 'Y', ''),
       ('QDFF', '메신저', '동부금융', '파일전송', 'O', 195, 'Y', ''),
       ('QDFM', '메신저', '동부금융', '쪽지', 'O', 196, 'Y', ''),
       ('QDGC', '메신저', '동국제강', '채팅', 'O', 197, 'Y', ''),
       ('QDGF', '메신저', '동국제강', '파일전송', 'O', 198, 'Y', ''),
       ('QDGM', '메신저', '동국제강', '쪽지', 'O', 199, 'Y', ''),
       ('QFMC', '메신저', '프리본드', '채팅', 'O', 200, 'Y', 'MSG'),
       ('QFMF', '메신저', '프리본드', '파일전송', 'O', 201, 'Y', 'MSG'),
       ('QFMM', '메신저', '프리본드', '쪽지', 'O', 202, 'Y', 'MSG'),
       ('QFMJ', '메신저', '프리본드', '참여', 'O', 203, 'Y', 'MSG'),
       ('QFML', '메신저', '프리본드', '떠남', 'O', 204, 'Y', 'MSG'),
       ('QMCC', '메신저', 'M-채널', '채팅', 'O', 205, 'Y', ''),
       ('QMCF', '메신저', 'M-채널', '파일전송', 'O', 206, 'Y', ''),
       ('QMCM', '메신저', 'M-채널', '쪽지', 'O', 207, 'Y', ''),
       ('QMSC', '메신저', '미쓰리', '채팅', 'O', 208, 'Y', 'MSG'),
       ('QMSF', '메신저', '미쓰리', '파일전송', 'O', 209, 'Y', 'MSG'),
       ('QMSM', '메신저', '미쓰리', '쪽지', 'O', 210, 'Y', 'MSG'),
       ('QMSJ', '메신저', '미쓰리', '참여', 'O', 211, 'Y', 'MSG'),
       ('QMSL', '메신저', '미쓰리', '떠남', 'O', 212, 'Y', 'MSG'),
       ('QNTC', '메신저', '네이트', '채팅', 'O', 213, 'Y', 'MSG'),
       ('QNTF', '메신저', '네이트', '파일전송', 'O', 214, 'Y', 'MSG'),
       ('QNTM', '메신저', '네이트', '쪽지', 'O', 215, 'Y', 'MSG'),
       ('QNTJ', '메신저', '네이트', '참여', 'O', 216, 'Y', 'MSG'),
       ('QNTL', '메신저', '네이트', '떠남', 'O', 217, 'Y', 'MSG'),
       ('QSSC', '메신저', '삼성증권', '채팅', 'O', 218, 'N', ''),
       ('QSSF', '메신저', '삼성증권', '파일전송', 'O', 219, 'N', ''),
       ('QSSM', '메신저', '삼성증권', '쪽지', 'O', 220, 'N', ''),
       ('QSFC', '메신저', '삼성화재', '채팅', 'O', 221, 'Y', ''),
       ('QSFF', '메신저', '삼성화재', '파일전송', 'O', 222, 'Y', ''),
       ('QSFM', '메신저', '삼성화재', '쪽지', 'O', 223, 'Y', ''),
       ('QSFJ', '메신저', '삼성화재', '참여', 'O', 224, 'Y', ''),
       ('QSFL', '메신저', '삼성화재', '떠남', 'O', 225, 'Y', ''),
       ('QSPC', '메신저', 'SK 프라이든', '채팅', 'O', 226, 'Y', ''),
       ('QSPF', '메신저', 'SK 프라이든', '파일전송', 'O', 227, 'Y', ''),
       ('QSPM', '메신저', 'SK 프라이든', '쪽지', 'O', 228, 'Y', ''),
       ('QSPJ', '메신저', 'SK 프라이든', '참여', 'O', 229, 'Y', ''),
       ('QSPL', '메신저', 'SK 프라이든', '떠남', 'O', 230, 'Y', ''),
       ('QSBC', '메신저', 'SK 비즈', '채팅', 'O', 231, 'N', ''),
       ('QSBF', '메신저', 'SK 비즈', '파일전송', 'O', 232, 'N', ''),
       ('QSBM', '메신저', 'SK 비즈', '쪽지', 'O', 233, 'N', ''),
       ('QWJC', '메신저', '웅진', '채팅', 'O', 234, 'Y', ''),
       ('QWJF', '메신저', '웅진', '파일전송', 'O', 235, 'Y', ''),
       ('QWJM', '메신저', '웅진', '쪽지', 'O', 236, 'Y', ''),
       ('QGPC', '메신저', 'ChatGPT', '채팅', 'O', 237, 'Y', ''),
       ('QDAC', '메신저', 'Dall-E', '채팅', 'O', 238, 'Y', ''),
       ('QDAF', '메신저', 'Dall-E', '파일전송', 'O', 239, 'Y', ''),
       ('QCLC', '메신저', '쿨', '채팅', 'O', 240, 'Y', 'MSG'),
       ('QCLF', '메신저', '쿨', '파일전송', 'O', 241, 'Y', 'MSG'),
       ('QCLM', '메신저', '쿨', '쪽지', 'O', 242, 'Y', 'MSG'),
       ('QCLJ', '메신저', '쿨', '참여', 'O', 243, 'Y', 'MSG'),
       ('QCLL', '메신저', '쿨', '떠남', 'O', 244, 'Y', 'MSG'),
       ('QKBC', '메신저', 'K-bond', '채팅', 'O', 245, 'Y', 'MSG'),
       ('QKBF', '메신저', 'K-bond', '파일전송', 'O', 246, 'Y', 'MSG'),
       ('QKBM', '메신저', 'K-bond', '쪽지', 'O', 247, 'Y', 'MSG'),
       ('QKBJ', '메신저', 'K-bond', '참여', 'O', 248, 'Y', 'MSG'),
       ('QKBL', '메신저', 'K-bond', '떠남', 'O', 249, 'Y', 'MSG'),
       ('QEKC', '메신저', '아이콘', '채팅', 'O', 250, 'Y', 'MSG'),
       ('QEKF', '메신저', '아이콘', '파일전송', 'O', 251, 'Y', 'MSG'),
       ('QEKJ', '메신저', '아이콘', '참여', 'O', 252, 'Y', 'MSG'),
       ('QEKL', '메신저', '아이콘', '떠남', 'O', 253, 'Y', 'MSG'),
       ('QEKH', '메신저', '아이콘', '과거 데이터', 'O', 254, 'Y', 'MSG'),
       ('QSLC', '메신저', 'Slack', '채팅', 'O', 255, 'Y', 'MSG'),
       ('QSLF', '메신저', 'Slack', '파일전송', 'O', 256, 'Y', 'MSG'),
       ('QSLJ', '메신저', 'Slack', '참여', 'O', 257, 'Y', 'MSG'),
       ('QSLL', '메신저', 'Slack', '떠남', 'O', 258, 'Y', 'MSG'),
       ('QSYC', '메신저', '신영자산운용', '채팅', 'O', 259, 'Y', 'MSG'),
       ('QSYF', '메신저', '신영자산운용', '파일전송', 'O', 260, 'Y', 'MSG'),
       ('QSYM', '메신저', '신영자산운용', '쪽지', 'O', 261, 'Y', 'MSG'),
       ('QSYJ', '메신저', '신영자산운용', '참여', 'O', 262, 'Y', 'MSG'),
       ('QSYL', '메신저', '신영자산운용', '떠남', 'O', 263, 'Y', 'MSG'),
       ('QFBC', '메신저', '페이스북', '채팅', 'O', 264, 'Y', 'MSG'),
       ('QFBF', '메신저', '페이스북', '파일전송', 'O', 265, 'Y', 'MSG'),
       ('QKMC', '메신저', '삼성KnoxMessenger', '채팅', 'O', 266, 'Y', 'MSG'),
       ('QKMF', '메신저', '삼성KnoxMessenger', '파일전송', 'O', 267, 'Y', 'MSG'),
       ('QKMR', '메신저', '삼성KnoxMessenger', '파일수신', 'I', 268, 'Y', 'MSG'),
       ('QKMW', '메신저', '삼성KnoxMessenger', '전달', 'O', 269, 'Y', 'MSG'),
       ('QKMV', '메신저', '삼성KnoxMessenger', '파일-미리보기', 'O', 270, 'Y', 'MSG'),
       ('QGHC', '메신저', '구글 Hangout', '채팅', 'O', 271, 'Y', 'MSG'),
       ('QGHF', '메신저', '구글 Hangout', '파일전송', 'O', 272, 'Y', 'MSG'),
       ('QGGC', '메신저', '구글 chat', '채팅', 'O', 273, 'Y', 'MSG'),
       ('QGGF', '메신저', '구글 chat', '파일전송', 'O', 274, 'Y', 'MSG'),
       ('QGMC', '메신저', '구글 Meet', '채팅', 'O', 275, 'Y', 'MSG'),
       ('QGBC', '메신저', '구글 Bard', '채팅', 'O', 276, 'Y', 'MSG'),
       ('QBIC', '메신저', 'Microsoft BingAI Chat', '채팅', 'O', 277, 'Y', 'MSG'),
       ('QWTC', '메신저', 'Wrtn', '채팅', 'O', 278, 'Y', ''),
       ('QISC', '메신저', '인스타그램 DM', '채팅', 'O', 279, 'Y', 'MSG'),
       ('QISF', '메신저', '인스타그램 DM', '파일전송', 'O', 280, 'Y', 'MSG'),
       ('QZAC', '메신저', 'Zalo', '채팅', 'O', 281, 'Y', 'MSG'),
       ('QZAF', '메신저', 'Zalo', '파일전송', 'O', 282, 'Y', 'MSG'),
       ('QNBC', '메신저', '네이버 밴드 채팅', '채팅', 'O', 283, 'Y', 'MSG'),
       ('QNBF', '메신저', '네이버 밴드 채팅', '파일전송', 'O', 284, 'Y', 'MSG'),
       ('QDOC', '메신저', 'Dooray app', '채팅', 'O', 285, 'Y', 'MSG'),
       ('QDOF', '메신저', 'Dooray app', '파일전송', 'O', 286, 'Y', 'MSG'),
       ('QUKC', '메신저', '기타', '채팅', 'O', 287, 'Y', 'MSG'),
       ('QUKF', '메신저', '기타', '파일전송', 'O', 288, 'Y', 'MSG'),
       ('QUKM', '메신저', '기타', '쪽지', 'O', 289, 'Y', 'MSG'),
       ('QUKJ', '메신저', '기타', '참여', 'O', 290, 'Y', 'MSG'),
       ('QUKL', '메신저', '기타', '떠남', 'O', 291, 'Y', 'MSG'),
       ('FFTC', '파일전송', 'FTP', 'CMD', 'O', 292, 'Y', ''),
       ('FFTG', '파일전송', 'FTP', 'GET', 'I', 293, 'Y', ''),
       ('FFTP', '파일전송', 'FTP', 'PUT', 'O', 294, 'Y', ''),
       ('FFTL', '파일전송', 'FTP', 'CONNECT', 'O', 295, 'Y', ''),
       ('FZM-', '파일전송', 'Zmodem', '-', 'O', 296, 'Y', ''),
       ('FNVR', '파일전송', '네이버 MYBOX', '수신', 'I', 297, 'Y', ''),
       ('FNVS', '파일전송', '네이버 MYBOX', '발신', 'O', 298, 'Y', ''),
       ('FGGR', '파일전송', '구글 드라이브', '수신', 'I', 299, 'Y', ''),
       ('FGGS', '파일전송', '구글 드라이브', '발신', 'O', 300, 'Y', ''),
       ('FODR', '파일전송', 'OneDrive', '수신', 'I', 301, 'Y', ''),
       ('FODS', '파일전송', 'OneDrive', '발신', 'O', 302, 'Y', ''),
       ('FDBR', '파일전송', 'Dropbox', '수신', 'I', 303, 'Y', ''),
       ('FDBS', '파일전송', 'Dropbox', '발신', 'O', 304, 'Y', ''),
       ('F2NR', '파일전송', '2nd 드라이브', '수신', 'I', 305, 'N', ''),
       ('F2NS', '파일전송', '2nd 드라이브', '발신', 'O', 306, 'N', ''),
       ('FPSR', '파일전송', 'Polarisoffice ', '수신', 'I', 307, 'Y', ''),
       ('FPSS', '파일전송', 'Polarisoffice ', '발신', 'O', 308, 'Y', ''),
       ('FICR', '파일전송', 'Icloud', '수신', 'I', 309, 'Y', ''),
       ('FICS', '파일전송', 'Icloud', '발신', 'O', 310, 'Y', ''),
       ('FYDR', '파일전송', 'Yandex', '수신', 'I', 311, 'Y', ''),
       ('FYDS', '파일전송', 'Yandex', '발신', 'O', 312, 'Y', ''),
       ('FWHR', '파일전송', 'LG 웹하드', '수신', 'I', 313, 'Y', ''),
       ('FWHS', '파일전송', 'LG 웹하드', '발신', 'O', 314, 'Y', ''),
       ('FGIR', '파일전송', 'GitHub', '수신', 'I', 315, 'Y', ''),
       ('FGIS', '파일전송', 'GitHub', '발신', 'O', 316, 'Y', ''),
       ('FDOR', '파일전송', 'Dooray', '수신', 'I', 317, 'Y', ''),
       ('FDOS', '파일전송', 'Dooray', '발신', 'O', 318, 'Y', ''),
       ('FWES', '파일전송', 'Wetransfer', '발신', 'O', 319, 'Y', ''),
       ('FASS', '파일전송', 'AWS S3 bucket', '발신', 'O', 320, 'Y', ''),
       ('FGES', '파일전송', '구글 렌즈', '발신', 'O', 321, 'Y', ''),
       ('FTRS', '파일전송', 'File Transfer.io', '발신', 'O', 322, 'Y', ''),
       ('FCLS', '파일전송', 'pCloud Transfer', '발신', 'O', 323, 'Y', ''),
       ('FMZS', '파일전송', 'M/Z Cloud', '발신', 'O', 324, 'Y', ''),
       ('FMZR', '파일전송', 'M/Z Cloud', '수신', 'O', 325, 'Y', ''),
       ('FUKR', '파일전송', '기타', '수신', 'I', 326, 'Y', ''),
       ('FUKS', '파일전송', '기타', '발신', 'O', 327, 'Y', ''),
       ('NENR', '노트', 'EVERNOTE', '수신', 'I', 328, 'Y', ''),
       ('NENS', '노트', 'EVERNOTE', '발신', 'O', 329, 'Y', ''),
       ('NONR', '노트', 'ONENOTE', '수신', 'I', 330, 'Y', ''),
       ('NONS', '노트', 'ONENOTE', '발신', 'O', 331, 'Y', ''),
       ('NLVS', '노트', 'Outlook.com 메모', '발신', 'O', 332, 'Y', ''),
       ('NBTS', '노트', 'BIT.AI', '발신', 'O', 333, 'Y', ''),
       ('NNOS', '노트', 'Notion', '발신', 'O', 334, 'Y', ''),
       ('NGGS', '노트', '구글 docs', '발신', 'O', 335, 'Y', ''),
       ('NGTS', '노트', '구글 tasks', '발신', 'O', 336, 'Y', ''),
       ('NGKS', '노트', '구글 keep', '발신', 'O', 337, 'Y', ''),
       ('NSSR', '노트', '삼성 노트', '수신', 'I', 338, 'Y', ''),
       ('NSSS', '노트', '삼성 노트', '발신', 'O', 339, 'Y', ''),
       ('NNVS', '노트', '네이버 오피스', '발신', 'O', 340, 'Y', ''),
       ('NDBS', '노트', 'Dropbox paper', '발신', 'O', 341, 'Y', ''),
       ('NHCS', '노트', '한컴 오피스', '발신', 'O', 342, 'Y', ''),
       ('NMOS', '노트', 'MS오피스', '발신', 'O', 343, 'Y', ''),
       ('NCDS', '노트', 'Coda', '발신', 'O', 344, 'Y', ''),
       ('NNMR', '노트', '네이버 메모', '수신', 'I', 345, 'Y', ''),
       ('NNMS', '노트', '네이버 메모', '발신', 'O', 346, 'Y', ''),
       ('NCNS', '노트', 'Clova Note', '발신', 'O', 347, 'Y', ''),
       ('NGIS', '노트', 'Github Gist', '발신', 'O', 348, 'Y', ''),
       ('NSNS', '노트', 'SimpleNote', '발신', 'O', 349, 'Y', ''),
       ('NAGS', '노트', 'Agit', '발신', 'O', 350, 'Y', ''),
       ('NPSS', '노트', 'Polaris office', '발신', 'O', 351, 'Y', ''),
       ('NBOS', '노트', 'Box', '발신', 'O', 352, 'Y', ''),
       ('NCKS', '노트', 'ClickUp', '발신', 'O', 353, 'Y', ''),
       ('NGNS', '노트', 'Goodnotes', '발신', 'O', 354, 'Y', ''),
       ('NMNS', '노트', 'Milanote', '발신', 'O', 355, 'Y', ''),
       ('NZQS', '노트', 'zohocliq', '발신', 'O', 356, 'Y', ''),
       ('NMTS', '노트', 'Mentimeter', '발신', 'O', 357, 'Y', ''),
       ('NOOS', '노트', 'Goorm', '발신', 'O', 358, 'Y', ''),
       ('NUKS', '노트', '기타', '발신', 'O', 359, 'Y', ''),
       ('AGCR', '일정', '구글캘린더일정', '수신', 'I', 360, 'N', ''),
       ('AGCS', '일정', '구글캘린더일정', '발신', 'O', 361, 'Y', ''),
       ('AGLR', '일정', '구글캘린더메일', '수신', 'I', 362, 'N', ''),
       ('AGLS', '일정', '구글캘린더메일', '발신', 'O', 363, 'Y', ''),
       ('ANCS', '일정', '네이버 캘린더', '발신', 'O', 364, 'Y', ''),
       ('ZTN-', '기타 서비스', 'Telnet', '-', 'O', 365, 'Y', ''),
       ('ZXT-', '기타 서비스', 'Xterm', '-', 'O', 366, 'Y', ''),
       ('ZRL-', '기타 서비스', 'R-Login', '-', 'O', 367, 'Y', ''),
       ('ZNP-', '기타 서비스', 'NNTP', '-', 'O', 368, 'Y', ''),
       ('ZPC-', '기타 서비스', 'PC 보안', '-', 'O', 369, 'N', ''),
       ('ZSH-', '기타 서비스', 'SSH', 'SSH 세션 정보', 'O', 370, 'Y', ''),
       ('XX1R', '모니터링_제외', '미분류_타입1', '수신', 'I', 371, 'Y', ''),
       ('XX1S', '모니터링_제외', '미분류_타입1', '발신', 'O', 372, 'Y', ''),
       ('XX2R', '모니터링_제외', '미분류_타입2', '수신', 'I', 373, 'Y', ''),
       ('XX2S', '모니터링_제외', '미분류_타입2', '발신', 'O', 374, 'Y', ''),
       ('XX3R', '모니터링_제외', '미분류_타입3', '수신', 'I', 375, 'Y', ''),
       ('XX3S', '모니터링_제외', '미분류_타입3', '발신', 'O', 376, 'Y', ''),
       ('XU1R', '모니터링_제외', '웹서비스(미분류)_타입1', '수신', 'I', 377, 'Y', ''),
       ('XU1S', '모니터링_제외', '웹서비스(미분류)_타입1', '발신', 'O', 378, 'Y', ''),
       ('XU2R', '모니터링_제외', '웹서비스(미분류)_타입2', '수신', 'I', 379, 'Y', ''),
       ('XU2S', '모니터링_제외', '웹서비스(미분류)_타입2', '발신', 'O', 380, 'Y', ''),
       ('XU3R', '모니터링_제외', '웹서비스(미분류)_타입3', '수신', 'I', 381, 'Y', ''),
       ('XU3S', '모니터링_제외', '웹서비스(미분류)_타입3', '발신', 'O', 382, 'Y', ''),
       ('UWSD', '웹서비스(미분류)', '웹 발신', '첨부 - 문서타입', 'O', 383, 'Y', ''),
       ('UWSE', '웹서비스(미분류)', '웹 발신', '첨부 - 문서아님', 'O', 384, 'Y', ''),
       ('UWSU', '웹서비스(미분류)', '웹 발신', '첨부 없음', 'O', 385, 'Y', ''),
       ('UWSH', '웹서비스(미분류)', '웹 발신', '중요도(상)', 'O', 386, 'Y', ''),
       ('UWSM', '웹서비스(미분류)', '웹 발신', '중요도(중)', 'O', 387, 'Y', ''),
       ('UWSL', '웹서비스(미분류)', '웹 발신', '중요도(하)', 'O', 388, 'Y', ''),
       ('UX1R', '웹서비스(미분류)', '미분류_타입1', '수신', 'I', 389, 'Y', ''),
       ('UX1S', '웹서비스(미분류)', '미분류_타입1', '발신', 'O', 390, 'Y', ''),
       ('UX2R', '웹서비스(미분류)', '미분류_타입2', '수신', 'I', 391, 'Y', ''),
       ('UX2S', '웹서비스(미분류)', '미분류_타입2', '발신', 'O', 392, 'Y', ''),
       ('UX3R', '웹서비스(미분류)', '미분류_타입3', '수신', 'I', 393, 'Y', ''),
       ('UX3S', '웹서비스(미분류)', '미분류_타입3', '발신', 'O', 394, 'Y', ''),
       ('UWRD', '웹서비스(미분류)', '웹 수신', '첨부 - 문서타입', 'I', 395, 'Y', ''),
       ('UWRE', '웹서비스(미분류)', '웹 수신', '첨부 - 문서아님', 'I', 396, 'Y', ''),
       ('UWRU', '웹서비스(미분류)', '웹 수신', '첨부 없음', 'I', 397, 'Y', ''),
       ('BWSD', '웹서비스(업무)', '업무 발신', '첨부 - 문서타입', 'O', 398, 'Y', ''),
       ('BWSE', '웹서비스(업무)', '업무 발신', '첨부 - 문서아님', 'O', 399, 'Y', ''),
       ('BWSU', '웹서비스(업무)', '업무 발신', '첨부 없음', 'O', 400, 'Y', ''),
       ('BWRD', '웹서비스(업무)', '업무 수신', '첨부 - 문서타입', 'I', 401, 'Y', ''),
       ('BWRE', '웹서비스(업무)', '업무 수신', '첨부 - 문서아님', 'I', 402, 'Y', ''),
       ('BWRU', '웹서비스(업무)', '업무 수신', '첨부 없음', 'I', 403, 'Y', ''),
       ('TWEC', '화상회의', 'Webex', '채팅', 'O', 404, 'Y', 'MSG'),
       ('TWEF', '화상회의', 'Webex', '파일전송', 'O', 405, 'Y', 'MSG'),
       ('TWEJ', '화상회의', 'Webex', '참여', 'O', 406, 'Y', 'MSG'),
       ('TWEL', '화상회의', 'Webex', '떠남', 'O', 407, 'Y', 'MSG'),
       ('TZOC', '화상회의', 'Zoom', '채팅', 'O', 408, 'Y', 'MSG'),
       ('TZOF', '화상회의', 'Zoom', '파일전송', 'O', 409, 'Y', 'MSG'),
       ('TZOJ', '화상회의', 'Zoom', '참여', 'O', 410, 'Y', 'MSG'),
       ('TZOL', '화상회의', 'Zoom', '떠남', 'O', 411, 'Y', 'MSG'),
       ('TTMC', '화상회의', 'Teams', '채팅', 'O', 412, 'Y', 'MSG'),
       ('TTMF', '화상회의', 'Teams', '파일전송', 'O', 413, 'Y', 'MSG'),
       ('TTMJ', '화상회의', 'Teams', '참여', 'O', 414, 'Y', 'MSG'),
       ('TTML', '화상회의', 'Teams', '떠남', 'O', 415, 'Y', 'MSG'),
       ('TSKC', '화상회의', 'Skype', '채팅', 'O', 416, 'Y', 'MSG'),
       ('TSKF', '화상회의', 'Skype', '파일전송', 'O', 417, 'Y', 'MSG'),
       ('TSKJ', '화상회의', 'Skype', '참여', 'O', 418, 'Y', 'MSG'),
       ('TSKL', '화상회의', 'Skype', '떠남', 'O', 419, 'Y', 'MSG'),
       ('TJMC', '화상회의', 'JoinME', '채팅', 'O', 420, 'Y', 'MSG'),
       ('TJMF', '화상회의', 'JoinME', '파일전송', 'O', 421, 'Y', 'MSG'),
       ('TAMC', '화상회의', 'Amazon Chime', '채팅', 'O', 422, 'Y', 'MSG'),
       ('TAMF', '화상회의', 'Amazon Chime', '파일전송', 'O', 423, 'Y', 'MSG'),
       ('TBJC', '화상회의', 'BlueJeans', '채팅', 'O', 424, 'Y', 'MSG'),
       ('TTDS', '화상회의', 'Tl;dv', '채팅', 'O', 425, 'Y', 'MSG'),
       ('LNVS', '번역기', '파파고 번역', '발신', 'O', 426, 'Y', ''),
       ('LGGS', '번역기', '구글 번역', '발신', 'O', 427, 'Y', ''),
       ('LGPS', '번역기', '구글 번역 플러그인', '발신', 'O', 428, 'Y', ''),
       ('LDES', '번역기', 'Deepl', '발신', 'O', 429, 'Y', ''),
       ('LBIS', '번역기', 'Bing 번역', '발신', 'O', 430, 'Y', ''),
       ('LYMS', '번역기', 'Yandex 번역', '발신', 'O', 431, 'Y', ''),
       ('LGAS', '번역기', 'Google Cloud Translation Api', '발신', 'O', 432, 'Y', ''),
       ('LFTS', '번역기', 'Flitto', '발신', 'O', 433, 'Y', ''),
       ('LOTS', '번역기', 'O-Translator', '발신', 'O', 434, 'Y', ''),
       ('LUKS', '번역기', '기타', '발신', 'I', 435, 'Y', ''),
       ('IGBS', '생성형 AI', '구글 Gemini', '발신', 'O', 436, 'Y', ''),
       ('IBIS', '생성형 AI', ' Microsoft Copilot', '발신', 'O', 437, 'Y', ''),
       ('IWTS', '생성형 AI', 'Wrtn', '발신', 'O', 438, 'Y', ''),
       ('IGPS', '생성형 AI', 'ChatGPT', '발신', 'O', 439, 'Y', ''),
       ('IDAS', '생성형 AI', 'Dall-E', '발신', 'O', 440, 'Y', ''),
       ('IGCS', '생성형 AI', 'Github Copilot', '발신', 'I', 441, 'Y', ''),
       ('IYCS', '생성형 AI', 'YouChat', '발신', 'I', 442, 'Y', ''),
       ('ICSS', '생성형 AI', 'Chatsonic', '발신', 'I', 443, 'Y', ''),
       ('IRPS', '생성형 AI', 'Replika', '발신', 'I', 444, 'Y', ''),
       ('IPPS', '생성형 AI', 'Perplexity', '발신', 'I', 445, 'Y', ''),
       ('ITCS', '생성형 AI', 'TextCortex', '발신', 'I', 446, 'Y', ''),
       ('IPHS', '생성형 AI', 'Phind', '발신', 'I', 447, 'Y', ''),
       ('IPOS', '생성형 AI', 'Poe', '발신', 'I', 448, 'Y', ''),
       ('IHFS', '생성형 AI', 'Hugging Face', '발신', 'I', 449, 'Y', ''),
       ('ICPS', '생성형 AI', 'Copy.AI', '발신', 'I', 450, 'Y', ''),
       ('IHWS', '생성형 AI', 'HyperWrite', '발신', 'I', 451, 'Y', ''),
       ('IDPS', '생성형 AI', 'DeepAI', '발신', 'I', 452, 'Y', ''),
       ('IACS', '생성형 AI', 'AskCodi', '발신', 'I', 453, 'Y', ''),
       ('INAS', '생성형 AI', 'Native', '발신', 'I', 454, 'Y', ''),
       ('INFS', '생성형 AI', 'NeuroFlash', '발신', 'I', 455, 'Y', ''),
       ('INOS', '생성형 AI', 'Notion AI', '발신', 'I', 456, 'Y', ''),
       ('IMES', '생성형 AI', 'Merlin', '발신', 'I', 457, 'Y', ''),
       ('ICXS', '생성형 AI', 'CLOVA-X', '발신', 'I', 458, 'Y', ''),
       ('IADS', '생성형 AI', 'Adobe AI', '발신', 'I', 459, 'Y', ''),
       ('ICDS', '생성형 AI', 'ClipDrop', '발신', 'I', 460, 'Y', ''),
       ('ISBS', '생성형 AI', 'Stability.Ai', '발신', 'I', 461, 'Y', ''),
       ('IRMS', '생성형 AI', 'Runwayml', '발신', 'I', 462, 'Y', ''),
       ('IGVS', '생성형 AI', 'Google Vertex', '발신', 'I', 463, 'Y', ''),
       ('IGLS', '생성형 AI', 'Google Colab', '발신', 'I', 464, 'Y', ''),
       ('ICWS', '생성형 AI', 'CodeWhisperer', '발신', 'I', 465, 'Y', ''),
       ('IMSS', '생성형 AI', 'Google AI Studio', '발신', 'I', 466, 'Y', ''),
       ('IOCS', '생성형 AI', 'Clova OCR', '발신', 'I', 467, 'Y', ''),
       ('IAOS', '생성형 AI', 'Azure OpenAI', '발신', 'I', 468, 'Y', ''),
       ('ICUS', '생성형 AI', '네이버 CUE:', '발신', 'I', 469, 'Y', ''),
       ('IMJS', '생성형 AI', 'Midjourney', '발신', 'I', 470, 'Y', ''),
       ('ISGR', '생성형 AI', 'slidesGPT', '수신', 'I', 471, 'Y', ''),
       ('ISGS', '생성형 AI', 'SlidesGPT', '발신', 'I', 472, 'Y', ''),
       ('IDMS', '생성형 AI', 'Ai Docmaker', '발신', 'I', 473, 'Y', ''),
       ('IRKS', '생성형 AI', 'Reka AI', '발신', 'I', 474, 'Y', ''),
       ('ICLS', '생성형 AI', 'Claude', '발신', 'I', 475, 'Y', ''),
       ('IDMR', '생성형 AI', 'AI Docmaker Attach', '수신', 'I', 476, 'Y', ''),
       ('IADR', '생성형 AI', 'Adobe AI', '수신', 'I', 477, 'Y', ''),
       ('IWDS', '생성형 AI', 'Dream by WOMBO', '발신', 'I', 478, 'Y', ''),
       ('IGAS', '생성형 AI', 'GetImg.AI', '발신', 'I', 479, 'Y', ''),
       ('IWKS', '생성형 AI', 'Wrks.ai', '발신', 'I', 480, 'Y', ''),
       ('IPSS', '생성형 AI', 'Polaris office ai', '발신', 'I', 481, 'Y', ''),
       ('IBGS', '생성형 AI', 'Goover AI', '발신', 'I', 482, 'Y', ''),
       ('IIAS', '생성형 AI', 'iAsk AI', '발신', 'I', 483, 'Y', ''),
       ('ISNS', '생성형 AI', 'Suno AI', '발신', 'I', 484, 'Y', ''),
       ('IPES', '생성형 AI', 'Perchance', '발신', 'I', 485, 'Y', ''),
       ('IPFS', '생성형 AI', 'ChatPDF', '발신', 'I', 486, 'Y', ''),
       ('IXOS', '생성형 AI', 'Exaone', '발신', 'I', 487, 'Y', ''),
       ('ISOR', '생성형 AI', 'Slidesgo', '수신', 'I', 488, 'Y', ''),
       ('ISOS', '생성형 AI', 'Slidesgo', '발신', 'I', 489, 'Y', ''),
       ('IKRS', '생성형 AI', 'KREA', '발신', 'I', 490, 'Y', ''),
       ('ILMS', '생성형 AI', 'GoogleNotebook LM', '발신', 'I', 491, 'Y', ''),
       ('ICCS', '생성형 AI', 'Capcut', '발신', 'I', 492, 'Y', ''),
       ('IMGS', '생성형 AI', 'Magictool', '발신', 'I', 493, 'Y', ''),
       ('IGSS', '생성형 AI', 'Genspark', '발신', 'I', 494, 'Y', ''),
       ('IFES', '생성형 AI', 'felo', '발신', 'I', 495, 'Y', ''),
       ('ITPS', '생성형 AI', 'Tripo3D', '발신', 'I', 496, 'Y', ''),
       ('ITPR', '생성형 AI', 'Tripo3D', '수신', 'I', 497, 'Y', ''),
       ('IELS', '생성형 AI', 'Elevenlabs', '발신', 'I', 498, 'Y', ''),
       ('IELR', '생성형 AI', 'Elevenlabs', '수신', 'I', 499, 'Y', ''),
       ('IGRS', '생성형 AI', 'Grammarly', '발신', 'I', 500, 'Y', ''),
       ('IVRS', '생성형 AI', 'Vrew', '발신', 'I', 501, 'Y', ''),
       ('INIS', '생성형 AI', 'NightCafe', '발신', 'I', 502, 'Y', ''),
       ('ICAS', '생성형 AI', 'CivitAI', '발신', 'I', 503, 'Y', ''),
       ('ILIS', '생성형 AI', 'Liner', '발신', 'I', 504, 'Y', ''),
       ('IBCS', '생성형 AI', 'Bing Image Creator', '발신', 'I', 505, 'Y', ''),
       ('IDSS', '생성형 AI', 'Deepseek', '발신', 'I', 506, 'Y', ''),
       ('IBDS', '생성형 AI', 'Baidu Ai', '발신', 'I', 507, 'Y', ''),
       ('IGIS', '생성형 AI', 'Gemini AI api', '발신', 'I', 508, 'Y', ''),
       ('IDTS', '생성형 AI', '에이닷', '발신', 'I', 509, 'Y', ''),
       ('IQBS', '생성형 AI', 'QuillBot', '발신', 'I', 510, 'Y', ''),
       ('ICHC', '생성형 AI', 'Character.ai', '발신', 'I', 511, 'Y', ''),
       ('ISRS', '생성형 AI', 'Sora/Openai', '발신', 'I', 512, 'Y', ''),
       ('INNS', '생성형 AI', 'Nano AI', '발신', 'I', 513, 'Y', ''),
       ('IDBS', '생성형 AI', 'Doubao', '발신', 'I', 514, 'Y', ''),
       ('ITYS', '생성형 AI', 'Tongyi', '발신', 'I', 515, 'Y', ''),
       ('IYBS', '생성형 AI', 'Yuanbao', '발신', 'I', 516, 'Y', ''),
       ('IYYS', '생성형 AI', 'Yiyan', '발신', 'I', 517, 'Y', ''),
       ('IKMS', '생성형 AI', 'Kimi', '발신', 'I', 518, 'Y', ''),
       ('IBAS', '생성형 AI', 'Baichuan', '발신', 'I', 519, 'Y', ''),
       ('ITGS', '생성형 AI', 'Tiangong', '발신', 'I', 520, 'Y', ''),
       ('ISDS', '생성형 AI', 'Stable Diffusion', '발신', 'I', 521, 'Y', ''),
       ('IGOS', '생성형 AI', 'Grok', '발신', 'I', 522, 'Y', ''),
       ('ICGS', '생성형 AI', 'ChatGLM', '발신', 'I', 523, 'Y', ''),
       ('INKS', '생성형 AI', 'Napkin AI', '발신', 'I', 524, 'Y', ''),
       ('IBIR', '생성형 AI', 'Microsoft Copilot(Chat)', '수신', 'I', 525, 'Y', ''),
       ('IOOS', '생성형 AI', 'AI Goormee', '발신', 'I', 526, 'Y', ''),
       ('IUKS', '생성형 AI', '기타', '발신', 'I', 527, 'Y', ''),
       ('PDOS', '프로젝트', 'dooray', '발신', 'O', 528, 'Y', ''),
       ('PGIS', '프로젝트', 'github', '발신', 'O', 529, 'Y', ''),
       ('PGLS', '프로젝트', 'Glassdoor', '발신', 'O', 530, 'Y', ''),
       ('PJDS', '프로젝트', '잔디', '발신', 'O', 531, 'Y', ''),
       ('PITS', '프로젝트', 'Google Isuue Tracker', '발신', 'O', 532, 'Y', ''),
       ('EBDR', '그룹웨어', '게시', '수신', 'I', 533, 'Y', ''),
       ('EBD-', '그룹웨어', '게시', '발신', 'O', 534, 'Y', ''),
       ('EBBR', '그룹웨어', '게시판', '수신', 'I', 535, 'Y', ''),
       ('EBBS', '그룹웨어', '게시판', '발신', 'O', 536, 'Y', ''),
       ('EBBF', '그룹웨어', '게시판', '파일수신', 'I', 537, 'Y', ''),
       ('EAAR', '그룹웨어', '결재', '수신', 'I', 538, 'Y', ''),
       ('EAAS', '그룹웨어', '결재', '발신', 'O', 539, 'Y', ''),
       ('EAAG', '그룹웨어', '결재', '통보 - 수신', 'I', 540, 'Y', ''),
       ('EAAP', '그룹웨어', '결재', '통보 - 발신', 'O', 541, 'Y', ''),
       ('EAAF', '그룹웨어', '결재', '파일수신', 'I', 542, 'Y', ''),
       ('EMMR', '그룹웨어', '메일', '그룹웨어 수신', 'I', 543, 'Y', ''),
       ('EMMS', '그룹웨어', '메일', '그룹웨어 발신', 'O', 544, 'Y', ''),
       ('EMMG', '그룹웨어', '메일', 'OWA 수신', 'I', 545, 'Y', ''),
       ('EMMP', '그룹웨어', '메일', 'OWA 발신', 'O', 546, 'Y', ''),
       ('EMMD', '그룹웨어', '메일', 'RPC 수신', 'I', 547, 'Y', ''),
       ('EMMU', '그룹웨어', '메일', 'RPC 발신', 'O', 548, 'Y', ''),
       ('EMMC', '그룹웨어', '메일', '수신', 'I', 549, 'Y', ''),
       ('EMML', '그룹웨어', '메일', '발신', 'O', 550, 'Y', ''),
       ('EMM1', '그룹웨어', '메일', '보안등급1', 'O', 551, 'Y', ''),
       ('EMM2', '그룹웨어', '메일', '보안등급2', 'O', 552, 'Y', ''),
       ('EMM3', '그룹웨어', '메일', '보안등급3', 'O', 553, 'Y', ''),
       ('EMM4', '그룹웨어', '메일', '보안등급4', 'O', 554, 'Y', ''),
       ('EMMA', '그룹웨어', '메일', '임시(자동)', 'O', 555, 'Y', ''),
       ('EMMT', '그룹웨어', '메일', '임시(수동)', 'O', 556, 'Y', ''),
       ('EMMK', '그룹웨어', '메일', 'Outlook - 수신', 'I', 557, 'Y', ''),
       ('EMMO', '그룹웨어', '메일', 'Outlook - 발신', 'O', 558, 'Y', ''),
       ('EMMB', '그룹웨어', '메일', '그룹웨어 예약메일', 'O', 559, 'Y', ''),
       ('EMBR', '그룹웨어', '모바일', '수신', 'I', 560, 'Y', ''),
       ('EMB-', '그룹웨어', '모바일', '발신', 'O', 561, 'Y', ''),
       ('EWSR', '그룹웨어', '웹서비스', '수신', 'I', 562, 'Y', ''),
       ('EWS-', '그룹웨어', '웹서비스', '발신', 'O', 563, 'Y', ''),
       ('EPUR', '그룹웨어', '일반', '수신', 'I', 564, 'Y', ''),
       ('EPU-', '그룹웨어', '일반', '발신', 'O', 565, 'Y', ''),
       ('EAU-', '그룹웨어', '일반(자동전달)', '자동전달', 'O', 566, 'Y', ''),
       ('ESCR', '그룹웨어', '일정 명함', '수신', 'I', 567, 'Y', ''),
       ('ESC-', '그룹웨어', '일정 명함', '발신', 'O', 568, 'Y', ''),
       ('EMF-', '그룹웨어', '파일 다운로드', '-', 'I', 569, 'Y', ''),
       ('EMU-', '그룹웨어', '기타', '', 'O', 570, 'Y', ''),
       ('EMDR', '그룹웨어', '드라이브', '수신', 'I', 571, 'Y', ''),
       ('EMDS', '그룹웨어', '드라이브', '발신', 'O', 572, 'Y', ''),
       ('ECIS', '그룹웨어', 'Samsung cic', '발신', 'O', 573, 'Y', ''),
       ('EMER', '그룹웨어', '메신저', '수신', 'O', 574, 'Y', ''),
       ('EMES', '그룹웨어', '메신저', '발신', 'O', 575, 'Y', ''),
       ('EZQC', '그룹웨어', 'Zohocliq', '채팅', 'O', 576, 'Y', ''),
       ('EZQS', '그룹웨어', 'Zohocliq', '캘린더', 'O', 577, 'Y', ''),
       ('EKWS', '그룹웨어', '카카오워크', '발신', 'O', 578, 'Y', ''),
       ('DCCS', '편집기', 'Clip Champ', '발신', 'O', 579, 'Y', ''),
       ('DFGS', '편집기', 'Figma', '발신', 'O', 580, 'Y', ''),
       ('DOVS', '편집기', 'Overleaf', '발신', 'O', 581, 'Y', ''),
       ('DOVR', '편집기', 'Overleaf', '수신', 'O', 582, 'Y', ''),
       ('DPKS', '편집기', 'Plunker', '발신', 'O', 583, 'Y', ''),
       ('DNWS', '편집기', 'Namu.wiki', '발신', 'O', 584, 'Y', ''),
       ('DWKS', '편집기', 'WikiPedia', '발신', 'O', 585, 'Y', ''),
       ('DAES', '편집기', 'Adobe Express', '발신', 'O', 586, 'Y', ''),
       ('DSMS', '편집기', 'Sketchmon', '발신', 'O', 587, 'Y', ''),
       ('JBDS', '웹사이트', 'Baidu', '발신', 'O', 588, 'Y', ''),
       ('JANS', '웹사이트', 'Anthropic', '발신', 'O', 589, 'Y', '');
...
('STAT_KEYWORDSERVICE','핵심 기술 키워드 탐지 서비스 TOP','STAT_CONTENT','L','M','ems/keywordService.do','fa fa-pie-chart',18,'Y',NULL),
