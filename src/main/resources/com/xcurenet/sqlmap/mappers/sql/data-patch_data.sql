...
VALUES ('MP3-', '메일', 'POP3', '-', 'I', 1, 'Y', ''),
       ...
       ('IUKS', '생성형 AI', '기타', '발신', 'I', 535, 'Y', ''),
       ('PDOS', '프로젝트', 'dooray', '발신', 'O', 536, 'Y', ''),
       ('PGIS', '프로젝트', 'github', '발신', 'O', 537, 'Y', ''),
       ('PGLS', '프로젝트', 'Glassdoor', '발신', 'O', 538, 'Y', ''),
       ('PJDS', '프로젝트', '잔디', '발신', 'O', 539, 'Y', ''),
       ('PITS', '프로젝트', 'Google Issue Tracker', '발신', 'O', 540, 'Y', ''),
       ('EBDR', '그룹웨어', '게시', '수신', 'I', 541, 'Y', ''),
       ('EBD-', '그룹웨어', '게시', '발신', 'O', 542, 'Y', ''),
       ('EBBR', '그룹웨어', '게시판', '수신', 'I', 543, 'Y', ''),
       ('EBBS', '그룹웨어', '게시판', '발신', 'O', 544, 'Y', ''),
       ('EBBF', '그룹웨어', '게시판', '파일수신', 'I', 545, 'Y', ''),
       ('EAAR', '그룹웨어', '결재', '수신', 'I', 546, 'Y', ''),
       ('EAAS', '그룹웨어', '결재', '발신', 'O', 547, 'Y', ''),
       ('EAAG', '그룹웨어', '결재', '통보 - 수신', 'I', 548, 'Y', ''),
       ('EAAP', '그룹웨어', '결재', '통보 - 발신', 'O', 549, 'Y', ''),
       ('EAAF', '그룹웨어', '결재', '파일수신', 'I', 550, 'Y', ''),
       ('EMMR', '그룹웨어', '메일', '그룹웨어 수신', 'I', 551, 'Y', ''),
       ('EMMS', '그룹웨어', '메일', '그룹웨어 발신', 'O', 552, 'Y', ''),
       ('EMMG', '그룹웨어', '메일', 'OWA 수신', 'I', 553, 'Y', ''),
       ('EMMP', '그룹웨어', '메일', 'OWA 발신', 'O', 554, 'Y', ''),
       ('EMMD', '그룹웨어', '메일', 'RPC 수신', 'I', 555, 'Y', ''),
       ('EMMU', '그룹웨어', '메일', 'RPC 발신', 'O', 556, 'Y', ''),
       ('EMMC', '그룹웨어', '메일', '수신', 'I', 557, 'Y', ''),
       ('EMML', '그룹웨어', '메일', '발신', 'O', 558, 'Y', ''),
       ('EMM1', '그룹웨어', '메일', '보안등급1', 'O', 559, 'Y', ''),
       ('EMM2', '그룹웨어', '메일', '보안등급2', 'O', 560, 'Y', ''),
       ('EMM3', '그룹웨어', '메일', '보안등급3', 'O', 561, 'Y', ''),
       ('EMM4', '그룹웨어', '메일', '보안등급4', 'O', 562, 'Y', ''),
       ('EMMA', '그룹웨어', '메일', '임시(자동)', 'O', 563, 'Y', ''),
       ('EMMT', '그룹웨어', '메일', '임시(수동)', 'O', 564, 'Y', ''),
       ('EMMK', '그룹웨어', '메일', 'Outlook - 수신', 'I', 565, 'Y', ''),
       ('EMMO', '그룹웨어', '메일', 'Outlook - 발신', 'O', 566, 'Y', ''),
       ('EMMB', '그룹웨어', '메일', '그룹웨어 예약메일', 'O', 567, 'Y', ''),
       ('EMBR', '그룹웨어', '모바일', '수신', 'I', 568, 'Y', ''),
       ('EMB-', '그룹웨어', '모바일', '발신', 'O', 569, 'Y', ''),
       ('EWSR', '그룹웨어', '웹서비스', '수신', 'I', 570, 'Y', ''),
       ('EWS-', '그룹웨어', '웹서비스', '발신', 'O', 571, 'Y', ''),
       ('EPUR', '그룹웨어', '일반', '수신', 'I', 572, 'Y', ''),
       ('EPU-', '그룹웨어', '일반', '발신', 'O', 573, 'Y', ''),
       ('EAU-', '그룹웨어', '일반(자동전달)', '자동전달', 'O', 574, 'Y', ''),
       ('ESCR', '그룹웨어', '일정 명함', '수신', 'I', 575, 'Y', ''),
       ('ESC-', '그룹웨어', '일정 명함', '발신', 'O', 576, 'Y', ''),
       ('EMF-', '그룹웨어', '파일 다운로드', '-', 'I', 577, 'Y', ''),
       ('EMU-', '그룹웨어', '기타', '', 'O', 578, 'Y', ''),
       ('EMDR', '그룹웨어', '드라이브', '수신', 'I', 579, 'Y', ''),
       ('EMDS', '그룹웨어', '드라이브', '발신', 'O', 580, 'Y', ''),
       ('ECIS', '그룹웨어', 'Samsung cic', '발신', 'O', 581, 'Y', ''),
       ('EMER', '그룹웨어', '메신저', '수신', 'O', 582, 'Y', ''),
       ('EMES', '그룹웨어', '메신저', '발신', 'O', 583, 'Y', ''),
       ('EZQC', '그룹웨어', 'Zohocliq', '채팅', 'O', 584, 'Y', ''),
       ('EZQS', '그룹웨어', 'Zohocliq', '캘린더', 'O', 585, 'Y', ''),
       ('EKWS', '그룹웨어', '카카오워크', '발신', 'O', 586, 'Y', ''),
       ('DCCS', '편집기', 'Clip Champ', '발신', 'O', 587, 'Y', ''),
       ('DFGS', '편집기', 'Figma', '발신', 'O', 588, 'Y', ''),
       ('DOVS', '편집기', 'Overleaf', '발신', 'O', 589, 'Y', ''),
       ('DOVR', '편집기', 'Overleaf', '수신', 'O', 590, 'Y', ''),
       ('DPKS', '편집기', 'Plunker', '발신', 'O', 591, 'Y', ''),
       ('DNWS', '편집기', 'Namu.wiki', '발신', 'O', 592, 'Y', ''),
       ('DWKS', '편집기', 'WikiPedia', '발신', 'O', 593, 'Y', ''),
       ('DAES', '편집기', 'Adobe Express', '발신', 'O', 594, 'Y', ''),
       ('DSMS', '편집기', 'Sketchmon', '발신', 'O', 595, 'Y', ''),
       ('DGSS', '편집기', 'Google Site', '발신', 'O', 596, 'Y', ''),
       ('JBDS', '웹사이트', 'Baidu', '발신', 'O', 597, 'Y', ''),
       ('JANS', '웹사이트', 'Anthropic', '발신', 'O', 598, 'Y', ''),
       ('RGUS', '원격접속', '아파치 과카몰리', '발신', 'O', 599, 'Y', '');
