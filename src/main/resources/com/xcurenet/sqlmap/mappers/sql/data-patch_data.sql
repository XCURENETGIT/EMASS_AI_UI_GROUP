...
('IJRS', '생성형 AI', 'Jira AI', '발신', 'O', 695, 'Y', ''),
('IJRR', '생성형 AI', 'Jira AI', '수신', 'I', 696, 'Y', ''),
('IDIS', '생성형 AI', 'D-ID', '발신', 'O', 697, 'Y', ''),
('IDIR', '생성형 AI', 'D-ID', '수신', 'I', 698, 'Y', ''),
('IDIQ', '생성형 AI', 'D-ID', '발신', 'O', 699, 'Y', ''),
('PDOS', '프로젝트', 'dooray', '발신', 'O', 700, 'Y', ''),
('PGIS', '프로젝트', 'github', '발신', 'O', 701, 'Y', ''),
('PGLS', '프로젝트', 'Glassdoor', '발신', 'O', 702, 'Y', ''),
('PJDS', '프로젝트', '잔디', '발신', 'O', 703, 'Y', ''),
('PITS', '프로젝트', 'Google Issue Tracker', '발신', 'O', 704, 'Y', ''),
('EBDR', '그룹웨어', '게시', '수신', 'I', 705, 'Y', ''),
('EBD-', '그룹웨어', '게시', '발신', 'O', 706, 'Y', ''),
('EBBR', '그룹웨어', '게시판', '수신', 'I', 707, 'Y', ''),
('EBBS', '그룹웨어', '게시판', '발신', 'O', 708, 'Y', ''),
('EBBF', '그룹웨어', '게시판', '파일수신', 'I', 709, 'Y', ''),
('EAAR', '그룹웨어', '결재', '수신', 'I', 710, 'Y', ''),
('EAAS', '그룹웨어', '결재', '발신', 'O', 711, 'Y', ''),
('EAAG', '그룹웨어', '결재', '통보 - 수신', 'I', 712, 'Y', ''),
('EAAP', '그룹웨어', '결재', '통보 - 발신', 'O', 713, 'Y', ''),
('EAAF', '그룹웨어', '결재', '파일수신', 'I', 714, 'Y', ''),
('EMMR', '그룹웨어', '메일', '그룹웨어 수신', 'I', 715, 'Y', ''),
('EMMS', '그룹웨어', '메일', '그룹웨어 발신', 'O', 716, 'Y', ''),
('EMMG', '그룹웨어', '메일', 'OWA 수신', 'I', 717, 'Y', ''),
('EMMP', '그룹웨어', '메일', 'OWA 발신', 'O', 718, 'Y', ''),
('EMMD', '그룹웨어', '메일', 'RPC 수신', 'I', 719, 'Y', ''),
('EMMU', '그룹웨어', '메일', 'RPC 발신', 'O', 720, 'Y', ''),
('EMMC', '그룹웨어', '메일', '수신', 'I', 721, 'Y', ''),
('EMML', '그룹웨어', '메일', '발신', 'O', 722, 'Y', ''),
('EMM1', '그룹웨어', '메일', '보안등급1', 'O', 723, 'Y', ''),
('EMM2', '그룹웨어', '메일', '보안등급2', 'O', 724, 'Y', ''),
('EMM3', '그룹웨어', '메일', '보안등급3', 'O', 725, 'Y', ''),
('EMM4', '그룹웨어', '메일', '보안등급4', 'O', 726, 'Y', ''),
('EMMA', '그룹웨어', '메일', '임시(자동)', 'O', 727, 'Y', ''),
('EMMT', '그룹웨어', '메일', '임시(수동)', 'O', 728, 'Y', ''),
('EMMK', '그룹웨어', '메일', 'Outlook - 수신', 'I', 729, 'Y', ''),
('EMMO', '그룹웨어', '메일', 'Outlook - 발신', 'O', 730, 'Y', ''),
('EMMB', '그룹웨어', '메일', '그룹웨어 예약메일', 'O', 731, 'Y', ''),
('EMBR', '그룹웨어', '모바일', '수신', 'I', 732, 'Y', ''),
('EMB-', '그룹웨어', '모바일', '발신', 'O', 733, 'Y', ''),
('EWSR', '그룹웨어', '웹서비스', '수신', 'I', 734, 'Y', ''),
('EWS-', '그룹웨어', '웹서비스', '발신', 'O', 735, 'Y', ''),
('EPUR', '그룹웨어', '일반', '수신', 'I', 736, 'Y', ''),
('EPU-', '그룹웨어', '일반', '발신', 'O', 737, 'Y', ''),
('EAU-', '그룹웨어', '일반(자동전달)', '자동전달', 'O', 738, 'Y', ''),
('ESCR', '그룹웨어', '일정 명함', '수신', 'I', 739, 'Y', ''),
('ESC-', '그룹웨어', '일정 명함', '발신', 'O', 740, 'Y', ''),
('EMF-', '그룹웨어', '파일 다운로드', '-', 'I', 741, 'Y', ''),
('EMU-', '그룹웨어', '기타', '', 'O', 742, 'Y', ''),
('ETOS', '그룹웨어', 'Tigris', '기타', 'O', 743, 'Y', ''),
('EMDR', '그룹웨어', '드라이브', '수신', 'I', 744, 'Y', ''),
('EMDS', '그룹웨어', '드라이브', '발신', 'O', 745, 'Y', ''),
('ETOD', '그룹웨어', 'Tigris', '드라이브', 'O', 746, 'Y', ''),
('ECIS', '그룹웨어', 'Samsung cic', '발신', 'O', 747, 'Y', ''),
('EMER', '그룹웨어', '메신저', '수신', 'I', 748, 'Y', ''),
('EMES', '그룹웨어', '메신저', '발신', 'O', 749, 'Y', ''),
('EMEC', '그룹웨어', '메신저', '채팅', 'O', 750, 'Y', 'MSG'),
('ETOC', '그룹웨어', 'Tigris', '메신저', 'O', 751, 'Y', ''),
('ETOA', '그룹웨어', 'Tigris', '결재', 'O', 752, 'Y', ''),
('EZQC', '그룹웨어', 'Zohocliq', '채팅', 'O', 753, 'Y', ''),
('EZQS', '그룹웨어', 'Zohocliq', '캘린더', 'O', 754, 'Y', ''),
('EKWS', '그룹웨어', '카카오워크', '발신', 'O', 755, 'Y', ''),
('ECAS', '그룹웨어', '일정', '발신', 'O', 756, 'Y', ''),
('DCCS', '편집기', 'Clip Champ', '발신', 'O', 757, 'Y', ''),
('DFGS', '편집기', 'Figma', '발신', 'O', 758, 'Y', ''),
('DOVS', '편집기', 'Overleaf', '발신', 'O', 759, 'Y', ''),
('DOVR', '편집기', 'Overleaf', '수신', 'I', 760, 'Y', ''),
('DPKS', '편집기', 'Plunker', '발신', 'O', 761, 'Y', ''),
('DNWS', '편집기', 'Namu.wiki', '발신', 'O', 762, 'Y', ''),
('DWKS', '편집기', 'WikiPedia', '발신', 'O', 763, 'Y', ''),
('DAES', '편집기', 'Adobe Express', '발신', 'O', 764, 'Y', ''),
('DSMS', '편집기', 'Sketchmon', '발신', 'O', 765, 'Y', ''),
('DGSS', '편집기', 'Google Site', '발신', 'O', 766, 'Y', ''),
('DCVS', '편집기', 'Canva', '발신', 'O', 767, 'Y', ''),
('DMBS', '편집기', '망고보드', '발신', 'O', 768, 'Y', ''),
('DMTS', '편집기', '망고툰', '발신', 'O', 769, 'Y', ''),
('JBDS', '웹사이트', 'Baidu', '발신', 'O', 770, 'Y', ''),
('JANS', '웹사이트', 'Anthropic', '발신', 'O', 771, 'Y', ''),
('JKAS', '웹사이트', 'Kaggle', '발신', 'O', 772, 'Y', ''),
('JJPS', '웹사이트', 'justpaste.it', '발신', 'O', 773, 'Y', ''),
('JPBS', '웹사이트', 'pastebin.com', '발신', 'O', 774, 'Y', ''),
('JNNS', '웹사이트', 'n8n', '발신', 'O', 775, 'Y', ''),
('JGHS', '웹사이트', 'Google cloud console', '발신', 'O', 776, 'Y', ''),
('JALS', '웹사이트', 'AnessLab', '발신', 'O', 777, 'Y', ''),
('JCCS', '웹사이트', 'CMCC [GUI-AGENT]', '발신', 'O', 778, 'Y', ''),
('JOTS', '웹사이트', 'Otter.ai', '발신', 'O', 779, 'Y', ''),
('JMLS', '웹사이트', 'Menlosecurity', '발신', 'O', 780, 'Y', ''),
('JHFS', '웹사이트', 'Hugging Face', '발신', 'O', 781, 'Y', ''),
('JSNS', '웹사이트', 'AWS SNS', '발신', 'O', 782, 'Y', ''),
('JAGS', '웹사이트', 'AWS API Gateway', '발신', 'O', 783, 'Y', ''),
('JASS', '웹사이트', 'AWS SSM', '발신', 'O', 784, 'Y', ''),
('JGBS', '웹사이트', 'GitLab', '발신', 'O', 785, 'Y', ''),
('JMYS', '웹사이트', 'Mintlify', '발신', 'O', 786, 'Y', ''),
('RGUS', '원격접속', '아파치 과카몰리', '발신', 'O', 787, 'Y', ''),
('RGUR', '원격접속', '아파치 과카몰리', '수신', 'I', 788, 'Y', ''),
('KAAR', '웹서비스(분류)', '웹 수신', '수신', 'I', 789, 'Y', ''),
('KAAS', '웹서비스(분류)', '웹 발신', '발신', 'O', 790, 'Y', '')
