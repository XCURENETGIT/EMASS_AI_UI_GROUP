...
('IEGS', '생성형 AI', '사내 생성형 AI 게이트웨이', '발신', 'O', 681, 'Y', ''),
('IEGR', '생성형 AI', '사내 생성형 AI 게이트웨이', '수신', 'I', 682, 'Y', ''),
('ICFS', '생성형 AI', 'Confluence AI', '발신', 'O', 683, 'Y', ''),
('ICFR', '생성형 AI', 'Confluence AI', '수신', 'I', 684, 'Y', ''),
('IGDS', '생성형 AI', 'GitLab Duo Chat', '발신', 'O', 685, 'Y', ''),
('IGDR', '생성형 AI', 'GitLab Duo Chat', '수신', 'I', 686, 'Y', ''),
('ICVS', '생성형 AI', 'Canva AI', '발신', 'O', 687, 'Y', ''),
('ICVR', '생성형 AI', 'Canva AI', '수신', 'I', 688, 'Y', ''),
('PDOS', '프로젝트', 'dooray', '발신', 'O', 689, 'Y', ''),
('PGIS', '프로젝트', 'github', '발신', 'O', 690, 'Y', ''),
('PGLS', '프로젝트', 'Glassdoor', '발신', 'O', 691, 'Y', ''),
('PJDS', '프로젝트', '잔디', '발신', 'O', 692, 'Y', ''),
('PITS', '프로젝트', 'Google Issue Tracker', '발신', 'O', 693, 'Y', ''),
('EBDR', '그룹웨어', '게시', '수신', 'I', 694, 'Y', ''),
('EBD-', '그룹웨어', '게시', '발신', 'O', 695, 'Y', ''),
('EBBR', '그룹웨어', '게시판', '수신', 'I', 696, 'Y', ''),
('EBBS', '그룹웨어', '게시판', '발신', 'O', 697, 'Y', ''),
('EBBF', '그룹웨어', '게시판', '파일수신', 'I', 698, 'Y', ''),
('EAAR', '그룹웨어', '결재', '수신', 'I', 699, 'Y', ''),
('EAAS', '그룹웨어', '결재', '발신', 'O', 700, 'Y', ''),
('EAAG', '그룹웨어', '결재', '통보 - 수신', 'I', 701, 'Y', ''),
('EAAP', '그룹웨어', '결재', '통보 - 발신', 'O', 702, 'Y', ''),
('EAAF', '그룹웨어', '결재', '파일수신', 'I', 703, 'Y', ''),
('EMMR', '그룹웨어', '메일', '그룹웨어 수신', 'I', 704, 'Y', ''),
('EMMS', '그룹웨어', '메일', '그룹웨어 발신', 'O', 705, 'Y', ''),
('EMMG', '그룹웨어', '메일', 'OWA 수신', 'I', 706, 'Y', ''),
('EMMP', '그룹웨어', '메일', 'OWA 발신', 'O', 707, 'Y', ''),
('EMMD', '그룹웨어', '메일', 'RPC 수신', 'I', 708, 'Y', ''),
('EMMU', '그룹웨어', '메일', 'RPC 발신', 'O', 709, 'Y', ''),
('EMMC', '그룹웨어', '메일', '수신', 'I', 710, 'Y', ''),
('EMML', '그룹웨어', '메일', '발신', 'O', 711, 'Y', ''),
('EMM1', '그룹웨어', '메일', '보안등급1', 'O', 712, 'Y', ''),
('EMM2', '그룹웨어', '메일', '보안등급2', 'O', 713, 'Y', ''),
('EMM3', '그룹웨어', '메일', '보안등급3', 'O', 714, 'Y', ''),
('EMM4', '그룹웨어', '메일', '보안등급4', 'O', 715, 'Y', ''),
('EMMA', '그룹웨어', '메일', '임시(자동)', 'O', 716, 'Y', ''),
('EMMT', '그룹웨어', '메일', '임시(수동)', 'O', 717, 'Y', ''),
('EMMK', '그룹웨어', '메일', 'Outlook - 수신', 'I', 718, 'Y', ''),
('EMMO', '그룹웨어', '메일', 'Outlook - 발신', 'O', 719, 'Y', ''),
('EMMB', '그룹웨어', '메일', '그룹웨어 예약메일', 'O', 720, 'Y', ''),
('EMBR', '그룹웨어', '모바일', '수신', 'I', 721, 'Y', ''),
('EMB-', '그룹웨어', '모바일', '발신', 'O', 722, 'Y', ''),
('EWSR', '그룹웨어', '웹서비스', '수신', 'I', 723, 'Y', ''),
('EWS-', '그룹웨어', '웹서비스', '발신', 'O', 724, 'Y', ''),
('EPUR', '그룹웨어', '일반', '수신', 'I', 725, 'Y', ''),
('EPU-', '그룹웨어', '일반', '발신', 'O', 726, 'Y', ''),
('EAU-', '그룹웨어', '일반(자동전달)', '자동전달', 'O', 727, 'Y', ''),
('ESCR', '그룹웨어', '일정 명함', '수신', 'I', 728, 'Y', ''),
('ESC-', '그룹웨어', '일정 명함', '발신', 'O', 729, 'Y', ''),
('EMF-', '그룹웨어', '파일 다운로드', '-', 'I', 730, 'Y', ''),
('EMU-', '그룹웨어', '기타', '', 'O', 731, 'Y', ''),
('ETOS', '그룹웨어', 'Tigris', '기타', 'O', 732, 'Y', ''),
('EMDR', '그룹웨어', '드라이브', '수신', 'I', 733, 'Y', ''),
('EMDS', '그룹웨어', '드라이브', '발신', 'O', 734, 'Y', ''),
('ETOD', '그룹웨어', 'Tigris', '드라이브', 'O', 735, 'Y', ''),
('ECIS', '그룹웨어', 'Samsung cic', '발신', 'O', 736, 'Y', ''),
('EMER', '그룹웨어', '메신저', '수신', 'I', 737, 'Y', ''),
('EMES', '그룹웨어', '메신저', '발신', 'O', 738, 'Y', ''),
('EMEC', '그룹웨어', '메신저', '채팅', 'O', 739, 'Y', 'MSG'),
('ETOC', '그룹웨어', 'Tigris', '메신저', 'O', 740, 'Y', ''),
('ETOA', '그룹웨어', 'Tigris', '결재', 'O', 741, 'Y', ''),
('EZQC', '그룹웨어', 'Zohocliq', '채팅', 'O', 742, 'Y', ''),
('EZQS', '그룹웨어', 'Zohocliq', '캘린더', 'O', 743, 'Y', ''),
('EKWS', '그룹웨어', '카카오워크', '발신', 'O', 744, 'Y', ''),
('ECAS', '그룹웨어', '일정', '발신', 'O', 745, 'Y', ''),
('DCCS', '편집기', 'Clip Champ', '발신', 'O', 746, 'Y', ''),
('DFGS', '편집기', 'Figma', '발신', 'O', 747, 'Y', ''),
('DOVS', '편집기', 'Overleaf', '발신', 'O', 748, 'Y', ''),
('DOVR', '편집기', 'Overleaf', '수신', 'I', 749, 'Y', ''),
('DPKS', '편집기', 'Plunker', '발신', 'O', 750, 'Y', ''),
('DNWS', '편집기', 'Namu.wiki', '발신', 'O', 751, 'Y', ''),
('DWKS', '편집기', 'WikiPedia', '발신', 'O', 752, 'Y', ''),
('DAES', '편집기', 'Adobe Express', '발신', 'O', 753, 'Y', ''),
('DSMS', '편집기', 'Sketchmon', '발신', 'O', 754, 'Y', ''),
('DGSS', '편집기', 'Google Site', '발신', 'O', 755, 'Y', ''),
('DCVS', '편집기', 'Canva', '발신', 'O', 756, 'Y', ''),
('DMBS', '편집기', '망고보드', '발신', 'O', 757, 'Y', ''),
('DMTS', '편집기', '망고툰', '발신', 'O', 758, 'Y', ''),
('JBDS', '웹사이트', 'Baidu', '발신', 'O', 759, 'Y', ''),
('JANS', '웹사이트', 'Anthropic', '발신', 'O', 760, 'Y', ''),
('JKAS', '웹사이트', 'Kaggle', '발신', 'O', 761, 'Y', ''),
('JJPS', '웹사이트', 'justpaste.it', '발신', 'O', 762, 'Y', ''),
('JPBS', '웹사이트', 'pastebin.com', '발신', 'O', 763, 'Y', ''),
('JNNS', '웹사이트', 'n8n', '발신', 'O', 764, 'Y', ''),
('JGHS', '웹사이트', 'Google cloud console', '발신', 'O', 765, 'Y', ''),
('JALS', '웹사이트', 'AnessLab', '발신', 'O', 766, 'Y', ''),
('JCCS', '웹사이트', 'CMCC [GUI-AGENT]', '발신', 'O', 767, 'Y', ''),
('JOTS', '웹사이트', 'Otter.ai', '발신', 'O', 768, 'Y', ''),
('JMLS', '웹사이트', 'Menlosecurity', '발신', 'O', 769, 'Y', ''),
('JHFS', '웹사이트', 'Hugging Face', '발신', 'O', 770, 'Y', ''),
('JSNS', '웹사이트', 'AWS SNS', '발신', 'O', 771, 'Y', ''),
('JAGS', '웹사이트', 'AWS API Gateway', '발신', 'O', 772, 'Y', ''),
('JASS', '웹사이트', 'AWS SSM', '발신', 'O', 773, 'Y', ''),
('JGBS', '웹사이트', 'GitLab', '발신', 'O', 774, 'Y', ''),
('RGUS', '원격접속', '아파치 과카몰리', '발신', 'O', 775, 'Y', ''),
('RGUR', '원격접속', '아파치 과카몰리', '수신', 'I', 776, 'Y', ''),
('KAAR', '웹서비스(분류)', '웹 수신', '수신', 'I', 777, 'Y', ''),
('KAAS', '웹서비스(분류)', '웹 발신', '발신', 'O', 778, 'Y', '')
ON DUPLICATE KEY UPDATE
    SERVICENM_LV1 = VALUES(SERVICENM_LV1),
    SERVICENM_LV2 = VALUES(SERVICENM_LV2),
    SERVICENM_LV3 = VALUES(SERVICENM_LV3),
    IN_OUT = VALUES(IN_OUT),
    SORT = VALUES(SORT),
    MSGGRPCD = VALUES(MSGGRPCD);
...
ALTER TABLE UI_ID_NOLOG MODIFY COLUMN SERVICECD VARCHAR(500);