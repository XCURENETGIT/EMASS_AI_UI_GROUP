...
('XU4R', '모니터링_제외', '필수 로깅', '수신', 'I', 389, 'Y', ''),
('XU4S', '모니터링_제외', '필수 로깅', '발신', 'O', 390, 'Y', ''),
('UWSD', '웹서비스(미분류)', '웹 발신', '첨부 - 문서타입', 'O', 391, 'Y', ''),
('UWSE', '웹서비스(미분류)', '웹 발신', '첨부 - 문서아님', 'O', 392, 'Y', ''),
('UWSU', '웹서비스(미분류)', '웹 발신', '첨부 없음', 'O', 393, 'Y', ''),
('UWSH', '웹서비스(미분류)', '웹 발신', '중요도(상)', 'O', 394, 'Y', ''),
('UWSM', '웹서비스(미분류)', '웹 발신', '중요도(중)', 'O', 395, 'Y', ''),
('UWSL', '웹서비스(미분류)', '웹 발신', '중요도(하)', 'O', 396, 'Y', ''),
('UX1R', '웹서비스(미분류)', '미분류_타입1', '수신', 'I', 397, 'Y', ''),
('UX1S', '웹서비스(미분류)', '미분류_타입1', '발신', 'O', 398, 'Y', ''),
('UX2R', '웹서비스(미분류)', '미분류_타입2', '수신', 'I', 399, 'Y', ''),
('UX2S', '웹서비스(미분류)', '미분류_타입2', '발신', 'O', 400, 'Y', ''),
('UX3R', '웹서비스(미분류)', '미분류_타입3', '수신', 'I', 401, 'Y', ''),
('UX3S', '웹서비스(미분류)', '미분류_타입3', '발신', 'O', 402, 'Y', ''),
('UWRD', '웹서비스(미분류)', '웹 수신', '첨부 - 문서타입', 'I', 403, 'Y', ''),
('UWRE', '웹서비스(미분류)', '웹 수신', '첨부 - 문서아님', 'I', 404, 'Y', ''),
('UWRU', '웹서비스(미분류)', '웹 수신', '첨부 없음', 'I', 405, 'Y', ''),
('BWSD', '웹서비스(업무)', '업무 발신', '첨부 - 문서타입', 'O', 406, 'Y', ''),
('BWSE', '웹서비스(업무)', '업무 발신', '첨부 - 문서아님', 'O', 407, 'Y', ''),
('BWSU', '웹서비스(업무)', '업무 발신', '첨부 없음', 'O', 408, 'Y', ''),
('BWRD', '웹서비스(업무)', '업무 수신', '첨부 - 문서타입', 'I', 409, 'Y', ''),
('BWRE', '웹서비스(업무)', '업무 수신', '첨부 - 문서아님', 'I', 410, 'Y', ''),
('BWRU', '웹서비스(업무)', '업무 수신', '첨부 없음', 'I', 411, 'Y', ''),
('TWEC', '화상회의', 'Webex', '채팅', 'O', 412, 'Y', 'MSG'),
('TWEF', '화상회의', 'Webex', '파일전송', 'O', 413, 'Y', 'MSG'),
('TWEJ', '화상회의', 'Webex', '참여', 'O', 414, 'Y', 'MSG'),
('TWEL', '화상회의', 'Webex', '떠남', 'O', 415, 'Y', 'MSG'),
('TZOC', '화상회의', 'Zoom', '채팅', 'O', 416, 'Y', 'MSG'),
('TZOF', '화상회의', 'Zoom', '파일전송', 'O', 417, 'Y', 'MSG'),
('TZOJ', '화상회의', 'Zoom', '참여', 'O', 418, 'Y', 'MSG'),
('TZOL', '화상회의', 'Zoom', '떠남', 'O', 419, 'Y', 'MSG'),
('TTMC', '화상회의', 'Teams', '채팅', 'O', 420, 'Y', 'MSG'),
('TTMF', '화상회의', 'Teams', '파일전송', 'O', 421, 'Y', 'MSG'),
('TTMJ', '화상회의', 'Teams', '참여', 'O', 422, 'Y', 'MSG'),
('TTML', '화상회의', 'Teams', '떠남', 'O', 423, 'Y', 'MSG'),
('TSKC', '화상회의', 'Skype', '채팅', 'O', 424, 'Y', 'MSG'),
('TSKF', '화상회의', 'Skype', '파일전송', 'O', 425, 'Y', 'MSG'),
('TSKJ', '화상회의', 'Skype', '참여', 'O', 426, 'Y', 'MSG'),
('TSKL', '화상회의', 'Skype', '떠남', 'O', 427, 'Y', 'MSG'),
('TJMC', '화상회의', 'JoinME', '채팅', 'O', 428, 'Y', 'MSG'),
('TJMF', '화상회의', 'JoinME', '파일전송', 'O', 429, 'Y', 'MSG'),
('TAMC', '화상회의', 'Amazon Chime', '채팅', 'O', 430, 'Y', 'MSG'),
('TAMF', '화상회의', 'Amazon Chime', '파일전송', 'O', 431, 'Y', 'MSG'),
('TBJC', '화상회의', 'BlueJeans', '채팅', 'O', 432, 'Y', 'MSG'),
('TTDS', '화상회의', 'Tl;dv', '채팅', 'O', 433, 'Y', 'MSG'),
('LNVS', '번역기', '파파고 번역', '발신', 'O', 434, 'Y', ''),
('LGGS', '번역기', '구글 번역', '발신', 'O', 435, 'Y', ''),
('LGPS', '번역기', '구글 번역 플러그인', '발신', 'O', 436, 'Y', ''),
('LDES', '번역기', 'Deepl', '발신', 'O', 437, 'Y', ''),
('LBIS', '번역기', 'Bing 번역', '발신', 'O', 438, 'Y', ''),
('LYMS', '번역기', 'Yandex 번역', '발신', 'O', 439, 'Y', ''),
('LGAS', '번역기', 'Google Cloud Translation Api', '발신', 'O', 440, 'Y', ''),
('LFTS', '번역기', 'Flitto', '발신', 'O', 441, 'Y', ''),
('LOTS', '번역기', 'O-Translator', '발신', 'O', 442, 'Y', ''),
('LUKS', '번역기', '기타', '발신', 'I', 443, 'Y', ''),
('IGBS', '생성형 AI', '구글 Gemini', '발신', 'O', 444, 'Y', ''),
('IBIS', '생성형 AI', ' Microsoft Copilot', '발신', 'O', 445, 'Y', ''),
('IWTS', '생성형 AI', 'Wrtn', '발신', 'O', 446, 'Y', ''),
('IGPS', '생성형 AI', 'ChatGPT', '발신', 'O', 447, 'Y', ''),
('IGPR', '생성형 AI', 'ChatGPT', '수신', 'O', 448, 'Y', ''),
('IDAS', '생성형 AI', 'Dall-E', '발신', 'O', 449, 'Y', ''),
('IGCS', '생성형 AI', 'Github Copilot', '발신', 'I', 450, 'Y', ''),
('IGCR', '생성형 AI', 'Github Copilot', '수신', 'O', 451, 'Y', ''),
('IYCS', '생성형 AI', 'YouChat', '발신', 'I', 452, 'Y', ''),
('ICSS', '생성형 AI', 'Chatsonic', '발신', 'I', 453, 'Y', ''),
('IRPS', '생성형 AI', 'Replika', '발신', 'I', 454, 'Y', ''),
('IPPS', '생성형 AI', 'Perplexity', '발신', 'I', 455, 'Y', ''),
('IPPR', '생성형 AI', 'Perplexity', '수신', 'O', 456, 'Y', ''),
('ITCS', '생성형 AI', 'TextCortex', '발신', 'I', 457, 'Y', ''),
('IPHS', '생성형 AI', 'Phind', '발신', 'I', 458, 'Y', ''),
('IPOS', '생성형 AI', 'Poe', '발신', 'I', 459, 'Y', ''),
('IHFS', '생성형 AI', 'Hugging Face', '발신', 'I', 460, 'Y', ''),
('ICPS', '생성형 AI', 'Copy.AI', '발신', 'I', 461, 'Y', ''),
('IHWS', '생성형 AI', 'HyperWrite', '발신', 'I', 462, 'Y', ''),
('IDPS', '생성형 AI', 'DeepAI', '발신', 'I', 463, 'Y', ''),
('IACS', '생성형 AI', 'AskCodi', '발신', 'I', 464, 'Y', ''),
('INAS', '생성형 AI', 'Native', '발신', 'I', 465, 'Y', ''),
('INFS', '생성형 AI', 'NeuroFlash', '발신', 'I', 466, 'Y', ''),
('INOS', '생성형 AI', 'Notion AI', '발신', 'I', 467, 'Y', ''),
('IMES', '생성형 AI', 'Merlin', '발신', 'I', 468, 'Y', ''),
('ICXS', '생성형 AI', 'CLOVA-X', '발신', 'I', 469, 'Y', ''),
('IADS', '생성형 AI', 'Adobe AI', '발신', 'I', 470, 'Y', ''),
('ICDS', '생성형 AI', 'ClipDrop', '발신', 'I', 471, 'Y', ''),
('ISBS', '생성형 AI', 'Stability.Ai', '발신', 'I', 472, 'Y', ''),
('IRMS', '생성형 AI', 'Runwayml', '발신', 'I', 473, 'Y', ''),
('IGVS', '생성형 AI', 'Google Vertex', '발신', 'I', 474, 'Y', ''),
('IGLS', '생성형 AI', 'Google Colab', '발신', 'I', 475, 'Y', ''),
('ICWS', '생성형 AI', 'CodeWhisperer', '발신', 'I', 476, 'Y', ''),
('IMSS', '생성형 AI', 'Google AI Studio', '발신', 'I', 477, 'Y', ''),
('IOCS', '생성형 AI', 'Clova OCR', '발신', 'I', 478, 'Y', ''),
('IAOS', '생성형 AI', 'Azure OpenAI', '발신', 'I', 479, 'Y', ''),
('ICUS', '생성형 AI', '네이버 CUE:', '발신', 'I', 480, 'Y', ''),
('IMJS', '생성형 AI', 'Midjourney', '발신', 'I', 481, 'Y', ''),
('ISGR', '생성형 AI', 'slidesGPT', '수신', 'I', 482, 'Y', ''),
('ISGS', '생성형 AI', 'SlidesGPT', '발신', 'I', 483, 'Y', ''),
('IDMS', '생성형 AI', 'Ai Docmaker', '발신', 'I', 484, 'Y', ''),
('IRKS', '생성형 AI', 'Reka AI', '발신', 'I', 485, 'Y', ''),
('ICLS', '생성형 AI', 'Claude', '발신', 'I', 486, 'Y', ''),
('IDMR', '생성형 AI', 'AI Docmaker Attach', '수신', 'I', 487, 'Y', ''),
('IADR', '생성형 AI', 'Adobe firefly login', '수신', 'I', 488, 'Y', ''),
('IWDS', '생성형 AI', 'Dream by WOMBO', '발신', 'I', 489, 'Y', ''),
('IGAS', '생성형 AI', 'GetImg.AI', '발신', 'I', 490, 'Y', ''),
('IWKS', '생성형 AI', 'Wrks.ai', '발신', 'I', 491, 'Y', ''),
('IPSS', '생성형 AI', 'Polaris office ai', '발신', 'I', 492, 'Y', ''),
('IBGS', '생성형 AI', 'Goover AI', '발신', 'I', 493, 'Y', ''),
('IIAS', '생성형 AI', 'iAsk AI', '발신', 'I', 494, 'Y', ''),
('ISNS', '생성형 AI', 'Suno AI', '발신', 'I', 495, 'Y', ''),
('IPES', '생성형 AI', 'Perchance', '발신', 'I', 496, 'Y', ''),
('IPFS', '생성형 AI', 'ChatPDF', '발신', 'I', 497, 'Y', ''),
('IXOS', '생성형 AI', 'Exaone', '발신', 'I', 498, 'Y', ''),
('ISOR', '생성형 AI', 'Slidesgo', '수신', 'I', 499, 'Y', ''),
('ISOS', '생성형 AI', 'Slidesgo', '발신', 'I', 500, 'Y', ''),
('IKRS', '생성형 AI', 'KREA', '발신', 'I', 501, 'Y', ''),
('ILMS', '생성형 AI', 'GoogleNotebook LM', '발신', 'I', 502, 'Y', ''),
('ICCS', '생성형 AI', 'Capcut', '발신', 'I', 503, 'Y', ''),
('IMGS', '생성형 AI', 'Magictool', '발신', 'I', 504, 'Y', ''),
('IGSS', '생성형 AI', 'Genspark', '발신', 'I', 505, 'Y', ''),
('IFES', '생성형 AI', 'felo', '발신', 'I', 506, 'Y', ''),
('ITPS', '생성형 AI', 'Tripo3D', '발신', 'I', 507, 'Y', ''),
('ITPR', '생성형 AI', 'Tripo3D', '수신', 'I', 508, 'Y', ''),
('IELS', '생성형 AI', 'Elevenlabs', '발신', 'I', 509, 'Y', ''),
('IELR', '생성형 AI', 'Elevenlabs', '수신', 'I', 510, 'Y', ''),
('IGRS', '생성형 AI', 'Grammarly', '발신', 'I', 511, 'Y', ''),
('IVRS', '생성형 AI', 'Vrew', '발신', 'I', 512, 'Y', ''),
('INIS', '생성형 AI', 'NightCafe', '발신', 'I', 513, 'Y', ''),
('ICAS', '생성형 AI', 'CivitAI', '발신', 'I', 514, 'Y', ''),
('ILIS', '생성형 AI', 'Liner', '발신', 'I', 515, 'Y', ''),
('IBCS', '생성형 AI', 'Bing Image Creator', '발신', 'I', 516, 'Y', ''),
('IDSS', '생성형 AI', 'Deepseek', '발신', 'I', 517, 'Y', ''),
('IBDS', '생성형 AI', 'Baidu Ai', '발신', 'I', 518, 'Y', ''),
('IGIS', '생성형 AI', 'Gemini AI api', '발신', 'I', 519, 'Y', ''),
('IDTS', '생성형 AI', '에이닷', '발신', 'I', 520, 'Y', ''),
('IQBS', '생성형 AI', 'QuillBot', '발신', 'I', 521, 'Y', ''),
('ICHS', '생성형 AI', 'Character ai', '발신', 'I', 522, 'Y', ''),
('ISRS', '생성형 AI', 'Sora/Openai', '발신', 'I', 523, 'Y', ''),
('ISRR', '생성형 AI', 'Sora/Openai', '수신', 'O', 524, 'Y', ''),
('INNS', '생성형 AI', 'Nano AI', '발신', 'I', 525, 'Y', ''),
('IDBS', '생성형 AI', 'Doubao', '발신', 'I', 526, 'Y', ''),
('ITYS', '생성형 AI', 'Tongyi', '발신', 'I', 527, 'Y', ''),
('IYBS', '생성형 AI', 'Yuanbao', '발신', 'I', 528, 'Y', ''),
('IYYS', '생성형 AI', 'Yiyan', '발신', 'I', 529, 'Y', ''),
('IKMS', '생성형 AI', 'Kimi', '발신', 'I', 530, 'Y', ''),
('IBAS', '생성형 AI', 'Baichuan', '발신', 'I', 531, 'Y', ''),
('ITGS', '생성형 AI', 'Tiangong', '발신', 'I', 532, 'Y', ''),
('ISDS', '생성형 AI', 'Stable Diffusion', '발신', 'I', 533, 'Y', ''),
('IGOS', '생성형 AI', 'Grok', '발신', 'I', 534, 'Y', ''),
('ICGS', '생성형 AI', 'ChatGLM', '발신', 'I', 535, 'Y', ''),
('INKS', '생성형 AI', 'Napkin AI', '발신', 'I', 536, 'Y', ''),
('IBIR', '생성형 AI', 'Microsoft Copilot(Chat)', '수신', 'I', 537, 'Y', ''),
('IOOS', '생성형 AI', 'AI Goormee', '발신', 'I', 538, 'Y', ''),
('IABS', '생성형 AI', 'Allibee', '발신', 'I', 539, 'Y', ''),
('ILXS', '생성형 AI', 'Lexis+', '발신', 'I', 540, 'Y', ''),
('ILAS', '생성형 AI', 'SuperLawyer', '발신', 'I', 541, 'Y', ''),
('ICOS', '생성형 AI', 'CoCounsel', '발신', 'I', 542, 'Y', ''),
('IANS', '생성형 AI', 'Anthropic', '발신', 'I', 543, 'Y', ''),
('ISIS', '생성형 AI', 'Sider AI', '발신', 'I', 544, 'Y', ''),
('IGMS', '생성형 AI', 'Gamma', '발신', 'I', 545, 'Y', ''),
('IGMR', '생성형 AI', 'Gamma', '수신', 'I', 546, 'Y', ''),
('ICRS', '생성형 AI', 'Cursor', '발신', 'I', 547, 'Y', ''),
('IMAS', '생성형 AI', 'ManusAI', '발신', 'I', 548, 'Y', ''),
('IMTS', '생성형 AI', 'Mistral AI', '발신', 'I', 549, 'Y', ''),
('ICBS', '생성형 AI', 'Cline', '발신', 'I', 550, 'Y', ''),
('IWBS', '생성형 AI', 'Weight & Biases', '발신', 'I', 551, 'Y', ''),
('IWBR', '생성형 AI', 'Weight & Biases', '수신', 'I', 552, 'Y', ''),
('ILLS', '생성형 AI', 'Lilys AI', '발신', 'I', 553, 'Y', ''),
('IUKS', '생성형 AI', '기타', '발신', 'I', 554, 'Y', ''),
('IGES', '생성형 AI', 'Gemini Code Assist', '발신', 'O', 555, 'Y', ''),
('IOES', '생성형 AI', 'Codex/OpenAI', '발신', 'O', 556, 'Y', ''),
('IJLS', '생성형 AI', 'Jules', '발신', 'O', 557, 'Y', ''),
('IHVS', '생성형 AI', 'Harvey', '발신', 'O', 558, 'Y', ''),
('IXAS', '생성형 AI', 'x.AI', '발신', 'O', 559, 'Y', ''),
('ICES', '생성형 AI', 'Cohere', '발신', 'O', 560, 'Y', ''),
('IWTR', '생성형 AI', 'Wrtn', '수신', 'I', 561, 'Y', ''),
('ICHR', '생성형 AI', 'Character ai', '수신', 'I', 562, 'Y', ''),
('IOWR', '생성형 AI', 'Open WebUi', '수신', 'O', 563, 'Y', ''),
('IOWS', '생성형 AI', 'Open WebUi', '발신', 'O', 564, 'Y', ''),
('PDOS', '프로젝트', 'dooray', '발신', 'O', 565, 'Y', ''),
('PGIS', '프로젝트', 'github', '발신', 'O', 566, 'Y', ''),
('PGLS', '프로젝트', 'Glassdoor', '발신', 'O', 567, 'Y', ''),
('PJDS', '프로젝트', '잔디', '발신', 'O', 568, 'Y', ''),
('PITS', '프로젝트', 'Google Issue Tracker', '발신', 'O', 569, 'Y', ''),
('EBDR', '그룹웨어', '게시', '수신', 'I', 570, 'Y', ''),
('EBD-', '그룹웨어', '게시', '발신', 'O', 571, 'Y', ''),
('EBBR', '그룹웨어', '게시판', '수신', 'I', 572, 'Y', ''),
('EBBS', '그룹웨어', '게시판', '발신', 'O', 573, 'Y', ''),
('EBBF', '그룹웨어', '게시판', '파일수신', 'I', 574, 'Y', ''),
('EAAR', '그룹웨어', '결재', '수신', 'I', 575, 'Y', ''),
('EAAS', '그룹웨어', '결재', '발신', 'O', 576, 'Y', ''),
('EAAG', '그룹웨어', '결재', '통보 - 수신', 'I', 577, 'Y', ''),
('EAAP', '그룹웨어', '결재', '통보 - 발신', 'O', 578, 'Y', ''),
('EAAF', '그룹웨어', '결재', '파일수신', 'I', 579, 'Y', ''),
('EMMR', '그룹웨어', '메일', '그룹웨어 수신', 'I', 580, 'Y', ''),
('EMMS', '그룹웨어', '메일', '그룹웨어 발신', 'O', 581, 'Y', ''),
('EMMG', '그룹웨어', '메일', 'OWA 수신', 'I', 582, 'Y', ''),
('EMMP', '그룹웨어', '메일', 'OWA 발신', 'O', 583, 'Y', ''),
('EMMD', '그룹웨어', '메일', 'RPC 수신', 'I', 584, 'Y', ''),
('EMMU', '그룹웨어', '메일', 'RPC 발신', 'O', 585, 'Y', ''),
('EMMC', '그룹웨어', '메일', '수신', 'I', 586, 'Y', ''),
('EMML', '그룹웨어', '메일', '발신', 'O', 587, 'Y', ''),
('EMM1', '그룹웨어', '메일', '보안등급1', 'O', 588, 'Y', ''),
('EMM2', '그룹웨어', '메일', '보안등급2', 'O', 589, 'Y', ''),
('EMM3', '그룹웨어', '메일', '보안등급3', 'O', 590, 'Y', ''),
('EMM4', '그룹웨어', '메일', '보안등급4', 'O', 591, 'Y', ''),
('EMMA', '그룹웨어', '메일', '임시(자동)', 'O', 592, 'Y', ''),
('EMMT', '그룹웨어', '메일', '임시(수동)', 'O', 593, 'Y', ''),
('EMMK', '그룹웨어', '메일', 'Outlook - 수신', 'I', 594, 'Y', ''),
('EMMO', '그룹웨어', '메일', 'Outlook - 발신', 'O', 595, 'Y', ''),
('EMMB', '그룹웨어', '메일', '그룹웨어 예약메일', 'O', 596, 'Y', ''),
('EMBR', '그룹웨어', '모바일', '수신', 'I', 597, 'Y', ''),
('EMB-', '그룹웨어', '모바일', '발신', 'O', 598, 'Y', ''),
('EWSR', '그룹웨어', '웹서비스', '수신', 'I', 599, 'Y', ''),
('EWS-', '그룹웨어', '웹서비스', '발신', 'O', 600, 'Y', ''),
('EPUR', '그룹웨어', '일반', '수신', 'I', 601, 'Y', ''),
('EPU-', '그룹웨어', '일반', '발신', 'O', 602, 'Y', ''),
('EAU-', '그룹웨어', '일반(자동전달)', '자동전달', 'O', 603, 'Y', ''),
('ESCR', '그룹웨어', '일정 명함', '수신', 'I', 604, 'Y', ''),
('ESC-', '그룹웨어', '일정 명함', '발신', 'O', 605, 'Y', ''),
('EMF-', '그룹웨어', '파일 다운로드', '-', 'I', 606, 'Y', ''),
('EMU-', '그룹웨어', '기타', '', 'O', 607, 'Y', ''),
('EMDR', '그룹웨어', '드라이브', '수신', 'I', 608, 'Y', ''),
('EMDS', '그룹웨어', '드라이브', '발신', 'O', 609, 'Y', ''),
('ECIS', '그룹웨어', 'Samsung cic', '발신', 'O', 610, 'Y', ''),
('EMER', '그룹웨어', '메신저', '수신', 'O', 611, 'Y', ''),
('EMES', '그룹웨어', '메신저', '발신', 'O', 612, 'Y', ''),
('EZQC', '그룹웨어', 'Zohocliq', '채팅', 'O', 613, 'Y', ''),
('EZQS', '그룹웨어', 'Zohocliq', '캘린더', 'O', 614, 'Y', ''),
('EKWS', '그룹웨어', '카카오워크', '발신', 'O', 615, 'Y', ''),
('DCCS', '편집기', 'Clip Champ', '발신', 'O', 616, 'Y', ''),
('DFGS', '편집기', 'Figma', '발신', 'O', 617, 'Y', ''),
('DOVS', '편집기', 'Overleaf', '발신', 'O', 618, 'Y', ''),
('DOVR', '편집기', 'Overleaf', '수신', 'O', 619, 'Y', ''),
('DPKS', '편집기', 'Plunker', '발신', 'O', 620, 'Y', ''),
('DNWS', '편집기', 'Namu.wiki', '발신', 'O', 621, 'Y', ''),
('DWKS', '편집기', 'WikiPedia', '발신', 'O', 622, 'Y', ''),
('DAES', '편집기', 'Adobe Express', '발신', 'O', 623, 'Y', ''),
('DSMS', '편집기', 'Sketchmon', '발신', 'O', 624, 'Y', ''),
('DGSS', '편집기', 'Google Site', '발신', 'O', 625, 'Y', ''),
('DCVS', '편집기', 'Canva', '발신', 'O', 626, 'Y', ''),
('JBDS', '웹사이트', 'Baidu', '발신', 'O', 627, 'Y', ''),
('JANS', '웹사이트', 'Anthropic', '발신', 'O', 628, 'Y', ''),
('RGUS', '원격접속', '아파치 과카몰리', '발신', 'O', 629, 'Y', ''),
('KAAR', '웹서비스(분류)', '웹 수신', '수신', 'I', 630, 'Y', ''),
('KAAS', '웹서비스(분류)', '웹 발신', '발신', 'O', 631, 'Y', '');
