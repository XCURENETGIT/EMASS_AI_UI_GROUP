...
('IBIR', '생성형 AI', 'Microsoft Copilot(Chat)', '수신', 'I', 568, 'Y', ''),
...
('IOES', '생성형 AI', 'Codex/OpenAI', '발신', 'O', 589, 'Y', ''),
('IOER', '생성형 AI', 'Codex/OpenAI', '수신', 'I', 590, 'Y', ''),
('IJLS', '생성형 AI', 'Jules', '발신', 'O', 591, 'Y', ''),
('IHVS', '생성형 AI', 'Harvey', '발신', 'O', 592, 'Y', ''),
('IXAS', '생성형 AI', 'x.AI', '발신', 'O', 593, 'Y', ''),
('ICES', '생성형 AI', 'Cohere', '발신', 'O', 594, 'Y', ''),
('IWTR', '생성형 AI', 'wrtn', '수신', 'I', 595, 'Y', ''),
('ICHR', '생성형 AI', 'Character ai', '수신', 'I', 596, 'Y', ''),
('IOWR', '생성형 AI', 'Open WebUi', '수신', 'I', 597, 'Y', ''),
('IOWS', '생성형 AI', 'Open WebUi', '발신', 'O', 598, 'Y', ''),
('ISKS', '생성형 AI', 'Skywork', '발신', 'O', 599, 'Y', ''),
('IVES', '생성형 AI', 'Veo3', '발신', 'O', 600, 'Y', ''),
('IGTS', '생성형 AI', 'Gptoss', '발신', 'O', 601, 'Y', ''),
('ILRS', '생성형 AI', 'LMArena', '발신', 'O', 602, 'Y', ''),
('ILRR', '생성형 AI', 'LMArena', '수신', 'I', 603, 'Y', ''),
('IASS', '생성형 AI', 'Chat & Ask AI', '발신', 'O', 604, 'Y', ''),
('IASR', '생성형 AI', 'Chat & Ask AI', '수신', 'I', 605, 'Y', ''),
('IARR', '생성형 AI', 'Android Studio', '수신', 'O', 606, 'Y', ''),
('IARS', '생성형 AI', 'Android Studio', '발신', 'O', 607, 'Y', ''),
('IORR', '생성형 AI', 'Open Router', '수신', 'O', 608, 'Y', ''),
('IORS', '생성형 AI', 'Open Router', '발신', 'O', 609, 'Y', ''),
('IAMS', '생성형 AI', '구글 AI 모드', '발신', 'O', 610, 'Y', ''),
('IAMR', '생성형 AI', '구글 AI 모드', '수신', 'O', 611, 'Y', ''),
('ITIS', '생성형 AI', 'Timely GPT', '발신', 'O', 612, 'Y', ''),
('ITIR', '생성형 AI', 'Timely GPT', '수신', 'O', 613, 'Y', ''),
('IOTS', '생성형 AI', 'Otter.ai', '발신', 'O', 614, 'Y', ''),
('IOTR', '생성형 AI', 'Otter.ai', '수신', 'O', 615, 'Y', ''),
('IAGS', '생성형 AI', 'Google Agent Space', '발신', 'O', 616, 'Y', ''),
('IAGR', '생성형 AI', 'Google Agent Space', '수신', 'I', 617, 'Y', ''),
('ISPS', '생성형 AI', 'Soda Pdf', '발신', 'O', 618, 'Y', ''),
('ISPR', '생성형 AI', 'Soda Pdf', '수신', 'I', 619, 'Y', ''),
('IFPS', '생성형 AI', 'FreePik', '발신', 'O', 620, 'Y', ''),
('IFPR', '생성형 AI', 'FreePik', '수신', 'I', 621, 'Y', ''),
('ITOS', '생성형 AI', 'Tigris AI+', '발신', 'O', 622, 'Y', ''),
('IATS', '생성형 AI', 'Antigravity', '발신', 'O', 623, 'Y', ''),
('IATR', '생성형 AI', 'Antigravity', '수신', 'I', 624, 'Y', ''),
('IODS', '생성형 AI', 'OpenCode AI', '발신', 'O', 625, 'Y', ''),
('IODR', '생성형 AI', 'OpenCode AI', '수신', 'I', 626, 'Y', ''),
('ITNS', '생성형 AI', 'Tunee AI', '발신', 'O', 627, 'Y', ''),
('ITNR', '생성형 AI', 'Tunee AI', '수신', 'I', 628, 'Y', ''),
('IWES', '생성형 AI', 'WeeAI', '발신', 'O', 629, 'Y', ''),
('IWER', '생성형 AI', 'WeeAI', '수신', 'I', 630, 'Y', ''),
('IHAS', '생성형 AI', 'Hailuo AI', '발신', 'O', 631, 'Y', ''),
('IHAR', '생성형 AI', 'Hailuo AI', '수신', 'I', 632, 'Y', ''),
('IHIS', '생성형 AI', 'Higgsfield', '발신', 'O', 633, 'Y', ''),
('IKLS', '생성형 AI', 'Kling AI', '발신', 'O', 634, 'Y', ''),
('IKLR', '생성형 AI', 'Kling AI', '수신', 'I', 635, 'Y', ''),
('IOAS', '생성형 AI', 'OpenAI API', '발신', 'O', 636, 'Y', ''),
('IOAR', '생성형 AI', 'OpenAI API', '수신', 'I', 637, 'Y', ''),
('ICKS', '생성형 AI', 'CudekAI', '발신', 'O', 638, 'Y', ''),
('ICKR', '생성형 AI', 'CudekAI', '수신', 'I', 639, 'Y', ''),
('IAKS', '생성형 AI', 'Amazonbedrock', '발신', 'O', 640, 'Y', ''),
('IAKR', '생성형 AI', 'Amazonbedrock', '수신', 'I', 641, 'Y', ''),
('PDOS', '프로젝트', 'dooray', '발신', 'O', 642, 'Y', ''),
('PGIS', '프로젝트', 'github', '발신', 'O', 643, 'Y', ''),
('PGLS', '프로젝트', 'Glassdoor', '발신', 'O', 644, 'Y', ''),
('PJDS', '프로젝트', '잔디', '발신', 'O', 645, 'Y', ''),
('PITS', '프로젝트', 'Google Issue Tracker', '발신', 'O', 646, 'Y', ''),
('EBDR', '그룹웨어', '게시', '수신', 'I', 647, 'Y', ''),
('EBD-', '그룹웨어', '게시', '발신', 'O', 648, 'Y', ''),
('EBBR', '그룹웨어', '게시판', '수신', 'I', 649, 'Y', ''),
('EBBS', '그룹웨어', '게시판', '발신', 'O', 650, 'Y', ''),
('EBBF', '그룹웨어', '게시판', '파일수신', 'I', 651, 'Y', ''),
('EAAR', '그룹웨어', '결재', '수신', 'I', 652, 'Y', ''),
('EAAS', '그룹웨어', '결재', '발신', 'O', 653, 'Y', ''),
('EAAG', '그룹웨어', '결재', '통보 - 수신', 'I', 654, 'Y', ''),
('EAAP', '그룹웨어', '결재', '통보 - 발신', 'O', 655, 'Y', ''),
('EAAF', '그룹웨어', '결재', '파일수신', 'I', 656, 'Y', ''),
('EMMR', '그룹웨어', '메일', '그룹웨어 수신', 'I', 657, 'Y', ''),
('EMMS', '그룹웨어', '메일', '그룹웨어 발신', 'O', 658, 'Y', ''),
('EMMG', '그룹웨어', '메일', 'OWA 수신', 'I', 659, 'Y', ''),
('EMMP', '그룹웨어', '메일', 'OWA 발신', 'O', 660, 'Y', ''),
('EMMD', '그룹웨어', '메일', 'RPC 수신', 'I', 661, 'Y', ''),
('EMMU', '그룹웨어', '메일', 'RPC 발신', 'O', 662, 'Y', ''),
('EMMC', '그룹웨어', '메일', '수신', 'I', 663, 'Y', ''),
('EMML', '그룹웨어', '메일', '발신', 'O', 664, 'Y', ''),
('EMM1', '그룹웨어', '메일', '보안등급1', 'O', 665, 'Y', ''),
('EMM2', '그룹웨어', '메일', '보안등급2', 'O', 666, 'Y', ''),
('EMM3', '그룹웨어', '메일', '보안등급3', 'O', 667, 'Y', ''),
('EMM4', '그룹웨어', '메일', '보안등급4', 'O', 668, 'Y', ''),
('EMMA', '그룹웨어', '메일', '임시(자동)', 'O', 669, 'Y', ''),
('EMMT', '그룹웨어', '메일', '임시(수동)', 'O', 670, 'Y', ''),
('EMMK', '그룹웨어', '메일', 'Outlook - 수신', 'I', 671, 'Y', ''),
('EMMO', '그룹웨어', '메일', 'Outlook - 발신', 'O', 672, 'Y', ''),
('EMMB', '그룹웨어', '메일', '그룹웨어 예약메일', 'O', 673, 'Y', ''),
('EMBR', '그룹웨어', '모바일', '수신', 'I', 674, 'Y', ''),
('EMB-', '그룹웨어', '모바일', '발신', 'O', 675, 'Y', ''),
('EWSR', '그룹웨어', '웹서비스', '수신', 'I', 676, 'Y', ''),
('EWS-', '그룹웨어', '웹서비스', '발신', 'O', 677, 'Y', ''),
('EPUR', '그룹웨어', '일반', '수신', 'I', 678, 'Y', ''),
('EPU-', '그룹웨어', '일반', '발신', 'O', 679, 'Y', ''),
('EAU-', '그룹웨어', '일반(자동전달)', '자동전달', 'O', 680, 'Y', ''),
('ESCR', '그룹웨어', '일정 명함', '수신', 'I', 681, 'Y', ''),
('ESC-', '그룹웨어', '일정 명함', '발신', 'O', 682, 'Y', ''),
('EMF-', '그룹웨어', '파일 다운로드', '-', 'I', 683, 'Y', ''),
('EMU-', '그룹웨어', '기타', '', 'O', 684, 'Y', ''),
('EMDR', '그룹웨어', '드라이브', '수신', 'I', 685, 'Y', ''),
('EMDS', '그룹웨어', '드라이브', '발신', 'O', 686, 'Y', ''),
('ECIS', '그룹웨어', 'Samsung cic', '발신', 'O', 687, 'Y', ''),
('EMER', '그룹웨어', '메신저', '수신', 'I', 688, 'Y', ''),
('EMES', '그룹웨어', '메신저', '발신', 'O', 689, 'Y', ''),
('EMEC', '그룹웨어', '메신저', '채팅', 'O', 690, 'Y', 'MSG'),
('EZQC', '그룹웨어', 'Zohocliq', '채팅', 'O', 691, 'Y', ''),
('EZQS', '그룹웨어', 'Zohocliq', '캘린더', 'O', 692, 'Y', ''),
('EKWS', '그룹웨어', '카카오워크', '발신', 'O', 693, 'Y', ''),
('ECAS', '그룹웨어', '일정', '발신', 'O', 694, 'Y', ''),
('ETOS', '그룹웨어', 'Tigris', '기타', 'O', 695, 'Y', ''),
('ETOC', '그룹웨어', 'Tigris', '메신저', 'O', 696, 'Y', ''),
('ETOD', '그룹웨어', 'Tigris', '드라이브', 'O', 697, 'Y', ''),
('ETOA', '그룹웨어', 'Tigris', '결재', 'O', 698, 'Y', ''),
('DCCS', '편집기', 'Clip Champ', '발신', 'O', 699, 'Y', ''),
('DFGS', '편집기', 'Figma', '발신', 'O', 700, 'Y', ''),
('DOVS', '편집기', 'Overleaf', '발신', 'O', 701, 'Y', ''),
('DOVR', '편집기', 'Overleaf', '수신', 'I', 702, 'Y', ''),
('DPKS', '편집기', 'Plunker', '발신', 'O', 703, 'Y', ''),
('DNWS', '편집기', 'Namu.wiki', '발신', 'O', 704, 'Y', ''),
('DWKS', '편집기', 'WikiPedia', '발신', 'O', 705, 'Y', ''),
('DAES', '편집기', 'Adobe Express', '발신', 'O', 706, 'Y', ''),
('DSMS', '편집기', 'Sketchmon', '발신', 'O', 707, 'Y', ''),
('DGSS', '편집기', 'Google Site', '발신', 'O', 708, 'Y', ''),
('DCVS', '편집기', 'Canva', '발신', 'O', 709, 'Y', ''),
('DMBS', '편집기', '망고보드', '발신', 'O', 710, 'Y', ''),
('DMTS', '편집기', '망고툰', '발신', 'O', 711, 'Y', ''),
('JBDS', '웹사이트', 'Baidu', '발신', 'O', 712, 'Y', ''),
('JANS', '웹사이트', 'Anthropic', '발신', 'O', 713, 'Y', ''),
('JKAS', '웹사이트', 'Kaggle', '발신', 'O', 714, 'Y', ''),
('JJPS', '웹사이트', 'justpaste.it', '발신', 'O', 715, 'Y', ''),
('JPBS', '웹사이트', 'pastebin.com', '발신', 'O', 716, 'Y', ''),
('JNNS', '웹사이트', 'n8n', '발신', 'O', 717, 'Y', ''),
('JGHS', '웹사이트', 'Google cloud console', '발신', 'O', 718, 'Y', ''),
('JALS', '웹사이트', 'AnessLab', '발신', 'O', 719, 'Y', ''),
('JCCS', '웹사이트', 'CMCC [GUI-AGENT]', '발신', 'O', 720, 'Y', ''),
('JOTS', '웹사이트', 'Otter.ai', '발신', 'O', 721, 'Y', ''),
('JMLS', '웹사이트', 'Menlosecurity', '발신', 'O', 722, 'Y', ''),
('JHFS', '웹사이트', 'Hugging Face', '발신', 'O', 723, 'Y', ''),
('JSNS', '웹사이트', 'AWS SNS', '발신', 'O', 724, 'Y', ''),
('JAGS', '웹사이트', 'AWS API Gateway', '발신', 'O', 725, 'Y', ''),
('JASS', '웹사이트', 'AWS SSM', '발신', 'O', 726, 'Y', ''),
('RGUS', '원격접속', '아파치 과카몰리', '발신', 'O', 727, 'Y', ''),
('RGUR', '원격접속', '아파치 과카몰리', '수신', 'I', 728, 'Y', ''),
('KAAR', '웹서비스(분류)', '웹 수신', '수신', 'I', 729, 'Y', ''),
('KAAS', '웹서비스(분류)', '웹 발신', '발신', 'O', 730, 'Y', '');
