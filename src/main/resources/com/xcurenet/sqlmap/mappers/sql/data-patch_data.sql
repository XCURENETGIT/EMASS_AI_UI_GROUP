...
('NENR', '노트', 'EVERNOTE', '수신', 'I', 336, 'Y', ''),
('NENS', '노트', 'EVERNOTE', '발신', 'O', 337, 'Y', ''),
('NONR', '노트', 'ONENOTE', '수신', 'I', 338, 'Y', ''),
('NONS', '노트', 'ONENOTE', '발신', 'O', 339, 'Y', ''),
('NLVS', '노트', 'Outlook.com 메모', '발신', 'O', 340, 'Y', ''),
('NBTS', '노트', 'BIT.AI', '발신', 'O', 341, 'Y', ''),
('NNOS', '노트', 'Notion', '발신', 'O', 342, 'Y', ''),
('NGGS', '노트', '구글 docs', '발신', 'O', 343, 'Y', ''),
('NGTS', '노트', '구글 tasks', '발신', 'O', 344, 'Y', ''),
('NGKS', '노트', '구글 keep', '발신', 'O', 345, 'Y', ''),
('NSSR', '노트', '삼성 노트', '수신', 'I', 346, 'Y', ''),
('NSSS', '노트', '삼성 노트', '발신', 'O', 347, 'Y', ''),
('NNVS', '노트', '네이버 오피스', '발신', 'O', 348, 'Y', ''),
('NDBS', '노트', 'Dropbox paper', '발신', 'O', 349, 'Y', ''),
('NHCS', '노트', '한컴 오피스', '발신', 'O', 350, 'Y', ''),
('NMOS', '노트', 'MS오피스', '발신', 'O', 351, 'Y', ''),
('NCDS', '노트', 'Coda', '발신', 'O', 352, 'Y', ''),
('NNMR', '노트', '네이버 메모', '수신', 'I', 353, 'Y', ''),
('NNMS', '노트', '네이버 메모', '발신', 'O', 354, 'Y', ''),
('NCNS', '노트', 'Clova Note', '발신', 'O', 355, 'Y', ''),
('NGIS', '노트', 'Github Gist', '발신', 'O', 356, 'Y', ''),
('NSNS', '노트', 'SimpleNote', '발신', 'O', 357, 'Y', ''),
('NAGS', '노트', 'Agit', '발신', 'O', 358, 'Y', ''),
('NPSS', '노트', 'Polaris office', '발신', 'O', 359, 'Y', ''),
('NBOS', '노트', 'Box', '발신', 'O', 360, 'Y', ''),
('NCKS', '노트', 'ClickUp', '발신', 'O', 361, 'Y', ''),
('NGNS', '노트', 'Goodnotes', '발신', 'O', 362, 'Y', ''),
('NMNS', '노트', 'Milanote', '발신', 'O', 363, 'Y', ''),
('NZQS', '노트', 'zohocliq', '발신', 'O', 364, 'Y', ''),
('NMTS', '노트', 'Mentimeter', '발신', 'O', 365, 'Y', ''),
('NOOS', '노트', 'Goorm', '발신', 'O', 366, 'Y', ''),
('NMIS', '노트', '밀리의서재', '발신', 'O', 367, 'Y', ''),
('NUKS', '노트', '기타', '발신', 'O', 368, 'Y', ''),
('NCRS', '노트', 'Craft', '발신', 'O', 369, 'Y', ''),
('AGCR', '일정', '구글캘린더일정', '수신', 'I', 370, 'N', ''),
('AGCS', '일정', '구글캘린더일정', '발신', 'O', 371, 'Y', ''),
('AGLR', '일정', '구글캘린더메일', '수신', 'I', 372, 'N', ''),
('AGLS', '일정', '구글캘린더메일', '발신', 'O', 373, 'Y', ''),
('ANCS', '일정', '네이버 캘린더', '발신', 'O', 374, 'Y', ''),
('ZTN-', '기타 서비스', 'Telnet', '-', 'O', 375, 'Y', ''),
('ZXT-', '기타 서비스', 'Xterm', '-', 'O', 376, 'Y', ''),
('ZRL-', '기타 서비스', 'R-Login', '-', 'O', 377, 'Y', ''),
('ZNP-', '기타 서비스', 'NNTP', '-', 'O', 378, 'Y', ''),
('ZPC-', '기타 서비스', 'PC 보안', '-', 'O', 379, 'N', ''),
('ZSH-', '기타 서비스', 'SSH', 'SSH 세션 정보', 'O', 380, 'Y', ''),
('XX1R', '모니터링_제외', '미분류_타입1', '수신', 'I', 381, 'Y', ''),
('XX1S', '모니터링_제외', '미분류_타입1', '발신', 'O', 382, 'Y', ''),
('XX2R', '모니터링_제외', '미분류_타입2', '수신', 'I', 383, 'Y', ''),
('XX2S', '모니터링_제외', '미분류_타입2', '발신', 'O', 384, 'Y', ''),
('XX3R', '모니터링_제외', '미분류_타입3', '수신', 'I', 385, 'Y', ''),
('XX3S', '모니터링_제외', '미분류_타입3', '발신', 'O', 386, 'Y', ''),
('XU1R', '모니터링_제외', '웹서비스(미분류)_타입1', '수신', 'I', 387, 'Y', ''),
('XU1S', '모니터링_제외', '웹서비스(미분류)_타입1', '발신', 'O', 388, 'Y', ''),
('XU2R', '모니터링_제외', '웹서비스(미분류)_타입2', '수신', 'I', 389, 'Y', ''),
('XU2S', '모니터링_제외', '웹서비스(미분류)_타입2', '발신', 'O', 390, 'Y', ''),
('XU3R', '모니터링_제외', '웹서비스(미분류)_타입3', '수신', 'I', 391, 'Y', ''),
('XU3S', '모니터링_제외', '웹서비스(미분류)_타입3', '발신', 'O', 392, 'Y', ''),
('XU4R', '모니터링_제외', '필수 로깅', '수신', 'I', 393, 'Y', ''),
('XU4S', '모니터링_제외', '필수 로깅', '발신', 'O', 394, 'Y', ''),
('UWSD', '웹서비스(미분류)', '웹 발신', '첨부 - 문서타입', 'O', 395, 'Y', ''),
('UWSE', '웹서비스(미분류)', '웹 발신', '첨부 - 문서아님', 'O', 396, 'Y', ''),
('UWSU', '웹서비스(미분류)', '웹 발신', '첨부 없음', 'O', 397, 'Y', ''),
('UWSH', '웹서비스(미분류)', '웹 발신', '중요도(상)', 'O', 398, 'Y', ''),
('UWSM', '웹서비스(미분류)', '웹 발신', '중요도(중)', 'O', 399, 'Y', ''),
('UWSL', '웹서비스(미분류)', '웹 발신', '중요도(하)', 'O', 400, 'Y', ''),
('UX1R', '웹서비스(미분류)', '미분류_타입1', '수신', 'I', 401, 'Y', ''),
('UX1S', '웹서비스(미분류)', '미분류_타입1', '발신', 'O', 402, 'Y', ''),
('UX2R', '웹서비스(미분류)', '미분류_타입2', '수신', 'I', 403, 'Y', ''),
('UX2S', '웹서비스(미분류)', '미분류_타입2', '발신', 'O', 404, 'Y', ''),
('UX3R', '웹서비스(미분류)', '미분류_타입3', '수신', 'I', 405, 'Y', ''),
('UX3S', '웹서비스(미분류)', '미분류_타입3', '발신', 'O', 406, 'Y', ''),
('UWRD', '웹서비스(미분류)', '웹 수신', '첨부 - 문서타입', 'I', 407, 'Y', ''),
('UWRE', '웹서비스(미분류)', '웹 수신', '첨부 - 문서아님', 'I', 408, 'Y', ''),
('UWRU', '웹서비스(미분류)', '웹 수신', '첨부 없음', 'I', 409, 'Y', ''),
('BWSD', '웹서비스(업무)', '업무 발신', '첨부 - 문서타입', 'O', 410, 'Y', ''),
('BWSE', '웹서비스(업무)', '업무 발신', '첨부 - 문서아님', 'O', 411, 'Y', ''),
('BWSU', '웹서비스(업무)', '업무 발신', '첨부 없음', 'O', 412, 'Y', ''),
('BWRD', '웹서비스(업무)', '업무 수신', '첨부 - 문서타입', 'I', 413, 'Y', ''),
('BWRE', '웹서비스(업무)', '업무 수신', '첨부 - 문서아님', 'I', 414, 'Y', ''),
('BWRU', '웹서비스(업무)', '업무 수신', '첨부 없음', 'I', 415, 'Y', ''),
('TWEC', '화상회의', 'Webex', '채팅', 'O', 416, 'Y', 'MSG'),
('TWEF', '화상회의', 'Webex', '파일전송', 'O', 417, 'Y', 'MSG'),
('TWEJ', '화상회의', 'Webex', '참여', 'O', 418, 'Y', 'MSG'),
('TWEL', '화상회의', 'Webex', '떠남', 'O', 419, 'Y', 'MSG'),
('TZOC', '화상회의', 'Zoom', '채팅', 'O', 420, 'Y', 'MSG'),
('TZOF', '화상회의', 'Zoom', '파일전송', 'O', 421, 'Y', 'MSG'),
('TZOJ', '화상회의', 'Zoom', '참여', 'O', 422, 'Y', 'MSG'),
('TZOL', '화상회의', 'Zoom', '떠남', 'O', 423, 'Y', 'MSG'),
('TTMC', '화상회의', 'Teams', '채팅', 'O', 424, 'Y', 'MSG'),
('TTMF', '화상회의', 'Teams', '파일전송', 'O', 425, 'Y', 'MSG'),
('TTMJ', '화상회의', 'Teams', '참여', 'O', 426, 'Y', 'MSG'),
('TTML', '화상회의', 'Teams', '떠남', 'O', 427, 'Y', 'MSG'),
('TSKC', '화상회의', 'Skype', '채팅', 'O', 428, 'Y', 'MSG'),
('TSKF', '화상회의', 'Skype', '파일전송', 'O', 429, 'Y', 'MSG'),
('TSKJ', '화상회의', 'Skype', '참여', 'O', 430, 'Y', 'MSG'),
('TSKL', '화상회의', 'Skype', '떠남', 'O', 431, 'Y', 'MSG'),
('TJMC', '화상회의', 'JoinME', '채팅', 'O', 432, 'Y', 'MSG'),
('TJMF', '화상회의', 'JoinME', '파일전송', 'O', 433, 'Y', 'MSG'),
('TAMC', '화상회의', 'Amazon Chime', '채팅', 'O', 434, 'Y', 'MSG'),
('TAMF', '화상회의', 'Amazon Chime', '파일전송', 'O', 435, 'Y', 'MSG'),
('TBJC', '화상회의', 'BlueJeans', '채팅', 'O', 436, 'Y', 'MSG'),
('TTDS', '화상회의', 'Tl;dv', '채팅', 'O', 437, 'Y', 'MSG'),
('LNVS', '번역기', '파파고 번역', '발신', 'O', 438, 'Y', ''),
('LGGS', '번역기', '구글 번역', '발신', 'O', 439, 'Y', ''),
('LGPS', '번역기', '구글 번역 플러그인', '발신', 'O', 440, 'Y', ''),
('LDES', '번역기', 'Deepl', '발신', 'O', 441, 'Y', ''),
('LBIS', '번역기', 'Bing 번역', '발신', 'O', 442, 'Y', ''),
('LYMS', '번역기', 'Yandex 번역', '발신', 'O', 443, 'Y', ''),
('LGAS', '번역기', 'Google Cloud Translation Api', '발신', 'O', 444, 'Y', ''),
('LFTS', '번역기', 'Flitto', '발신', 'O', 445, 'Y', ''),
('LOTS', '번역기', 'O-Translator', '발신', 'O', 446, 'Y', ''),
('LUKS', '번역기', '기타', '발신', 'O', 447, 'Y', ''),
('LTRS', '번역기', 'Translate', '발신', 'O', 448, 'Y', ''),
('LODS', '번역기', 'onlinedoctranslator', '발신', 'O', 449, 'Y', ''),
('IGBS', '생성형 AI', '구글 Gemini', '발신', 'O', 450, 'Y', ''),
('IBIS', '생성형 AI', ' Microsoft Copilot', '발신', 'O', 451, 'Y', ''),
('IWTS', '생성형 AI', 'Wrtn', '발신', 'O', 452, 'Y', ''),
('IGPS', '생성형 AI', 'ChatGPT', '발신', 'O', 453, 'Y', ''),
('IGPR', '생성형 AI', 'ChatGPT', '수신', 'I', 454, 'Y', ''),
('IDAS', '생성형 AI', 'Dall-E', '발신', 'O', 455, 'Y', ''),
('IGCS', '생성형 AI', 'Github Copilot', '발신', 'O', 456, 'Y', ''),
('IGCR', '생성형 AI', 'Github Copilot', '수신', 'I', 457, 'Y', ''),
('IYCS', '생성형 AI', 'YouChat', '발신', 'O', 458, 'Y', ''),
('ICSS', '생성형 AI', 'Chatsonic', '발신', 'O', 459, 'Y', ''),
('IRPS', '생성형 AI', 'Replika', '발신', 'O', 460, 'Y', ''),
('IPPS', '생성형 AI', 'Perplexity', '발신', 'O', 461, 'Y', ''),
('IPPR', '생성형 AI', 'Perplexity', '수신', 'I', 462, 'Y', ''),
('ITCS', '생성형 AI', 'TextCortex', '발신', 'O', 463, 'Y', ''),
('IPHS', '생성형 AI', 'Phind', '발신', 'O', 464, 'Y', ''),
('IPOS', '생성형 AI', 'Poe', '발신', 'O', 465, 'Y', ''),
('IHFS', '생성형 AI', 'Hugging Face', '발신', 'O', 466, 'Y', ''),
('ICPS', '생성형 AI', 'Copy.AI', '발신', 'O', 467, 'Y', ''),
('IHWS', '생성형 AI', 'HyperWrite', '발신', 'O', 468, 'Y', ''),
('IDPS', '생성형 AI', 'DeepAI', '발신', 'O', 469, 'Y', ''),
('IACS', '생성형 AI', 'AskCodi', '발신', 'O', 470, 'Y', ''),
('INAS', '생성형 AI', 'Native', '발신', 'O', 471, 'Y', ''),
('INFS', '생성형 AI', 'NeuroFlash', '발신', 'O', 472, 'Y', ''),
('INOS', '생성형 AI', 'Notion AI', '발신', 'O', 473, 'Y', ''),
('INOR', '생성형 AI', 'Notion AI', '수신', 'I', 474, 'Y', ''),
('IMES', '생성형 AI', 'Merlin', '발신', 'O', 475, 'Y', ''),
('IMER', '생성형 AI', 'Merlin', '수신', 'O', 476, 'Y', ''),
('ICXS', '생성형 AI', 'CLOVA-X', '발신', 'O', 477, 'Y', ''),
('IADS', '생성형 AI', 'Adobe AI', '발신', 'O', 478, 'Y', ''),
('ICDS', '생성형 AI', 'ClipDrop', '발신', 'O', 479, 'Y', ''),
('ISBS', '생성형 AI', 'Stability.Ai', '발신', 'O', 480, 'Y', ''),
('IRMS', '생성형 AI', 'Runwayml', '발신', 'O', 481, 'Y', ''),
('IGVS', '생성형 AI', 'Google Vertex', '발신', 'O', 482, 'Y', ''),
('IGLS', '생성형 AI', 'Google Colab', '발신', 'O', 483, 'Y', ''),
('ICWS', '생성형 AI', 'CodeWhisperer', '발신', 'O', 484, 'Y', ''),
('IMSS', '생성형 AI', 'Google AI Studio', '발신', 'O', 485, 'Y', ''),
('IOCS', '생성형 AI', 'Clova OCR', '발신', 'O', 486, 'Y', ''),
('IAOS', '생성형 AI', 'Azure OpenAI', '발신', 'O', 487, 'Y', ''),
('ICUS', '생성형 AI', '네이버 CUE:', '발신', 'O', 488, 'Y', ''),
('IMJS', '생성형 AI', 'Midjourney', '발신', 'O', 489, 'Y', ''),
('ISGR', '생성형 AI', 'slidesGPT', '수신', 'I', 490, 'Y', ''),
('ISGS', '생성형 AI', 'SlidesGPT', '발신', 'O', 491, 'Y', ''),
('IDMS', '생성형 AI', 'Ai Docmaker', '발신', 'O', 492, 'Y', ''),
('IRKS', '생성형 AI', 'Reka AI', '발신', 'O', 493, 'Y', ''),
('IRKR', '생성형 AI', 'Reka AI', '수신', 'O', 494, 'Y', ''),
('ICLS', '생성형 AI', 'Claude', '발신', 'O', 495, 'Y', ''),
('IDMR', '생성형 AI', 'AI Docmaker Attach', '수신', 'I', 496, 'Y', ''),
('IADR', '생성형 AI', 'Adobe firefly login', '수신', 'I', 497, 'Y', ''),
('IWDS', '생성형 AI', 'Dream by WOMBO', '발신', 'O', 498, 'Y', ''),
('IGAS', '생성형 AI', 'GetImg.AI', '발신', 'O', 499, 'Y', ''),
('IWKS', '생성형 AI', 'Wrks.ai', '발신', 'O', 500, 'Y', ''),
('IPSS', '생성형 AI', 'Polaris office ai', '발신', 'O', 501, 'Y', ''),
('IBGS', '생성형 AI', 'Goover AI', '발신', 'O', 502, 'Y', ''),
('IIAS', '생성형 AI', 'iAsk AI', '발신', 'O', 503, 'Y', ''),
('ISNS', '생성형 AI', 'Suno AI', '발신', 'O', 504, 'Y', ''),
('IPES', '생성형 AI', 'Perchance', '발신', 'O', 505, 'Y', ''),
('IPFS', '생성형 AI', 'ChatPDF', '발신', 'O', 506, 'Y', ''),
('IXOS', '생성형 AI', 'Exaone', '발신', 'O', 507, 'Y', ''),
('ISOR', '생성형 AI', 'Slidesgo', '수신', 'I', 508, 'Y', ''),
('ISOS', '생성형 AI', 'Slidesgo', '발신', 'O', 509, 'Y', ''),
('IKRS', '생성형 AI', 'KREA', '발신', 'O', 510, 'Y', ''),
('ILMS', '생성형 AI', 'GoogleNotebook LM', '발신', 'O', 511, 'Y', ''),
('ICCS', '생성형 AI', 'Capcut', '발신', 'O', 512, 'Y', ''),
('IMGS', '생성형 AI', 'Magictool', '발신', 'O', 513, 'Y', ''),
('IGSS', '생성형 AI', 'Genspark', '발신', 'O', 514, 'Y', ''),
('IFES', '생성형 AI', 'felo', '발신', 'O', 515, 'Y', ''),
('ITPS', '생성형 AI', 'Tripo3D', '발신', 'O', 516, 'Y', ''),
('ITPR', '생성형 AI', 'Tripo3D', '수신', 'I', 517, 'Y', ''),
('IELS', '생성형 AI', 'Elevenlabs', '발신', 'O', 518, 'Y', ''),
('IELR', '생성형 AI', 'Elevenlabs', '수신', 'I', 519, 'Y', ''),
('IGRS', '생성형 AI', 'Grammarly', '발신', 'O', 520, 'Y', ''),
('IVRS', '생성형 AI', 'Vrew', '발신', 'O', 521, 'Y', ''),
('INIS', '생성형 AI', 'NightCafe', '발신', 'O', 522, 'Y', ''),
('ICAS', '생성형 AI', 'CivitAI', '발신', 'O', 523, 'Y', ''),
('ILIS', '생성형 AI', 'Liner', '발신', 'O', 524, 'Y', ''),
('IBCS', '생성형 AI', 'Bing Image Creator', '발신', 'O', 525, 'Y', ''),
('IDSS', '생성형 AI', 'Deepseek', '발신', 'O', 526, 'Y', ''),
('IBDS', '생성형 AI', 'Baidu Ai', '발신', 'O', 527, 'Y', ''),
('IGIS', '생성형 AI', 'Gemini AI api', '발신', 'O', 528, 'Y', ''),
('IDTS', '생성형 AI', '에이닷', '발신', 'O', 529, 'Y', ''),
('IDTR', '생성형 AI', '에이닷', '수신', 'I', 530, 'Y', ''),
('IQBS', '생성형 AI', 'QuillBot', '발신', 'O', 531, 'Y', ''),
('ICHS', '생성형 AI', 'Character ai', '발신', 'O', 532, 'Y', ''),
('ISRS', '생성형 AI', 'Sora/Openai', '발신', 'O', 533, 'Y', ''),
('ISRR', '생성형 AI', 'Sora/Openai', '수신', 'I', 534, 'Y', ''),
('INNS', '생성형 AI', 'Nano AI', '발신', 'O', 535, 'Y', ''),
('IDBS', '생성형 AI', 'Doubao', '발신', 'O', 536, 'Y', ''),
('ITYS', '생성형 AI', 'Tongyi', '발신', 'O', 537, 'Y', ''),
('IYBS', '생성형 AI', 'Yuanbao', '발신', 'O', 538, 'Y', ''),
('IYYS', '생성형 AI', 'Yiyan', '발신', 'O', 539, 'Y', ''),
('IKMS', '생성형 AI', 'Kimi', '발신', 'O', 540, 'Y', ''),
('IBAS', '생성형 AI', 'Baichuan', '발신', 'O', 541, 'Y', ''),
('ITGS', '생성형 AI', 'Tiangong', '발신', 'O', 542, 'Y', ''),
('ISDS', '생성형 AI', 'Stable Diffusion', '발신', 'O', 543, 'Y', ''),
('IGOS', '생성형 AI', 'Grok', '발신', 'O', 544, 'Y', ''),
('ICGS', '생성형 AI', 'ChatGLM', '발신', 'O', 545, 'Y', ''),
('INKS', '생성형 AI', 'Napkin AI', '발신', 'O', 546, 'Y', ''),
('IBIR', '생성형 AI', 'Microsoft Copilot(Chat)', '수신', 'I', 547, 'Y', ''),
('IOOS', '생성형 AI', 'AI Goormee', '발신', 'O', 548, 'Y', ''),
('IABS', '생성형 AI', 'Allibee', '발신', 'O', 549, 'Y', ''),
('ILXS', '생성형 AI', 'Lexis+', '발신', 'O', 550, 'Y', ''),
('ILAS', '생성형 AI', 'SuperLawyer', '발신', 'O', 551, 'Y', ''),
('ICOS', '생성형 AI', 'CoCounsel', '발신', 'O', 552, 'Y', ''),
('IANS', '생성형 AI', 'Anthropic', '발신', 'O', 553, 'Y', ''),
('ISIS', '생성형 AI', 'Sider AI', '발신', 'O', 554, 'Y', ''),
('IGMS', '생성형 AI', 'Gamma', '발신', 'O', 555, 'Y', ''),
('IGMR', '생성형 AI', 'Gamma', '수신', 'I', 556, 'Y', ''),
('ICRS', '생성형 AI', 'Cursor', '발신', 'O', 557, 'Y', ''),
('IMAS', '생성형 AI', 'ManusAI', '발신', 'O', 558, 'Y', ''),
('IMTS', '생성형 AI', 'Mistral AI', '발신', 'O', 559, 'Y', ''),
('ICBS', '생성형 AI', 'Cline', '발신', 'O', 560, 'Y', ''),
('IWBS', '생성형 AI', 'Weight & Biases', '발신', 'O', 561, 'Y', ''),
('IWBR', '생성형 AI', 'Weight & Biases', '수신', 'I', 562, 'Y', ''),
('ILLS', '생성형 AI', 'Lilys AI', '발신', 'O', 563, 'Y', ''),
('IUKS', '생성형 AI', '기타', '발신', 'O', 564, 'Y', ''),
('IGES', '생성형 AI', 'Gemini Code Assist', '발신', 'O', 565, 'Y', ''),
('IOES', '생성형 AI', 'Codex/OpenAI', '발신', 'O', 566, 'Y', ''),
('IJLS', '생성형 AI', 'Jules', '발신', 'O', 567, 'Y', ''),
('IHVS', '생성형 AI', 'Harvey', '발신', 'O', 568, 'Y', ''),
('IXAS', '생성형 AI', 'x.AI', '발신', 'O', 569, 'Y', ''),
('ICES', '생성형 AI', 'Cohere', '발신', 'O', 570, 'Y', ''),
('IWTR', '생성형 AI', 'wrtn', '수신', 'I', 571, 'Y', ''),
('ICHR', '생성형 AI', 'Character ai', '수신', 'I', 572, 'Y', ''),
('IOWR', '생성형 AI', 'Open WebUi', '수신', 'I', 573, 'Y', ''),
('IOWS', '생성형 AI', 'Open WebUi', '발신', 'O', 574, 'Y', ''),
('ISKS', '생성형 AI', 'Skywork', '발신', 'O', 575, 'Y', ''),
('IVES', '생성형 AI', 'Veo3', '발신', 'O', 576, 'Y', ''),
('IGTS', '생성형 AI', 'Gptoss', '발신', 'O', 577, 'Y', ''),
('ILRS', '생성형 AI', 'LMArena', '발신', 'O', 578, 'Y', ''),
('ILRR', '생성형 AI', 'LMArena', '수신', 'I', 579, 'Y', ''),
('IASS', '생성형 AI', 'Chat & Ask AI', '발신', 'O', 580, 'Y', ''),
('IASR', '생성형 AI', 'Chat & Ask AI', '수신', 'I', 581, 'Y', ''),
('IARR', '생성형 AI', 'Android Studio', '수신', 'O', 582, 'Y', ''),
('IARS', '생성형 AI', 'Android Studio', '발신', 'O', 583, 'Y', ''),
('IORR', '생성형 AI', 'Open Router', '수신', 'O', 584, 'Y', ''),
('IORS', '생성형 AI', 'Open Router', '발신', 'O', 585, 'Y', ''),
('IAMS', '생성형 AI', '구글 AI 모드', '발신', 'O', 586, 'Y', ''),
('IAMR', '생성형 AI', '구글 AI 모드', '수신', 'O', 587, 'Y', ''),
('ITIS', '생성형 AI', 'Timely GPT', '발신', 'O', 588, 'Y', ''),
('ITIR', '생성형 AI', 'Timely GPT', '수신', 'I', 589, 'Y', ''),
('IOTS', '생성형 AI', 'Otter.ai', '발신', 'O', 590, 'Y', ''),
('IOTR', '생성형 AI', 'Otter.ai', '수신', 'O', 591, 'Y', ''),
('PDOS', '프로젝트', 'dooray', '발신', 'O', 592, 'Y', ''),
('PGIS', '프로젝트', 'github', '발신', 'O', 593, 'Y', ''),
('PGLS', '프로젝트', 'Glassdoor', '발신', 'O', 594, 'Y', ''),
('PJDS', '프로젝트', '잔디', '발신', 'O', 595, 'Y', ''),
('PITS', '프로젝트', 'Google Issue Tracker', '발신', 'O', 596, 'Y', ''),
('EBDR', '그룹웨어', '게시', '수신', 'I', 597, 'Y', ''),
('EBD-', '그룹웨어', '게시', '발신', 'O', 598, 'Y', ''),
('EBBR', '그룹웨어', '게시판', '수신', 'I', 599, 'Y', ''),
('EBBS', '그룹웨어', '게시판', '발신', 'O', 600, 'Y', ''),
('EBBF', '그룹웨어', '게시판', '파일수신', 'I', 601, 'Y', ''),
('EAAR', '그룹웨어', '결재', '수신', 'I', 602, 'Y', ''),
('EAAS', '그룹웨어', '결재', '발신', 'O', 603, 'Y', ''),
('EAAG', '그룹웨어', '결재', '통보 - 수신', 'I', 604, 'Y', ''),
('EAAP', '그룹웨어', '결재', '통보 - 발신', 'O', 605, 'Y', ''),
('EAAF', '그룹웨어', '결재', '파일수신', 'I', 606, 'Y', ''),
('EMMR', '그룹웨어', '메일', '그룹웨어 수신', 'I', 607, 'Y', ''),
('EMMS', '그룹웨어', '메일', '그룹웨어 발신', 'O', 608, 'Y', ''),
('EMMG', '그룹웨어', '메일', 'OWA 수신', 'I', 609, 'Y', ''),
('EMMP', '그룹웨어', '메일', 'OWA 발신', 'O', 610, 'Y', ''),
('EMMD', '그룹웨어', '메일', 'RPC 수신', 'I', 611, 'Y', ''),
('EMMU', '그룹웨어', '메일', 'RPC 발신', 'O', 612, 'Y', ''),
('EMMC', '그룹웨어', '메일', '수신', 'I', 613, 'Y', ''),
('EMML', '그룹웨어', '메일', '발신', 'O', 614, 'Y', ''),
('EMM1', '그룹웨어', '메일', '보안등급1', 'O', 615, 'Y', ''),
('EMM2', '그룹웨어', '메일', '보안등급2', 'O', 616, 'Y', ''),
('EMM3', '그룹웨어', '메일', '보안등급3', 'O', 617, 'Y', ''),
('EMM4', '그룹웨어', '메일', '보안등급4', 'O', 618, 'Y', ''),
('EMMA', '그룹웨어', '메일', '임시(자동)', 'O', 619, 'Y', ''),
('EMMT', '그룹웨어', '메일', '임시(수동)', 'O', 620, 'Y', ''),
('EMMK', '그룹웨어', '메일', 'Outlook - 수신', 'I', 621, 'Y', ''),
('EMMO', '그룹웨어', '메일', 'Outlook - 발신', 'O', 622, 'Y', ''),
('EMMB', '그룹웨어', '메일', '그룹웨어 예약메일', 'O', 623, 'Y', ''),
('EMBR', '그룹웨어', '모바일', '수신', 'I', 624, 'Y', ''),
('EMB-', '그룹웨어', '모바일', '발신', 'O', 625, 'Y', ''),
('EWSR', '그룹웨어', '웹서비스', '수신', 'I', 626, 'Y', ''),
('EWS-', '그룹웨어', '웹서비스', '발신', 'O', 627, 'Y', ''),
('EPUR', '그룹웨어', '일반', '수신', 'I', 628, 'Y', ''),
('EPU-', '그룹웨어', '일반', '발신', 'O', 629, 'Y', ''),
('EAU-', '그룹웨어', '일반(자동전달)', '자동전달', 'O', 630, 'Y', ''),
('ESCR', '그룹웨어', '일정 명함', '수신', 'I', 631, 'Y', ''),
('ESC-', '그룹웨어', '일정 명함', '발신', 'O', 632, 'Y', ''),
('EMF-', '그룹웨어', '파일 다운로드', '-', 'I', 633, 'Y', ''),
('EMU-', '그룹웨어', '기타', '', 'O', 634, 'Y', ''),
('EMDR', '그룹웨어', '드라이브', '수신', 'I', 635, 'Y', ''),
('EMDS', '그룹웨어', '드라이브', '발신', 'O', 636, 'Y', ''),
('ECIS', '그룹웨어', 'Samsung cic', '발신', 'O', 637, 'Y', ''),
('EMER', '그룹웨어', '메신저', '수신', 'I', 638, 'Y', ''),
('EMES', '그룹웨어', '메신저', '발신', 'O', 639, 'Y', ''),
('EZQC', '그룹웨어', 'Zohocliq', '채팅', 'O', 640, 'Y', ''),
('EZQS', '그룹웨어', 'Zohocliq', '캘린더', 'O', 641, 'Y', ''),
('EKWS', '그룹웨어', '카카오워크', '발신', 'O', 642, 'Y', ''),
('DCCS', '편집기', 'Clip Champ', '발신', 'O', 643, 'Y', ''),
('DFGS', '편집기', 'Figma', '발신', 'O', 644, 'Y', ''),
('DOVS', '편집기', 'Overleaf', '발신', 'O', 645, 'Y', ''),
('DOVR', '편집기', 'Overleaf', '수신', 'I', 646, 'Y', ''),
('DPKS', '편집기', 'Plunker', '발신', 'O', 647, 'Y', ''),
('DNWS', '편집기', 'Namu.wiki', '발신', 'O', 648, 'Y', ''),
('DWKS', '편집기', 'WikiPedia', '발신', 'O', 649, 'Y', ''),
('DAES', '편집기', 'Adobe Express', '발신', 'O', 650, 'Y', ''),
('DSMS', '편집기', 'Sketchmon', '발신', 'O', 651, 'Y', ''),
('DGSS', '편집기', 'Google Site', '발신', 'O', 652, 'Y', ''),
('DCVS', '편집기', 'Canva', '발신', 'O', 653, 'Y', ''),
('DMBS', '편집기', '망고보드', '발신', 'O', 654, 'Y', ''),
('DMTS', '편집기', '망고툰', '발신', 'O', 655, 'Y', ''),
('JBDS', '웹사이트', 'Baidu', '발신', 'O', 656, 'Y', ''),
('JANS', '웹사이트', 'Anthropic', '발신', 'O', 657, 'Y', ''),
('JKAS', '웹사이트', 'Kaggle', '발신', 'O', 658, 'Y', ''),
('JJPS', '웹사이트', 'justpaste.it', '발신', 'O', 659, 'Y', ''),
('JPBS', '웹사이트', 'pastebin.com', '발신', 'O', 660, 'Y', ''),
('JNNS', '웹사이트', 'n8n', '발신', 'O', 661, 'Y', ''),
('JGHS', '웹사이트', 'Google cloud console', '발신', 'O', 662, 'Y', ''),
('JALS', '웹사이트', 'AnessLab', '발신', 'O', 663, 'Y', ''),
('JCCS', '웹사이트', 'CMCC [GUI-AGENT]', '발신', 'O', 664, 'Y', ''),
('JOTS', '웹사이트', 'Otter.ai', '발신', 'O', 665, 'Y', ''),
('RGUS', '원격접속', '아파치 과카몰리', '발신', 'O', 666, 'Y', ''),
('RGUR', '원격접속', '아파치 과카몰리', '수신', 'I', 667, 'Y', ''),
('KAAR', '웹서비스(분류)', '웹 수신', '수신', 'I', 668, 'Y', ''),
('KAAS', '웹서비스(분류)', '웹 발신', '발신', 'O', 669, 'Y', '');
...
REPLACE INTO UI_REGEXP (CODE, NAME, REGEX,CODE_TYPE) VALUES('DRM', 'DRM 파일', NULL,'N');
