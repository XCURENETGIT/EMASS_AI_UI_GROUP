...
('PDOS', '프로젝트', 'dooray', '발신', 'O', 697, 'Y', ''),
('PGIS', '프로젝트', 'github', '발신', 'O', 698, 'Y', ''),
('PGLS', '프로젝트', 'Glassdoor', '발신', 'O', 699, 'Y', ''),
('PJDS', '프로젝트', '잔디', '발신', 'O', 700, 'Y', ''),
('PITS', '프로젝트', 'Google Issue Tracker', '발신', 'O', 701, 'Y', ''),
('EBDR', '그룹웨어', '게시', '수신', 'I', 702, 'Y', ''),
('EBD-', '그룹웨어', '게시', '발신', 'O', 703, 'Y', ''),
('EBBR', '그룹웨어', '게시판', '수신', 'I', 704, 'Y', ''),
('EBBS', '그룹웨어', '게시판', '발신', 'O', 705, 'Y', ''),
('EBBF', '그룹웨어', '게시판', '파일수신', 'I', 706, 'Y', ''),
('EAAR', '그룹웨어', '결재', '수신', 'I', 707, 'Y', ''),
('EAAS', '그룹웨어', '결재', '발신', 'O', 708, 'Y', ''),
('EAAG', '그룹웨어', '결재', '통보 - 수신', 'I', 709, 'Y', ''),
('EAAP', '그룹웨어', '결재', '통보 - 발신', 'O', 710, 'Y', ''),
('EAAF', '그룹웨어', '결재', '파일수신', 'I', 711, 'Y', ''),
('EMMR', '그룹웨어', '메일', '그룹웨어 수신', 'I', 712, 'Y', ''),
('EMMS', '그룹웨어', '메일', '그룹웨어 발신', 'O', 713, 'Y', ''),
('EMMG', '그룹웨어', '메일', 'OWA 수신', 'I', 714, 'Y', ''),
('EMMP', '그룹웨어', '메일', 'OWA 발신', 'O', 715, 'Y', ''),
('EMMD', '그룹웨어', '메일', 'RPC 수신', 'I', 716, 'Y', ''),
('EMMU', '그룹웨어', '메일', 'RPC 발신', 'O', 717, 'Y', ''),
('EMMC', '그룹웨어', '메일', '수신', 'I', 718, 'Y', ''),
('EMML', '그룹웨어', '메일', '발신', 'O', 719, 'Y', ''),
('EMM1', '그룹웨어', '메일', '보안등급1', 'O', 720, 'Y', ''),
('EMM2', '그룹웨어', '메일', '보안등급2', 'O', 721, 'Y', ''),
('EMM3', '그룹웨어', '메일', '보안등급3', 'O', 722, 'Y', ''),
('EMM4', '그룹웨어', '메일', '보안등급4', 'O', 723, 'Y', ''),
('EMMA', '그룹웨어', '메일', '임시(자동)', 'O', 724, 'Y', ''),
('EMMT', '그룹웨어', '메일', '임시(수동)', 'O', 725, 'Y', ''),
('EMMK', '그룹웨어', '메일', 'Outlook - 수신', 'I', 726, 'Y', ''),
('EMMO', '그룹웨어', '메일', 'Outlook - 발신', 'O', 727, 'Y', ''),
('EMMB', '그룹웨어', '메일', '그룹웨어 예약메일', 'O', 728, 'Y', ''),
('EMBR', '그룹웨어', '모바일', '수신', 'I', 729, 'Y', ''),
('EMB-', '그룹웨어', '모바일', '발신', 'O', 730, 'Y', ''),
('EWSR', '그룹웨어', '웹서비스', '수신', 'I', 731, 'Y', ''),
('EWS-', '그룹웨어', '웹서비스', '발신', 'O', 732, 'Y', ''),
('EPUR', '그룹웨어', '일반', '수신', 'I', 733, 'Y', ''),
('EPU-', '그룹웨어', '일반', '발신', 'O', 734, 'Y', ''),
('EAU-', '그룹웨어', '일반(자동전달)', '자동전달', 'O', 735, 'Y', ''),
('ESCR', '그룹웨어', '일정 명함', '수신', 'I', 736, 'Y', ''),
('ESC-', '그룹웨어', '일정 명함', '발신', 'O', 737, 'Y', ''),
('EMF-', '그룹웨어', '파일 다운로드', '-', 'I', 738, 'Y', ''),
('EMU-', '그룹웨어', '기타', '', 'O', 739, 'Y', ''),
('ETOS', '그룹웨어', 'Tigris', '기타', 'O', 740, 'Y', ''),
('EMDR', '그룹웨어', '드라이브', '수신', 'I', 741, 'Y', ''),
('EMDS', '그룹웨어', '드라이브', '발신', 'O', 742, 'Y', ''),
('ETOD', '그룹웨어', 'Tigris', '드라이브', 'O', 743, 'Y', ''),
('ECIS', '그룹웨어', 'Samsung cic', '발신', 'O', 744, 'Y', ''),
('EMER', '그룹웨어', '메신저', '수신', 'I', 745, 'Y', ''),
('EMES', '그룹웨어', '메신저', '발신', 'O', 746, 'Y', ''),
('EMEC', '그룹웨어', '메신저', '채팅', 'O', 747, 'Y', 'MSG'),
('ETOC', '그룹웨어', 'Tigris', '메신저', 'O', 748, 'Y', ''),
('ETOA', '그룹웨어', 'Tigris', '결재', 'O', 749, 'Y', ''),
('EZQC', '그룹웨어', 'Zohocliq', '채팅', 'O', 750, 'Y', ''),
('EZQS', '그룹웨어', 'Zohocliq', '캘린더', 'O', 751, 'Y', ''),
('EKWS', '그룹웨어', '카카오워크', '발신', 'O', 752, 'Y', ''),
('ECAS', '그룹웨어', '일정', '발신', 'O', 753, 'Y', ''),
('DCCS', '편집기', 'Clip Champ', '발신', 'O', 754, 'Y', ''),
('DFGS', '편집기', 'Figma', '발신', 'O', 755, 'Y', ''),
('DOVS', '편집기', 'Overleaf', '발신', 'O', 756, 'Y', ''),
('DOVR', '편집기', 'Overleaf', '수신', 'I', 757, 'Y', ''),
('DPKS', '편집기', 'Plunker', '발신', 'O', 758, 'Y', ''),
('DNWS', '편집기', 'Namu.wiki', '발신', 'O', 759, 'Y', ''),
('DWKS', '편집기', 'WikiPedia', '발신', 'O', 760, 'Y', ''),
('DAES', '편집기', 'Adobe Express', '발신', 'O', 761, 'Y', ''),
('DSMS', '편집기', 'Sketchmon', '발신', 'O', 762, 'Y', ''),
('DGSS', '편집기', 'Google Site', '발신', 'O', 763, 'Y', ''),
('DCVS', '편집기', 'Canva', '발신', 'O', 764, 'Y', ''),
('DMBS', '편집기', '망고보드', '발신', 'O', 765, 'Y', ''),
('DMTS', '편집기', '망고툰', '발신', 'O', 766, 'Y', ''),
('JBDS', '웹사이트', 'Baidu', '발신', 'O', 767, 'Y', ''),
('JANS', '웹사이트', 'Anthropic', '발신', 'O', 768, 'Y', ''),
('JKAS', '웹사이트', 'Kaggle', '발신', 'O', 769, 'Y', ''),
('JJPS', '웹사이트', 'justpaste.it', '발신', 'O', 770, 'Y', ''),
('JPBS', '웹사이트', 'pastebin.com', '발신', 'O', 771, 'Y', ''),
('JNNS', '웹사이트', 'n8n', '발신', 'O', 772, 'Y', ''),
('JGHS', '웹사이트', 'Google cloud console', '발신', 'O', 773, 'Y', ''),
('JALS', '웹사이트', 'AnessLab', '발신', 'O', 774, 'Y', ''),
('JCCS', '웹사이트', 'CMCC [GUI-AGENT]', '발신', 'O', 775, 'Y', ''),
('JOTS', '웹사이트', 'Otter.ai', '발신', 'O', 776, 'Y', ''),
('JMLS', '웹사이트', 'Menlosecurity', '발신', 'O', 777, 'Y', ''),
('JHFS', '웹사이트', 'Hugging Face', '발신', 'O', 778, 'Y', ''),
('JSNS', '웹사이트', 'AWS SNS', '발신', 'O', 779, 'Y', ''),
('JAGS', '웹사이트', 'AWS API Gateway', '발신', 'O', 780, 'Y', ''),
('JASS', '웹사이트', 'AWS SSM', '발신', 'O', 781, 'Y', ''),
('JGBS', '웹사이트', 'GitLab', '발신', 'O', 782, 'Y', ''),
('JMYS', '웹사이트', 'Mintlify', '발신', 'O', 783, 'Y', ''),
('RGUS', '원격접속', '아파치 과카몰리', '발신', 'O', 784, 'Y', ''),
('RGUR', '원격접속', '아파치 과카몰리', '수신', 'I', 785, 'Y', ''),
('KAAR', '웹서비스(분류)', '웹 수신', '수신', 'I', 786, 'Y', ''),
('KAAS', '웹서비스(분류)', '웹 발신', '발신', 'O', 787, 'Y', '')
