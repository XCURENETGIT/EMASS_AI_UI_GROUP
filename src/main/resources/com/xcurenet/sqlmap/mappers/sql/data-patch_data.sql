...
INSERT IGNORE INTO UI_SERVICE (`SERVICECD`, `SERVICENM_LV1`, `SERVICENM_LV2`, `SERVICENM_LV3`, `IN_OUT`, `SORT`, `USE_YN`, `MSGGRPCD`)  VALUES ('MP3-', '메일', 'POP3', '-', 'I', 1, 'Y', ''),
    ...
    ('SSFS', '소셜', 'Salesforce', '발신', 'O', 155, 'Y', ''),
    ('VDUR', '영상 스트리밍', '다음 TV', '수신', 'I', 156, 'Y', ''),
    ('VDUS', '영상 스트리밍', '다음 TV', '발신', 'O', 157, 'Y', ''),
    ('VPDR', '영상 스트리밍', '판도라 TV', '수신', 'I', 158, 'Y', ''),
    ('VPDS', '영상 스트리밍', '판도라 TV', '발신', 'O', 159, 'Y', ''),
    ('VGMR', '영상 스트리밍', '곰 TV', '수신', 'I', 160, 'Y', ''),
    ('VGMS', '영상 스트리밍', '곰 TV', '발신', 'O', 161, 'Y', ''),
    ('VYTR', '영상 스트리밍', '유튜브', '수신', 'I', 162, 'Y', ''),
    ('VYTS', '영상 스트리밍', '유튜브', '발신', 'O', 163, 'Y', ''),
    ('VYTD', '영상 스트리밍', '유튜브', '댓글', 'O', 164, 'Y', ''),
    ('VNVR', '영상 스트리밍', '네이버 TV캐스트', '수신', 'I', 165, 'Y', ''),
    ('VNVS', '영상 스트리밍', '네이버 TV캐스트', '발신', 'O', 166, 'Y', ''),
    ('QNVC', '메신저', '네이버', '채팅', 'O', 167, 'N', ''),
    ('QNVF', '메신저', '네이버', '파일전송', 'O', 168, 'N', ''),
    ('QNMR', '메신저', '네이버 쪽지', '수신', 'I', 169, 'N', ''),
    ('QNMS', '메신저', '네이버 쪽지', '발신', 'O', 170, 'N', ''),
    ('QDUC', '메신저', '다음', '채팅', 'O', 171, 'N', ''),
    ('QDUF', '메신저', '다음', '파일전송', 'O', 172, 'N', ''),
    ('QDUM', '메신저', '다음', '쪽지', 'O', 173, 'N', ''),
    ('QDSC', '메신저', '대신', '채팅', 'O', 174, 'N', ''),
    ('QDSF', '메신저', '대신', '파일전송', 'O', 175, 'N', ''),
    ('QDSM', '메신저', '대신', '쪽지', 'O', 176, 'N', ''),
    ('QSHC', '메신저', '삼홍사', '채팅', 'O', 177, 'Y', ''),
    ('QSHF', '메신저', '삼홍사', '파일전송', 'O', 178, 'Y', ''),
    ('QSHM', '메신저', '삼홍사', '쪽지', 'O', 179, 'Y', ''),
    ('QDIC', '메신저', '동부생명', '채팅', 'O', 180, 'Y', ''),
    ('QDIF', '메신저', '동부생명', '파일전송', 'O', 181, 'Y', ''),
    ('QDIM', '메신저', '동부생명', '쪽지', 'O', 182, 'Y', ''),
    ('QDFC', '메신저', '동부금융', '채팅', 'O', 183, 'Y', ''),
    ('QDFF', '메신저', '동부금융', '파일전송', 'O', 184, 'Y', ''),
    ('QDFM', '메신저', '동부금융', '쪽지', 'O', 185, 'Y', ''),
    ('QDGC', '메신저', '동국제강', '채팅', 'O', 186, 'Y', ''),
    ('QDGF', '메신저', '동국제강', '파일전송', 'O', 187, 'Y', ''),
    ('QDGM', '메신저', '동국제강', '쪽지', 'O', 188, 'Y', ''),
    ('QFMC', '메신저', '프리본드', '채팅', 'O', 189, 'Y', 'MSG'),
    ('QFMF', '메신저', '프리본드', '파일전송', 'O', 190, 'Y', 'MSG'),
    ('QFMM', '메신저', '프리본드', '쪽지', 'O', 191, 'Y', 'MSG'),
    ('QFMJ', '메신저', '프리본드', '참여', 'O', 192, 'Y', 'MSG'),
    ('QFML', '메신저', '프리본드', '떠남', 'O', 193, 'Y', 'MSG'),
    ('QMCC', '메신저', 'M-채널', '채팅', 'O', 194, 'Y', ''),
    ('QMCF', '메신저', 'M-채널', '파일전송', 'O', 195, 'Y', ''),
    ('QMCM', '메신저', 'M-채널', '쪽지', 'O', 196, 'Y', ''),
    ('QMSC', '메신저', '미쓰리', '채팅', 'O', 197, 'Y', 'MSG'),
    ('QMSF', '메신저', '미쓰리', '파일전송', 'O', 198, 'Y', 'MSG'),
    ('QMSM', '메신저', '미쓰리', '쪽지', 'O', 199, 'Y', 'MSG'),
    ('QMSJ', '메신저', '미쓰리', '참여', 'O', 200, 'Y', 'MSG'),
    ('QMSL', '메신저', '미쓰리', '떠남', 'O', 201, 'Y', 'MSG'),
    ('QNTC', '메신저', '네이트', '채팅', 'O', 202, 'Y', 'MSG'),
    ('QNTF', '메신저', '네이트', '파일전송', 'O', 203, 'Y', 'MSG'),
    ('QNTM', '메신저', '네이트', '쪽지', 'O', 204, 'Y', 'MSG'),
    ('QNTJ', '메신저', '네이트', '참여', 'O', 205, 'Y', 'MSG'),
    ('QNTL', '메신저', '네이트', '떠남', 'O', 206, 'Y', 'MSG'),
    ('QSSC', '메신저', '삼성증권', '채팅', 'O', 207, 'N', ''),
    ('QSSF', '메신저', '삼성증권', '파일전송', 'O', 208, 'N', ''),
    ('QSSM', '메신저', '삼성증권', '쪽지', 'O', 209, 'N', ''),
    ('QSFC', '메신저', '삼성화재', '채팅', 'O', 210, 'Y', ''),
    ('QSFF', '메신저', '삼성화재', '파일전송', 'O', 211, 'Y', ''),
    ('QSFM', '메신저', '삼성화재', '쪽지', 'O', 212, 'Y', ''),
    ('QSFJ', '메신저', '삼성화재', '참여', 'O', 213, 'Y', ''),
    ('QSFL', '메신저', '삼성화재', '떠남', 'O', 214, 'Y', ''),
    ('QSPC', '메신저', 'SK 프라이든', '채팅', 'O', 215, 'Y', ''),
    ('QSPF', '메신저', 'SK 프라이든', '파일전송', 'O', 216, 'Y', ''),
    ('QSPM', '메신저', 'SK 프라이든', '쪽지', 'O', 217, 'Y', ''),
    ('QSPJ', '메신저', 'SK 프라이든', '참여', 'O', 218, 'Y', ''),
    ('QSPL', '메신저', 'SK 프라이든', '떠남', 'O', 219, 'Y', ''),
    ('QSBC', '메신저', 'SK 비즈', '채팅', 'O', 220, 'N', ''),
    ('QSBF', '메신저', 'SK 비즈', '파일전송', 'O', 221, 'N', ''),
    ('QSBM', '메신저', 'SK 비즈', '쪽지', 'O', 222, 'N', ''),
    ('QWJC', '메신저', '웅진', '채팅', 'O', 223, 'Y', ''),
    ('QWJF', '메신저', '웅진', '파일전송', 'O', 224, 'Y', ''),
    ('QWJM', '메신저', '웅진', '쪽지', 'O', 225, 'Y', ''),
    ('QGPC', '메신저', 'chatGPT', '채팅', 'O', 226, 'Y', ''),
    ('QDAC', '메신저', 'Dall-E', '채팅', 'O', 227, 'Y', ''),
    ('QDAF', '메신저', 'Dall-E', '파일전송', 'O', 228, 'Y', ''),
    ('QCLC', '메신저', '쿨', '채팅', 'O', 229, 'Y', 'MSG'),
    ('QCLF', '메신저', '쿨', '파일전송', 'O', 230, 'Y', 'MSG'),
    ('QCLM', '메신저', '쿨', '쪽지', 'O', 231, 'Y', 'MSG'),
    ('QCLJ', '메신저', '쿨', '참여', 'O', 232, 'Y', 'MSG'),
    ('QCLL', '메신저', '쿨', '떠남', 'O', 233, 'Y', 'MSG'),
    ('QKBC', '메신저', 'K-bond', '채팅', 'O', 234, 'Y', 'MSG'),
    ('QKBF', '메신저', 'K-bond', '파일전송', 'O', 235, 'Y', 'MSG'),
    ('QKBM', '메신저', 'K-bond', '쪽지', 'O', 236, 'Y', 'MSG'),
    ('QKBJ', '메신저', 'K-bond', '참여', 'O', 237, 'Y', 'MSG'),
    ('QKBL', '메신저', 'K-bond', '떠남', 'O', 238, 'Y', 'MSG'),
    ('QEKC', '메신저', '아이콘', '채팅', 'O', 239, 'Y', 'MSG'),
    ('QEKF', '메신저', '아이콘', '파일전송', 'O', 240, 'Y', 'MSG'),
    ('QEKJ', '메신저', '아이콘', '참여', 'O', 241, 'Y', 'MSG'),
    ('QEKL', '메신저', '아이콘', '떠남', 'O', 242, 'Y', 'MSG'),
    ('QEKH', '메신저', '아이콘', '과거 데이터', 'O', 243, 'Y', 'MSG'),
    ('QSLC', '메신저', 'Slack', '채팅', 'O', 244, 'Y', 'MSG'),
    ('QSLF', '메신저', 'Slack', '파일전송', 'O', 245, 'Y', 'MSG'),
    ('QSLJ', '메신저', 'Slack', '참여', 'O', 246, 'Y', 'MSG'),
    ('QSLL', '메신저', 'Slack', '떠남', 'O', 247, 'Y', 'MSG'),
    ('QSYC', '메신저', '신영자산운용', '채팅', 'O', 248, 'Y', 'MSG'),
    ('QSYF', '메신저', '신영자산운용', '파일전송', 'O', 249, 'Y', 'MSG'),
    ('QSYM', '메신저', '신영자산운용', '쪽지', 'O', 250, 'Y', 'MSG'),
    ('QSYJ', '메신저', '신영자산운용', '참여', 'O', 251, 'Y', 'MSG'),
    ('QSYL', '메신저', '신영자산운용', '떠남', 'O', 252, 'Y', 'MSG'),
    ('QFBC', '메신저', '페이스북', '채팅', 'O', 253, 'Y', 'MSG'),
    ('QFBF', '메신저', '페이스북', '파일전송', 'O', 254, 'Y', 'MSG'),
    ('QKMC', '메신저', '삼성KnoxMessenger', '채팅', 'O', 255, 'Y', 'MSG'),
    ('QKMF', '메신저', '삼성KnoxMessenger', '파일전송', 'O', 256, 'Y', 'MSG'),
    ('QKMR', '메신저', '삼성KnoxMessenger', '파일수신', 'I', 257, 'Y', 'MSG'),
    ('QKMW', '메신저', '삼성KnoxMessenger', '전달', 'O', 258, 'Y', 'MSG'),
    ('QKMV', '메신저', '삼성KnoxMessenger', '파일-미리보기', 'O', 259, 'Y', 'MSG'),
    ('QGHC', '메신저', '구글 Hangout', '채팅', 'O', 260, 'Y', 'MSG'),
    ('QGHF', '메신저', '구글 Hangout', '파일전송', 'O', 261, 'Y', 'MSG'),
    ('QGGC', '메신저', '구글 chat', '채팅', 'O', 262, 'Y', 'MSG'),
    ('QGGF', '메신저', '구글 chat', '파일전송', 'O', 263, 'Y', 'MSG'),
    ('QGMC', '메신저', '구글 Meet', '채팅', 'O', 264, 'Y', 'MSG'),
    ('QGBC', '메신저', '구글 Bard', '채팅', 'O', 265, 'Y', 'MSG'),
    ('QBIC', '메신저', 'Microsoft BingAI Chat', '채팅', 'O', 266, 'Y', 'MSG'),
    ('QWTC', '메신저', 'wrtn', '채팅', 'O', 267, 'Y', ''),
    ('QISC', '메신저', '인스타그램 DM', '채팅', 'O', 268, 'Y', 'MSG'),
    ('QISF', '메신저', '인스타그램 DM', '파일전송', 'O', 269, 'Y', 'MSG'),
    ('QZAC', '메신저', 'Zalo', '채팅', 'O', 270, 'Y', 'MSG'),
    ('QZAF', '메신저', 'Zalo', '파일전송', 'O', 271, 'Y', 'MSG'),
    ('QNBC', '메신저', '네이버 밴드 채팅', '채팅', 'O', 272, 'Y', 'MSG'),
    ('QNBF', '메신저', '네이버 밴드 채팅', '파일전송', 'O', 273, 'Y', 'MSG'),
    ('QDOC', '메신저', 'Dooray app', '채팅', 'O', 274, 'Y', 'MSG'),
    ('QDOF', '메신저', 'Dooray app', '파일전송', 'O', 275, 'Y', 'MSG'),
    ('QUKC', '메신저', '기타', '채팅', 'O', 276, 'Y', 'MSG'),
    ('QUKF', '메신저', '기타', '파일전송', 'O', 277, 'Y', 'MSG'),
    ('QUKM', '메신저', '기타', '쪽지', 'O', 278, 'Y', 'MSG'),
    ('QUKJ', '메신저', '기타', '참여', 'O', 279, 'Y', 'MSG'),
    ('QUKL', '메신저', '기타', '떠남', 'O', 280, 'Y', 'MSG'),
    ('FFTC', '파일전송', 'FTP', 'CMD', 'O', 281, 'Y', ''),
    ('FFTG', '파일전송', 'FTP', 'GET', 'I', 282, 'Y', ''),
    ('FFTP', '파일전송', 'FTP', 'PUT', 'O', 283, 'Y', ''),
    ('FFTL', '파일전송', 'FTP', 'CONNECT', 'O', 284, 'Y', ''),
    ('FZM-', '파일전송', 'Zmodem', '-', 'O', 285, 'Y', ''),
    ('FNVR', '파일전송', '네이버 MYBOX', '수신', 'I', 286, 'Y', ''),
    ('FNVS', '파일전송', '네이버 MYBOX', '발신', 'O', 287, 'Y', ''),
    ('FGGR', '파일전송', '구글 드라이브', '수신', 'I', 288, 'Y', ''),
    ('FGGS', '파일전송', '구글 드라이브', '발신', 'O', 289, 'Y', ''),
    ('FODR', '파일전송', 'OneDrive', '수신', 'I', 290, 'Y', ''),
    ('FODS', '파일전송', 'OneDrive', '발신', 'O', 291, 'Y', ''),
    ('FDBR', '파일전송', 'Dropbox', '수신', 'I', 292, 'Y', ''),
    ('FDBS', '파일전송', 'Dropbox', '발신', 'O', 293, 'Y', ''),
    ('F2NR', '파일전송', '2nd 드라이브', '수신', 'I', 294, 'N', ''),
    ('F2NS', '파일전송', '2nd 드라이브', '발신', 'O', 295, 'N', ''),
    ('FPSR', '파일전송', 'Polarisoffice ', '수신', 'I', 296, 'Y', ''),
    ('FPSS', '파일전송', 'Polarisoffice ', '발신', 'O', 297, 'Y', ''),
    ('FICR', '파일전송', 'Icloud', '수신', 'I', 298, 'Y', ''),
    ('FICS', '파일전송', 'Icloud', '발신', 'O', 299, 'Y', ''),
    ('FYDR', '파일전송', 'Yandex', '수신', 'I', 300, 'Y', ''),
    ('FYDS', '파일전송', 'Yandex', '발신', 'O', 301, 'Y', ''),
    ('FWHR', '파일전송', 'LG 웹하드', '수신', 'I', 302, 'Y', ''),
    ('FWHS', '파일전송', 'LG 웹하드', '발신', 'O', 303, 'Y', ''),
    ('FGIR', '파일전송', 'GitHub', '수신', 'I', 304, 'Y', ''),
    ('FGIS', '파일전송', 'GitHub', '발신', 'O', 305, 'Y', ''),
    ('FDOR', '파일전송', 'Dooray', '수신', 'I', 306, 'Y', ''),
    ('FDOS', '파일전송', 'Dooray', '발신', 'O', 307, 'Y', ''),
    ('FWES', '파일전송', 'Wetransfer', '발신', 'O', 308, 'Y', ''),
    ('FASS', '파일전송', 'AWS S3 bucket', '발신', 'O', 309, 'Y', ''),
    ('FGES', '파일전송', '구글 렌즈', '발신', 'O', 310, 'Y', ''),
    ('FUKR', '파일전송', '기타', '수신', 'I', 311, 'Y', ''),
    ('FUKS', '파일전송', '기타', '발신', 'O', 312, 'Y', ''),
    ('NENR', '노트', 'EVERNOTE', '수신', 'I', 313, 'Y', ''),
    ('NENS', '노트', 'EVERNOTE', '발신', 'O', 314, 'Y', ''),
    ('NONR', '노트', 'ONENOTE', '수신', 'I', 315, 'Y', ''),
    ('NONS', '노트', 'ONENOTE', '발신', 'O', 316, 'Y', ''),
    ('NLVS', '노트', 'Outlook.com 메모', '발신', 'O', 317, 'Y', ''),
    ('NBTS', '노트', 'BIT.AI', '발신', 'O', 318, 'Y', ''),
    ('NNOS', '노트', 'notion', '발신', 'O', 319, 'Y', ''),
    ('NGGS', '노트', '구글 docs', '발신', 'O', 320, 'Y', ''),
    ('NGTS', '노트', '구글 tasks', '발신', 'O', 321, 'Y', ''),
    ('NGKS', '노트', '구글 keep', '발신', 'O', 322, 'Y', ''),
    ('NSSR', '노트', '삼성 노트', '수신', 'I', 323, 'Y', ''),
    ('NSSS', '노트', '삼성 노트', '발신', 'O', 324, 'Y', ''),
    ('NNVS', '노트', '네이버 오피스', '발신', 'O', 325, 'Y', ''),
    ('NDBS', '노트', 'Dropbox paper', '발신', 'O', 326, 'Y', ''),
    ('NHCS', '노트', '한컴 오피스', '발신', 'O', 327, 'Y', ''),
    ('NMOS', '노트', 'MS오피스', '발신', 'O', 328, 'Y', ''),
    ('NCDS', '노트', 'Coda', '발신', 'O', 329, 'Y', ''),
    ('NNMR', '노트', '네이버 메모', '수신', 'I', 330, 'Y', ''),
    ('NNMS', '노트', '네이버 메모', '발신', 'O', 331, 'Y', ''),
    ('NCNS', '노트', 'Clova Note', '발신', 'O', 332, 'Y', ''),
    ('NGIS', '노트', 'Github Gist', '발신', 'O', 333, 'Y', ''),
    ('NSNS', '노트', 'SimpleNote', '발신', 'O', 334, 'Y', ''),
    ('NAGS', '노트', 'Agit', '발신', 'O', 335, 'Y', ''),
    ('NPSS', '노트', 'Polaris office', '발신', 'O', 336, 'Y', ''),
    ('NBOS', '노트', 'Box', '발신', 'O', 337, 'Y', ''),
    ('NCKS', '노트', 'ClickUp', '발신', 'O', 338, 'Y', ''),
    ('NUKS', '노트', '기타', '발신', 'O', 339, 'Y', ''),
    ('AGCR', '일정', '구글캘린더일정', '수신', 'I', 340, 'N', ''),
    ('AGCS', '일정', '구글캘린더일정', '발신', 'O', 341, 'Y', ''),
    ('AGLR', '일정', '구글캘린더메일', '수신', 'I', 342, 'N', ''),
    ('AGLS', '일정', '구글캘린더메일', '발신', 'O', 343, 'Y', ''),
    ('ANCS', '일정', '네이버 캘린더', '발신', 'O', 344, 'Y', ''),
    ('ZTN-', '기타 서비스', 'Telnet', '-', 'O', 345, 'Y', ''),
    ('ZXT-', '기타 서비스', 'Xterm', '-', 'O', 346, 'Y', ''),
    ('ZRL-', '기타 서비스', 'R-Login', '-', 'O', 347, 'Y', ''),
    ('ZNP-', '기타 서비스', 'NNTP', '-', 'O', 348, 'Y', ''),
    ('ZPC-', '기타 서비스', 'PC 보안', '-', 'O', 349, 'N', ''),
    ('ZSH-', '기타 서비스', 'SSH', 'SSH 세션 정보', 'O', 350, 'Y', ''),
    ('XX1R', '모니터링_제외', '미분류_타입1', '수신', 'I', 351, 'Y', ''),
    ('XX1S', '모니터링_제외', '미분류_타입1', '발신', 'O', 352, 'Y', ''),
    ('XX2R', '모니터링_제외', '미분류_타입2', '수신', 'I', 353, 'Y', ''),
    ('XX2S', '모니터링_제외', '미분류_타입2', '발신', 'O', 354, 'Y', ''),
    ('XX3R', '모니터링_제외', '미분류_타입3', '수신', 'I', 355, 'Y', ''),
    ('XX3S', '모니터링_제외', '미분류_타입3', '발신', 'O', 356, 'Y', ''),
    ('XU1R', '모니터링_제외', '웹서비스(미분류)_타입1', '수신', 'I', 357, 'Y', ''),
    ('XU1S', '모니터링_제외', '웹서비스(미분류)_타입1', '발신', 'O', 358, 'Y', ''),
    ('XU2R', '모니터링_제외', '웹서비스(미분류)_타입2', '수신', 'I', 359, 'Y', ''),
    ('XU2S', '모니터링_제외', '웹서비스(미분류)_타입2', '발신', 'O', 360, 'Y', ''),
    ('XU3R', '모니터링_제외', '웹서비스(미분류)_타입3', '수신', 'I', 361, 'Y', ''),
    ('XU3S', '모니터링_제외', '웹서비스(미분류)_타입3', '발신', 'O', 362, 'Y', ''),
    ('UWSD', '웹서비스(미분류)', '웹 발신', '첨부 - 문서타입', 'O', 363, 'Y', ''),
    ('UWSE', '웹서비스(미분류)', '웹 발신', '첨부 - 문서아님', 'O', 364, 'Y', ''),
    ('UWSU', '웹서비스(미분류)', '웹 발신', '첨부 없음', 'O', 365, 'Y', ''),
    ('UWSH', '웹서비스(미분류)', '웹 발신', '중요도(상)', 'O', 366, 'Y', ''),
    ('UWSM', '웹서비스(미분류)', '웹 발신', '중요도(중)', 'O', 367, 'Y', ''),
    ('UWSL', '웹서비스(미분류)', '웹 발신', '중요도(하)', 'O', 368, 'Y', ''),
    ('UX1R', '웹서비스(미분류)', '미분류_타입1', '수신', 'I', 369, 'Y', ''),
    ('UX1S', '웹서비스(미분류)', '미분류_타입1', '발신', 'O', 370, 'Y', ''),
    ('UX2R', '웹서비스(미분류)', '미분류_타입2', '수신', 'I', 371, 'Y', ''),
    ('UX2S', '웹서비스(미분류)', '미분류_타입2', '발신', 'O', 372, 'Y', ''),
    ('UX3R', '웹서비스(미분류)', '미분류_타입3', '수신', 'I', 373, 'Y', ''),
    ('UX3S', '웹서비스(미분류)', '미분류_타입3', '발신', 'O', 374, 'Y', ''),
    ('UWRD', '웹서비스(미분류)', '웹 수신', '첨부 - 문서타입', 'I', 375, 'Y', ''),
    ('UWRE', '웹서비스(미분류)', '웹 수신', '첨부 - 문서아님', 'I', 376, 'Y', ''),
    ('UWRU', '웹서비스(미분류)', '웹 수신', '첨부 없음', 'I', 377, 'Y', ''),
    ('BWSD', '웹서비스(업무)', '업무 발신', '첨부 - 문서타입', 'O', 378, 'Y', ''),
    ('BWSE', '웹서비스(업무)', '업무 발신', '첨부 - 문서아님', 'O', 379, 'Y', ''),
    ('BWSU', '웹서비스(업무)', '업무 발신', '첨부 없음', 'O', 380, 'Y', ''),
    ('BWRD', '웹서비스(업무)', '업무 수신', '첨부 - 문서타입', 'I', 381, 'Y', ''),
    ('BWRE', '웹서비스(업무)', '업무 수신', '첨부 - 문서아님', 'I', 382, 'Y', ''),
    ('BWRU', '웹서비스(업무)', '업무 수신', '첨부 없음', 'I', 383, 'Y', ''),
    ('TWEC', '화상회의', 'Webex', '채팅', 'O', 384, 'Y', 'MSG'),
    ('TWEF', '화상회의', 'Webex', '파일전송', 'O', 385, 'Y', 'MSG'),
    ('TWEJ', '화상회의', 'Webex', '참여', 'O', 386, 'Y', 'MSG'),
    ('TWEL', '화상회의', 'Webex', '떠남', 'O', 387, 'Y', 'MSG'),
    ('TZOC', '화상회의', 'Zoom', '채팅', 'O', 388, 'Y', 'MSG'),
    ('TZOF', '화상회의', 'Zoom', '파일전송', 'O', 389, 'Y', 'MSG'),
    ('TZOJ', '화상회의', 'Zoom', '참여', 'O', 390, 'Y', 'MSG'),
    ('TZOL', '화상회의', 'Zoom', '떠남', 'O', 391, 'Y', 'MSG'),
    ('TTMC', '화상회의', 'Teams', '채팅', 'O', 392, 'Y', 'MSG'),
    ('TTMF', '화상회의', 'Teams', '파일전송', 'O', 393, 'Y', 'MSG'),
    ('TTMJ', '화상회의', 'Teams', '참여', 'O', 394, 'Y', 'MSG'),
    ('TTML', '화상회의', 'Teams', '떠남', 'O', 395, 'Y', 'MSG'),
    ('TSKC', '화상회의', 'Skype', '채팅', 'O', 396, 'Y', 'MSG'),
    ('TSKF', '화상회의', 'Skype', '파일전송', 'O', 397, 'Y', 'MSG'),
    ('TSKJ', '화상회의', 'Skype', '참여', 'O', 398, 'Y', 'MSG'),
    ('TSKL', '화상회의', 'Skype', '떠남', 'O', 399, 'Y', 'MSG'),
    ('TJMC', '화상회의', 'JoinME', '채팅', 'O', 400, 'Y', 'MSG'),
    ('TJMF', '화상회의', 'JoinME', '파일전송', 'O', 401, 'Y', 'MSG'),
    ('TAMC', '화상회의', 'Amazon Chime', '채팅', 'O', 402, 'Y', 'MSG'),
    ('TAMF', '화상회의', 'Amazon Chime', '파일전송', 'O', 403, 'Y', 'MSG'),
    ('TBJC', '화상회의', 'BlueJeans', '채팅', 'O', 404, 'Y', 'MSG'),
    ('TTDS', '화상회의', 'Tl;dv', '채팅', 'O', 405, 'Y', 'MSG'),
    ('LNVS', '번역기', '파파고 번역', '발신', 'O', 406, 'Y', ''),
    ('LGGS', '번역기', '구글 번역', '발신', 'O', 407, 'Y', ''),
    ('LGPS', '번역기', '구글 번역 플러그인', '발신', 'O', 408, 'Y', ''),
    ('LDES', '번역기', 'Deepl', '발신', 'O', 409, 'Y', ''),
    ('LBIS', '번역기', 'Bing 번역', '발신', 'O', 410, 'Y', ''),
    ('LYMS', '번역기', 'Yandex 번역', '발신', 'O', 411, 'Y', ''),
    ('LUKS', '번역기', '기타', '발신', 'I', 412, 'Y', ''),
    ('IGBS', '생성형 AI', '구글 Gemini', '발신', 'O', 413, 'Y', ''),
    ('IBIS', '생성형 AI', ' Microsoft Copilot', '발신', 'O', 414, 'Y', ''),
    ('IWTS', '생성형 AI', 'Wrtn', '발신', 'O', 415, 'Y', ''),
    ('IGPS', '생성형 AI', 'chatGPT', '발신', 'O', 416, 'Y', ''),
    ('IDAS', '생성형 AI', 'Dall-E', '발신', 'O', 417, 'Y', ''),
    ('IGCS', '생성형 AI', 'Github Copilot', '발신', 'I', 418, 'Y', ''),
    ('IYCS', '생성형 AI', 'YouChat', '발신', 'I', 419, 'Y', ''),
    ('ICSS', '생성형 AI', 'Chatsonic', '발신', 'I', 420, 'Y', ''),
    ('IRPS', '생성형 AI', 'replika', '발신', 'I', 421, 'Y', ''),
    ('IPPS', '생성형 AI', 'Perplexity', '발신', 'I', 422, 'Y', ''),
    ('ITCS', '생성형 AI', 'TextCortex', '발신', 'I', 423, 'Y', ''),
    ('IPHS', '생성형 AI', 'Phind', '발신', 'I', 424, 'Y', ''),
    ('IPOS', '생성형 AI', 'Poe', '발신', 'I', 425, 'Y', ''),
    ('IHFS', '생성형 AI', 'Hugging Face', '발신', 'I', 426, 'Y', ''),
    ('ICPS', '생성형 AI', 'Copy.AI', '발신', 'I', 427, 'Y', ''),
    ('IHWS', '생성형 AI', 'HyperWrite', '발신', 'I', 428, 'Y', ''),
    ('IDPS', '생성형 AI', 'DeepAI', '발신', 'I', 429, 'Y', ''),
    ('IACS', '생성형 AI', 'AskCodi', '발신', 'I', 430, 'Y', ''),
    ('INAS', '생성형 AI', 'Native', '발신', 'I', 431, 'Y', ''),
    ('INFS', '생성형 AI', 'NeuroFlash', '발신', 'I', 432, 'Y', ''),
    ('INOS', '생성형 AI', 'Notion AI', '발신', 'I', 433, 'Y', ''),
    ('IMES', '생성형 AI', 'Merlin', '발신', 'I', 434, 'Y', ''),
    ('ICXS', '생성형 AI', 'CLOVA-X', '발신', 'I', 435, 'Y', ''),
    ('IADS', '생성형 AI', 'Adobe AI', '발신', 'I', 436, 'Y', ''),
    ('ICDS', '생성형 AI', 'ClipDrop', '발신', 'I', 437, 'Y', ''),
    ('ISBS', '생성형 AI', 'Stability.Ai', '발신', 'I', 438, 'Y', ''),
    ('IRMS', '생성형 AI', 'Runwayml', '발신', 'I', 439, 'Y', ''),
    ('IGVS', '생성형 AI', 'Google Vertex', '발신', 'I', 440, 'Y', ''),
    ('IGLS', '생성형 AI', 'Google Colab', '발신', 'I', 441, 'Y', ''),
    ('ICWS', '생성형 AI', 'CodeWhisperer', '발신', 'I', 442, 'Y', ''),
    ('IMSS', '생성형 AI', 'MakerSuite', '발신', 'I', 443, 'Y', ''),
    ('IOCS', '생성형 AI', 'Clova OCR', '발신', 'I', 444, 'Y', ''),
    ('IAOS', '생성형 AI', 'Azure OpenAI', '발신', 'I', 445, 'Y', ''),
    ('ICUS', '생성형 AI', '네이버 CUE:', '발신', 'I', 446, 'Y', ''),
    ('IMJS', '생성형 AI', 'Midjourney', '발신', 'I', 447, 'Y', ''),
    ('ISGR', '생성형 AI', 'slidesGPT', '수신', 'I', 448, 'Y', ''),
    ('ISGS', '생성형 AI', 'slidesGPT', '발신', 'I', 449, 'Y', ''),
    ('IDMS', '생성형 AI', 'AiDocmaker', '발신', 'I', 450, 'Y', ''),
    ('IRKS', '생성형 AI', 'Reka AI', '발신', 'I', 451, 'Y', ''),
    ('ICLS', '생성형 AI', 'Claude', '발신', 'I', 452, 'Y', ''),
    ('IDMR', '생성형 AI', 'Ai Docker Attach', '수신', 'I', 453, 'Y', ''),
    ('IADR', '생성형 AI', 'Adobe firefly login', '수신', 'I', 454, 'Y', ''),
    ('IWDS', '생성형 AI', 'Dream by WOMBO', '발신', 'I', 455, 'Y', ''),
    ('IGAS', '생성형 AI', 'GetImg.AI', '발신', 'I', 456, 'Y', ''),
    ('IWKS', '생성형 AI', 'Wrks.ai', '발신', 'I', 457, 'Y', ''),
    ('IPSS', '생성형 AI', 'polaris office ai', '발신', 'I', 458, 'Y', ''),
    ('IBGS', '생성형 AI', 'Goover AI', '발신', 'I', 459, 'Y', ''),
    ('IIAS', '생성형 AI', 'IAsk AI', '발신', 'I', 460, 'Y', ''),
    ('ISNS', '생성형 AI', 'Suno AI', '발신', 'I', 461, 'Y', ''),
    ('IUKS', '생성형 AI', '기타', '발신', 'I', 462, 'Y', ''),
    ('PDOS', '프로젝트', 'Dooray', '발신', 'O', 463, 'Y', ''),
    ('PGIS', '프로젝트', 'Github', '발신', 'O', 464, 'Y', ''),
    ('PGLS', '프로젝트', 'Glassdoor', '발신', 'O', 465, 'Y', ''),
    ('EBDR', '그룹웨어', '게시', '수신', 'I', 466, 'Y', ''),
    ('EBD-', '그룹웨어', '게시', '발신', 'O', 467, 'Y', ''),
    ('EBBR', '그룹웨어', '게시판', '수신', 'I', 468, 'Y', ''),
    ('EBBS', '그룹웨어', '게시판', '발신', 'O', 469, 'Y', ''),
    ('EBBF', '그룹웨어', '게시판', '파일수신', 'I', 470, 'Y', ''),
    ('EAAR', '그룹웨어', '결재', '수신', 'I', 471, 'Y', ''),
    ('EAAS', '그룹웨어', '결재', '발신', 'O', 472, 'Y', ''),
    ('EAAG', '그룹웨어', '결재', '통보 - 수신', 'I', 473, 'Y', ''),
    ('EAAP', '그룹웨어', '결재', '통보 - 발신', 'O', 474, 'Y', ''),
    ('EAAF', '그룹웨어', '결재', '파일수신', 'I', 475, 'Y', ''),
    ('EMMR', '그룹웨어', '메일', '그룹웨어 수신', 'I', 476, 'Y', ''),
    ('EMMS', '그룹웨어', '메일', '그룹웨어 발신', 'O', 477, 'Y', ''),
    ('EMMG', '그룹웨어', '메일', 'OWA 수신', 'I', 478, 'Y', ''),
    ('EMMP', '그룹웨어', '메일', 'OWA 발신', 'O', 479, 'Y', ''),
    ('EMMD', '그룹웨어', '메일', 'RPC 수신', 'I', 480, 'Y', ''),
    ('EMMU', '그룹웨어', '메일', 'RPC 발신', 'O', 481, 'Y', ''),
    ('EMMC', '그룹웨어', '메일', '수신', 'I', 482, 'Y', ''),
    ('EMML', '그룹웨어', '메일', '발신', 'O', 483, 'Y', ''),
    ('EMM1', '그룹웨어', '메일', '보안등급1', 'O', 484, 'Y', ''),
    ('EMM2', '그룹웨어', '메일', '보안등급2', 'O', 485, 'Y', ''),
    ('EMM3', '그룹웨어', '메일', '보안등급3', 'O', 486, 'Y', ''),
    ('EMM4', '그룹웨어', '메일', '보안등급4', 'O', 487, 'Y', ''),
    ('EMMA', '그룹웨어', '메일', '임시(자동)', 'O', 488, 'Y', ''),
    ('EMMT', '그룹웨어', '메일', '임시(수동)', 'O', 489, 'Y', ''),
    ('EMMK', '그룹웨어', '메일', 'Outlook - 수신', 'I', 490, 'Y', ''),
    ('EMMO', '그룹웨어', '메일', 'Outlook - 발신', 'O', 491, 'Y', ''),
    ('EMMB', '그룹웨어', '메일', '그룹웨어 예약메일', 'O', 492, 'Y', ''),
    ('EMBR', '그룹웨어', '모바일', '수신', 'I', 493, 'Y', ''),
    ('EMB-', '그룹웨어', '모바일', '발신', 'O', 494, 'Y', ''),
    ('EWSR', '그룹웨어', '웹서비스', '수신', 'I', 495, 'Y', ''),
    ('EWS-', '그룹웨어', '웹서비스', '발신', 'O', 496, 'Y', ''),
    ('EPUR', '그룹웨어', '일반', '수신', 'I', 497, 'Y', ''),
    ('EPU-', '그룹웨어', '일반', '발신', 'O', 498, 'Y', ''),
    ('EAU-', '그룹웨어', '일반(자동전달)', '자동전달', 'O', 499, 'Y', ''),
    ('ESCR', '그룹웨어', '일정 명함', '수신', 'I', 500, 'Y', ''),
    ('ESC-', '그룹웨어', '일정 명함', '발신', 'O', 501, 'Y', ''),
    ('EMF-', '그룹웨어', '파일 다운로드', '-', 'I', 502, 'Y', ''),
    ('EMU-', '그룹웨어', '기타', '', 'O', 503, 'Y', ''),
    ('EMDR', '그룹웨어', '드라이브', '수신', 'I', 504, 'Y', ''),
    ('EMDS', '그룹웨어', '드라이브', '발신', 'O', 505, 'Y', ''),
    ('ECIS', '그룹웨어', 'Samsung cic', '발신', 'O', 506, 'Y', ''),
    ('EMER', '그룹웨어', '메신저', '수신', 'O', 507, 'Y', ''),
    ('EMES', '그룹웨어', '메신저', '발신', 'O', 508, 'Y', ''),
    ('DCCS', '편집기', 'Clip Champ', '발신', 'O', 509, 'Y', ''),
    ('DFGS', '편집기', 'Figma', '발신', 'O', 510, 'Y', '');
