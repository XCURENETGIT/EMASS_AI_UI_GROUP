...
('IDTR', '생성형 AI', '에이닷', '수신', 'O', 521, 'Y', ''),
('IQBS', '생성형 AI', 'QuillBot', '발신', 'I', 522, 'Y', ''),
('ICHS', '생성형 AI', 'Character ai', '발신', 'I', 523, 'Y', ''),
('ISRS', '생성형 AI', 'Sora/Openai', '발신', 'I', 524, 'Y', ''),
('ISRR', '생성형 AI', 'Sora/Openai', '수신', 'O', 525, 'Y', ''),
('INNS', '생성형 AI', 'Nano AI', '발신', 'I', 526, 'Y', ''),
('IDBS', '생성형 AI', 'Doubao', '발신', 'I', 527, 'Y', ''),
('ITYS', '생성형 AI', 'Tongyi', '발신', 'I', 528, 'Y', ''),
('IYBS', '생성형 AI', 'Yuanbao', '발신', 'I', 529, 'Y', ''),
('IYYS', '생성형 AI', 'Yiyan', '발신', 'I', 530, 'Y', ''),
('IKMS', '생성형 AI', 'Kimi', '발신', 'I', 531, 'Y', ''),
('IBAS', '생성형 AI', 'Baichuan', '발신', 'I', 532, 'Y', ''),
('ITGS', '생성형 AI', 'Tiangong', '발신', 'I', 533, 'Y', ''),
('ISDS', '생성형 AI', 'Stable Diffusion', '발신', 'I', 534, 'Y', ''),
('IGOS', '생성형 AI', 'Grok', '발신', 'I', 535, 'Y', ''),
('ICGS', '생성형 AI', 'ChatGLM', '발신', 'I', 536, 'Y', ''),
('INKS', '생성형 AI', 'Napkin AI', '발신', 'I', 537, 'Y', ''),
('IBIR', '생성형 AI', 'Microsoft Copilot(Chat)', '수신', 'I', 538, 'Y', ''),
('IOOS', '생성형 AI', 'AI Goormee', '발신', 'I', 539, 'Y', ''),
('IABS', '생성형 AI', 'Allibee', '발신', 'I', 540, 'Y', ''),
('ILXS', '생성형 AI', 'Lexis+', '발신', 'I', 541, 'Y', ''),
('ILAS', '생성형 AI', 'SuperLawyer', '발신', 'I', 542, 'Y', ''),
('ICOS', '생성형 AI', 'CoCounsel', '발신', 'I', 543, 'Y', ''),
('IANS', '생성형 AI', 'Anthropic', '발신', 'I', 544, 'Y', ''),
('ISIS', '생성형 AI', 'Sider AI', '발신', 'I', 545, 'Y', ''),
('IGMS', '생성형 AI', 'Gamma', '발신', 'I', 546, 'Y', ''),
('IGMR', '생성형 AI', 'Gamma', '수신', 'I', 547, 'Y', ''),
('ICRS', '생성형 AI', 'Cursor', '발신', 'I', 548, 'Y', ''),
('IMAS', '생성형 AI', 'ManusAI', '발신', 'I', 549, 'Y', ''),
('IMTS', '생성형 AI', 'Mistral AI', '발신', 'I', 550, 'Y', ''),
('ICBS', '생성형 AI', 'Cline', '발신', 'I', 551, 'Y', ''),
('IWBS', '생성형 AI', 'Weight & Biases', '발신', 'I', 552, 'Y', ''),
('IWBR', '생성형 AI', 'Weight & Biases', '수신', 'I', 553, 'Y', ''),
('ILLS', '생성형 AI', 'Lilys AI', '발신', 'I', 554, 'Y', ''),
('IUKS', '생성형 AI', '기타', '발신', 'I', 555, 'Y', ''),
('IGES', '생성형 AI', 'Gemini Code Assist', '발신', 'O', 556, 'Y', ''),
('IOES', '생성형 AI', 'Codex/OpenAI', '발신', 'O', 557, 'Y', ''),
('IJLS', '생성형 AI', 'Jules', '발신', 'O', 558, 'Y', ''),
('IHVS', '생성형 AI', 'Harvey', '발신', 'O', 559, 'Y', ''),
('IXAS', '생성형 AI', 'x.AI', '발신', 'O', 560, 'Y', ''),
('ICES', '생성형 AI', 'Cohere', '발신', 'O', 561, 'Y', ''),
('IWTR', '생성형 AI', 'Wrtn', '수신', 'I', 562, 'Y', ''),
('ICHR', '생성형 AI', 'Character ai', '수신', 'I', 563, 'Y', ''),
('IOWR', '생성형 AI', 'Open WebUi', '수신', 'O', 564, 'Y', ''),
('IOWS', '생성형 AI', 'Open WebUi', '발신', 'O', 565, 'Y', ''),
('PDOS', '프로젝트', 'dooray', '발신', 'O', 566, 'Y', ''),
('PGIS', '프로젝트', 'github', '발신', 'O', 567, 'Y', ''),
('PGLS', '프로젝트', 'Glassdoor', '발신', 'O', 568, 'Y', ''),
('PJDS', '프로젝트', '잔디', '발신', 'O', 569, 'Y', ''),
('PITS', '프로젝트', 'Google Issue Tracker', '발신', 'O', 570, 'Y', ''),
('EBDR', '그룹웨어', '게시', '수신', 'I', 571, 'Y', ''),
('EBD-', '그룹웨어', '게시', '발신', 'O', 572, 'Y', ''),
('EBBR', '그룹웨어', '게시판', '수신', 'I', 573, 'Y', ''),
('EBBS', '그룹웨어', '게시판', '발신', 'O', 574, 'Y', ''),
('EBBF', '그룹웨어', '게시판', '파일수신', 'I', 575, 'Y', ''),
('EAAR', '그룹웨어', '결재', '수신', 'I', 576, 'Y', ''),
('EAAS', '그룹웨어', '결재', '발신', 'O', 577, 'Y', ''),
('EAAG', '그룹웨어', '결재', '통보 - 수신', 'I', 578, 'Y', ''),
('EAAP', '그룹웨어', '결재', '통보 - 발신', 'O', 579, 'Y', ''),
('EAAF', '그룹웨어', '결재', '파일수신', 'I', 580, 'Y', ''),
('EMMR', '그룹웨어', '메일', '그룹웨어 수신', 'I', 581, 'Y', ''),
('EMMS', '그룹웨어', '메일', '그룹웨어 발신', 'O', 582, 'Y', ''),
('EMMG', '그룹웨어', '메일', 'OWA 수신', 'I', 583, 'Y', ''),
('EMMP', '그룹웨어', '메일', 'OWA 발신', 'O', 584, 'Y', ''),
('EMMD', '그룹웨어', '메일', 'RPC 수신', 'I', 585, 'Y', ''),
('EMMU', '그룹웨어', '메일', 'RPC 발신', 'O', 586, 'Y', ''),
('EMMC', '그룹웨어', '메일', '수신', 'I', 587, 'Y', ''),
('EMML', '그룹웨어', '메일', '발신', 'O', 588, 'Y', ''),
('EMM1', '그룹웨어', '메일', '보안등급1', 'O', 589, 'Y', ''),
('EMM2', '그룹웨어', '메일', '보안등급2', 'O', 590, 'Y', ''),
('EMM3', '그룹웨어', '메일', '보안등급3', 'O', 591, 'Y', ''),
('EMM4', '그룹웨어', '메일', '보안등급4', 'O', 592, 'Y', ''),
('EMMA', '그룹웨어', '메일', '임시(자동)', 'O', 593, 'Y', ''),
('EMMT', '그룹웨어', '메일', '임시(수동)', 'O', 594, 'Y', ''),
('EMMK', '그룹웨어', '메일', 'Outlook - 수신', 'I', 595, 'Y', ''),
('EMMO', '그룹웨어', '메일', 'Outlook - 발신', 'O', 596, 'Y', ''),
('EMMB', '그룹웨어', '메일', '그룹웨어 예약메일', 'O', 597, 'Y', ''),
('EMBR', '그룹웨어', '모바일', '수신', 'I', 598, 'Y', ''),
('EMB-', '그룹웨어', '모바일', '발신', 'O', 599, 'Y', ''),
('EWSR', '그룹웨어', '웹서비스', '수신', 'I', 600, 'Y', ''),
('EWS-', '그룹웨어', '웹서비스', '발신', 'O', 601, 'Y', ''),
('EPUR', '그룹웨어', '일반', '수신', 'I', 602, 'Y', ''),
('EPU-', '그룹웨어', '일반', '발신', 'O', 603, 'Y', ''),
('EAU-', '그룹웨어', '일반(자동전달)', '자동전달', 'O', 604, 'Y', ''),
('ESCR', '그룹웨어', '일정 명함', '수신', 'I', 605, 'Y', ''),
('ESC-', '그룹웨어', '일정 명함', '발신', 'O', 606, 'Y', ''),
('EMF-', '그룹웨어', '파일 다운로드', '-', 'I', 607, 'Y', ''),
('EMU-', '그룹웨어', '기타', '', 'O', 608, 'Y', ''),
('EMDR', '그룹웨어', '드라이브', '수신', 'I', 609, 'Y', ''),
('EMDS', '그룹웨어', '드라이브', '발신', 'O', 610, 'Y', ''),
('ECIS', '그룹웨어', 'Samsung cic', '발신', 'O', 611, 'Y', ''),
('EMER', '그룹웨어', '메신저', '수신', 'O', 612, 'Y', ''),
('EMES', '그룹웨어', '메신저', '발신', 'O', 613, 'Y', ''),
('EZQC', '그룹웨어', 'Zohocliq', '채팅', 'O', 614, 'Y', ''),
('EZQS', '그룹웨어', 'Zohocliq', '캘린더', 'O', 615, 'Y', ''),
('EKWS', '그룹웨어', '카카오워크', '발신', 'O', 616, 'Y', ''),
('DCCS', '편집기', 'Clip Champ', '발신', 'O', 617, 'Y', ''),
('DFGS', '편집기', 'Figma', '발신', 'O', 618, 'Y', ''),
('DOVS', '편집기', 'Overleaf', '발신', 'O', 619, 'Y', ''),
('DOVR', '편집기', 'Overleaf', '수신', 'O', 620, 'Y', ''),
('DPKS', '편집기', 'Plunker', '발신', 'O', 621, 'Y', ''),
('DNWS', '편집기', 'Namu.wiki', '발신', 'O', 622, 'Y', ''),
('DWKS', '편집기', 'WikiPedia', '발신', 'O', 623, 'Y', ''),
('DAES', '편집기', 'Adobe Express', '발신', 'O', 624, 'Y', ''),
('DSMS', '편집기', 'Sketchmon', '발신', 'O', 625, 'Y', ''),
('DGSS', '편집기', 'Google Site', '발신', 'O', 626, 'Y', ''),
('DCVS', '편집기', 'Canva', '발신', 'O', 627, 'Y', ''),
('JBDS', '웹사이트', 'Baidu', '발신', 'O', 628, 'Y', ''),
('JANS', '웹사이트', 'Anthropic', '발신', 'O', 629, 'Y', ''),
('RGUS', '원격접속', '아파치 과카몰리', '발신', 'O', 630, 'Y', ''),
