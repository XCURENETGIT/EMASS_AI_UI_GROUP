...
INSERT IGNORE INTO UI_SERVICE (`SERVICECD`, `SERVICENM_LV1`, `SERVICENM_LV2`, `SERVICENM_LV3`, `IN_OUT`, `SORT`, `USE_YN`, `MSGGRPCD`)  VALUES ('MP3-', '메일', 'POP3', '-', 'I', 1, 'Y', ''),
    ...
    ('IUKS', '생성형 AI', '기타', '발신', 'I', 446, 'Y', ''),
    ('PDOS', '프로젝트', 'dooray', '발신', 'O', 447, 'Y', ''),
    ('PGIS', '프로젝트', 'github', '발신', 'O', 448, 'Y', ''),
    ('PGLS', '프로젝트', 'Glassdoor', '발신', 'O', 449, 'Y', ''),
    ('EBDR', '그룹웨어', '게시', '수신', 'I', 450, 'Y', ''),
    ('EBD-', '그룹웨어', '게시', '발신', 'O', 451, 'Y', ''),
    ('EBBR', '그룹웨어', '게시판', '수신', 'I', 452, 'Y', ''),
    ('EBBS', '그룹웨어', '게시판', '발신', 'O', 453, 'Y', ''),
    ('EBBF', '그룹웨어', '게시판', '파일수신', 'I', 454, 'Y', ''),
    ('EAAR', '그룹웨어', '결재', '수신', 'I', 455, 'Y', ''),
    ('EAAS', '그룹웨어', '결재', '발신', 'O', 456, 'Y', ''),
    ('EAAG', '그룹웨어', '결재', '통보 - 수신', 'I', 457, 'Y', ''),
    ('EAAP', '그룹웨어', '결재', '통보 - 발신', 'O', 458, 'Y', ''),
    ('EAAF', '그룹웨어', '결재', '파일수신', 'I', 459, 'Y', ''),
    ('EMMR', '그룹웨어', '메일', '그룹웨어 수신', 'I', 460, 'Y', ''),
    ('EMMS', '그룹웨어', '메일', '그룹웨어 발신', 'O', 461, 'Y', ''),
    ('EMMG', '그룹웨어', '메일', 'OWA 수신', 'I', 462, 'Y', ''),
    ('EMMP', '그룹웨어', '메일', 'OWA 발신', 'O', 463, 'Y', ''),
    ('EMMD', '그룹웨어', '메일', 'RPC 수신', 'I', 464, 'Y', ''),
    ('EMMU', '그룹웨어', '메일', 'RPC 발신', 'O', 465, 'Y', ''),
    ('EMMC', '그룹웨어', '메일', '수신', 'I', 466, 'Y', ''),
    ('EMML', '그룹웨어', '메일', '발신', 'O', 467, 'Y', ''),
    ('EMM1', '그룹웨어', '메일', '보안등급1', 'O', 468, 'Y', ''),
    ('EMM2', '그룹웨어', '메일', '보안등급2', 'O', 469, 'Y', ''),
    ('EMM3', '그룹웨어', '메일', '보안등급3', 'O', 470, 'Y', ''),
    ('EMM4', '그룹웨어', '메일', '보안등급4', 'O', 471, 'Y', ''),
    ('EMMA', '그룹웨어', '메일', '임시(자동)', 'O', 472, 'Y', ''),
    ('EMMT', '그룹웨어', '메일', '임시(수동)', 'O', 473, 'Y', ''),
    ('EMMK', '그룹웨어', '메일', 'Outlook - 수신', 'I', 474, 'Y', ''),
    ('EMMO', '그룹웨어', '메일', 'Outlook - 발신', 'O', 475, 'Y', ''),
    ('EMMB', '그룹웨어', '메일', '그룹웨어 예약메일', 'O', 476, 'Y', ''),
    ('EMBR', '그룹웨어', '모바일', '수신', 'I', 477, 'Y', ''),
    ('EMB-', '그룹웨어', '모바일', '발신', 'O', 478, 'Y', ''),
    ('EWSR', '그룹웨어', '웹서비스', '수신', 'I', 479, 'Y', ''),
    ('EWS-', '그룹웨어', '웹서비스', '발신', 'O', 480, 'Y', ''),
    ('EPUR', '그룹웨어', '일반', '수신', 'I', 481, 'Y', ''),
    ('EPU-', '그룹웨어', '일반', '발신', 'O', 482, 'Y', ''),
    ('ESCR', '그룹웨어', '일정 명함', '수신', 'I', 483, 'Y', ''),
    ('ESC-', '그룹웨어', '일정 명함', '발신', 'O', 484, 'Y', ''),
    ('EMF-', '그룹웨어', '파일 다운로드', '-', 'I', 485, 'Y', ''),
    ('EMU-', '그룹웨어', '기타', '', 'O', 486, 'Y', ''),
    ('EMDR', '그룹웨어', '드라이브', '수신', 'I', 487, 'Y', ''),
    ('EMDS', '그룹웨어', '드라이브', '발신', 'O', 488, 'Y', ''),
