...
VALUES ('MP3-', '메일', 'POP3', '-', 'I', 1, 'Y', ''),
       ...
       ('IUKS', '생성형 AI', '기타', '발신', 'I', 540, 'Y', ''),
       ('PDOS', '프로젝트', 'dooray', '발신', 'O', 541, 'Y', ''),
       ('PGIS', '프로젝트', 'github', '발신', 'O', 542, 'Y', ''),
       ('PGLS', '프로젝트', 'Glassdoor', '발신', 'O', 543, 'Y', ''),
       ('PJDS', '프로젝트', '잔디', '발신', 'O', 544, 'Y', ''),
       ('PITS', '프로젝트', 'Google Issue Tracker', '발신', 'O', 545, 'Y', ''),
       ('EBDR', '그룹웨어', '게시', '수신', 'I', 546, 'Y', ''),
       ('EBD-', '그룹웨어', '게시', '발신', 'O', 547, 'Y', ''),
       ('EBBR', '그룹웨어', '게시판', '수신', 'I', 548, 'Y', ''),
       ('EBBS', '그룹웨어', '게시판', '발신', 'O', 549, 'Y', ''),
       ('EBBF', '그룹웨어', '게시판', '파일수신', 'I', 550, 'Y', ''),
       ('EAAR', '그룹웨어', '결재', '수신', 'I', 551, 'Y', ''),
       ('EAAS', '그룹웨어', '결재', '발신', 'O', 552, 'Y', ''),
       ('EAAG', '그룹웨어', '결재', '통보 - 수신', 'I', 553, 'Y', ''),
       ('EAAP', '그룹웨어', '결재', '통보 - 발신', 'O', 554, 'Y', ''),
       ('EAAF', '그룹웨어', '결재', '파일수신', 'I', 555, 'Y', ''),
       ('EMMR', '그룹웨어', '메일', '그룹웨어 수신', 'I', 556, 'Y', ''),
       ('EMMS', '그룹웨어', '메일', '그룹웨어 발신', 'O', 557, 'Y', ''),
       ('EMMG', '그룹웨어', '메일', 'OWA 수신', 'I', 558, 'Y', ''),
       ('EMMP', '그룹웨어', '메일', 'OWA 발신', 'O', 559, 'Y', ''),
       ('EMMD', '그룹웨어', '메일', 'RPC 수신', 'I', 560, 'Y', ''),
       ('EMMU', '그룹웨어', '메일', 'RPC 발신', 'O', 561, 'Y', ''),
       ('EMMC', '그룹웨어', '메일', '수신', 'I', 562, 'Y', ''),
       ('EMML', '그룹웨어', '메일', '발신', 'O', 563, 'Y', ''),
       ('EMM1', '그룹웨어', '메일', '보안등급1', 'O', 564, 'Y', ''),
       ('EMM2', '그룹웨어', '메일', '보안등급2', 'O', 565, 'Y', ''),
       ('EMM3', '그룹웨어', '메일', '보안등급3', 'O', 566, 'Y', ''),
       ('EMM4', '그룹웨어', '메일', '보안등급4', 'O', 567, 'Y', ''),
       ('EMMA', '그룹웨어', '메일', '임시(자동)', 'O', 568, 'Y', ''),
       ('EMMT', '그룹웨어', '메일', '임시(수동)', 'O', 569, 'Y', ''),
       ('EMMK', '그룹웨어', '메일', 'Outlook - 수신', 'I', 570, 'Y', ''),
       ('EMMO', '그룹웨어', '메일', 'Outlook - 발신', 'O', 571, 'Y', ''),
       ('EMMB', '그룹웨어', '메일', '그룹웨어 예약메일', 'O', 572, 'Y', ''),
       ('EMBR', '그룹웨어', '모바일', '수신', 'I', 573, 'Y', ''),
       ('EMB-', '그룹웨어', '모바일', '발신', 'O', 574, 'Y', ''),
       ('EWSR', '그룹웨어', '웹서비스', '수신', 'I', 575, 'Y', ''),
       ('EWS-', '그룹웨어', '웹서비스', '발신', 'O', 576, 'Y', ''),
       ('EPUR', '그룹웨어', '일반', '수신', 'I', 577, 'Y', ''),
       ('EPU-', '그룹웨어', '일반', '발신', 'O', 578, 'Y', ''),
       ('EAU-', '그룹웨어', '일반(자동전달)', '자동전달', 'O', 579, 'Y', ''),
       ('ESCR', '그룹웨어', '일정 명함', '수신', 'I', 580, 'Y', ''),
       ('ESC-', '그룹웨어', '일정 명함', '발신', 'O', 581, 'Y', ''),
       ('EMF-', '그룹웨어', '파일 다운로드', '-', 'I', 582, 'Y', ''),
       ('EMU-', '그룹웨어', '기타', '', 'O', 583, 'Y', ''),
       ('EMDR', '그룹웨어', '드라이브', '수신', 'I', 584, 'Y', ''),
       ('EMDS', '그룹웨어', '드라이브', '발신', 'O', 585, 'Y', ''),
       ('ECIS', '그룹웨어', 'Samsung cic', '발신', 'O', 586, 'Y', ''),
       ('EMER', '그룹웨어', '메신저', '수신', 'O', 587, 'Y', ''),
       ('EMES', '그룹웨어', '메신저', '발신', 'O', 588, 'Y', ''),
       ('EZQC', '그룹웨어', 'Zohocliq', '채팅', 'O', 589, 'Y', ''),
       ('EZQS', '그룹웨어', 'Zohocliq', '캘린더', 'O', 590, 'Y', ''),
       ('EKWS', '그룹웨어', '카카오워크', '발신', 'O', 591, 'Y', ''),
       ('DCCS', '편집기', 'Clip Champ', '발신', 'O', 592, 'Y', ''),
       ('DFGS', '편집기', 'Figma', '발신', 'O', 593, 'Y', ''),
       ('DOVS', '편집기', 'Overleaf', '발신', 'O', 594, 'Y', ''),
       ('DOVR', '편집기', 'Overleaf', '수신', 'O', 595, 'Y', ''),
       ('DPKS', '편집기', 'Plunker', '발신', 'O', 596, 'Y', ''),
       ('DNWS', '편집기', 'Namu.wiki', '발신', 'O', 597, 'Y', ''),
       ('DWKS', '편집기', 'WikiPedia', '발신', 'O', 598, 'Y', ''),
       ('DAES', '편집기', 'Adobe Express', '발신', 'O', 599, 'Y', ''),
       ('DSMS', '편집기', 'Sketchmon', '발신', 'O', 600, 'Y', ''),
       ('DGSS', '편집기', 'Google Site', '발신', 'O', 601, 'Y', ''),
       ('JBDS', '웹사이트', 'Baidu', '발신', 'O', 602, 'Y', ''),
       ('JANS', '웹사이트', 'Anthropic', '발신', 'O', 603, 'Y', ''),
       ('RGUS', '원격접속', '아파치 과카몰리', '발신', 'O', 604, 'Y', '');
