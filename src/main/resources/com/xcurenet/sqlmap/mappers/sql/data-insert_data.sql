...
('EMU-', '그룹웨어', '기타', '', 'O', 707, 'Y', ''),
('EMDR', '그룹웨어', '드라이브', '수신', 'I', 708, 'Y', ''),
('EMDS', '그룹웨어', '드라이브', '발신', 'O', 709, 'Y', ''),
('ECIS', '그룹웨어', 'Samsung cic', '발신', 'O', 710, 'Y', ''),
('EMER', '그룹웨어', '메신저', '수신', 'I', 711, 'Y', ''),
('EMES', '그룹웨어', '메신저', '발신', 'O', 712, 'Y', ''),
('EMEC', '그룹웨어', '메신저', '채팅', 'O', 713, 'Y', 'MSG'),
('EZQC', '그룹웨어', 'Zohocliq', '채팅', 'O', 714, 'Y', ''),
('EZQS', '그룹웨어', 'Zohocliq', '캘린더', 'O', 715, 'Y', ''),
('EKWS', '그룹웨어', '카카오워크', '발신', 'O', 716, 'Y', ''),
('ECAS', '그룹웨어', '일정', '발신', 'O', 717, 'Y', ''),
('ETOS', '그룹웨어', 'Tigris', '기타', 'O', 718, 'Y', ''),
('ETOC', '그룹웨어', 'Tigris', '메신저', 'O', 719, 'Y', ''),
('ETOD', '그룹웨어', 'Tigris', '드라이브', 'O', 720, 'Y', ''),
('ETOA', '그룹웨어', 'Tigris', '결재', 'O', 721, 'Y', ''),
