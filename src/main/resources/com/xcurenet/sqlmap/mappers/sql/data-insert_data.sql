...
VALUES ('MP3-', '메일', 'POP3', '-', 'I', 1, 'Y', ''),
       ...
       ('FFTC', '파일전송', 'FTP', 'CMD', 'O', 293, 'Y', ''),
       ('FFTG', '파일전송', 'FTP', 'GET', 'I', 294, 'Y', ''),
       ('FFTP', '파일전송', 'FTP', 'PUT', 'O', 295, 'Y', ''),
       ('FFTL', '파일전송', 'FTP', 'CONNECT', 'O', 296, 'Y', ''),
       ('FZM-', '파일전송', 'Zmodem', '-', 'O', 297, 'Y', ''),
       ('FNVR', '파일전송', '네이버 MYBOX', '수신', 'I', 298, 'Y', ''),
       ('FNVS', '파일전송', '네이버 MYBOX', '발신', 'O', 299, 'Y', ''),
       ('FGGR', '파일전송', '구글 드라이브', '수신', 'I', 300, 'Y', ''),
       ('FGGS', '파일전송', '구글 드라이브', '발신', 'O', 301, 'Y', ''),
       ('FODR', '파일전송', 'OneDrive', '수신', 'I', 302, 'Y', ''),
       ('FODS', '파일전송', 'OneDrive', '발신', 'O', 303, 'Y', ''),
       ('FDBR', '파일전송', 'Dropbox', '수신', 'I', 304, 'Y', ''),
       ('FDBS', '파일전송', 'Dropbox', '발신', 'O', 305, 'Y', ''),
       ('F2NR', '파일전송', '2nd 드라이브', '수신', 'I', 306, 'N', ''),
       ('F2NS', '파일전송', '2nd 드라이브', '발신', 'O', 307, 'N', ''),
       ('FPSR', '파일전송', 'Polarisoffice ', '수신', 'I', 308, 'Y', ''),
       ('FPSS', '파일전송', 'Polarisoffice ', '발신', 'O', 309, 'Y', ''),
       ('FICR', '파일전송', 'Icloud', '수신', 'I', 310, 'Y', ''),
       ('FICS', '파일전송', 'Icloud', '발신', 'O', 311, 'Y', ''),
       ('FYDR', '파일전송', 'Yandex', '수신', 'I', 312, 'Y', ''),
       ('FYDS', '파일전송', 'Yandex', '발신', 'O', 313, 'Y', ''),
       ('FWHR', '파일전송', 'LG 웹하드', '수신', 'I', 314, 'Y', ''),
       ('FWHS', '파일전송', 'LG 웹하드', '발신', 'O', 315, 'Y', ''),
       ('FGIR', '파일전송', 'GitHub', '수신', 'I', 316, 'Y', ''),
       ('FGIS', '파일전송', 'GitHub', '발신', 'O', 317, 'Y', ''),
       ('FDOR', '파일전송', 'Dooray', '수신', 'I', 318, 'Y', ''),
       ('FDOS', '파일전송', 'Dooray', '발신', 'O', 319, 'Y', ''),
       ('FWES', '파일전송', 'Wetransfer', '발신', 'O', 320, 'Y', ''),
       ('FASS', '파일전송', 'AWS S3 bucket', '발신', 'O', 321, 'Y', ''),
       ('FGES', '파일전송', '구글 렌즈', '발신', 'O', 322, 'Y', ''),
       ('FTRS', '파일전송', 'File Transfer.io', '발신', 'O', 323, 'Y', ''),
       ('FCLS', '파일전송', 'pCloud Transfer', '발신', 'O', 324, 'Y', ''),
       ('FMZS', '파일전송', 'M/Z Cloud', '발신', 'O', 325, 'Y', ''),
       ('FMZR', '파일전송', 'M/Z Cloud', '수신', 'O', 326, 'Y', ''),
       ('FUKR', '파일전송', '기타', '수신', 'I', 327, 'Y', ''),
       ('FUKS', '파일전송', '기타', '발신', 'O', 328, 'Y', ''),
       ('NENR', '노트', 'EVERNOTE', '수신', 'I', 329, 'Y', ''),
       ('NENS', '노트', 'EVERNOTE', '발신', 'O', 330, 'Y', ''),
       ('NONR', '노트', 'ONENOTE', '수신', 'I', 331, 'Y', ''),
       ('NONS', '노트', 'ONENOTE', '발신', 'O', 332, 'Y', ''),
       ('NLVS', '노트', 'Outlook.com 메모', '발신', 'O', 333, 'Y', ''),
       ('NBTS', '노트', 'BIT.AI', '발신', 'O', 334, 'Y', ''),
       ('NNOS', '노트', 'Notion', '발신', 'O', 335, 'Y', ''),
       ('NGGS', '노트', '구글 docs', '발신', 'O', 336, 'Y', ''),
       ('NGTS', '노트', '구글 tasks', '발신', 'O', 337, 'Y', ''),
       ('NGKS', '노트', '구글 keep', '발신', 'O', 338, 'Y', ''),
       ('NSSR', '노트', '삼성 노트', '수신', 'I', 339, 'Y', ''),
       ('NSSS', '노트', '삼성 노트', '발신', 'O', 340, 'Y', ''),
       ('NNVS', '노트', '네이버 오피스', '발신', 'O', 341, 'Y', ''),
       ('NDBS', '노트', 'Dropbox paper', '발신', 'O', 342, 'Y', ''),
       ('NHCS', '노트', '한컴 오피스', '발신', 'O', 343, 'Y', ''),
       ('NMOS', '노트', 'MS오피스', '발신', 'O', 344, 'Y', ''),
       ('NCDS', '노트', 'Coda', '발신', 'O', 345, 'Y', ''),
       ('NNMR', '노트', '네이버 메모', '수신', 'I', 346, 'Y', ''),
       ('NNMS', '노트', '네이버 메모', '발신', 'O', 347, 'Y', ''),
       ('NCNS', '노트', 'Clova Note', '발신', 'O', 348, 'Y', ''),
       ('NGIS', '노트', 'Github Gist', '발신', 'O', 349, 'Y', ''),
       ('NSNS', '노트', 'SimpleNote', '발신', 'O', 350, 'Y', ''),
       ('NAGS', '노트', 'Agit', '발신', 'O', 351, 'Y', ''),
       ('NPSS', '노트', 'Polaris office', '발신', 'O', 352, 'Y', ''),
       ('NBOS', '노트', 'Box', '발신', 'O', 353, 'Y', ''),
       ('NCKS', '노트', 'ClickUp', '발신', 'O', 354, 'Y', ''),
       ('NGNS', '노트', 'Goodnotes', '발신', 'O', 355, 'Y', ''),
       ('NMNS', '노트', 'Milanote', '발신', 'O', 356, 'Y', ''),
       ('NZQS', '노트', 'zohocliq', '발신', 'O', 357, 'Y', ''),
       ('NMTS', '노트', 'Mentimeter', '발신', 'O', 358, 'Y', ''),
       ('NOOS', '노트', 'Goorm', '발신', 'O', 359, 'Y', ''),
       ('NMIS', '노트', '밀리의서재', '발신', 'O', 360, 'Y', ''),
       ('NUKS', '노트', '기타', '발신', 'O', 361, 'Y', ''),
       ('AGCR', '일정', '구글캘린더일정', '수신', 'I', 362, 'N', ''),
       ('AGCS', '일정', '구글캘린더일정', '발신', 'O', 363, 'Y', ''),
       ('AGLR', '일정', '구글캘린더메일', '수신', 'I', 364, 'N', ''),
       ('AGLS', '일정', '구글캘린더메일', '발신', 'O', 365, 'Y', ''),
       ('ANCS', '일정', '네이버 캘린더', '발신', 'O', 366, 'Y', ''),
       ('ZTN-', '기타 서비스', 'Telnet', '-', 'O', 367, 'Y', ''),
       ('ZXT-', '기타 서비스', 'Xterm', '-', 'O', 368, 'Y', ''),
       ('ZRL-', '기타 서비스', 'R-Login', '-', 'O', 369, 'Y', ''),
       ('ZNP-', '기타 서비스', 'NNTP', '-', 'O', 370, 'Y', ''),
       ('ZPC-', '기타 서비스', 'PC 보안', '-', 'O', 371, 'N', ''),
       ('ZSH-', '기타 서비스', 'SSH', 'SSH 세션 정보', 'O', 372, 'Y', ''),
       ('XX1R', '모니터링_제외', '미분류_타입1', '수신', 'I', 373, 'Y', ''),
       ('XX1S', '모니터링_제외', '미분류_타입1', '발신', 'O', 374, 'Y', ''),
       ('XX2R', '모니터링_제외', '미분류_타입2', '수신', 'I', 375, 'Y', ''),
       ('XX2S', '모니터링_제외', '미분류_타입2', '발신', 'O', 376, 'Y', ''),
       ('XX3R', '모니터링_제외', '미분류_타입3', '수신', 'I', 377, 'Y', ''),
       ('XX3S', '모니터링_제외', '미분류_타입3', '발신', 'O', 378, 'Y', ''),
       ('XU1R', '모니터링_제외', '웹서비스(미분류)_타입1', '수신', 'I', 379, 'Y', ''),
       ('XU1S', '모니터링_제외', '웹서비스(미분류)_타입1', '발신', 'O', 380, 'Y', ''),
       ('XU2R', '모니터링_제외', '웹서비스(미분류)_타입2', '수신', 'I', 381, 'Y', ''),
       ('XU2S', '모니터링_제외', '웹서비스(미분류)_타입2', '발신', 'O', 382, 'Y', ''),
       ('XU3R', '모니터링_제외', '웹서비스(미분류)_타입3', '수신', 'I', 383, 'Y', ''),
       ('XU3S', '모니터링_제외', '웹서비스(미분류)_타입3', '발신', 'O', 384, 'Y', ''),
       ('UWSD', '웹서비스(미분류)', '웹 발신', '첨부 - 문서타입', 'O', 385, 'Y', ''),
       ('UWSE', '웹서비스(미분류)', '웹 발신', '첨부 - 문서아님', 'O', 386, 'Y', ''),
       ('UWSU', '웹서비스(미분류)', '웹 발신', '첨부 없음', 'O', 387, 'Y', ''),
       ('UWSH', '웹서비스(미분류)', '웹 발신', '중요도(상)', 'O', 388, 'Y', ''),
       ('UWSM', '웹서비스(미분류)', '웹 발신', '중요도(중)', 'O', 389, 'Y', ''),
       ('UWSL', '웹서비스(미분류)', '웹 발신', '중요도(하)', 'O', 390, 'Y', ''),
       ('UX1R', '웹서비스(미분류)', '미분류_타입1', '수신', 'I', 391, 'Y', ''),
       ('UX1S', '웹서비스(미분류)', '미분류_타입1', '발신', 'O', 392, 'Y', ''),
       ('UX2R', '웹서비스(미분류)', '미분류_타입2', '수신', 'I', 393, 'Y', ''),
       ('UX2S', '웹서비스(미분류)', '미분류_타입2', '발신', 'O', 394, 'Y', ''),
       ('UX3R', '웹서비스(미분류)', '미분류_타입3', '수신', 'I', 395, 'Y', ''),
       ('UX3S', '웹서비스(미분류)', '미분류_타입3', '발신', 'O', 396, 'Y', ''),
       ('UWRD', '웹서비스(미분류)', '웹 수신', '첨부 - 문서타입', 'I', 397, 'Y', ''),
       ('UWRE', '웹서비스(미분류)', '웹 수신', '첨부 - 문서아님', 'I', 398, 'Y', ''),
       ('UWRU', '웹서비스(미분류)', '웹 수신', '첨부 없음', 'I', 399, 'Y', ''),
       ('BWSD', '웹서비스(업무)', '업무 발신', '첨부 - 문서타입', 'O', 400, 'Y', ''),
       ('BWSE', '웹서비스(업무)', '업무 발신', '첨부 - 문서아님', 'O', 401, 'Y', ''),
       ('BWSU', '웹서비스(업무)', '업무 발신', '첨부 없음', 'O', 402, 'Y', ''),
       ('BWRD', '웹서비스(업무)', '업무 수신', '첨부 - 문서타입', 'I', 403, 'Y', ''),
       ('BWRE', '웹서비스(업무)', '업무 수신', '첨부 - 문서아님', 'I', 404, 'Y', ''),
       ('BWRU', '웹서비스(업무)', '업무 수신', '첨부 없음', 'I', 405, 'Y', ''),
       ('TWEC', '화상회의', 'Webex', '채팅', 'O', 406, 'Y', 'MSG'),
       ('TWEF', '화상회의', 'Webex', '파일전송', 'O', 407, 'Y', 'MSG'),
       ('TWEJ', '화상회의', 'Webex', '참여', 'O', 408, 'Y', 'MSG'),
       ('TWEL', '화상회의', 'Webex', '떠남', 'O', 409, 'Y', 'MSG'),
       ('TZOC', '화상회의', 'Zoom', '채팅', 'O', 410, 'Y', 'MSG'),
       ('TZOF', '화상회의', 'Zoom', '파일전송', 'O', 411, 'Y', 'MSG'),
       ('TZOJ', '화상회의', 'Zoom', '참여', 'O', 412, 'Y', 'MSG'),
       ('TZOL', '화상회의', 'Zoom', '떠남', 'O', 413, 'Y', 'MSG'),
       ('TTMC', '화상회의', 'Teams', '채팅', 'O', 414, 'Y', 'MSG'),
       ('TTMF', '화상회의', 'Teams', '파일전송', 'O', 415, 'Y', 'MSG'),
       ('TTMJ', '화상회의', 'Teams', '참여', 'O', 416, 'Y', 'MSG'),
       ('TTML', '화상회의', 'Teams', '떠남', 'O', 417, 'Y', 'MSG'),
       ('TSKC', '화상회의', 'Skype', '채팅', 'O', 418, 'Y', 'MSG'),
       ('TSKF', '화상회의', 'Skype', '파일전송', 'O', 419, 'Y', 'MSG'),
       ('TSKJ', '화상회의', 'Skype', '참여', 'O', 420, 'Y', 'MSG'),
       ('TSKL', '화상회의', 'Skype', '떠남', 'O', 421, 'Y', 'MSG'),
       ('TJMC', '화상회의', 'JoinME', '채팅', 'O', 422, 'Y', 'MSG'),
       ('TJMF', '화상회의', 'JoinME', '파일전송', 'O', 423, 'Y', 'MSG'),
       ('TAMC', '화상회의', 'Amazon Chime', '채팅', 'O', 424, 'Y', 'MSG'),
       ('TAMF', '화상회의', 'Amazon Chime', '파일전송', 'O', 425, 'Y', 'MSG'),
       ('TBJC', '화상회의', 'BlueJeans', '채팅', 'O', 426, 'Y', 'MSG'),
       ('TTDS', '화상회의', 'Tl;dv', '채팅', 'O', 427, 'Y', 'MSG'),
       ('LNVS', '번역기', '파파고 번역', '발신', 'O', 428, 'Y', ''),
       ('LGGS', '번역기', '구글 번역', '발신', 'O', 429, 'Y', ''),
       ('LGPS', '번역기', '구글 번역 플러그인', '발신', 'O', 430, 'Y', ''),
       ('LDES', '번역기', 'Deepl', '발신', 'O', 431, 'Y', ''),
       ('LBIS', '번역기', 'Bing 번역', '발신', 'O', 432, 'Y', ''),
       ('LYMS', '번역기', 'Yandex 번역', '발신', 'O', 433, 'Y', ''),
       ('LGAS', '번역기', 'Google Cloud Translation Api', '발신', 'O', 434, 'Y', ''),
       ('LFTS', '번역기', 'Flitto', '발신', 'O', 435, 'Y', ''),
       ('LOTS', '번역기', 'O-Translator', '발신', 'O', 436, 'Y', ''),
       ('LUKS', '번역기', '기타', '발신', 'I', 437, 'Y', ''),
       ('IGBS', '생성형 AI', '구글 Gemini', '발신', 'O', 438, 'Y', ''),
       ('IBIS', '생성형 AI', ' Microsoft Copilot', '발신', 'O', 439, 'Y', ''),
       ('IWTS', '생성형 AI', 'Wrtn', '발신', 'O', 440, 'Y', ''),
       ('IGPS', '생성형 AI', 'ChatGPT', '발신', 'O', 441, 'Y', ''),
       ('IDAS', '생성형 AI', 'Dall-E', '발신', 'O', 442, 'Y', ''),
       ('IGCS', '생성형 AI', 'Github Copilot', '발신', 'I', 443, 'Y', ''),
       ('IYCS', '생성형 AI', 'YouChat', '발신', 'I', 444, 'Y', ''),
       ('ICSS', '생성형 AI', 'Chatsonic', '발신', 'I', 445, 'Y', ''),
       ('IRPS', '생성형 AI', 'Replika', '발신', 'I', 446, 'Y', ''),
       ('IPPS', '생성형 AI', 'Perplexity', '발신', 'I', 447, 'Y', ''),
       ('ITCS', '생성형 AI', 'TextCortex', '발신', 'I', 448, 'Y', ''),
       ('IPHS', '생성형 AI', 'Phind', '발신', 'I', 449, 'Y', ''),
       ('IPOS', '생성형 AI', 'Poe', '발신', 'I', 450, 'Y', ''),
       ('IHFS', '생성형 AI', 'Hugging Face', '발신', 'I', 451, 'Y', ''),
       ('ICPS', '생성형 AI', 'Copy.AI', '발신', 'I', 452, 'Y', ''),
       ('IHWS', '생성형 AI', 'HyperWrite', '발신', 'I', 453, 'Y', ''),
       ('IDPS', '생성형 AI', 'DeepAI', '발신', 'I', 454, 'Y', ''),
       ('IACS', '생성형 AI', 'AskCodi', '발신', 'I', 455, 'Y', ''),
       ('INAS', '생성형 AI', 'Native', '발신', 'I', 456, 'Y', ''),
       ('INFS', '생성형 AI', 'NeuroFlash', '발신', 'I', 457, 'Y', ''),
       ('INOS', '생성형 AI', 'Notion AI', '발신', 'I', 458, 'Y', ''),
       ('IMES', '생성형 AI', 'Merlin', '발신', 'I', 459, 'Y', ''),
       ('ICXS', '생성형 AI', 'CLOVA-X', '발신', 'I', 460, 'Y', ''),
       ('IADS', '생성형 AI', 'Adobe AI', '발신', 'I', 461, 'Y', ''),
       ('ICDS', '생성형 AI', 'ClipDrop', '발신', 'I', 462, 'Y', ''),
       ('ISBS', '생성형 AI', 'Stability.Ai', '발신', 'I', 463, 'Y', ''),
       ('IRMS', '생성형 AI', 'Runwayml', '발신', 'I', 464, 'Y', ''),
       ('IGVS', '생성형 AI', 'Google Vertex', '발신', 'I', 465, 'Y', ''),
       ('IGLS', '생성형 AI', 'Google Colab', '발신', 'I', 466, 'Y', ''),
       ('ICWS', '생성형 AI', 'CodeWhisperer', '발신', 'I', 467, 'Y', ''),
       ('IMSS', '생성형 AI', 'Google AI Studio', '발신', 'I', 468, 'Y', ''),
       ('IOCS', '생성형 AI', 'Clova OCR', '발신', 'I', 469, 'Y', ''),
       ('IAOS', '생성형 AI', 'Azure OpenAI', '발신', 'I', 470, 'Y', ''),
       ('ICUS', '생성형 AI', '네이버 CUE:', '발신', 'I', 471, 'Y', ''),
       ('IMJS', '생성형 AI', 'Midjourney', '발신', 'I', 472, 'Y', ''),
       ('ISGR', '생성형 AI', 'slidesGPT', '수신', 'I', 473, 'Y', ''),
       ('ISGS', '생성형 AI', 'SlidesGPT', '발신', 'I', 474, 'Y', ''),
       ('IDMS', '생성형 AI', 'Ai Docmaker', '발신', 'I', 475, 'Y', ''),
       ('IRKS', '생성형 AI', 'Reka AI', '발신', 'I', 476, 'Y', ''),
       ('ICLS', '생성형 AI', 'Claude', '발신', 'I', 477, 'Y', ''),
       ('IDMR', '생성형 AI', 'AI Docmaker Attach', '수신', 'I', 478, 'Y', ''),
       ('IADR', '생성형 AI', 'Adobe firefly login', '수신', 'I', 479, 'Y', ''),
       ('IWDS', '생성형 AI', 'Dream by WOMBO', '발신', 'I', 480, 'Y', ''),
       ('IGAS', '생성형 AI', 'GetImg.AI', '발신', 'I', 481, 'Y', ''),
       ('IWKS', '생성형 AI', 'Wrks.ai', '발신', 'I', 482, 'Y', ''),
       ('IPSS', '생성형 AI', 'Polaris office ai', '발신', 'I', 483, 'Y', ''),
       ('IBGS', '생성형 AI', 'Goover AI', '발신', 'I', 484, 'Y', ''),
       ('IIAS', '생성형 AI', 'iAsk AI', '발신', 'I', 485, 'Y', ''),
       ('ISNS', '생성형 AI', 'Suno AI', '발신', 'I', 486, 'Y', ''),
       ('IPES', '생성형 AI', 'Perchance', '발신', 'I', 487, 'Y', ''),
       ('IPFS', '생성형 AI', 'ChatPDF', '발신', 'I', 488, 'Y', ''),
       ('IXOS', '생성형 AI', 'Exaone', '발신', 'I', 489, 'Y', ''),
       ('ISOR', '생성형 AI', 'Slidesgo', '수신', 'I', 490, 'Y', ''),
       ('ISOS', '생성형 AI', 'Slidesgo', '발신', 'I', 491, 'Y', ''),
       ('IKRS', '생성형 AI', 'KREA', '발신', 'I', 492, 'Y', ''),
       ('ILMS', '생성형 AI', 'GoogleNotebook LM', '발신', 'I', 493, 'Y', ''),
       ('ICCS', '생성형 AI', 'Capcut', '발신', 'I', 494, 'Y', ''),
       ('IMGS', '생성형 AI', 'Magictool', '발신', 'I', 495, 'Y', ''),
       ('IGSS', '생성형 AI', 'Genspark', '발신', 'I', 496, 'Y', ''),
       ('IFES', '생성형 AI', 'felo', '발신', 'I', 497, 'Y', ''),
       ('ITPS', '생성형 AI', 'Tripo3D', '발신', 'I', 498, 'Y', ''),
       ('ITPR', '생성형 AI', 'Tripo3D', '수신', 'I', 499, 'Y', ''),
       ('IELS', '생성형 AI', 'Elevenlabs', '발신', 'I', 500, 'Y', ''),
       ('IELR', '생성형 AI', 'Elevenlabs', '수신', 'I', 501, 'Y', ''),
       ('IGRS', '생성형 AI', 'Grammarly', '발신', 'I', 502, 'Y', ''),
       ('IVRS', '생성형 AI', 'Vrew', '발신', 'I', 503, 'Y', ''),
       ('INIS', '생성형 AI', 'NightCafe', '발신', 'I', 504, 'Y', ''),
       ('ICAS', '생성형 AI', 'CivitAI', '발신', 'I', 505, 'Y', ''),
       ('ILIS', '생성형 AI', 'Liner', '발신', 'I', 506, 'Y', ''),
       ('IBCS', '생성형 AI', 'Bing Image Creator', '발신', 'I', 507, 'Y', ''),
       ('IDSS', '생성형 AI', 'Deepseek', '발신', 'I', 508, 'Y', ''),
       ('IBDS', '생성형 AI', 'Baidu Ai', '발신', 'I', 509, 'Y', ''),
       ('IGIS', '생성형 AI', 'Gemini AI api', '발신', 'I', 510, 'Y', ''),
       ('IDTS', '생성형 AI', '에이닷', '발신', 'I', 511, 'Y', ''),
       ('IQBS', '생성형 AI', 'QuillBot', '발신', 'I', 512, 'Y', ''),
       ('ICHC', '생성형 AI', 'Character.ai', '발신', 'I', 513, 'Y', ''),
       ('ISRS', '생성형 AI', 'Sora/Openai', '발신', 'I', 514, 'Y', ''),
       ('INNS', '생성형 AI', 'Nano AI', '발신', 'I', 515, 'Y', ''),
       ('IDBS', '생성형 AI', 'Doubao', '발신', 'I', 516, 'Y', ''),
       ('ITYS', '생성형 AI', 'Tongyi', '발신', 'I', 517, 'Y', ''),
       ('IYBS', '생성형 AI', 'Yuanbao', '발신', 'I', 518, 'Y', ''),
       ('IYYS', '생성형 AI', 'Yiyan', '발신', 'I', 519, 'Y', ''),
       ('IKMS', '생성형 AI', 'Kimi', '발신', 'I', 520, 'Y', ''),
       ('IBAS', '생성형 AI', 'Baichuan', '발신', 'I', 521, 'Y', ''),
       ('ITGS', '생성형 AI', 'Tiangong', '발신', 'I', 522, 'Y', ''),
       ('ISDS', '생성형 AI', 'Stable Diffusion', '발신', 'I', 523, 'Y', ''),
       ('IGOS', '생성형 AI', 'Grok', '발신', 'I', 524, 'Y', ''),
       ('ICGS', '생성형 AI', 'ChatGLM', '발신', 'I', 525, 'Y', ''),
       ('INKS', '생성형 AI', 'Napkin AI', '발신', 'I', 526, 'Y', ''),
       ('IBIR', '생성형 AI', 'Microsoft Copilot(Chat)', '수신', 'I', 527, 'Y', ''),
       ('IOOS', '생성형 AI', 'AI Goormee', '발신', 'I', 528, 'Y', ''),
       ('IABS', '생성형 AI', 'Allibee', '발신', 'I', 529, 'Y', ''),
       ('ILXS', '생성형 AI', 'Lexis+', '발신', 'I', 530, 'Y', ''),
       ('ILAS', '생성형 AI', 'SuperLawyer', '발신', 'I', 531, 'Y', ''),
       ('ICOS', '생성형 AI', 'CoCounsel', '발신', 'I', 532, 'Y', ''),
       ('IANS', '생성형 AI', 'Anthropic', '발신', 'I', 533, 'Y', ''),
       ('ISIS', '생성형 AI', 'Sider AI', '발신', 'I', 534, 'Y', ''),
       ('IGMS', '생성형 AI', 'Gamma', '발신', 'I', 535, 'Y', ''),
       ('IGMR', '생성형 AI', 'Gamma', '수신', 'I', 536, 'Y', ''),
       ('ICRS', '생성형 AI', 'Cursor', '발신', 'I', 537, 'Y', ''),
       ('IMAS', '생성형 AI', 'ManusAI', '발신', 'I', 538, 'Y', ''),
       ('IMTS', '생성형 AI', 'Mistral AI', '발신', 'I', 539, 'Y', ''),
       ('ICBS', '생성형 AI', 'Cline', '발신', 'I', 540, 'Y', ''),
       ('IWBS', '생성형 AI', 'Weight & Biases', '발신', 'I', 541, 'Y', ''),
       ('IWBR', '생성형 AI', 'Weight & Biases', '수신', 'I', 542, 'Y', ''),
       ('ILLS', '생성형 AI', 'Lilys AI', '발신', 'I', 543, 'Y', ''),
       ('IUKS', '생성형 AI', '기타', '발신', 'I', 544, 'Y', ''),
       ('PDOS', '프로젝트', 'dooray', '발신', 'O', 545, 'Y', ''),
       ('PGIS', '프로젝트', 'github', '발신', 'O', 546, 'Y', ''),
       ('PGLS', '프로젝트', 'Glassdoor', '발신', 'O', 547, 'Y', ''),
       ('PJDS', '프로젝트', '잔디', '발신', 'O', 548, 'Y', ''),
       ('PITS', '프로젝트', 'Google Issue Tracker', '발신', 'O', 549, 'Y', ''),
       ('EBDR', '그룹웨어', '게시', '수신', 'I', 550, 'Y', ''),
       ('EBD-', '그룹웨어', '게시', '발신', 'O', 551, 'Y', ''),
       ('EBBR', '그룹웨어', '게시판', '수신', 'I', 552, 'Y', ''),
       ('EBBS', '그룹웨어', '게시판', '발신', 'O', 553, 'Y', ''),
       ('EBBF', '그룹웨어', '게시판', '파일수신', 'I', 554, 'Y', ''),
       ('EAAR', '그룹웨어', '결재', '수신', 'I', 555, 'Y', ''),
       ('EAAS', '그룹웨어', '결재', '발신', 'O', 556, 'Y', ''),
       ('EAAG', '그룹웨어', '결재', '통보 - 수신', 'I', 557, 'Y', ''),
       ('EAAP', '그룹웨어', '결재', '통보 - 발신', 'O', 558, 'Y', ''),
       ('EAAF', '그룹웨어', '결재', '파일수신', 'I', 559, 'Y', ''),
       ('EMMR', '그룹웨어', '메일', '그룹웨어 수신', 'I', 560, 'Y', ''),
       ('EMMS', '그룹웨어', '메일', '그룹웨어 발신', 'O', 561, 'Y', ''),
       ('EMMG', '그룹웨어', '메일', 'OWA 수신', 'I', 562, 'Y', ''),
       ('EMMP', '그룹웨어', '메일', 'OWA 발신', 'O', 563, 'Y', ''),
       ('EMMD', '그룹웨어', '메일', 'RPC 수신', 'I', 564, 'Y', ''),
       ('EMMU', '그룹웨어', '메일', 'RPC 발신', 'O', 565, 'Y', ''),
       ('EMMC', '그룹웨어', '메일', '수신', 'I', 566, 'Y', ''),
       ('EMML', '그룹웨어', '메일', '발신', 'O', 567, 'Y', ''),
       ('EMM1', '그룹웨어', '메일', '보안등급1', 'O', 568, 'Y', ''),
       ('EMM2', '그룹웨어', '메일', '보안등급2', 'O', 569, 'Y', ''),
       ('EMM3', '그룹웨어', '메일', '보안등급3', 'O', 570, 'Y', ''),
       ('EMM4', '그룹웨어', '메일', '보안등급4', 'O', 571, 'Y', ''),
       ('EMMA', '그룹웨어', '메일', '임시(자동)', 'O', 572, 'Y', ''),
       ('EMMT', '그룹웨어', '메일', '임시(수동)', 'O', 573, 'Y', ''),
       ('EMMK', '그룹웨어', '메일', 'Outlook - 수신', 'I', 574, 'Y', ''),
       ('EMMO', '그룹웨어', '메일', 'Outlook - 발신', 'O', 575, 'Y', ''),
       ('EMMB', '그룹웨어', '메일', '그룹웨어 예약메일', 'O', 576, 'Y', ''),
       ('EMBR', '그룹웨어', '모바일', '수신', 'I', 577, 'Y', ''),
       ('EMB-', '그룹웨어', '모바일', '발신', 'O', 578, 'Y', ''),
       ('EWSR', '그룹웨어', '웹서비스', '수신', 'I', 579, 'Y', ''),
       ('EWS-', '그룹웨어', '웹서비스', '발신', 'O', 580, 'Y', ''),
       ('EPUR', '그룹웨어', '일반', '수신', 'I', 581, 'Y', ''),
       ('EPU-', '그룹웨어', '일반', '발신', 'O', 582, 'Y', ''),
       ('EAU-', '그룹웨어', '일반(자동전달)', '자동전달', 'O', 583, 'Y', ''),
       ('ESCR', '그룹웨어', '일정 명함', '수신', 'I', 584, 'Y', ''),
       ('ESC-', '그룹웨어', '일정 명함', '발신', 'O', 585, 'Y', ''),
       ('EMF-', '그룹웨어', '파일 다운로드', '-', 'I', 586, 'Y', ''),
       ('EMU-', '그룹웨어', '기타', '', 'O', 587, 'Y', ''),
       ('EMDR', '그룹웨어', '드라이브', '수신', 'I', 588, 'Y', ''),
       ('EMDS', '그룹웨어', '드라이브', '발신', 'O', 589, 'Y', ''),
       ('ECIS', '그룹웨어', 'Samsung cic', '발신', 'O', 590, 'Y', ''),
       ('EMER', '그룹웨어', '메신저', '수신', 'O', 591, 'Y', ''),
       ('EMES', '그룹웨어', '메신저', '발신', 'O', 592, 'Y', ''),
       ('EZQC', '그룹웨어', 'Zohocliq', '채팅', 'O', 593, 'Y', ''),
       ('EZQS', '그룹웨어', 'Zohocliq', '캘린더', 'O', 594, 'Y', ''),
       ('EKWS', '그룹웨어', '카카오워크', '발신', 'O', 595, 'Y', ''),
       ('DCCS', '편집기', 'Clip Champ', '발신', 'O', 596, 'Y', ''),
       ('DFGS', '편집기', 'Figma', '발신', 'O', 597, 'Y', ''),
       ('DOVS', '편집기', 'Overleaf', '발신', 'O', 598, 'Y', ''),
       ('DOVR', '편집기', 'Overleaf', '수신', 'O', 599, 'Y', ''),
       ('DPKS', '편집기', 'Plunker', '발신', 'O', 600, 'Y', ''),
       ('DNWS', '편집기', 'Namu.wiki', '발신', 'O', 601, 'Y', ''),
       ('DWKS', '편집기', 'WikiPedia', '발신', 'O', 602, 'Y', ''),
       ('DAES', '편집기', 'Adobe Express', '발신', 'O', 603, 'Y', ''),
       ('DSMS', '편집기', 'Sketchmon', '발신', 'O', 604, 'Y', ''),
       ('DGSS', '편집기', 'Google Site', '발신', 'O', 605, 'Y', ''),
       ('JBDS', '웹사이트', 'Baidu', '발신', 'O', 606, 'Y', ''),
       ('JANS', '웹사이트', 'Anthropic', '발신', 'O', 607, 'Y', ''),
       ('RGUS', '원격접속', '아파치 과카몰리', '발신', 'O', 608, 'Y', '');
...
INSERT IGNORE INTO UI_REGEXP (CODE, NAME, REGEX) VALUES('LAOP', '대용량의 동일종류 첨부파일 하루 3회이상 외부전송', NULL);
INSERT IGNORE INTO UI_REGEXP (CODE, NAME, REGEX) VALUES('FCA', '타국에서 접속', NULL);
INSERT IGNORE INTO UI_REGEXP (CODE, NAME, REGEX) VALUES('AOH', '평균 접속 시간대 외의 접속', NULL);
INSERT IGNORE INTO UI_REGEXP (CODE, NAME, REGEX) VALUES('STG', '스테가노 그래피', NULL);
