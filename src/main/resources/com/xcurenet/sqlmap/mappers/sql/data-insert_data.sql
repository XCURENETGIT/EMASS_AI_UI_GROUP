...
('NPPS', '노트', 'polarisoffice', '발신', 'O', 345, 'Y', ''),
('NENR', '노트', 'EVERNOTE', '수신', 'I', 346, 'Y', ''),
('NENS', '노트', 'EVERNOTE', '발신', 'O', 347, 'Y', ''),
('NONR', '노트', 'ONENOTE', '수신', 'I', 348, 'Y', ''),
('NONS', '노트', 'ONENOTE', '발신', 'O', 349, 'Y', ''),
('NLVS', '노트', 'Outlook.com 메모', '발신', 'O', 350, 'Y', ''),
('NBTS', '노트', 'BIT.AI', '발신', 'O', 351, 'Y', ''),
('NNOS', '노트', 'Notion', '발신', 'O', 352, 'Y', ''),
('NGGS', '노트', '구글 docs', '발신', 'O', 353, 'Y', ''),
('NGTS', '노트', '구글 tasks', '발신', 'O', 354, 'Y', ''),
('NGKS', '노트', '구글 keep', '발신', 'O', 355, 'Y', ''),
('NSSR', '노트', '삼성 노트', '수신', 'I', 356, 'Y', ''),
('NSSS', '노트', '삼성 노트', '발신', 'O', 357, 'Y', ''),
('NNVS', '노트', '네이버 오피스', '발신', 'O', 358, 'Y', ''),
('NDBS', '노트', 'Dropbox paper', '발신', 'O', 359, 'Y', ''),
('NHCS', '노트', '한컴 오피스', '발신', 'O', 360, 'Y', ''),
('NMOS', '노트', 'MS오피스', '발신', 'O', 361, 'Y', ''),
('NCDS', '노트', 'Coda', '발신', 'O', 362, 'Y', ''),
('NNMR', '노트', '네이버 메모', '수신', 'I', 363, 'Y', ''),
('NNMS', '노트', '네이버 메모', '발신', 'O', 364, 'Y', ''),
('NCNS', '노트', 'Clova Note', '발신', 'O', 365, 'Y', ''),
('NGIS', '노트', 'Github Gist', '발신', 'O', 366, 'Y', ''),
('NSNS', '노트', 'SimpleNote', '발신', 'O', 367, 'Y', ''),
('NAGS', '노트', 'Agit', '발신', 'O', 368, 'Y', ''),
('NPSS', '노트', 'Polaris office', '발신', 'O', 369, 'Y', ''),
('NBOS', '노트', 'Box', '발신', 'O', 370, 'Y', ''),
('NCKS', '노트', 'ClickUp', '발신', 'O', 371, 'Y', ''),
('NGNS', '노트', 'Goodnotes', '발신', 'O', 372, 'Y', ''),
('NMNS', '노트', 'Milanote', '발신', 'O', 373, 'Y', ''),
('NZQS', '노트', 'zohocliq', '발신', 'O', 374, 'Y', ''),
('NMTS', '노트', 'Mentimeter', '발신', 'O', 375, 'Y', ''),
('NOOS', '노트', 'Goorm', '발신', 'O', 376, 'Y', ''),
('NMIS', '노트', '밀리의서재', '발신', 'O', 377, 'Y', ''),
('NUKS', '노트', '기타', '발신', 'O', 378, 'Y', ''),
('NCRS', '노트', 'Craft', '발신', 'O', 379, 'Y', ''),
('AGCR', '일정', '구글캘린더일정', '수신', 'I', 380, 'N', ''),
('AGCS', '일정', '구글캘린더일정', '발신', 'O', 381, 'Y', ''),
('AGLR', '일정', '구글캘린더메일', '수신', 'I', 382, 'N', ''),
('AGLS', '일정', '구글캘린더메일', '발신', 'O', 383, 'Y', ''),
('ANCS', '일정', '네이버 캘린더', '발신', 'O', 384, 'Y', ''),
('ZTN-', '기타 서비스', 'Telnet', '-', 'O', 385, 'Y', ''),
('ZXT-', '기타 서비스', 'Xterm', '-', 'O', 386, 'Y', ''),
('ZRL-', '기타 서비스', 'R-Login', '-', 'O', 387, 'Y', ''),
('ZNP-', '기타 서비스', 'NNTP', '-', 'O', 388, 'Y', ''),
('ZPC-', '기타 서비스', 'PC 보안', '-', 'O', 389, 'N', ''),
('ZSH-', '기타 서비스', 'SSH', 'SSH 세션 정보', 'O', 390, 'Y', ''),
('XX1R', '모니터링_제외', '미분류_타입1', '수신', 'I', 391, 'Y', ''),
('XX1S', '모니터링_제외', '미분류_타입1', '발신', 'O', 392, 'Y', ''),
('XX2R', '모니터링_제외', '미분류_타입2', '수신', 'I', 393, 'Y', ''),
('XX2S', '모니터링_제외', '미분류_타입2', '발신', 'O', 394, 'Y', ''),
('XX3R', '모니터링_제외', '미분류_타입3', '수신', 'I', 395, 'Y', ''),
('XX3S', '모니터링_제외', '미분류_타입3', '발신', 'O', 396, 'Y', ''),
('XU1R', '모니터링_제외', '웹서비스(미분류)_타입1', '수신', 'I', 397, 'Y', ''),
('XU1S', '모니터링_제외', '웹서비스(미분류)_타입1', '발신', 'O', 398, 'Y', ''),
('XU2R', '모니터링_제외', '웹서비스(미분류)_타입2', '수신', 'I', 399, 'Y', ''),
('XU2S', '모니터링_제외', '웹서비스(미분류)_타입2', '발신', 'O', 400, 'Y', ''),
('XU3R', '모니터링_제외', '웹서비스(미분류)_타입3', '수신', 'I', 401, 'Y', ''),
('XU3S', '모니터링_제외', '웹서비스(미분류)_타입3', '발신', 'O', 402, 'Y', ''),
('XU4R', '모니터링_제외', '필수 로깅', '수신', 'I', 403, 'Y', ''),
('XU4S', '모니터링_제외', '필수 로깅', '발신', 'O', 404, 'Y', ''),
('UWSD', '웹서비스(미분류)', '웹 발신', '첨부 - 문서타입', 'O', 405, 'Y', ''),
('UWSE', '웹서비스(미분류)', '웹 발신', '첨부 - 문서아님', 'O', 406, 'Y', ''),
('UWSU', '웹서비스(미분류)', '웹 발신', '첨부 없음', 'O', 407, 'Y', ''),
('UWSH', '웹서비스(미분류)', '웹 발신', '중요도(상)', 'O', 408, 'Y', ''),
('UWSM', '웹서비스(미분류)', '웹 발신', '중요도(중)', 'O', 409, 'Y', ''),
('UWSL', '웹서비스(미분류)', '웹 발신', '중요도(하)', 'O', 410, 'Y', ''),
('UX1R', '웹서비스(미분류)', '미분류_타입1', '수신', 'I', 411, 'Y', ''),
('UX1S', '웹서비스(미분류)', '미분류_타입1', '발신', 'O', 412, 'Y', ''),
('UX2R', '웹서비스(미분류)', '미분류_타입2', '수신', 'I', 413, 'Y', ''),
('UX2S', '웹서비스(미분류)', '미분류_타입2', '발신', 'O', 414, 'Y', ''),
('UX3R', '웹서비스(미분류)', '미분류_타입3', '수신', 'I', 415, 'Y', ''),
('UX3S', '웹서비스(미분류)', '미분류_타입3', '발신', 'O', 416, 'Y', ''),
('UWRD', '웹서비스(미분류)', '웹 수신', '첨부 - 문서타입', 'I', 417, 'Y', ''),
('UWRE', '웹서비스(미분류)', '웹 수신', '첨부 - 문서아님', 'I', 418, 'Y', ''),
('UWRU', '웹서비스(미분류)', '웹 수신', '첨부 없음', 'I', 419, 'Y', ''),
('BWSD', '웹서비스(업무)', '업무 발신', '첨부 - 문서타입', 'O', 420, 'Y', ''),
('BWSE', '웹서비스(업무)', '업무 발신', '첨부 - 문서아님', 'O', 421, 'Y', ''),
('BWSU', '웹서비스(업무)', '업무 발신', '첨부 없음', 'O', 422, 'Y', ''),
('BWRD', '웹서비스(업무)', '업무 수신', '첨부 - 문서타입', 'I', 423, 'Y', ''),
('BWRE', '웹서비스(업무)', '업무 수신', '첨부 - 문서아님', 'I', 424, 'Y', ''),
('BWRU', '웹서비스(업무)', '업무 수신', '첨부 없음', 'I', 425, 'Y', ''),
('TWEC', '화상회의', 'Webex', '채팅', 'O', 426, 'Y', 'MSG'),
('TWEF', '화상회의', 'Webex', '파일전송', 'O', 427, 'Y', 'MSG'),
('TWEJ', '화상회의', 'Webex', '참여', 'O', 428, 'Y', 'MSG'),
('TWEL', '화상회의', 'Webex', '떠남', 'O', 429, 'Y', 'MSG'),
('TZOC', '화상회의', 'Zoom', '채팅', 'O', 430, 'Y', 'MSG'),
('TZOF', '화상회의', 'Zoom', '파일전송', 'O', 431, 'Y', 'MSG'),
('TZOJ', '화상회의', 'Zoom', '참여', 'O', 432, 'Y', 'MSG'),
('TZOL', '화상회의', 'Zoom', '떠남', 'O', 433, 'Y', 'MSG'),
('TTMC', '화상회의', 'Teams', '채팅', 'O', 434, 'Y', 'MSG'),
('TTMF', '화상회의', 'Teams', '파일전송', 'O', 435, 'Y', 'MSG'),
('TTMJ', '화상회의', 'Teams', '참여', 'O', 436, 'Y', 'MSG'),
('TTML', '화상회의', 'Teams', '떠남', 'O', 437, 'Y', 'MSG'),
('TSKC', '화상회의', 'Skype', '채팅', 'O', 438, 'Y', 'MSG'),
('TSKF', '화상회의', 'Skype', '파일전송', 'O', 439, 'Y', 'MSG'),
('TSKJ', '화상회의', 'Skype', '참여', 'O', 440, 'Y', 'MSG'),
('TSKL', '화상회의', 'Skype', '떠남', 'O', 441, 'Y', 'MSG'),
('TJMC', '화상회의', 'JoinME', '채팅', 'O', 442, 'Y', 'MSG'),
('TJMF', '화상회의', 'JoinME', '파일전송', 'O', 443, 'Y', 'MSG'),
('TAMC', '화상회의', 'Amazon Chime', '채팅', 'O', 444, 'Y', 'MSG'),
('TAMF', '화상회의', 'Amazon Chime', '파일전송', 'O', 445, 'Y', 'MSG'),
('TBJC', '화상회의', 'BlueJeans', '채팅', 'O', 446, 'Y', 'MSG'),
('TTDS', '화상회의', 'Tl;dv', '채팅', 'O', 447, 'Y', 'MSG'),
('LNVS', '번역기', '파파고 번역', '발신', 'O', 448, 'Y', ''),
('LGGS', '번역기', '구글 번역', '발신', 'O', 449, 'Y', ''),
('LGPS', '번역기', '구글 번역 플러그인', '발신', 'O', 450, 'Y', ''),
('LDES', '번역기', 'Deepl', '발신', 'O', 451, 'Y', ''),
('LBIS', '번역기', 'Bing 번역', '발신', 'O', 452, 'Y', ''),
('LYMS', '번역기', 'Yandex 번역', '발신', 'O', 453, 'Y', ''),
('LGAS', '번역기', 'Google Cloud Translation Api', '발신', 'O', 454, 'Y', ''),
('LFTS', '번역기', 'Flitto', '발신', 'O', 455, 'Y', ''),
('LOTS', '번역기', 'O-Translator', '발신', 'O', 456, 'Y', ''),
('LUKS', '번역기', '기타', '발신', 'O', 457, 'Y', ''),
('LTRS', '번역기', 'Translate', '발신', 'O', 458, 'Y', ''),
('LODS', '번역기', 'onlinedoctranslator', '발신', 'O', 459, 'Y', ''),
('IGBS', '생성형 AI', '구글 Gemini', '발신', 'O', 460, 'Y', ''),
('IGBR', '생성형 AI', '구글 Gemini', '수신', 'I', 461, 'Y', ''),
('IBIS', '생성형 AI', ' Microsoft Copilot', '발신', 'O', 462, 'Y', ''),
('IWTS', '생성형 AI', 'Wrtn', '발신', 'O', 463, 'Y', ''),
('IGPS', '생성형 AI', 'ChatGPT', '발신', 'O', 464, 'Y', ''),
('IGPR', '생성형 AI', 'ChatGPT', '수신', 'I', 465, 'Y', ''),
('IDAS', '생성형 AI', 'Dall-E', '발신', 'O', 466, 'Y', ''),
('IGCS', '생성형 AI', 'Github Copilot', '발신', 'O', 467, 'Y', ''),
('IGCR', '생성형 AI', 'Github Copilot', '수신', 'I', 468, 'Y', ''),
('IYCS', '생성형 AI', 'YouChat', '발신', 'O', 469, 'Y', ''),
('ICSS', '생성형 AI', 'Chatsonic', '발신', 'O', 470, 'Y', ''),
('IRPS', '생성형 AI', 'Replika', '발신', 'O', 471, 'Y', ''),
('IPPS', '생성형 AI', 'Perplexity', '발신', 'O', 472, 'Y', ''),
('IPPR', '생성형 AI', 'Perplexity', '수신', 'I', 473, 'Y', ''),
('ITCS', '생성형 AI', 'TextCortex', '발신', 'O', 474, 'Y', ''),
('IPHS', '생성형 AI', 'Phind', '발신', 'O', 475, 'Y', ''),
('IPOS', '생성형 AI', 'Poe', '발신', 'O', 476, 'Y', ''),
('IHFS', '생성형 AI', 'Hugging Face', '발신', 'O', 477, 'Y', ''),
('IHFR', '생성형 AI', 'Hugging Face', '수신', 'I', 478, 'Y', ''),
('ICPS', '생성형 AI', 'Copy.AI', '발신', 'O', 479, 'Y', ''),
('IHWS', '생성형 AI', 'HyperWrite', '발신', 'O', 480, 'Y', ''),
('IDPS', '생성형 AI', 'DeepAI', '발신', 'O', 481, 'Y', ''),
('IACS', '생성형 AI', 'AskCodi', '발신', 'O', 482, 'Y', ''),
('IACR', '생성형 AI', 'AskCodi', '수신', 'I', 483, 'Y', ''),
('INAS', '생성형 AI', 'Native', '발신', 'O', 484, 'Y', ''),
('INFS', '생성형 AI', 'NeuroFlash', '발신', 'O', 485, 'Y', ''),
('INOS', '생성형 AI', 'Notion AI', '발신', 'O', 486, 'Y', ''),
('INOR', '생성형 AI', 'Notion AI', '수신', 'I', 487, 'Y', ''),
('IMES', '생성형 AI', 'Merlin', '발신', 'O', 488, 'Y', ''),
('IMER', '생성형 AI', 'Merlin', '수신', 'O', 489, 'Y', ''),
('ICXS', '생성형 AI', 'CLOVA-X', '발신', 'O', 490, 'Y', ''),
('IADS', '생성형 AI', 'Adobe AI', '발신', 'O', 491, 'Y', ''),
('ICDS', '생성형 AI', 'ClipDrop', '발신', 'O', 492, 'Y', ''),
('ISBS', '생성형 AI', 'Stability.Ai', '발신', 'O', 493, 'Y', ''),
('IRMS', '생성형 AI', 'Runwayml', '발신', 'O', 494, 'Y', ''),
('IGVS', '생성형 AI', 'Google Vertex', '발신', 'O', 495, 'Y', ''),
('IGVR', '생성형 AI', 'Google Vertex', '수신', 'I', 496, 'Y', ''),
('IGLS', '생성형 AI', 'Google Colab', '발신', 'O', 497, 'Y', ''),
('ICWS', '생성형 AI', 'CodeWhisperer', '발신', 'O', 498, 'Y', ''),
('IMSS', '생성형 AI', 'Google AI Studio', '발신', 'O', 499, 'Y', ''),
('IOCS', '생성형 AI', 'Clova OCR', '발신', 'O', 500, 'Y', ''),
('IAOS', '생성형 AI', 'Azure OpenAI', '발신', 'O', 501, 'Y', ''),
('IAOR', '생성형 AI', 'Azure OpenAI', '수신', 'I', 502, 'Y', ''),
('ICUS', '생성형 AI', '네이버 CUE:', '발신', 'O', 503, 'Y', ''),
('IMJS', '생성형 AI', 'Midjourney', '발신', 'O', 504, 'Y', ''),
('ISGR', '생성형 AI', 'slidesGPT', '수신', 'I', 505, 'Y', ''),
('ISGS', '생성형 AI', 'SlidesGPT', '발신', 'O', 506, 'Y', ''),
('IDMS', '생성형 AI', 'Ai Docmaker', '발신', 'O', 507, 'Y', ''),
('IRKS', '생성형 AI', 'Reka AI', '발신', 'O', 508, 'Y', ''),
('IRKR', '생성형 AI', 'Reka AI', '수신', 'O', 509, 'Y', ''),
('ICLS', '생성형 AI', 'Claude', '발신', 'O', 510, 'Y', ''),
('ICLR', '생성형 AI', 'Claude', '수신', 'I', 511, 'Y', ''),
('IDMR', '생성형 AI', 'AI Docmaker Attach', '수신', 'I', 512, 'Y', ''),
('IADR', '생성형 AI', 'Adobe firefly login', '수신', 'I', 513, 'Y', ''),
('IWDS', '생성형 AI', 'Dream by WOMBO', '발신', 'O', 514, 'Y', ''),
('IGAS', '생성형 AI', 'GetImg.AI', '발신', 'O', 515, 'Y', ''),
('IWKS', '생성형 AI', 'Wrks.ai', '발신', 'O', 516, 'Y', ''),
('IPSS', '생성형 AI', 'Polaris office ai', '발신', 'O', 517, 'Y', ''),
('IBGS', '생성형 AI', 'Goover AI', '발신', 'O', 518, 'Y', ''),
('IIAS', '생성형 AI', 'iAsk AI', '발신', 'O', 519, 'Y', ''),
('ISNS', '생성형 AI', 'Suno AI', '발신', 'O', 520, 'Y', ''),
('IPES', '생성형 AI', 'Perchance', '발신', 'O', 521, 'Y', ''),
('IPER', '생성형 AI', 'Perchance', '수신', 'I', 522, 'Y', ''),
('IPFS', '생성형 AI', 'ChatPDF', '발신', 'O', 523, 'Y', ''),
('IXOS', '생성형 AI', 'Exaone', '발신', 'O', 524, 'Y', ''),
('IXOR', '생성형 AI', 'Exaone', '수신', 'I', 525, 'Y', ''),
('ISOR', '생성형 AI', 'Slidesgo', '수신', 'I', 526, 'Y', ''),
('ISOS', '생성형 AI', 'Slidesgo', '발신', 'O', 527, 'Y', ''),
('IKRS', '생성형 AI', 'KREA', '발신', 'O', 528, 'Y', ''),
('ILMS', '생성형 AI', 'GoogleNotebook LM', '발신', 'O', 529, 'Y', ''),
('ICCS', '생성형 AI', 'Capcut', '발신', 'O', 530, 'Y', ''),
('IMGS', '생성형 AI', 'Magictool', '발신', 'O', 531, 'Y', ''),
('IGSS', '생성형 AI', 'Genspark', '발신', 'O', 532, 'Y', ''),
('IGSR', '생성형 AI', 'Genspark', '수신', 'I', 533, 'Y', ''),
('IFES', '생성형 AI', 'felo', '발신', 'O', 534, 'Y', ''),
('ITPS', '생성형 AI', 'Tripo3D', '발신', 'O', 535, 'Y', ''),
('ITPR', '생성형 AI', 'Tripo3D', '수신', 'I', 536, 'Y', ''),
('IELS', '생성형 AI', 'Elevenlabs', '발신', 'O', 537, 'Y', ''),
('IELR', '생성형 AI', 'Elevenlabs', '수신', 'I', 538, 'Y', ''),
('IGRS', '생성형 AI', 'Grammarly', '발신', 'O', 539, 'Y', ''),
('IVRS', '생성형 AI', 'Vrew', '발신', 'O', 540, 'Y', ''),
('INIS', '생성형 AI', 'NightCafe', '발신', 'O', 541, 'Y', ''),
('ICAS', '생성형 AI', 'CivitAI', '발신', 'O', 542, 'Y', ''),
('ILIS', '생성형 AI', 'Liner', '발신', 'O', 543, 'Y', ''),
('IBCS', '생성형 AI', 'Bing Image Creator', '발신', 'O', 544, 'Y', ''),
('IDSS', '생성형 AI', 'Deepseek', '발신', 'O', 545, 'Y', ''),
('IBDS', '생성형 AI', 'Baidu Ai', '발신', 'O', 546, 'Y', ''),
('IGIS', '생성형 AI', 'Gemini AI api', '발신', 'O', 547, 'Y', ''),
('IGIR', '생성형 AI', 'Gemini AI api', '수신', 'I', 548, 'Y', ''),
('IDTS', '생성형 AI', '에이닷', '발신', 'O', 549, 'Y', ''),
('IDTR', '생성형 AI', '에이닷', '수신', 'I', 550, 'Y', ''),
('IQBS', '생성형 AI', 'QuillBot', '발신', 'O', 551, 'Y', ''),
('ICHS', '생성형 AI', 'Character ai', '발신', 'O', 552, 'Y', ''),
('ISRS', '생성형 AI', 'Sora/Openai', '발신', 'O', 553, 'Y', ''),
('ISRR', '생성형 AI', 'Sora/Openai', '수신', 'I', 554, 'Y', ''),
('INNS', '생성형 AI', 'Nano AI', '발신', 'O', 555, 'Y', ''),
('IDBS', '생성형 AI', 'Doubao', '발신', 'O', 556, 'Y', ''),
('ITYS', '생성형 AI', 'Tongyi', '발신', 'O', 557, 'Y', ''),
('IYBS', '생성형 AI', 'Yuanbao', '발신', 'O', 558, 'Y', ''),
('IYYS', '생성형 AI', 'Yiyan', '발신', 'O', 559, 'Y', ''),
('IKMS', '생성형 AI', 'Kimi', '발신', 'O', 560, 'Y', ''),
('IBAS', '생성형 AI', 'Baichuan', '발신', 'O', 561, 'Y', ''),
('ITGS', '생성형 AI', 'Tiangong', '발신', 'O', 562, 'Y', ''),
('ISDS', '생성형 AI', 'Stable Diffusion', '발신', 'O', 563, 'Y', ''),
('IGOS', '생성형 AI', 'Grok', '발신', 'O', 564, 'Y', ''),
('IGOR', '생성형 AI', 'Grok', '수신', 'O', 565, 'Y', ''),
('ICGS', '생성형 AI', 'ChatGLM', '발신', 'O', 566, 'Y', ''),
('INKS', '생성형 AI', 'Napkin AI', '발신', 'O', 567, 'Y', ''),
('IBIR', '생성형 AI', 'Microsoft Copilot', '수신', 'I', 568, 'Y', ''),
('IOOS', '생성형 AI', 'AI Goormee', '발신', 'O', 569, 'Y', ''),
('IABS', '생성형 AI', 'Allibee', '발신', 'O', 570, 'Y', ''),
('ILXS', '생성형 AI', 'Lexis+', '발신', 'O', 571, 'Y', ''),
('ILAS', '생성형 AI', 'SuperLawyer', '발신', 'O', 572, 'Y', ''),
('ICOS', '생성형 AI', 'CoCounsel', '발신', 'O', 573, 'Y', ''),
('IANS', '생성형 AI', 'Anthropic', '발신', 'O', 574, 'Y', ''),
('IANR', '생성형 AI', 'Anthropic', '수신', 'I', 575, 'Y', ''),
('ISIS', '생성형 AI', 'Sider AI', '발신', 'O', 576, 'Y', ''),
('IGMS', '생성형 AI', 'Gamma', '발신', 'O', 577, 'Y', ''),
('IGMR', '생성형 AI', 'Gamma', '수신', 'I', 578, 'Y', ''),
('ICRS', '생성형 AI', 'Cursor', '발신', 'O', 579, 'Y', ''),
('ICRR', '생성형 AI', 'Cursor', '수신', 'O', 580, 'Y', ''),
('IMAS', '생성형 AI', 'ManusAI', '발신', 'O', 581, 'Y', ''),
('IMTS', '생성형 AI', 'Mistral AI', '발신', 'O', 582, 'Y', ''),
('ICBS', '생성형 AI', 'Cline', '발신', 'O', 583, 'Y', ''),
('IWBS', '생성형 AI', 'Weight & Biases', '발신', 'O', 584, 'Y', ''),
('IWBR', '생성형 AI', 'Weight & Biases', '수신', 'I', 585, 'Y', ''),
('ILLS', '생성형 AI', 'Lilys AI', '발신', 'O', 586, 'Y', ''),
('IUKS', '생성형 AI', '기타', '발신', 'O', 587, 'Y', ''),
('IGES', '생성형 AI', 'Gemini Code Assist', '발신', 'O', 588, 'Y', ''),
('IGER', '생성형 AI', 'Gemini Code Assist', '수신', 'I', 589, 'Y', ''),
('IOES', '생성형 AI', 'Codex/OpenAI', '발신', 'O', 590, 'Y', ''),
('IOER', '생성형 AI', 'Codex/OpenAI', '수신', 'I', 591, 'Y', ''),
('IJLS', '생성형 AI', 'Jules', '발신', 'O', 592, 'Y', ''),
('IHVS', '생성형 AI', 'Harvey', '발신', 'O', 593, 'Y', ''),
('IXAS', '생성형 AI', 'x.AI', '발신', 'O', 594, 'Y', ''),
('ICES', '생성형 AI', 'Cohere', '발신', 'O', 595, 'Y', ''),
('IWTR', '생성형 AI', 'wrtn', '수신', 'I', 596, 'Y', ''),
('ICHR', '생성형 AI', 'Character ai', '수신', 'I', 597, 'Y', ''),
('IOWR', '생성형 AI', 'Open WebUi', '수신', 'I', 598, 'Y', ''),
('IOWS', '생성형 AI', 'Open WebUi', '발신', 'O', 599, 'Y', ''),
('ISKS', '생성형 AI', 'Skywork', '발신', 'O', 600, 'Y', ''),
('IVES', '생성형 AI', 'Veo3', '발신', 'O', 601, 'Y', ''),
('IGTS', '생성형 AI', 'Gptoss', '발신', 'O', 602, 'Y', ''),
('ILRS', '생성형 AI', 'LMArena', '발신', 'O', 603, 'Y', ''),
('ILRR', '생성형 AI', 'LMArena', '수신', 'I', 604, 'Y', ''),
('IASS', '생성형 AI', 'Chat & Ask AI', '발신', 'O', 605, 'Y', ''),
('IASR', '생성형 AI', 'Chat & Ask AI', '수신', 'I', 606, 'Y', ''),
('IARR', '생성형 AI', 'Android Studio', '수신', 'O', 607, 'Y', ''),
('IARS', '생성형 AI', 'Android Studio', '발신', 'O', 608, 'Y', ''),
('IORR', '생성형 AI', 'Open Router', '수신', 'O', 609, 'Y', ''),
('IORS', '생성형 AI', 'Open Router', '발신', 'O', 610, 'Y', ''),
('IAMS', '생성형 AI', '구글 AI 모드', '발신', 'O', 611, 'Y', ''),
('IAMR', '생성형 AI', '구글 AI 모드', '수신', 'O', 612, 'Y', ''),
('ITIS', '생성형 AI', 'Timely GPT', '발신', 'O', 613, 'Y', ''),
('ITIR', '생성형 AI', 'Timely GPT', '수신', 'O', 614, 'Y', ''),
('IOTS', '생성형 AI', 'Otter.ai', '발신', 'O', 615, 'Y', ''),
('IOTR', '생성형 AI', 'Otter.ai', '수신', 'O', 616, 'Y', ''),
('IAGS', '생성형 AI', 'Gemini Enterprise', '발신', 'O', 617, 'Y', ''),
('IAGR', '생성형 AI', 'Gemini Enterprise', '수신', 'I', 618, 'Y', ''),
('ISPS', '생성형 AI', 'Soda Pdf', '발신', 'O', 619, 'Y', ''),
('ISPR', '생성형 AI', 'Soda Pdf', '수신', 'I', 620, 'Y', ''),
('IFPS', '생성형 AI', 'FreePik', '발신', 'O', 621, 'Y', ''),
('IFPR', '생성형 AI', 'FreePik', '수신', 'I', 622, 'Y', ''),
('ITOS', '생성형 AI', 'Tigris AI+', '발신', 'O', 623, 'Y', ''),
('IATS', '생성형 AI', 'Antigravity', '발신', 'O', 624, 'Y', ''),
('IATR', '생성형 AI', 'Antigravity', '수신', 'I', 625, 'Y', ''),
('IODS', '생성형 AI', 'OpenCode AI', '발신', 'O', 626, 'Y', ''),
('IODR', '생성형 AI', 'OpenCode AI', '수신', 'I', 627, 'Y', ''),
('ITNS', '생성형 AI', 'Tunee AI', '발신', 'O', 628, 'Y', ''),
('ITNR', '생성형 AI', 'Tunee AI', '수신', 'I', 629, 'Y', ''),
('IWES', '생성형 AI', 'WeeAI', '발신', 'O', 630, 'Y', ''),
('IWER', '생성형 AI', 'WeeAI', '수신', 'I', 631, 'Y', ''),
('IHAS', '생성형 AI', 'Hailuo AI', '발신', 'O', 632, 'Y', ''),
('IHAR', '생성형 AI', 'Hailuo AI', '수신', 'I', 633, 'Y', ''),
('IHIS', '생성형 AI', 'Higgsfield', '발신', 'O', 634, 'Y', ''),
('IKLS', '생성형 AI', 'Kling AI', '발신', 'O', 635, 'Y', ''),
('IKLR', '생성형 AI', 'Kling AI', '수신', 'I', 636, 'Y', ''),
('IOAS', '생성형 AI', 'OpenAI API', '발신', 'O', 637, 'Y', ''),
('IOAR', '생성형 AI', 'OpenAI API', '수신', 'I', 638, 'Y', ''),
('ICKS', '생성형 AI', 'CudekAI', '발신', 'O', 639, 'Y', ''),
('ICKR', '생성형 AI', 'CudekAI', '수신', 'I', 640, 'Y', ''),
('IAKS', '생성형 AI', 'Amazonbedrock', '발신', 'O', 641, 'Y', ''),
('IAKR', '생성형 AI', 'Amazonbedrock', '수신', 'I', 642, 'Y', ''),
('IBIQ', '생성형 AI', 'Microsoft Copilot', '발신', 'O', 643, 'Y', ''),
('IBIZ', '생성형 AI', 'Microsoft Copilot', '수신', 'I', 644, 'Y', ''),
('PDOS', '프로젝트', 'dooray', '발신', 'O', 645, 'Y', ''),
('PGIS', '프로젝트', 'github', '발신', 'O', 646, 'Y', ''),
('PGLS', '프로젝트', 'Glassdoor', '발신', 'O', 647, 'Y', ''),
('PJDS', '프로젝트', '잔디', '발신', 'O', 648, 'Y', ''),
('PITS', '프로젝트', 'Google Issue Tracker', '발신', 'O', 649, 'Y', ''),
('EBDR', '그룹웨어', '게시', '수신', 'I', 650, 'Y', ''),
('EBD-', '그룹웨어', '게시', '발신', 'O', 651, 'Y', ''),
('EBBR', '그룹웨어', '게시판', '수신', 'I', 652, 'Y', ''),
('EBBS', '그룹웨어', '게시판', '발신', 'O', 653, 'Y', ''),
('EBBF', '그룹웨어', '게시판', '파일수신', 'I', 654, 'Y', ''),
('EAAR', '그룹웨어', '결재', '수신', 'I', 655, 'Y', ''),
('EAAS', '그룹웨어', '결재', '발신', 'O', 656, 'Y', ''),
('EAAG', '그룹웨어', '결재', '통보 - 수신', 'I', 657, 'Y', ''),
('EAAP', '그룹웨어', '결재', '통보 - 발신', 'O', 658, 'Y', ''),
('EAAF', '그룹웨어', '결재', '파일수신', 'I', 659, 'Y', ''),
('EMMR', '그룹웨어', '메일', '그룹웨어 수신', 'I', 660, 'Y', ''),
('EMMS', '그룹웨어', '메일', '그룹웨어 발신', 'O', 661, 'Y', ''),
('EMMG', '그룹웨어', '메일', 'OWA 수신', 'I', 662, 'Y', ''),
('EMMP', '그룹웨어', '메일', 'OWA 발신', 'O', 663, 'Y', ''),
('EMMD', '그룹웨어', '메일', 'RPC 수신', 'I', 664, 'Y', ''),
('EMMU', '그룹웨어', '메일', 'RPC 발신', 'O', 665, 'Y', ''),
('EMMC', '그룹웨어', '메일', '수신', 'I', 666, 'Y', ''),
('EMML', '그룹웨어', '메일', '발신', 'O', 667, 'Y', ''),
('EMM1', '그룹웨어', '메일', '보안등급1', 'O', 668, 'Y', ''),
('EMM2', '그룹웨어', '메일', '보안등급2', 'O', 669, 'Y', ''),
('EMM3', '그룹웨어', '메일', '보안등급3', 'O', 670, 'Y', ''),
('EMM4', '그룹웨어', '메일', '보안등급4', 'O', 671, 'Y', ''),
('EMMA', '그룹웨어', '메일', '임시(자동)', 'O', 672, 'Y', ''),
('EMMT', '그룹웨어', '메일', '임시(수동)', 'O', 673, 'Y', ''),
('EMMK', '그룹웨어', '메일', 'Outlook - 수신', 'I', 674, 'Y', ''),
('EMMO', '그룹웨어', '메일', 'Outlook - 발신', 'O', 675, 'Y', ''),
('EMMB', '그룹웨어', '메일', '그룹웨어 예약메일', 'O', 676, 'Y', ''),
('EMBR', '그룹웨어', '모바일', '수신', 'I', 677, 'Y', ''),
('EMB-', '그룹웨어', '모바일', '발신', 'O', 678, 'Y', ''),
('EWSR', '그룹웨어', '웹서비스', '수신', 'I', 679, 'Y', ''),
('EWS-', '그룹웨어', '웹서비스', '발신', 'O', 680, 'Y', ''),
('EPUR', '그룹웨어', '일반', '수신', 'I', 681, 'Y', ''),
('EPU-', '그룹웨어', '일반', '발신', 'O', 682, 'Y', ''),
('EAU-', '그룹웨어', '일반(자동전달)', '자동전달', 'O', 683, 'Y', ''),
('ESCR', '그룹웨어', '일정 명함', '수신', 'I', 684, 'Y', ''),
('ESC-', '그룹웨어', '일정 명함', '발신', 'O', 685, 'Y', ''),
('EMF-', '그룹웨어', '파일 다운로드', '-', 'I', 686, 'Y', ''),
('EMU-', '그룹웨어', '기타', '', 'O', 687, 'Y', ''),
('EMDR', '그룹웨어', '드라이브', '수신', 'I', 688, 'Y', ''),
('EMDS', '그룹웨어', '드라이브', '발신', 'O', 689, 'Y', ''),
('ECIS', '그룹웨어', 'Samsung cic', '발신', 'O', 690, 'Y', ''),
('EMER', '그룹웨어', '메신저', '수신', 'I', 691, 'Y', ''),
('EMES', '그룹웨어', '메신저', '발신', 'O', 692, 'Y', ''),
('EMEC', '그룹웨어', '메신저', '채팅', 'O', 693, 'Y', 'MSG'),
('EZQC', '그룹웨어', 'Zohocliq', '채팅', 'O', 694, 'Y', ''),
('EZQS', '그룹웨어', 'Zohocliq', '캘린더', 'O', 695, 'Y', ''),
('EKWS', '그룹웨어', '카카오워크', '발신', 'O', 696, 'Y', ''),
('ECAS', '그룹웨어', '일정', '발신', 'O', 697, 'Y', ''),
('ETOS', '그룹웨어', 'Tigris', '기타', 'O', 698, 'Y', ''),
('ETOC', '그룹웨어', 'Tigris', '메신저', 'O', 699, 'Y', ''),
('ETOD', '그룹웨어', 'Tigris', '드라이브', 'O', 700, 'Y', ''),
('ETOA', '그룹웨어', 'Tigris', '결재', 'O', 701, 'Y', ''),
('DCCS', '편집기', 'Clip Champ', '발신', 'O', 702, 'Y', ''),
('DFGS', '편집기', 'Figma', '발신', 'O', 703, 'Y', ''),
('DOVS', '편집기', 'Overleaf', '발신', 'O', 704, 'Y', ''),
('DOVR', '편집기', 'Overleaf', '수신', 'I', 705, 'Y', ''),
('DPKS', '편집기', 'Plunker', '발신', 'O', 706, 'Y', ''),
('DNWS', '편집기', 'Namu.wiki', '발신', 'O', 707, 'Y', ''),
('DWKS', '편집기', 'WikiPedia', '발신', 'O', 708, 'Y', ''),
('DAES', '편집기', 'Adobe Express', '발신', 'O', 709, 'Y', ''),
('DSMS', '편집기', 'Sketchmon', '발신', 'O', 710, 'Y', ''),
('DGSS', '편집기', 'Google Site', '발신', 'O', 711, 'Y', ''),
('DCVS', '편집기', 'Canva', '발신', 'O', 712, 'Y', ''),
('DMBS', '편집기', '망고보드', '발신', 'O', 713, 'Y', ''),
('DMTS', '편집기', '망고툰', '발신', 'O', 714, 'Y', ''),
('JBDS', '웹사이트', 'Baidu', '발신', 'O', 715, 'Y', ''),
('JANS', '웹사이트', 'Anthropic', '발신', 'O', 716, 'Y', ''),
('JKAS', '웹사이트', 'Kaggle', '발신', 'O', 717, 'Y', ''),
('JJPS', '웹사이트', 'justpaste.it', '발신', 'O', 718, 'Y', ''),
('JPBS', '웹사이트', 'pastebin.com', '발신', 'O', 719, 'Y', ''),
('JNNS', '웹사이트', 'n8n', '발신', 'O', 720, 'Y', ''),
('JGHS', '웹사이트', 'Google cloud console', '발신', 'O', 721, 'Y', ''),
('JALS', '웹사이트', 'AnessLab', '발신', 'O', 722, 'Y', ''),
('JCCS', '웹사이트', 'CMCC [GUI-AGENT]', '발신', 'O', 723, 'Y', ''),
('JOTS', '웹사이트', 'Otter.ai', '발신', 'O', 724, 'Y', ''),
('JMLS', '웹사이트', 'Menlosecurity', '발신', 'O', 725, 'Y', ''),
('JHFS', '웹사이트', 'Hugging Face', '발신', 'O', 726, 'Y', ''),
('JSNS', '웹사이트', 'AWS SNS', '발신', 'O', 727, 'Y', ''),
('JAGS', '웹사이트', 'AWS API Gateway', '발신', 'O', 728, 'Y', ''),
('JASS', '웹사이트', 'AWS SSM', '발신', 'O', 729, 'Y', ''),
('RGUS', '원격접속', '아파치 과카몰리', '발신', 'O', 730, 'Y', ''),
('RGUR', '원격접속', '아파치 과카몰리', '수신', 'I', 731, 'Y', ''),
('KAAR', '웹서비스(분류)', '웹 수신', '수신', 'I', 732, 'Y', ''),
('KAAS', '웹서비스(분류)', '웹 발신', '발신', 'O', 733, 'Y', '');
