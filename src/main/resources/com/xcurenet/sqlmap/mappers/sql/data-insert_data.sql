...
VALUES ('MP3-', '메일', 'POP3', '-', 'I', 1, 'Y', ''),
       ...
       ('IUKS', '생성형 AI', '기타', '발신', 'I', 534, 'Y', ''),
       ('PDOS', '프로젝트', 'dooray', '발신', 'O', 535, 'Y', ''),
       ('PGIS', '프로젝트', 'github', '발신', 'O', 536, 'Y', ''),
       ('PGLS', '프로젝트', 'Glassdoor', '발신', 'O', 537, 'Y', ''),
       ('PJDS', '프로젝트', '잔디', '발신', 'O', 538, 'Y', ''),
       ('PITS', '프로젝트', 'Google Issue Tracker', '발신', 'O', 539, 'Y', ''),
       ('EBDR', '그룹웨어', '게시', '수신', 'I', 540, 'Y', ''),
       ('EBD-', '그룹웨어', '게시', '발신', 'O', 541, 'Y', ''),
       ('EBBR', '그룹웨어', '게시판', '수신', 'I', 542, 'Y', ''),
       ('EBBS', '그룹웨어', '게시판', '발신', 'O', 543, 'Y', ''),
       ('EBBF', '그룹웨어', '게시판', '파일수신', 'I', 544, 'Y', ''),
       ('EAAR', '그룹웨어', '결재', '수신', 'I', 545, 'Y', ''),
       ('EAAS', '그룹웨어', '결재', '발신', 'O', 546, 'Y', ''),
       ('EAAG', '그룹웨어', '결재', '통보 - 수신', 'I', 547, 'Y', ''),
       ('EAAP', '그룹웨어', '결재', '통보 - 발신', 'O', 548, 'Y', ''),
       ('EAAF', '그룹웨어', '결재', '파일수신', 'I', 549, 'Y', ''),
       ('EMMR', '그룹웨어', '메일', '그룹웨어 수신', 'I', 550, 'Y', ''),
       ('EMMS', '그룹웨어', '메일', '그룹웨어 발신', 'O', 551, 'Y', ''),
       ('EMMG', '그룹웨어', '메일', 'OWA 수신', 'I', 552, 'Y', ''),
       ('EMMP', '그룹웨어', '메일', 'OWA 발신', 'O', 553, 'Y', ''),
       ('EMMD', '그룹웨어', '메일', 'RPC 수신', 'I', 554, 'Y', ''),
       ('EMMU', '그룹웨어', '메일', 'RPC 발신', 'O', 555, 'Y', ''),
       ('EMMC', '그룹웨어', '메일', '수신', 'I', 556, 'Y', ''),
       ('EMML', '그룹웨어', '메일', '발신', 'O', 557, 'Y', ''),
       ('EMM1', '그룹웨어', '메일', '보안등급1', 'O', 558, 'Y', ''),
       ('EMM2', '그룹웨어', '메일', '보안등급2', 'O', 559, 'Y', ''),
       ('EMM3', '그룹웨어', '메일', '보안등급3', 'O', 560, 'Y', ''),
       ('EMM4', '그룹웨어', '메일', '보안등급4', 'O', 561, 'Y', ''),
       ('EMMA', '그룹웨어', '메일', '임시(자동)', 'O', 562, 'Y', ''),
       ('EMMT', '그룹웨어', '메일', '임시(수동)', 'O', 563, 'Y', ''),
       ('EMMK', '그룹웨어', '메일', 'Outlook - 수신', 'I', 564, 'Y', ''),
       ('EMMO', '그룹웨어', '메일', 'Outlook - 발신', 'O', 565, 'Y', ''),
       ('EMMB', '그룹웨어', '메일', '그룹웨어 예약메일', 'O', 566, 'Y', ''),
       ('EMBR', '그룹웨어', '모바일', '수신', 'I', 567, 'Y', ''),
       ('EMB-', '그룹웨어', '모바일', '발신', 'O', 568, 'Y', ''),
       ('EWSR', '그룹웨어', '웹서비스', '수신', 'I', 569, 'Y', ''),
       ('EWS-', '그룹웨어', '웹서비스', '발신', 'O', 570, 'Y', ''),
       ('EPUR', '그룹웨어', '일반', '수신', 'I', 571, 'Y', ''),
       ('EPU-', '그룹웨어', '일반', '발신', 'O', 572, 'Y', ''),
       ('EAU-', '그룹웨어', '일반(자동전달)', '자동전달', 'O', 573, 'Y', ''),
       ('ESCR', '그룹웨어', '일정 명함', '수신', 'I', 574, 'Y', ''),
       ('ESC-', '그룹웨어', '일정 명함', '발신', 'O', 575, 'Y', ''),
       ('EMF-', '그룹웨어', '파일 다운로드', '-', 'I', 576, 'Y', ''),
       ('EMU-', '그룹웨어', '기타', '', 'O', 577, 'Y', ''),
       ('EMDR', '그룹웨어', '드라이브', '수신', 'I', 578, 'Y', ''),
       ('EMDS', '그룹웨어', '드라이브', '발신', 'O', 579, 'Y', ''),
       ('ECIS', '그룹웨어', 'Samsung cic', '발신', 'O', 580, 'Y', ''),
       ('EMER', '그룹웨어', '메신저', '수신', 'O', 581, 'Y', ''),
       ('EMES', '그룹웨어', '메신저', '발신', 'O', 582, 'Y', ''),
       ('EZQC', '그룹웨어', 'Zohocliq', '채팅', 'O', 583, 'Y', ''),
       ('EZQS', '그룹웨어', 'Zohocliq', '캘린더', 'O', 584, 'Y', ''),
       ('EKWS', '그룹웨어', '카카오워크', '발신', 'O', 585, 'Y', ''),
       ('DCCS', '편집기', 'Clip Champ', '발신', 'O', 586, 'Y', ''),
       ('DFGS', '편집기', 'Figma', '발신', 'O', 587, 'Y', ''),
       ('DOVS', '편집기', 'Overleaf', '발신', 'O', 588, 'Y', ''),
       ('DOVR', '편집기', 'Overleaf', '수신', 'O', 589, 'Y', ''),
       ('DPKS', '편집기', 'Plunker', '발신', 'O', 590, 'Y', ''),
       ('DNWS', '편집기', 'Namu.wiki', '발신', 'O', 591, 'Y', ''),
       ('DWKS', '편집기', 'WikiPedia', '발신', 'O', 592, 'Y', ''),
       ('DAES', '편집기', 'Adobe Express', '발신', 'O', 593, 'Y', ''),
       ('DSMS', '편집기', 'Sketchmon', '발신', 'O', 594, 'Y', ''),
       ('JBDS', '웹사이트', 'Baidu', '발신', 'O', 595, 'Y', ''),
       ('JANS', '웹사이트', 'Anthropic', '발신', 'O', 596, 'Y', ''),
       ('RGUS', '원격접속', '아파치 과카몰리', '발신', 'O', 597, 'Y', '');
