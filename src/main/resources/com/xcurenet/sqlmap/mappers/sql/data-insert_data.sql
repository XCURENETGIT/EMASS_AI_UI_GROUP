...
('IGVS', '생성형 AI', 'Google Vertex', '발신', 'O', 504, 'Y', ''),
('IGVR', '생성형 AI', 'Google Vertex', '수신', 'I', 505, 'Y', ''),
('IGLS', '생성형 AI', 'Google Colab', '발신', 'O', 506, 'Y', ''),
('ICWS', '생성형 AI', 'CodeWhisperer', '발신', 'O', 507, 'Y', ''),
('IMSS', '생성형 AI', 'Google AI Studio', '발신', 'O', 508, 'Y', ''),
('IOCS', '생성형 AI', 'Clova OCR', '발신', 'O', 509, 'Y', ''),
('IAOS', '생성형 AI', 'Azure OpenAI', '발신', 'O', 510, 'Y', ''),
('IAOR', '생성형 AI', 'Azure OpenAI', '수신', 'I', 511, 'Y', ''),
('ICUS', '생성형 AI', '네이버 CUE:', '발신', 'O', 512, 'Y', ''),
('IMJS', '생성형 AI', 'Midjourney', '발신', 'O', 513, 'Y', ''),
('ISGR', '생성형 AI', 'slidesGPT', '수신', 'I', 514, 'Y', ''),
('ISGS', '생성형 AI', 'SlidesGPT', '발신', 'O', 515, 'Y', ''),
('IDMS', '생성형 AI', 'Ai Docmaker', '발신', 'O', 516, 'Y', ''),
('IRKS', '생성형 AI', 'Reka AI', '발신', 'O', 517, 'Y', ''),
('IRKR', '생성형 AI', 'Reka AI', '수신', 'O', 518, 'Y', ''),
('ICLS', '생성형 AI', 'Claude', '발신', 'O', 519, 'Y', ''),
('ICLR', '생성형 AI', 'Claude', '수신', 'I', 520, 'Y', ''),
('ICLQ', '생성형 AI', 'Claude', '발신', 'O', 521, 'Y', ''),
('IDMR', '생성형 AI', 'AI Docmaker Attach', '수신', 'I', 522, 'Y', ''),
('IADR', '생성형 AI', 'Adobe firefly login', '수신', 'I', 523, 'Y', ''),
('IWDS', '생성형 AI', 'Dream by WOMBO', '발신', 'O', 524, 'Y', ''),
('IGAS', '생성형 AI', 'GetImg.AI', '발신', 'O', 525, 'Y', ''),
('IWKS', '생성형 AI', 'Wrks.ai', '발신', 'O', 526, 'Y', ''),
('IPSS', '생성형 AI', 'Polaris office ai', '발신', 'O', 527, 'Y', ''),
('IBGS', '생성형 AI', 'Goover AI', '발신', 'O', 528, 'Y', ''),
('IIAS', '생성형 AI', 'iAsk AI', '발신', 'O', 529, 'Y', ''),
('ISNS', '생성형 AI', 'Suno AI', '발신', 'O', 530, 'Y', ''),
('IPES', '생성형 AI', 'Perchance', '발신', 'O', 531, 'Y', ''),
('IPER', '생성형 AI', 'Perchance', '수신', 'I', 532, 'Y', ''),
('IPFS', '생성형 AI', 'ChatPDF', '발신', 'O', 533, 'Y', ''),
('IXOS', '생성형 AI', 'Exaone', '발신', 'O', 534, 'Y', ''),
('IXOR', '생성형 AI', 'Exaone', '수신', 'I', 535, 'Y', ''),
('ISOR', '생성형 AI', 'Slidesgo', '수신', 'I', 536, 'Y', ''),
('ISOS', '생성형 AI', 'Slidesgo', '발신', 'O', 537, 'Y', ''),
('IKRS', '생성형 AI', 'KREA', '발신', 'O', 538, 'Y', ''),
('ILMS', '생성형 AI', 'GoogleNotebook LM', '발신', 'O', 539, 'Y', ''),
('ICCS', '생성형 AI', 'Capcut', '발신', 'O', 540, 'Y', ''),
('IMGS', '생성형 AI', 'Magictool', '발신', 'O', 541, 'Y', ''),
('IGSS', '생성형 AI', 'Genspark', '발신', 'O', 542, 'Y', ''),
('IGSR', '생성형 AI', 'Genspark', '수신', 'I', 543, 'Y', ''),
('IGSQ', '생성형 AI', 'Genspark', '발신', 'O', 544, 'Y', ''),
('IFES', '생성형 AI', 'felo', '발신', 'O', 545, 'Y', ''),
('ITPS', '생성형 AI', 'Tripo3D', '발신', 'O', 546, 'Y', ''),
('ITPR', '생성형 AI', 'Tripo3D', '수신', 'I', 547, 'Y', ''),
('IELS', '생성형 AI', 'Elevenlabs', '발신', 'O', 548, 'Y', ''),
('IELR', '생성형 AI', 'Elevenlabs', '수신', 'I', 549, 'Y', ''),
('IGRS', '생성형 AI', 'Grammarly', '발신', 'O', 550, 'Y', ''),
('IVRS', '생성형 AI', 'Vrew', '발신', 'O', 551, 'Y', ''),
('INIS', '생성형 AI', 'NightCafe', '발신', 'O', 552, 'Y', ''),
('ICAS', '생성형 AI', 'CivitAI', '발신', 'O', 553, 'Y', ''),
('ILIS', '생성형 AI', 'Liner', '발신', 'O', 554, 'Y', ''),
('IBCS', '생성형 AI', 'Bing Image Creator', '발신', 'O', 555, 'Y', ''),
('IDSS', '생성형 AI', 'Deepseek', '발신', 'O', 556, 'Y', ''),
('IBDS', '생성형 AI', 'Baidu Ai', '발신', 'O', 557, 'Y', ''),
('IBDR', '생성형 AI', 'Baidu Ai', '수신', 'I', 558, 'Y', ''),
('IGIS', '생성형 AI', 'Gemini AI api', '발신', 'O', 559, 'Y', ''),
('IGIR', '생성형 AI', 'Gemini AI api', '수신', 'I', 560, 'Y', ''),
('IDTS', '생성형 AI', '에이닷', '발신', 'O', 561, 'Y', ''),
('IDTR', '생성형 AI', '에이닷', '수신', 'I', 562, 'Y', ''),
('IQBS', '생성형 AI', 'QuillBot', '발신', 'O', 563, 'Y', ''),
('ICHS', '생성형 AI', 'Character ai', '발신', 'O', 564, 'Y', ''),
('ISRS', '생성형 AI', 'Sora/Openai', '발신', 'O', 565, 'Y', ''),
('ISRR', '생성형 AI', 'Sora/Openai', '수신', 'I', 566, 'Y', ''),
('INNS', '생성형 AI', 'Nano AI', '발신', 'O', 567, 'Y', ''),
('IDBS', '생성형 AI', 'Doubao', '발신', 'O', 568, 'Y', ''),
('ITYS', '생성형 AI', 'Tongyi', '발신', 'O', 569, 'Y', ''),
('IYBS', '생성형 AI', 'Yuanbao', '발신', 'O', 570, 'Y', ''),
('IYYS', '생성형 AI', 'Yiyan', '발신', 'O', 571, 'Y', ''),
('IKMS', '생성형 AI', 'Kimi', '발신', 'O', 572, 'Y', ''),
('IBAS', '생성형 AI', 'Baichuan', '발신', 'O', 573, 'Y', ''),
('ITGS', '생성형 AI', 'Tiangong', '발신', 'O', 574, 'Y', ''),
('ISDS', '생성형 AI', 'Stable Diffusion', '발신', 'O', 575, 'Y', ''),
('IGOS', '생성형 AI', 'Grok', '발신', 'O', 576, 'Y', ''),
('IGOR', '생성형 AI', 'Grok', '수신', 'O', 577, 'Y', ''),
('ICGS', '생성형 AI', 'ChatGLM', '발신', 'O', 578, 'Y', ''),
('INKS', '생성형 AI', 'Napkin AI', '발신', 'O', 579, 'Y', ''),
('IBIR', '생성형 AI', 'Microsoft Copilot', '수신', 'I', 580, 'Y', ''),
('IOOS', '생성형 AI', 'AI Goormee', '발신', 'O', 581, 'Y', ''),
('IABS', '생성형 AI', 'Allibee', '발신', 'O', 582, 'Y', ''),
('ILXS', '생성형 AI', 'Lexis+', '발신', 'O', 583, 'Y', ''),
('ILAS', '생성형 AI', 'SuperLawyer', '발신', 'O', 584, 'Y', ''),
('ICOS', '생성형 AI', 'CoCounsel', '발신', 'O', 585, 'Y', ''),
('IANS', '생성형 AI', 'Anthropic', '발신', 'O', 586, 'Y', ''),
('IANR', '생성형 AI', 'Anthropic', '수신', 'I', 587, 'Y', ''),
('ISIS', '생성형 AI', 'Sider AI', '발신', 'O', 588, 'Y', ''),
('IGMS', '생성형 AI', 'Gamma', '발신', 'O', 589, 'Y', ''),
('IGMR', '생성형 AI', 'Gamma', '수신', 'I', 590, 'Y', ''),
('ICRS', '생성형 AI', 'Cursor', '발신', 'O', 591, 'Y', ''),
('ICRR', '생성형 AI', 'Cursor', '수신', 'O', 592, 'Y', ''),
('IMAS', '생성형 AI', 'ManusAI', '발신', 'O', 593, 'Y', ''),
('IMTS', '생성형 AI', 'Mistral AI', '발신', 'O', 594, 'Y', ''),
('ICBS', '생성형 AI', 'Cline', '발신', 'O', 595, 'Y', ''),
('IWBS', '생성형 AI', 'Weight & Biases', '발신', 'O', 596, 'Y', ''),
('IWBR', '생성형 AI', 'Weight & Biases', '수신', 'I', 597, 'Y', ''),
('ILLS', '생성형 AI', 'Lilys AI', '발신', 'O', 598, 'Y', ''),
('IUKS', '생성형 AI', '기타', '발신', 'O', 599, 'Y', ''),
('IGES', '생성형 AI', 'Gemini Code Assist', '발신', 'O', 600, 'Y', ''),
('IGER', '생성형 AI', 'Gemini Code Assist', '수신', 'I', 601, 'Y', ''),
('IOES', '생성형 AI', 'Codex/OpenAI', '발신', 'O', 602, 'Y', ''),
('IOER', '생성형 AI', 'Codex/OpenAI', '수신', 'O', 603, 'Y', ''),
('IJLS', '생성형 AI', 'Jules', '발신', 'O', 604, 'Y', ''),
('IHVS', '생성형 AI', 'Harvey', '발신', 'O', 605, 'Y', ''),
('IXAS', '생성형 AI', 'x.AI', '발신', 'O', 606, 'Y', ''),
('ICES', '생성형 AI', 'Cohere', '발신', 'O', 607, 'Y', ''),
('IWTR', '생성형 AI', 'wrtn', '수신', 'I', 608, 'Y', ''),
('ICHR', '생성형 AI', 'Character ai', '수신', 'I', 609, 'Y', ''),
('IOWR', '생성형 AI', 'Open WebUi', '수신', 'I', 610, 'Y', ''),
('IOWS', '생성형 AI', 'Open WebUi', '발신', 'O', 611, 'Y', ''),
('ISKS', '생성형 AI', 'Skywork', '발신', 'O', 612, 'Y', ''),
('IVES', '생성형 AI', 'Veo3', '발신', 'O', 613, 'Y', ''),
('IGTS', '생성형 AI', 'Gptoss', '발신', 'O', 614, 'Y', ''),
('ILRS', '생성형 AI', 'LMArena', '발신', 'O', 615, 'Y', ''),
('ILRR', '생성형 AI', 'LMArena', '수신', 'I', 616, 'Y', ''),
('IASS', '생성형 AI', 'Chat & Ask AI', '발신', 'O', 617, 'Y', ''),
('IASR', '생성형 AI', 'Chat & Ask AI', '수신', 'I', 618, 'Y', ''),
('IARR', '생성형 AI', 'Android Studio', '수신', 'O', 619, 'Y', ''),
('IARS', '생성형 AI', 'Android Studio', '발신', 'O', 620, 'Y', ''),
('IORR', '생성형 AI', 'Open Router', '수신', 'O', 621, 'Y', ''),
('IORS', '생성형 AI', 'Open Router', '발신', 'O', 622, 'Y', ''),
('IAMS', '생성형 AI', '구글 AI 모드', '발신', 'O', 623, 'Y', ''),
('IAMR', '생성형 AI', '구글 AI 모드', '수신', 'O', 624, 'Y', ''),
('ITIS', '생성형 AI', 'Timely GPT', '발신', 'O', 625, 'Y', ''),
('ITIR', '생성형 AI', 'Timely GPT', '수신', 'O', 626, 'Y', ''),
('IOTS', '생성형 AI', 'Otter.ai', '발신', 'O', 627, 'Y', ''),
('IOTR', '생성형 AI', 'Otter.ai', '수신', 'O', 628, 'Y', ''),
('IAGS', '생성형 AI', 'Gemini Enterprise', '발신', 'O', 629, 'Y', ''),
('IAGR', '생성형 AI', 'Gemini Enterprise', '수신', 'I', 630, 'Y', ''),
('ISPS', '생성형 AI', 'Soda Pdf', '발신', 'O', 631, 'Y', ''),
('ISPR', '생성형 AI', 'Soda Pdf', '수신', 'I', 632, 'Y', ''),
('IFPS', '생성형 AI', 'FreePik', '발신', 'O', 633, 'Y', ''),
('IFPR', '생성형 AI', 'FreePik', '수신', 'I', 634, 'Y', ''),
('IATS', '생성형 AI', 'Antigravity', '발신', 'O', 635, 'Y', ''),
('IATR', '생성형 AI', 'Antigravity', '수신', 'I', 636, 'Y', ''),
('ITOS', '생성형 AI', 'Tigris AI+', '발신', 'O', 637, 'Y', ''),
('IODS', '생성형 AI', 'OpenCode AI', '발신', 'O', 638, 'Y', ''),
('IODR', '생성형 AI', 'OpenCode AI', '수신', 'I', 639, 'Y', ''),
('ITNS', '생성형 AI', 'Tunee AI', '발신', 'O', 640, 'Y', ''),
('ITNR', '생성형 AI', 'Tunee AI', '수신', 'I', 641, 'Y', ''),
('IWES', '생성형 AI', 'WeeAI', '발신', 'O', 642, 'Y', ''),
('IWER', '생성형 AI', 'WeeAI', '수신', 'I', 643, 'Y', ''),
('IHAS', '생성형 AI', 'Hailuo AI', '발신', 'O', 644, 'Y', ''),
('IHAR', '생성형 AI', 'Hailuo AI', '수신', 'I', 645, 'Y', ''),
('IHIS', '생성형 AI', 'Higgsfield', '발신', 'O', 646, 'Y', ''),
('IOAS', '생성형 AI', 'OpenAI API', '발신', 'O', 647, 'Y', ''),
('IOAR', '생성형 AI', 'OpenAI API', '수신', 'I', 648, 'Y', ''),
('IKLS', '생성형 AI', 'Kling AI', '발신', 'O', 649, 'Y', ''),
('IKLR', '생성형 AI', 'Kling AI', '수신', 'I', 650, 'Y', ''),
('ICKS', '생성형 AI', 'CudekAI', '발신', 'O', 651, 'Y', ''),
('ICKR', '생성형 AI', 'CudekAI', '수신', 'I', 652, 'Y', ''),
('IAKS', '생성형 AI', 'Amazonbedrock', '발신', 'O', 653, 'Y', ''),
('IAKR', '생성형 AI', 'Amazonbedrock', '수신', 'I', 654, 'Y', ''),
('IBIQ', '생성형 AI', 'Microsoft Copilot', '발신', 'O', 655, 'Y', ''),
('IBIZ', '생성형 AI', 'Microsoft Copilot', '수신', 'I', 656, 'Y', ''),
('IINS', '생성형 AI', 'IN7', '발신', 'O', 657, 'Y', ''),
('IINR', '생성형 AI', 'IN7', '수신', 'I', 658, 'Y', ''),
('IINQ', '생성형 AI', 'IN7', '발신', 'O', 659, 'Y', ''),
('IGXS', '생성형 AI', 'Google Labs', '발신', 'O', 660, 'Y', ''),
('IGXR', '생성형 AI', 'Google Labs', '수신', 'I', 661, 'Y', ''),
('IDCS', '생성형 AI', 'Claude Console', '발신', 'O', 662, 'Y', ''),
('IDCR', '생성형 AI', 'Claude Console', '수신', 'I', 663, 'Y', ''),
('IDCQ', '생성형 AI', 'Claude Console', '발신', 'O', 664, 'Y', ''),
('IPZS', '생성형 AI', 'Pulze', '발신', 'O', 665, 'Y', ''),
('IPZQ', '생성형 AI', 'Pulze', '발신', 'O', 666, 'Y', ''),
('IMSR', '생성형 AI', 'Google Ai Studio', '수신', 'I', 667, 'Y', ''),
('ILMR', '생성형 AI', 'GoogleNotebook LM', '수신', 'I', 668, 'Y', ''),
('ICYS', '생성형 AI', 'Cherry API', '발신', 'O', 669, 'Y', ''),
('ICYR', '생성형 AI', 'Cherry API', '수신', 'I', 670, 'Y', ''),
('ITAS', '생성형 AI', 'Timely AI', '발신', 'O', 671, 'Y', ''),
('ITAQ', '생성형 AI', 'Timely AI', '발신', 'O', 672, 'Y', ''),
('ITAR', '생성형 AI', 'Timely AI', '수신', 'I', 673, 'Y', ''),
('IPJS', '생성형 AI', 'Pitch', '발신', 'O', 674, 'Y', ''),
('IPJR', '생성형 AI', 'Pitch', '수신', 'I', 675, 'Y', ''),
('IPJQ', '생성형 AI', 'Pitch', '발신', 'O', 676, 'Y', ''),
('ISLS', '생성형 AI', 'Slack AI', '발신', 'O', 677, 'Y', ''),
('ISLR', '생성형 AI', 'Slack AI', '수신', 'I', 678, 'Y', ''),
('PDOS', '프로젝트', 'dooray', '발신', 'O', 679, 'Y', ''),
('PGIS', '프로젝트', 'github', '발신', 'O', 680, 'Y', ''),
('PGLS', '프로젝트', 'Glassdoor', '발신', 'O', 681, 'Y', ''),
('PJDS', '프로젝트', '잔디', '발신', 'O', 682, 'Y', ''),
('PITS', '프로젝트', 'Google Issue Tracker', '발신', 'O', 683, 'Y', ''),
('EBDR', '그룹웨어', '게시', '수신', 'I', 684, 'Y', ''),
('EBD-', '그룹웨어', '게시', '발신', 'O', 685, 'Y', ''),
('EBBR', '그룹웨어', '게시판', '수신', 'I', 686, 'Y', ''),
('EBBS', '그룹웨어', '게시판', '발신', 'O', 687, 'Y', ''),
('EBBF', '그룹웨어', '게시판', '파일수신', 'I', 688, 'Y', ''),
('EAAR', '그룹웨어', '결재', '수신', 'I', 689, 'Y', ''),
('EAAS', '그룹웨어', '결재', '발신', 'O', 690, 'Y', ''),
('EAAG', '그룹웨어', '결재', '통보 - 수신', 'I', 691, 'Y', ''),
('EAAP', '그룹웨어', '결재', '통보 - 발신', 'O', 692, 'Y', ''),
('EAAF', '그룹웨어', '결재', '파일수신', 'I', 693, 'Y', ''),
('EMMR', '그룹웨어', '메일', '그룹웨어 수신', 'I', 694, 'Y', ''),
('EMMS', '그룹웨어', '메일', '그룹웨어 발신', 'O', 695, 'Y', ''),
('EMMG', '그룹웨어', '메일', 'OWA 수신', 'I', 696, 'Y', ''),
('EMMP', '그룹웨어', '메일', 'OWA 발신', 'O', 697, 'Y', ''),
('EMMD', '그룹웨어', '메일', 'RPC 수신', 'I', 698, 'Y', ''),
('EMMU', '그룹웨어', '메일', 'RPC 발신', 'O', 699, 'Y', ''),
('EMMC', '그룹웨어', '메일', '수신', 'I', 700, 'Y', ''),
('EMML', '그룹웨어', '메일', '발신', 'O', 701, 'Y', ''),
('EMM1', '그룹웨어', '메일', '보안등급1', 'O', 702, 'Y', ''),
('EMM2', '그룹웨어', '메일', '보안등급2', 'O', 703, 'Y', ''),
('EMM3', '그룹웨어', '메일', '보안등급3', 'O', 704, 'Y', ''),
('EMM4', '그룹웨어', '메일', '보안등급4', 'O', 705, 'Y', ''),
('EMMA', '그룹웨어', '메일', '임시(자동)', 'O', 706, 'Y', ''),
('EMMT', '그룹웨어', '메일', '임시(수동)', 'O', 707, 'Y', ''),
('EMMK', '그룹웨어', '메일', 'Outlook - 수신', 'I', 708, 'Y', ''),
('EMMO', '그룹웨어', '메일', 'Outlook - 발신', 'O', 709, 'Y', ''),
('EMMB', '그룹웨어', '메일', '그룹웨어 예약메일', 'O', 710, 'Y', ''),
('EMBR', '그룹웨어', '모바일', '수신', 'I', 711, 'Y', ''),
('EMB-', '그룹웨어', '모바일', '발신', 'O', 712, 'Y', ''),
('EWSR', '그룹웨어', '웹서비스', '수신', 'I', 713, 'Y', ''),
('EWS-', '그룹웨어', '웹서비스', '발신', 'O', 714, 'Y', ''),
('EPUR', '그룹웨어', '일반', '수신', 'I', 715, 'Y', ''),
('EPU-', '그룹웨어', '일반', '발신', 'O', 716, 'Y', ''),
('EAU-', '그룹웨어', '일반(자동전달)', '자동전달', 'O', 717, 'Y', ''),
('ESCR', '그룹웨어', '일정 명함', '수신', 'I', 718, 'Y', ''),
('ESC-', '그룹웨어', '일정 명함', '발신', 'O', 719, 'Y', ''),
('EMF-', '그룹웨어', '파일 다운로드', '-', 'I', 720, 'Y', ''),
('EMU-', '그룹웨어', '기타', '', 'O', 721, 'Y', ''),
('ETOS', '그룹웨어', 'Tigris', '기타', 'O', 722, 'Y', ''),
('EMDR', '그룹웨어', '드라이브', '수신', 'I', 723, 'Y', ''),
('EMDS', '그룹웨어', '드라이브', '발신', 'O', 724, 'Y', ''),
('ETOD', '그룹웨어', 'Tigris', '드라이브', 'O', 725, 'Y', ''),
('ECIS', '그룹웨어', 'Samsung cic', '발신', 'O', 726, 'Y', ''),
('EMER', '그룹웨어', '메신저', '수신', 'I', 727, 'Y', ''),
('EMES', '그룹웨어', '메신저', '발신', 'O', 728, 'Y', ''),
('EMEC', '그룹웨어', '메신저', '채팅', 'O', 729, 'Y', 'MSG'),
('ETOC', '그룹웨어', 'Tigris', '메신저', 'O', 730, 'Y', ''),
('ETOA', '그룹웨어', 'Tigris', '결재', 'O', 731, 'Y', ''),
('EZQC', '그룹웨어', 'Zohocliq', '채팅', 'O', 732, 'Y', ''),
('EZQS', '그룹웨어', 'Zohocliq', '캘린더', 'O', 733, 'Y', ''),
('EKWS', '그룹웨어', '카카오워크', '발신', 'O', 734, 'Y', ''),
('ECAS', '그룹웨어', '일정', '발신', 'O', 735, 'Y', ''),
('DCCS', '편집기', 'Clip Champ', '발신', 'O', 736, 'Y', ''),
('DFGS', '편집기', 'Figma', '발신', 'O', 737, 'Y', ''),
('DOVS', '편집기', 'Overleaf', '발신', 'O', 738, 'Y', ''),
('DOVR', '편집기', 'Overleaf', '수신', 'I', 739, 'Y', ''),
('DPKS', '편집기', 'Plunker', '발신', 'O', 740, 'Y', ''),
('DNWS', '편집기', 'Namu.wiki', '발신', 'O', 741, 'Y', ''),
('DWKS', '편집기', 'WikiPedia', '발신', 'O', 742, 'Y', ''),
('DAES', '편집기', 'Adobe Express', '발신', 'O', 743, 'Y', ''),
('DSMS', '편집기', 'Sketchmon', '발신', 'O', 744, 'Y', ''),
('DGSS', '편집기', 'Google Site', '발신', 'O', 745, 'Y', ''),
('DCVS', '편집기', 'Canva', '발신', 'O', 746, 'Y', ''),
('DMBS', '편집기', '망고보드', '발신', 'O', 747, 'Y', ''),
('DMTS', '편집기', '망고툰', '발신', 'O', 748, 'Y', ''),
('JBDS', '웹사이트', 'Baidu', '발신', 'O', 749, 'Y', ''),
('JANS', '웹사이트', 'Anthropic', '발신', 'O', 750, 'Y', ''),
('JKAS', '웹사이트', 'Kaggle', '발신', 'O', 751, 'Y', ''),
('JJPS', '웹사이트', 'justpaste.it', '발신', 'O', 752, 'Y', ''),
('JPBS', '웹사이트', 'pastebin.com', '발신', 'O', 753, 'Y', ''),
('JNNS', '웹사이트', 'n8n', '발신', 'O', 754, 'Y', ''),
('JGHS', '웹사이트', 'Google cloud console', '발신', 'O', 755, 'Y', ''),
('JALS', '웹사이트', 'AnessLab', '발신', 'O', 756, 'Y', ''),
('JCCS', '웹사이트', 'CMCC [GUI-AGENT]', '발신', 'O', 757, 'Y', ''),
('JOTS', '웹사이트', 'Otter.ai', '발신', 'O', 758, 'Y', ''),
('JMLS', '웹사이트', 'Menlosecurity', '발신', 'O', 759, 'Y', ''),
('JHFS', '웹사이트', 'Hugging Face', '발신', 'O', 760, 'Y', ''),
('JSNS', '웹사이트', 'AWS SNS', '발신', 'O', 761, 'Y', ''),
('JAGS', '웹사이트', 'AWS API Gateway', '발신', 'O', 762, 'Y', ''),
('JASS', '웹사이트', 'AWS SSM', '발신', 'O', 763, 'Y', ''),
('RGUS', '원격접속', '아파치 과카몰리', '발신', 'O', 764, 'Y', ''),
('RGUR', '원격접속', '아파치 과카몰리', '수신', 'I', 765, 'Y', ''),
('KAAR', '웹서비스(분류)', '웹 수신', '수신', 'I', 766, 'Y', ''),
('KAAS', '웹서비스(분류)', '웹 발신', '발신', 'O', 767, 'Y', '');
