...
('IBDR', '생성형 AI', 'Baidu Ai', '수신', 'I', 553, 'Y', ''),
('IGIS', '생성형 AI', 'Gemini AI api', '발신', 'O', 554, 'Y', ''),
('IGIR', '생성형 AI', 'Gemini AI api', '수신', 'I', 555, 'Y', ''),
('IDTS', '생성형 AI', '에이닷', '발신', 'O', 556, 'Y', ''),
('IDTR', '생성형 AI', '에이닷', '수신', 'I', 557, 'Y', ''),
('IQBS', '생성형 AI', 'QuillBot', '발신', 'O', 558, 'Y', ''),
('ICHS', '생성형 AI', 'Character ai', '발신', 'O', 559, 'Y', ''),
('ISRS', '생성형 AI', 'Sora/Openai', '발신', 'O', 560, 'Y', ''),
('ISRR', '생성형 AI', 'Sora/Openai', '수신', 'I', 561, 'Y', ''),
('INNS', '생성형 AI', 'Nano AI', '발신', 'O', 562, 'Y', ''),
('IDBS', '생성형 AI', 'Doubao', '발신', 'O', 563, 'Y', ''),
('ITYS', '생성형 AI', 'Tongyi', '발신', 'O', 564, 'Y', ''),
('IYBS', '생성형 AI', 'Yuanbao', '발신', 'O', 565, 'Y', ''),
('IYYS', '생성형 AI', 'Yiyan', '발신', 'O', 566, 'Y', ''),
('IKMS', '생성형 AI', 'Kimi', '발신', 'O', 567, 'Y', ''),
('IBAS', '생성형 AI', 'Baichuan', '발신', 'O', 568, 'Y', ''),
('ITGS', '생성형 AI', 'Tiangong', '발신', 'O', 569, 'Y', ''),
('ISDS', '생성형 AI', 'Stable Diffusion', '발신', 'O', 570, 'Y', ''),
('IGOS', '생성형 AI', 'Grok', '발신', 'O', 571, 'Y', ''),
('IGOR', '생성형 AI', 'Grok', '수신', 'O', 572, 'Y', ''),
('ICGS', '생성형 AI', 'ChatGLM', '발신', 'O', 573, 'Y', ''),
('INKS', '생성형 AI', 'Napkin AI', '발신', 'O', 574, 'Y', ''),
('IBIR', '생성형 AI', 'Microsoft Copilot', '수신', 'I', 575, 'Y', ''),
('IOOS', '생성형 AI', 'AI Goormee', '발신', 'O', 576, 'Y', ''),
('IABS', '생성형 AI', 'Allibee', '발신', 'O', 577, 'Y', ''),
('ILXS', '생성형 AI', 'Lexis+', '발신', 'O', 578, 'Y', ''),
('ILAS', '생성형 AI', 'SuperLawyer', '발신', 'O', 579, 'Y', ''),
('ICOS', '생성형 AI', 'CoCounsel', '발신', 'O', 580, 'Y', ''),
('IANS', '생성형 AI', 'Anthropic', '발신', 'O', 581, 'Y', ''),
('IANR', '생성형 AI', 'Anthropic', '수신', 'I', 582, 'Y', ''),
('ISIS', '생성형 AI', 'Sider AI', '발신', 'O', 583, 'Y', ''),
('IGMS', '생성형 AI', 'Gamma', '발신', 'O', 584, 'Y', ''),
('IGMR', '생성형 AI', 'Gamma', '수신', 'I', 585, 'Y', ''),
('ICRS', '생성형 AI', 'Cursor', '발신', 'O', 586, 'Y', ''),
('ICRR', '생성형 AI', 'Cursor', '수신', 'O', 587, 'Y', ''),
('IMAS', '생성형 AI', 'ManusAI', '발신', 'O', 588, 'Y', ''),
('IMTS', '생성형 AI', 'Mistral AI', '발신', 'O', 589, 'Y', ''),
('ICBS', '생성형 AI', 'Cline', '발신', 'O', 590, 'Y', ''),
('IWBS', '생성형 AI', 'Weight & Biases', '발신', 'O', 591, 'Y', ''),
('IWBR', '생성형 AI', 'Weight & Biases', '수신', 'I', 592, 'Y', ''),
('ILLS', '생성형 AI', 'Lilys AI', '발신', 'O', 593, 'Y', ''),
('IUKS', '생성형 AI', '기타', '발신', 'O', 594, 'Y', ''),
('IGES', '생성형 AI', 'Gemini Code Assist', '발신', 'O', 595, 'Y', ''),
('IGER', '생성형 AI', 'Gemini Code Assist', '수신', 'I', 596, 'Y', ''),
('IOES', '생성형 AI', 'Codex/OpenAI', '발신', 'O', 597, 'Y', ''),
('IOER', '생성형 AI', 'Codex/OpenAI', '수신', 'O', 598, 'Y', ''),
('IJLS', '생성형 AI', 'Jules', '발신', 'O', 599, 'Y', ''),
('IHVS', '생성형 AI', 'Harvey', '발신', 'O', 600, 'Y', ''),
('IXAS', '생성형 AI', 'x.AI', '발신', 'O', 601, 'Y', ''),
('ICES', '생성형 AI', 'Cohere', '발신', 'O', 602, 'Y', ''),
('IWTR', '생성형 AI', 'wrtn', '수신', 'I', 603, 'Y', ''),
('ICHR', '생성형 AI', 'Character ai', '수신', 'I', 604, 'Y', ''),
('IOWR', '생성형 AI', 'Open WebUi', '수신', 'I', 605, 'Y', ''),
('IOWS', '생성형 AI', 'Open WebUi', '발신', 'O', 606, 'Y', ''),
('ISKS', '생성형 AI', 'Skywork', '발신', 'O', 607, 'Y', ''),
('IVES', '생성형 AI', 'Veo3', '발신', 'O', 608, 'Y', ''),
('IGTS', '생성형 AI', 'Gptoss', '발신', 'O', 609, 'Y', ''),
('ILRS', '생성형 AI', 'LMArena', '발신', 'O', 610, 'Y', ''),
('ILRR', '생성형 AI', 'LMArena', '수신', 'I', 611, 'Y', ''),
('IASS', '생성형 AI', 'Chat & Ask AI', '발신', 'O', 612, 'Y', ''),
('IASR', '생성형 AI', 'Chat & Ask AI', '수신', 'I', 613, 'Y', ''),
('IARR', '생성형 AI', 'Android Studio', '수신', 'O', 614, 'Y', ''),
('IARS', '생성형 AI', 'Android Studio', '발신', 'O', 615, 'Y', ''),
('IORR', '생성형 AI', 'Open Router', '수신', 'O', 616, 'Y', ''),
('IORS', '생성형 AI', 'Open Router', '발신', 'O', 617, 'Y', ''),
('IAMS', '생성형 AI', '구글 AI 모드', '발신', 'O', 618, 'Y', ''),
('IAMR', '생성형 AI', '구글 AI 모드', '수신', 'O', 619, 'Y', ''),
('ITIS', '생성형 AI', 'Timely GPT', '발신', 'O', 620, 'Y', ''),
('ITIR', '생성형 AI', 'Timely GPT', '수신', 'O', 621, 'Y', ''),
('IOTS', '생성형 AI', 'Otter.ai', '발신', 'O', 622, 'Y', ''),
('IOTR', '생성형 AI', 'Otter.ai', '수신', 'O', 623, 'Y', ''),
('IAGS', '생성형 AI', 'Gemini Enterprise', '발신', 'O', 624, 'Y', ''),
('IAGR', '생성형 AI', 'Gemini Enterprise', '수신', 'I', 625, 'Y', ''),
('ISPS', '생성형 AI', 'Soda Pdf', '발신', 'O', 626, 'Y', ''),
('ISPR', '생성형 AI', 'Soda Pdf', '수신', 'I', 627, 'Y', ''),
('IFPS', '생성형 AI', 'FreePik', '발신', 'O', 628, 'Y', ''),
('IFPR', '생성형 AI', 'FreePik', '수신', 'I', 629, 'Y', ''),
('IATS', '생성형 AI', 'Antigravity', '발신', 'O', 630, 'Y', ''),
('IATR', '생성형 AI', 'Antigravity', '수신', 'I', 631, 'Y', ''),
('ITOS', '생성형 AI', 'Tigris AI+', '발신', 'O', 632, 'Y', ''),
('IODS', '생성형 AI', 'OpenCode AI', '발신', 'O', 633, 'Y', ''),
('IODR', '생성형 AI', 'OpenCode AI', '수신', 'I', 634, 'Y', ''),
('ITNS', '생성형 AI', 'Tunee AI', '발신', 'O', 635, 'Y', ''),
('ITNR', '생성형 AI', 'Tunee AI', '수신', 'I', 636, 'Y', ''),
('IWES', '생성형 AI', 'WeeAI', '발신', 'O', 637, 'Y', ''),
('IWER', '생성형 AI', 'WeeAI', '수신', 'I', 638, 'Y', ''),
('IHAS', '생성형 AI', 'Hailuo AI', '발신', 'O', 639, 'Y', ''),
('IHAR', '생성형 AI', 'Hailuo AI', '수신', 'I', 640, 'Y', ''),
('IHIS', '생성형 AI', 'Higgsfield', '발신', 'O', 641, 'Y', ''),
('IOAS', '생성형 AI', 'OpenAI API', '발신', 'O', 642, 'Y', ''),
('IOAR', '생성형 AI', 'OpenAI API', '수신', 'I', 643, 'Y', ''),
('IKLS', '생성형 AI', 'Kling AI', '발신', 'O', 644, 'Y', ''),
('IKLR', '생성형 AI', 'Kling AI', '수신', 'I', 645, 'Y', ''),
('ICKS', '생성형 AI', 'CudekAI', '발신', 'O', 646, 'Y', ''),
('ICKR', '생성형 AI', 'CudekAI', '수신', 'I', 647, 'Y', ''),
('IAKS', '생성형 AI', 'Amazonbedrock', '발신', 'O', 648, 'Y', ''),
('IAKR', '생성형 AI', 'Amazonbedrock', '수신', 'I', 649, 'Y', ''),
('IBIQ', '생성형 AI', 'Microsoft Copilot', '발신', 'O', 650, 'Y', ''),
('IBIZ', '생성형 AI', 'Microsoft Copilot', '수신', 'I', 651, 'Y', ''),
('IINS', '생성형 AI', 'IN7', '발신', 'O', 652, 'Y', ''),
('IINR', '생성형 AI', 'IN7', '수신', 'I', 653, 'Y', ''),
('IINQ', '생성형 AI', 'IN7', '발신', 'O', 654, 'Y', ''),
('IGXS', '생성형 AI', 'Google Labs', '발신', 'O', 655, 'Y', ''),
('IGXR', '생성형 AI', 'Google Labs', '수신', 'I', 656, 'Y', ''),
('IDCS', '생성형 AI', 'Claude Console', '발신', 'O', 657, 'Y', ''),
('IDCR', '생성형 AI', 'Claude Console', '수신', 'I', 658, 'Y', ''),
('IDCQ', '생성형 AI', 'Claude Console', '발신', 'O', 659, 'Y', ''),
('IPZS', '생성형 AI', 'Pulze', '발신', 'O', 660, 'Y', ''),
('IPZQ', '생성형 AI', 'Pulze', '발신', 'O', 661, 'Y', ''),
('IMSR', '생성형 AI', 'Google Ai Studio', '수신', 'I', 662, 'Y', ''),
('ILMR', '생성형 AI', 'GoogleNotebook LM', '수신', 'I', 663, 'Y', ''),
('ICYS', '생성형 AI', 'Cherry API', '발신', 'O', 664, 'Y', ''),
('ICYR', '생성형 AI', 'Cherry API', '수신', 'I', 665, 'Y', ''),
('ITAS', '생성형 AI', 'Timely AI', '발신', 'O', 666, 'Y', ''),
('ITAQ', '생성형 AI', 'Timely AI', '발신', 'O', 667, 'Y', ''),
('ITAR', '생성형 AI', 'Timely AI', '수신', 'I', 668, 'Y', ''),
('IPJS', '생성형 AI', 'Pitch', '발신', 'O', 669, 'Y', ''),
('IPJR', '생성형 AI', 'Pitch', '수신', 'I', 670, 'Y', ''),
('IPJQ', '생성형 AI', 'Pitch', '발신', 'O', 671, 'Y', ''),
('PDOS', '프로젝트', 'dooray', '발신', 'O', 672, 'Y', ''),
('PGIS', '프로젝트', 'github', '발신', 'O', 673, 'Y', ''),
('PGLS', '프로젝트', 'Glassdoor', '발신', 'O', 674, 'Y', ''),
('PJDS', '프로젝트', '잔디', '발신', 'O', 675, 'Y', ''),
('PITS', '프로젝트', 'Google Issue Tracker', '발신', 'O', 676, 'Y', ''),
('EBDR', '그룹웨어', '게시', '수신', 'I', 677, 'Y', ''),
('EBD-', '그룹웨어', '게시', '발신', 'O', 678, 'Y', ''),
('EBBR', '그룹웨어', '게시판', '수신', 'I', 679, 'Y', ''),
('EBBS', '그룹웨어', '게시판', '발신', 'O', 680, 'Y', ''),
('EBBF', '그룹웨어', '게시판', '파일수신', 'I', 681, 'Y', ''),
('EAAR', '그룹웨어', '결재', '수신', 'I', 682, 'Y', ''),
('EAAS', '그룹웨어', '결재', '발신', 'O', 683, 'Y', ''),
('EAAG', '그룹웨어', '결재', '통보 - 수신', 'I', 684, 'Y', ''),
('EAAP', '그룹웨어', '결재', '통보 - 발신', 'O', 685, 'Y', ''),
('EAAF', '그룹웨어', '결재', '파일수신', 'I', 686, 'Y', ''),
('EMMR', '그룹웨어', '메일', '그룹웨어 수신', 'I', 687, 'Y', ''),
('EMMS', '그룹웨어', '메일', '그룹웨어 발신', 'O', 688, 'Y', ''),
('EMMG', '그룹웨어', '메일', 'OWA 수신', 'I', 689, 'Y', ''),
('EMMP', '그룹웨어', '메일', 'OWA 발신', 'O', 690, 'Y', ''),
('EMMD', '그룹웨어', '메일', 'RPC 수신', 'I', 691, 'Y', ''),
('EMMU', '그룹웨어', '메일', 'RPC 발신', 'O', 692, 'Y', ''),
('EMMC', '그룹웨어', '메일', '수신', 'I', 693, 'Y', ''),
('EMML', '그룹웨어', '메일', '발신', 'O', 694, 'Y', ''),
('EMM1', '그룹웨어', '메일', '보안등급1', 'O', 695, 'Y', ''),
('EMM2', '그룹웨어', '메일', '보안등급2', 'O', 696, 'Y', ''),
('EMM3', '그룹웨어', '메일', '보안등급3', 'O', 697, 'Y', ''),
('EMM4', '그룹웨어', '메일', '보안등급4', 'O', 698, 'Y', ''),
('EMMA', '그룹웨어', '메일', '임시(자동)', 'O', 699, 'Y', ''),
('EMMT', '그룹웨어', '메일', '임시(수동)', 'O', 700, 'Y', ''),
('EMMK', '그룹웨어', '메일', 'Outlook - 수신', 'I', 701, 'Y', ''),
('EMMO', '그룹웨어', '메일', 'Outlook - 발신', 'O', 702, 'Y', ''),
('EMMB', '그룹웨어', '메일', '그룹웨어 예약메일', 'O', 703, 'Y', ''),
('EMBR', '그룹웨어', '모바일', '수신', 'I', 704, 'Y', ''),
('EMB-', '그룹웨어', '모바일', '발신', 'O', 705, 'Y', ''),
('EWSR', '그룹웨어', '웹서비스', '수신', 'I', 706, 'Y', ''),
('EWS-', '그룹웨어', '웹서비스', '발신', 'O', 707, 'Y', ''),
('EPUR', '그룹웨어', '일반', '수신', 'I', 708, 'Y', ''),
('EPU-', '그룹웨어', '일반', '발신', 'O', 709, 'Y', ''),
('EAU-', '그룹웨어', '일반(자동전달)', '자동전달', 'O', 710, 'Y', ''),
('ESCR', '그룹웨어', '일정 명함', '수신', 'I', 711, 'Y', ''),
('ESC-', '그룹웨어', '일정 명함', '발신', 'O', 712, 'Y', ''),
('EMF-', '그룹웨어', '파일 다운로드', '-', 'I', 713, 'Y', ''),
('EMU-', '그룹웨어', '기타', '', 'O', 714, 'Y', ''),
('ETOS', '그룹웨어', 'Tigris', '기타', 'O', 715, 'Y', ''),
('EMDR', '그룹웨어', '드라이브', '수신', 'I', 716, 'Y', ''),
('EMDS', '그룹웨어', '드라이브', '발신', 'O', 717, 'Y', ''),
('ETOD', '그룹웨어', 'Tigris', '드라이브', 'O', 718, 'Y', ''),
('ECIS', '그룹웨어', 'Samsung cic', '발신', 'O', 719, 'Y', ''),
('EMER', '그룹웨어', '메신저', '수신', 'I', 720, 'Y', ''),
('EMES', '그룹웨어', '메신저', '발신', 'O', 721, 'Y', ''),
('EMEC', '그룹웨어', '메신저', '채팅', 'O', 722, 'Y', 'MSG'),
('ETOC', '그룹웨어', 'Tigris', '메신저', 'O', 723, 'Y', ''),
('ETOA', '그룹웨어', 'Tigris', '결재', 'O', 724, 'Y', ''),
('EZQC', '그룹웨어', 'Zohocliq', '채팅', 'O', 725, 'Y', ''),
('EZQS', '그룹웨어', 'Zohocliq', '캘린더', 'O', 726, 'Y', ''),
('EKWS', '그룹웨어', '카카오워크', '발신', 'O', 727, 'Y', ''),
('ECAS', '그룹웨어', '일정', '발신', 'O', 728, 'Y', ''),
('DCCS', '편집기', 'Clip Champ', '발신', 'O', 729, 'Y', ''),
('DFGS', '편집기', 'Figma', '발신', 'O', 730, 'Y', ''),
('DOVS', '편집기', 'Overleaf', '발신', 'O', 731, 'Y', ''),
('DOVR', '편집기', 'Overleaf', '수신', 'I', 732, 'Y', ''),
('DPKS', '편집기', 'Plunker', '발신', 'O', 733, 'Y', ''),
('DNWS', '편집기', 'Namu.wiki', '발신', 'O', 734, 'Y', ''),
('DWKS', '편집기', 'WikiPedia', '발신', 'O', 735, 'Y', ''),
('DAES', '편집기', 'Adobe Express', '발신', 'O', 736, 'Y', ''),
('DSMS', '편집기', 'Sketchmon', '발신', 'O', 737, 'Y', ''),
('DGSS', '편집기', 'Google Site', '발신', 'O', 738, 'Y', ''),
('DCVS', '편집기', 'Canva', '발신', 'O', 739, 'Y', ''),
('DMBS', '편집기', '망고보드', '발신', 'O', 740, 'Y', ''),
('DMTS', '편집기', '망고툰', '발신', 'O', 741, 'Y', ''),
('JBDS', '웹사이트', 'Baidu', '발신', 'O', 742, 'Y', ''),
('JANS', '웹사이트', 'Anthropic', '발신', 'O', 743, 'Y', ''),
('JKAS', '웹사이트', 'Kaggle', '발신', 'O', 744, 'Y', ''),
('JJPS', '웹사이트', 'justpaste.it', '발신', 'O', 745, 'Y', ''),
('JPBS', '웹사이트', 'pastebin.com', '발신', 'O', 746, 'Y', ''),
('JNNS', '웹사이트', 'n8n', '발신', 'O', 747, 'Y', ''),
('JGHS', '웹사이트', 'Google cloud console', '발신', 'O', 748, 'Y', ''),
('JALS', '웹사이트', 'AnessLab', '발신', 'O', 749, 'Y', ''),
('JCCS', '웹사이트', 'CMCC [GUI-AGENT]', '발신', 'O', 750, 'Y', ''),
('JOTS', '웹사이트', 'Otter.ai', '발신', 'O', 751, 'Y', ''),
('JMLS', '웹사이트', 'Menlosecurity', '발신', 'O', 752, 'Y', ''),
('JHFS', '웹사이트', 'Hugging Face', '발신', 'O', 753, 'Y', ''),
('JSNS', '웹사이트', 'AWS SNS', '발신', 'O', 754, 'Y', ''),
('JAGS', '웹사이트', 'AWS API Gateway', '발신', 'O', 755, 'Y', ''),
('JASS', '웹사이트', 'AWS SSM', '발신', 'O', 756, 'Y', ''),
('RGUS', '원격접속', '아파치 과카몰리', '발신', 'O', 757, 'Y', ''),
('RGUR', '원격접속', '아파치 과카몰리', '수신', 'I', 758, 'Y', ''),
('KAAR', '웹서비스(분류)', '웹 수신', '수신', 'I', 759, 'Y', ''),
('KAAS', '웹서비스(분류)', '웹 발신', '발신', 'O', 760, 'Y', '');
