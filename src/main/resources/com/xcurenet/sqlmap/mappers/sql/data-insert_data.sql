...
('QDCC', '메신저', 'Discord', '채팅', 'O', 297, 'Y', ''),
('QDCF', '메신저', 'Discord', '첨부파일', 'O', 298, 'Y', ''),
('FFTC', '파일전송', 'FTP', 'CMD', 'O', 299, 'Y', ''),
('FFTG', '파일전송', 'FTP', 'GET', 'I', 300, 'Y', ''),
('FFTP', '파일전송', 'FTP', 'PUT', 'O', 301, 'Y', ''),
('FFTL', '파일전송', 'FTP', 'CONNECT', 'O', 302, 'Y', ''),
('FZM-', '파일전송', 'Zmodem', '-', 'O', 303, 'Y', ''),
('FNVR', '파일전송', '네이버 MYBOX', '수신', 'I', 304, 'Y', ''),
('FNVS', '파일전송', '네이버 MYBOX', '발신', 'O', 305, 'Y', ''),
('FGGR', '파일전송', '구글 드라이브', '수신', 'I', 306, 'Y', ''),
('FGGS', '파일전송', '구글 드라이브', '발신', 'O', 307, 'Y', ''),
('FODR', '파일전송', 'OneDrive', '수신', 'I', 308, 'Y', ''),
('FODS', '파일전송', 'OneDrive', '발신', 'O', 309, 'Y', ''),
('FDBR', '파일전송', 'Dropbox', '수신', 'I', 310, 'Y', ''),
('FDBS', '파일전송', 'Dropbox', '발신', 'O', 311, 'Y', ''),
('F2NR', '파일전송', '2nd 드라이브', '수신', 'I', 312, 'N', ''),
('F2NS', '파일전송', '2nd 드라이브', '발신', 'O', 313, 'N', ''),
('FPSR', '파일전송', 'Polarisoffice ', '수신', 'I', 314, 'Y', ''),
('FICR', '파일전송', 'Icloud', '수신', 'I', 315, 'Y', ''),
('FICS', '파일전송', 'Icloud', '발신', 'O', 316, 'Y', ''),
('FYDR', '파일전송', 'Yandex', '수신', 'I', 317, 'Y', ''),
('FYDS', '파일전송', 'Yandex', '발신', 'O', 318, 'Y', ''),
('FWHR', '파일전송', 'LG 웹하드', '수신', 'I', 319, 'Y', ''),
('FWHS', '파일전송', 'LG 웹하드', '발신', 'O', 320, 'Y', ''),
('FGIR', '파일전송', 'GitHub', '수신', 'I', 321, 'Y', ''),
('FGIS', '파일전송', 'GitHub', '발신', 'O', 322, 'Y', ''),
('FDOR', '파일전송', 'Dooray', '수신', 'I', 323, 'Y', ''),
('FDOS', '파일전송', 'Dooray', '발신', 'O', 324, 'Y', ''),
('FWES', '파일전송', 'Wetransfer', '발신', 'O', 325, 'Y', ''),
('FASS', '파일전송', 'AWS S3 bucket', '발신', 'O', 326, 'Y', ''),
('FGES', '파일전송', '구글 렌즈', '발신', 'O', 327, 'Y', ''),
('FTRS', '파일전송', 'File Transfer.io', '발신', 'O', 328, 'Y', ''),
('FCLS', '파일전송', 'pCloud Transfer', '발신', 'O', 329, 'Y', ''),
('FMZS', '파일전송', 'M/Z Cloud', '발신', 'O', 330, 'Y', ''),
('FMZR', '파일전송', 'M/Z Cloud', '수신', 'I', 331, 'Y', ''),
('FUKR', '파일전송', '기타', '수신', 'I', 332, 'Y', ''),
('FUKS', '파일전송', '기타', '발신', 'O', 333, 'Y', ''),
('FPTS', '파일전송', '구글 포토', '발신', 'O', 334, 'Y', ''),
('FAZS', '파일전송', 'Azure Blob Storage', '발신', 'O', 335, 'Y', ''),
('FCTS', '파일전송', 'Cow Transfer', '발신', 'O', 336, 'Y', ''),
('FGCS', '파일전송', '구글 클라우드 스토리지', '발신', 'O', 337, 'Y', ''),
('FSVS', '파일전송', 'Tortoise SVN', '발신', 'O', 338, 'Y', ''),
('FTFS', '파일전송', 'AWS Transfer Family', '발신', 'O', 339, 'Y', ''),
('NPPS', '노트', 'polarisoffice', '발신', 'O', 340, 'Y', ''),
('NENR', '노트', 'EVERNOTE', '수신', 'I', 341, 'Y', ''),
('NENS', '노트', 'EVERNOTE', '발신', 'O', 342, 'Y', ''),
('NONR', '노트', 'ONENOTE', '수신', 'I', 343, 'Y', ''),
('NONS', '노트', 'ONENOTE', '발신', 'O', 344, 'Y', ''),
('NLVS', '노트', 'Outlook.com 메모', '발신', 'O', 345, 'Y', ''),
('NBTS', '노트', 'BIT.AI', '발신', 'O', 346, 'Y', ''),
('NNOS', '노트', 'Notion', '발신', 'O', 347, 'Y', ''),
('NGGS', '노트', '구글 docs', '발신', 'O', 348, 'Y', ''),
('NGTS', '노트', '구글 tasks', '발신', 'O', 349, 'Y', ''),
('NGKS', '노트', '구글 keep', '발신', 'O', 350, 'Y', ''),
('NSSR', '노트', '삼성 노트', '수신', 'I', 351, 'Y', ''),
('NSSS', '노트', '삼성 노트', '발신', 'O', 352, 'Y', ''),
('NNVS', '노트', '네이버 오피스', '발신', 'O', 353, 'Y', ''),
('NDBS', '노트', 'Dropbox paper', '발신', 'O', 354, 'Y', ''),
('NHCS', '노트', '한컴 오피스', '발신', 'O', 355, 'Y', ''),
('NMOS', '노트', 'MS오피스', '발신', 'O', 356, 'Y', ''),
('NCDS', '노트', 'Coda', '발신', 'O', 357, 'Y', ''),
('NNMR', '노트', '네이버 메모', '수신', 'I', 358, 'Y', ''),
('NNMS', '노트', '네이버 메모', '발신', 'O', 359, 'Y', ''),
('NCNS', '노트', 'Clova Note', '발신', 'O', 360, 'Y', ''),
('NGIS', '노트', 'Github Gist', '발신', 'O', 361, 'Y', ''),
('NSNS', '노트', 'SimpleNote', '발신', 'O', 362, 'Y', ''),
('NAGS', '노트', 'Agit', '발신', 'O', 363, 'Y', ''),
('NPSS', '노트', 'Polaris office', '발신', 'O', 364, 'Y', ''),
('NBOS', '노트', 'Box', '발신', 'O', 365, 'Y', ''),
('NCKS', '노트', 'ClickUp', '발신', 'O', 366, 'Y', ''),
('NGNS', '노트', 'Goodnotes', '발신', 'O', 367, 'Y', ''),
('NMNS', '노트', 'Milanote', '발신', 'O', 368, 'Y', ''),
('NZQS', '노트', 'zohocliq', '발신', 'O', 369, 'Y', ''),
('NMTS', '노트', 'Mentimeter', '발신', 'O', 370, 'Y', ''),
('NOOS', '노트', 'Goorm', '발신', 'O', 371, 'Y', ''),
('NMIS', '노트', '밀리의서재', '발신', 'O', 372, 'Y', ''),
('NUKS', '노트', '기타', '발신', 'O', 373, 'Y', ''),
('NCRS', '노트', 'Craft', '발신', 'O', 374, 'Y', ''),
('AGCR', '일정', '구글캘린더일정', '수신', 'I', 375, 'N', ''),
('AGCS', '일정', '구글캘린더일정', '발신', 'O', 376, 'Y', ''),
('AGLR', '일정', '구글캘린더메일', '수신', 'I', 377, 'N', ''),
('AGLS', '일정', '구글캘린더메일', '발신', 'O', 378, 'Y', ''),
('ANCS', '일정', '네이버 캘린더', '발신', 'O', 379, 'Y', ''),
('ZTN-', '기타 서비스', 'Telnet', '-', 'O', 380, 'Y', ''),
('ZXT-', '기타 서비스', 'Xterm', '-', 'O', 381, 'Y', ''),
('ZRL-', '기타 서비스', 'R-Login', '-', 'O', 382, 'Y', ''),
('ZNP-', '기타 서비스', 'NNTP', '-', 'O', 383, 'Y', ''),
('ZPC-', '기타 서비스', 'PC 보안', '-', 'O', 384, 'N', ''),
('ZSH-', '기타 서비스', 'SSH', 'SSH 세션 정보', 'O', 385, 'Y', ''),
('XX1R', '모니터링_제외', '미분류_타입1', '수신', 'I', 386, 'Y', ''),
('XX1S', '모니터링_제외', '미분류_타입1', '발신', 'O', 387, 'Y', ''),
('XX2R', '모니터링_제외', '미분류_타입2', '수신', 'I', 388, 'Y', ''),
('XX2S', '모니터링_제외', '미분류_타입2', '발신', 'O', 389, 'Y', ''),
('XX3R', '모니터링_제외', '미분류_타입3', '수신', 'I', 390, 'Y', ''),
('XX3S', '모니터링_제외', '미분류_타입3', '발신', 'O', 391, 'Y', ''),
('XU1R', '모니터링_제외', '웹서비스(미분류)_타입1', '수신', 'I', 392, 'Y', ''),
('XU1S', '모니터링_제외', '웹서비스(미분류)_타입1', '발신', 'O', 393, 'Y', ''),
('XU2R', '모니터링_제외', '웹서비스(미분류)_타입2', '수신', 'I', 394, 'Y', ''),
('XU2S', '모니터링_제외', '웹서비스(미분류)_타입2', '발신', 'O', 395, 'Y', ''),
('XU3R', '모니터링_제외', '웹서비스(미분류)_타입3', '수신', 'I', 396, 'Y', ''),
('XU3S', '모니터링_제외', '웹서비스(미분류)_타입3', '발신', 'O', 397, 'Y', ''),
('XU4R', '모니터링_제외', '필수 로깅', '수신', 'I', 398, 'Y', ''),
('XU4S', '모니터링_제외', '필수 로깅', '발신', 'O', 399, 'Y', ''),
('UWSD', '웹서비스(미분류)', '웹 발신', '첨부 - 문서타입', 'O', 400, 'Y', ''),
('UWSE', '웹서비스(미분류)', '웹 발신', '첨부 - 문서아님', 'O', 401, 'Y', ''),
('UWSU', '웹서비스(미분류)', '웹 발신', '첨부 없음', 'O', 402, 'Y', ''),
('UWSH', '웹서비스(미분류)', '웹 발신', '중요도(상)', 'O', 403, 'Y', ''),
('UWSM', '웹서비스(미분류)', '웹 발신', '중요도(중)', 'O', 404, 'Y', ''),
('UWSL', '웹서비스(미분류)', '웹 발신', '중요도(하)', 'O', 405, 'Y', ''),
('UX1R', '웹서비스(미분류)', '미분류_타입1', '수신', 'I', 406, 'Y', ''),
('UX1S', '웹서비스(미분류)', '미분류_타입1', '발신', 'O', 407, 'Y', ''),
('UX2R', '웹서비스(미분류)', '미분류_타입2', '수신', 'I', 408, 'Y', ''),
('UX2S', '웹서비스(미분류)', '미분류_타입2', '발신', 'O', 409, 'Y', ''),
('UX3R', '웹서비스(미분류)', '미분류_타입3', '수신', 'I', 410, 'Y', ''),
('UX3S', '웹서비스(미분류)', '미분류_타입3', '발신', 'O', 411, 'Y', ''),
('UWRD', '웹서비스(미분류)', '웹 수신', '첨부 - 문서타입', 'I', 412, 'Y', ''),
('UWRE', '웹서비스(미분류)', '웹 수신', '첨부 - 문서아님', 'I', 413, 'Y', ''),
('UWRU', '웹서비스(미분류)', '웹 수신', '첨부 없음', 'I', 414, 'Y', ''),
('BWSD', '웹서비스(업무)', '업무 발신', '첨부 - 문서타입', 'O', 415, 'Y', ''),
('BWSE', '웹서비스(업무)', '업무 발신', '첨부 - 문서아님', 'O', 416, 'Y', ''),
('BWSU', '웹서비스(업무)', '업무 발신', '첨부 없음', 'O', 417, 'Y', ''),
('BWRD', '웹서비스(업무)', '업무 수신', '첨부 - 문서타입', 'I', 418, 'Y', ''),
('BWRE', '웹서비스(업무)', '업무 수신', '첨부 - 문서아님', 'I', 419, 'Y', ''),
('BWRU', '웹서비스(업무)', '업무 수신', '첨부 없음', 'I', 420, 'Y', ''),
('TWEC', '화상회의', 'Webex', '채팅', 'O', 421, 'Y', 'MSG'),
('TWEF', '화상회의', 'Webex', '파일전송', 'O', 422, 'Y', 'MSG'),
('TWEJ', '화상회의', 'Webex', '참여', 'O', 423, 'Y', 'MSG'),
('TWEL', '화상회의', 'Webex', '떠남', 'O', 424, 'Y', 'MSG'),
('TZOC', '화상회의', 'Zoom', '채팅', 'O', 425, 'Y', 'MSG'),
('TZOF', '화상회의', 'Zoom', '파일전송', 'O', 426, 'Y', 'MSG'),
('TZOJ', '화상회의', 'Zoom', '참여', 'O', 427, 'Y', 'MSG'),
('TZOL', '화상회의', 'Zoom', '떠남', 'O', 428, 'Y', 'MSG'),
('TTMC', '화상회의', 'Teams', '채팅', 'O', 429, 'Y', 'MSG'),
('TTMF', '화상회의', 'Teams', '파일전송', 'O', 430, 'Y', 'MSG'),
('TTMJ', '화상회의', 'Teams', '참여', 'O', 431, 'Y', 'MSG'),
('TTML', '화상회의', 'Teams', '떠남', 'O', 432, 'Y', 'MSG'),
('TSKC', '화상회의', 'Skype', '채팅', 'O', 433, 'Y', 'MSG'),
('TSKF', '화상회의', 'Skype', '파일전송', 'O', 434, 'Y', 'MSG'),
('TSKJ', '화상회의', 'Skype', '참여', 'O', 435, 'Y', 'MSG'),
('TSKL', '화상회의', 'Skype', '떠남', 'O', 436, 'Y', 'MSG'),
('TJMC', '화상회의', 'JoinME', '채팅', 'O', 437, 'Y', 'MSG'),
('TJMF', '화상회의', 'JoinME', '파일전송', 'O', 438, 'Y', 'MSG'),
('TAMC', '화상회의', 'Amazon Chime', '채팅', 'O', 439, 'Y', 'MSG'),
('TAMF', '화상회의', 'Amazon Chime', '파일전송', 'O', 440, 'Y', 'MSG'),
('TBJC', '화상회의', 'BlueJeans', '채팅', 'O', 441, 'Y', 'MSG'),
('TTDS', '화상회의', 'Tl;dv', '채팅', 'O', 442, 'Y', 'MSG'),
('LNVS', '번역기', '파파고 번역', '발신', 'O', 443, 'Y', ''),
('LGGS', '번역기', '구글 번역', '발신', 'O', 444, 'Y', ''),
('LGPS', '번역기', '구글 번역 플러그인', '발신', 'O', 445, 'Y', ''),
('LDES', '번역기', 'Deepl', '발신', 'O', 446, 'Y', ''),
('LBIS', '번역기', 'Bing 번역', '발신', 'O', 447, 'Y', ''),
('LYMS', '번역기', 'Yandex 번역', '발신', 'O', 448, 'Y', ''),
('LGAS', '번역기', 'Google Cloud Translation Api', '발신', 'O', 449, 'Y', ''),
('LFTS', '번역기', 'Flitto', '발신', 'O', 450, 'Y', ''),
('LOTS', '번역기', 'O-Translator', '발신', 'O', 451, 'Y', ''),
('LUKS', '번역기', '기타', '발신', 'O', 452, 'Y', ''),
('LTRS', '번역기', 'Translate', '발신', 'O', 453, 'Y', ''),
('LODS', '번역기', 'onlinedoctranslator', '발신', 'O', 454, 'Y', ''),
('IGBS', '생성형 AI', '구글 Gemini', '발신', 'O', 455, 'Y', ''),
('IGBR', '생성형 AI', '구글 Gemini', '수신', 'I', 456, 'Y', ''),
('IBIS', '생성형 AI', ' Microsoft Copilot', '발신', 'O', 457, 'Y', ''),
('IWTS', '생성형 AI', 'Wrtn', '발신', 'O', 458, 'Y', ''),
('IGPS', '생성형 AI', 'ChatGPT', '발신', 'O', 459, 'Y', ''),
('IGPR', '생성형 AI', 'ChatGPT', '수신', 'I', 460, 'Y', ''),
('IDAS', '생성형 AI', 'Dall-E', '발신', 'O', 461, 'Y', ''),
('IGCS', '생성형 AI', 'Github Copilot', '발신', 'O', 462, 'Y', ''),
('IGCR', '생성형 AI', 'Github Copilot', '수신', 'I', 463, 'Y', ''),
('IYCS', '생성형 AI', 'YouChat', '발신', 'O', 464, 'Y', ''),
('ICSS', '생성형 AI', 'Chatsonic', '발신', 'O', 465, 'Y', ''),
('IRPS', '생성형 AI', 'Replika', '발신', 'O', 466, 'Y', ''),
('IPPS', '생성형 AI', 'Perplexity', '발신', 'O', 467, 'Y', ''),
('IPPR', '생성형 AI', 'Perplexity', '수신', 'I', 468, 'Y', ''),
('ITCS', '생성형 AI', 'TextCortex', '발신', 'O', 469, 'Y', ''),
('IPHS', '생성형 AI', 'Phind', '발신', 'O', 470, 'Y', ''),
('IPOS', '생성형 AI', 'Poe', '발신', 'O', 471, 'Y', ''),
('IHFS', '생성형 AI', 'Hugging Face', '발신', 'O', 472, 'Y', ''),
('IHFR', '생성형 AI', 'Hugging Face', '수신', 'I', 473, 'Y', ''),
('ICPS', '생성형 AI', 'Copy.AI', '발신', 'O', 474, 'Y', ''),
('IHWS', '생성형 AI', 'HyperWrite', '발신', 'O', 475, 'Y', ''),
('IDPS', '생성형 AI', 'DeepAI', '발신', 'O', 476, 'Y', ''),
('IACS', '생성형 AI', 'AskCodi', '발신', 'O', 477, 'Y', ''),
('IACR', '생성형 AI', 'AskCodi', '수신', 'I', 478, 'Y', ''),
('INAS', '생성형 AI', 'Native', '발신', 'O', 479, 'Y', ''),
('INFS', '생성형 AI', 'NeuroFlash', '발신', 'O', 480, 'Y', ''),
('INOS', '생성형 AI', 'Notion AI', '발신', 'O', 481, 'Y', ''),
('INOR', '생성형 AI', 'Notion AI', '수신', 'I', 482, 'Y', ''),
('IMES', '생성형 AI', 'Merlin', '발신', 'O', 483, 'Y', ''),
('IMER', '생성형 AI', 'Merlin', '수신', 'O', 484, 'Y', ''),
('ICXS', '생성형 AI', 'CLOVA-X', '발신', 'O', 485, 'Y', ''),
('IADS', '생성형 AI', 'Adobe AI', '발신', 'O', 486, 'Y', ''),
('ICDS', '생성형 AI', 'ClipDrop', '발신', 'O', 487, 'Y', ''),
('ISBS', '생성형 AI', 'Stability.Ai', '발신', 'O', 488, 'Y', ''),
('IRMS', '생성형 AI', 'Runwayml', '발신', 'O', 489, 'Y', ''),
('IGVS', '생성형 AI', 'Google Vertex', '발신', 'O', 490, 'Y', ''),
('IGVR', '생성형 AI', 'Google Vertex', '수신', 'I', 491, 'Y', ''),
('IGLS', '생성형 AI', 'Google Colab', '발신', 'O', 492, 'Y', ''),
('ICWS', '생성형 AI', 'CodeWhisperer', '발신', 'O', 493, 'Y', ''),
('IMSS', '생성형 AI', 'Google AI Studio', '발신', 'O', 494, 'Y', ''),
('IOCS', '생성형 AI', 'Clova OCR', '발신', 'O', 495, 'Y', ''),
('IAOS', '생성형 AI', 'Azure OpenAI', '발신', 'O', 496, 'Y', ''),
('IAOR', '생성형 AI', 'Azure OpenAI', '수신', 'I', 497, 'Y', ''),
('ICUS', '생성형 AI', '네이버 CUE:', '발신', 'O', 498, 'Y', ''),
('IMJS', '생성형 AI', 'Midjourney', '발신', 'O', 499, 'Y', ''),
('ISGR', '생성형 AI', 'slidesGPT', '수신', 'I', 500, 'Y', ''),
('ISGS', '생성형 AI', 'SlidesGPT', '발신', 'O', 501, 'Y', ''),
('IDMS', '생성형 AI', 'Ai Docmaker', '발신', 'O', 502, 'Y', ''),
('IRKS', '생성형 AI', 'Reka AI', '발신', 'O', 503, 'Y', ''),
('IRKR', '생성형 AI', 'Reka AI', '수신', 'O', 504, 'Y', ''),
('ICLS', '생성형 AI', 'Claude', '발신', 'O', 505, 'Y', ''),
('ICLR', '생성형 AI', 'Claude', '수신', 'I', 506, 'Y', ''),
('IDMR', '생성형 AI', 'AI Docmaker Attach', '수신', 'I', 507, 'Y', ''),
('IADR', '생성형 AI', 'Adobe firefly login', '수신', 'I', 508, 'Y', ''),
('IWDS', '생성형 AI', 'Dream by WOMBO', '발신', 'O', 509, 'Y', ''),
('IGAS', '생성형 AI', 'GetImg.AI', '발신', 'O', 510, 'Y', ''),
('IWKS', '생성형 AI', 'Wrks.ai', '발신', 'O', 511, 'Y', ''),
('IPSS', '생성형 AI', 'Polaris office ai', '발신', 'O', 512, 'Y', ''),
('IBGS', '생성형 AI', 'Goover AI', '발신', 'O', 513, 'Y', ''),
('IIAS', '생성형 AI', 'iAsk AI', '발신', 'O', 514, 'Y', ''),
('ISNS', '생성형 AI', 'Suno AI', '발신', 'O', 515, 'Y', ''),
('IPES', '생성형 AI', 'Perchance', '발신', 'O', 516, 'Y', ''),
('IPFS', '생성형 AI', 'ChatPDF', '발신', 'O', 517, 'Y', ''),
('IXOS', '생성형 AI', 'Exaone', '발신', 'O', 518, 'Y', ''),
('IXOR', '생성형 AI', 'Exaone', '수신', 'I', 519, 'Y', ''),
('ISOR', '생성형 AI', 'Slidesgo', '수신', 'I', 520, 'Y', ''),
('ISOS', '생성형 AI', 'Slidesgo', '발신', 'O', 521, 'Y', ''),
('IKRS', '생성형 AI', 'KREA', '발신', 'O', 522, 'Y', ''),
('ILMS', '생성형 AI', 'GoogleNotebook LM', '발신', 'O', 523, 'Y', ''),
('ICCS', '생성형 AI', 'Capcut', '발신', 'O', 524, 'Y', ''),
('IMGS', '생성형 AI', 'Magictool', '발신', 'O', 525, 'Y', ''),
('IGSS', '생성형 AI', 'Genspark', '발신', 'O', 526, 'Y', ''),
('IFES', '생성형 AI', 'felo', '발신', 'O', 527, 'Y', ''),
('ITPS', '생성형 AI', 'Tripo3D', '발신', 'O', 528, 'Y', ''),
('ITPR', '생성형 AI', 'Tripo3D', '수신', 'I', 529, 'Y', ''),
('IELS', '생성형 AI', 'Elevenlabs', '발신', 'O', 530, 'Y', ''),
('IELR', '생성형 AI', 'Elevenlabs', '수신', 'I', 531, 'Y', ''),
('IGRS', '생성형 AI', 'Grammarly', '발신', 'O', 532, 'Y', ''),
('IVRS', '생성형 AI', 'Vrew', '발신', 'O', 533, 'Y', ''),
('INIS', '생성형 AI', 'NightCafe', '발신', 'O', 534, 'Y', ''),
('ICAS', '생성형 AI', 'CivitAI', '발신', 'O', 535, 'Y', ''),
('ILIS', '생성형 AI', 'Liner', '발신', 'O', 536, 'Y', ''),
('IBCS', '생성형 AI', 'Bing Image Creator', '발신', 'O', 537, 'Y', ''),
('IDSS', '생성형 AI', 'Deepseek', '발신', 'O', 538, 'Y', ''),
('IBDS', '생성형 AI', 'Baidu Ai', '발신', 'O', 539, 'Y', ''),
('IGIS', '생성형 AI', 'Gemini AI api', '발신', 'O', 540, 'Y', ''),
('IDTS', '생성형 AI', '에이닷', '발신', 'O', 541, 'Y', ''),
('IDTR', '생성형 AI', '에이닷', '수신', 'I', 542, 'Y', ''),
('IQBS', '생성형 AI', 'QuillBot', '발신', 'O', 543, 'Y', ''),
('ICHS', '생성형 AI', 'Character ai', '발신', 'O', 544, 'Y', ''),
('ISRS', '생성형 AI', 'Sora/Openai', '발신', 'O', 545, 'Y', ''),
('ISRR', '생성형 AI', 'Sora/Openai', '수신', 'I', 546, 'Y', ''),
('INNS', '생성형 AI', 'Nano AI', '발신', 'O', 547, 'Y', ''),
('IDBS', '생성형 AI', 'Doubao', '발신', 'O', 548, 'Y', ''),
('ITYS', '생성형 AI', 'Tongyi', '발신', 'O', 549, 'Y', ''),
('IYBS', '생성형 AI', 'Yuanbao', '발신', 'O', 550, 'Y', ''),
('IYYS', '생성형 AI', 'Yiyan', '발신', 'O', 551, 'Y', ''),
('IKMS', '생성형 AI', 'Kimi', '발신', 'O', 552, 'Y', ''),
('IBAS', '생성형 AI', 'Baichuan', '발신', 'O', 553, 'Y', ''),
('ITGS', '생성형 AI', 'Tiangong', '발신', 'O', 554, 'Y', ''),
('ISDS', '생성형 AI', 'Stable Diffusion', '발신', 'O', 555, 'Y', ''),
('IGOS', '생성형 AI', 'Grok', '발신', 'O', 556, 'Y', ''),
('IGOR', '생성형 AI', 'Grok', '수신', 'O', 557, 'Y', ''),
('ICGS', '생성형 AI', 'ChatGLM', '발신', 'O', 558, 'Y', ''),
('INKS', '생성형 AI', 'Napkin AI', '발신', 'O', 559, 'Y', ''),
('IBIR', '생성형 AI', 'Microsoft Copilot(Chat)', '수신', 'I', 560, 'Y', ''),
('IOOS', '생성형 AI', 'AI Goormee', '발신', 'O', 561, 'Y', ''),
('IABS', '생성형 AI', 'Allibee', '발신', 'O', 562, 'Y', ''),
('ILXS', '생성형 AI', 'Lexis+', '발신', 'O', 563, 'Y', ''),
('ILAS', '생성형 AI', 'SuperLawyer', '발신', 'O', 564, 'Y', ''),
('ICOS', '생성형 AI', 'CoCounsel', '발신', 'O', 565, 'Y', ''),
('IANS', '생성형 AI', 'Anthropic', '발신', 'O', 566, 'Y', ''),
('IANR', '생성형 AI', 'Anthropic', '수신', 'I', 567, 'Y', ''),
('ISIS', '생성형 AI', 'Sider AI', '발신', 'O', 568, 'Y', ''),
('IGMS', '생성형 AI', 'Gamma', '발신', 'O', 569, 'Y', ''),
('IGMR', '생성형 AI', 'Gamma', '수신', 'I', 570, 'Y', ''),
('ICRS', '생성형 AI', 'Cursor', '발신', 'O', 571, 'Y', ''),
('ICRR', '생성형 AI', 'Cursor', '수신', 'O', 572, 'Y', ''),
('IMAS', '생성형 AI', 'ManusAI', '발신', 'O', 573, 'Y', ''),
('IMTS', '생성형 AI', 'Mistral AI', '발신', 'O', 574, 'Y', ''),
('ICBS', '생성형 AI', 'Cline', '발신', 'O', 575, 'Y', ''),
('IWBS', '생성형 AI', 'Weight & Biases', '발신', 'O', 576, 'Y', ''),
('IWBR', '생성형 AI', 'Weight & Biases', '수신', 'I', 577, 'Y', ''),
('ILLS', '생성형 AI', 'Lilys AI', '발신', 'O', 578, 'Y', ''),
('IUKS', '생성형 AI', '기타', '발신', 'O', 579, 'Y', ''),
('IGES', '생성형 AI', 'Gemini Code Assist', '발신', 'O', 580, 'Y', ''),
('IOES', '생성형 AI', 'Codex/OpenAI', '발신', 'O', 581, 'Y', ''),
('IOER', '생성형 AI', 'Codex/OpenAI', '수신', 'I', 582, 'Y', ''),
('IJLS', '생성형 AI', 'Jules', '발신', 'O', 583, 'Y', ''),
('IHVS', '생성형 AI', 'Harvey', '발신', 'O', 584, 'Y', ''),
('IXAS', '생성형 AI', 'x.AI', '발신', 'O', 585, 'Y', ''),
('ICES', '생성형 AI', 'Cohere', '발신', 'O', 586, 'Y', ''),
('IWTR', '생성형 AI', 'wrtn', '수신', 'I', 587, 'Y', ''),
('ICHR', '생성형 AI', 'Character ai', '수신', 'I', 588, 'Y', ''),
('IOWR', '생성형 AI', 'Open WebUi', '수신', 'I', 589, 'Y', ''),
('IOWS', '생성형 AI', 'Open WebUi', '발신', 'O', 590, 'Y', ''),
('ISKS', '생성형 AI', 'Skywork', '발신', 'O', 591, 'Y', ''),
('IVES', '생성형 AI', 'Veo3', '발신', 'O', 592, 'Y', ''),
('IGTS', '생성형 AI', 'Gptoss', '발신', 'O', 593, 'Y', ''),
('ILRS', '생성형 AI', 'LMArena', '발신', 'O', 594, 'Y', ''),
('ILRR', '생성형 AI', 'LMArena', '수신', 'I', 595, 'Y', ''),
('IASS', '생성형 AI', 'Chat & Ask AI', '발신', 'O', 596, 'Y', ''),
('IASR', '생성형 AI', 'Chat & Ask AI', '수신', 'I', 597, 'Y', ''),
('IARR', '생성형 AI', 'Android Studio', '수신', 'O', 598, 'Y', ''),
('IARS', '생성형 AI', 'Android Studio', '발신', 'O', 599, 'Y', ''),
('IORR', '생성형 AI', 'Open Router', '수신', 'O', 600, 'Y', ''),
('IORS', '생성형 AI', 'Open Router', '발신', 'O', 601, 'Y', ''),
('IAMS', '생성형 AI', '구글 AI 모드', '발신', 'O', 602, 'Y', ''),
('IAMR', '생성형 AI', '구글 AI 모드', '수신', 'O', 603, 'Y', ''),
('ITIS', '생성형 AI', 'Timely GPT', '발신', 'O', 604, 'Y', ''),
('ITIR', '생성형 AI', 'Timely GPT', '수신', 'O', 605, 'Y', ''),
('IOTS', '생성형 AI', 'Otter.ai', '발신', 'O', 606, 'Y', ''),
('IOTR', '생성형 AI', 'Otter.ai', '수신', 'O', 607, 'Y', ''),
('IAGS', '생성형 AI', 'Google Agent Space', '발신', 'O', 608, 'Y', ''),
('IAGR', '생성형 AI', 'Google Agent Space', '수신', 'I', 609, 'Y', ''),
('ISPS', '생성형 AI', 'Soda Pdf', '발신', 'O', 610, 'Y', ''),
('ISPR', '생성형 AI', 'Soda Pdf', '수신', 'I', 611, 'Y', ''),
('IFPS', '생성형 AI', 'FreePik', '발신', 'O', 612, 'Y', ''),
('IFPR', '생성형 AI', 'FreePik', '수신', 'I', 613, 'Y', ''),
('ITOS', '생성형 AI', 'Tigris AI+', '발신', 'O', 614, 'Y', ''),
('IATS', '생성형 AI', 'Antigravity', '발신', 'O', 615, 'Y', ''),
('IATR', '생성형 AI', 'Antigravity', '수신', 'I', 616, 'Y', ''),
('IODS', '생성형 AI', 'OpenCode AI', '발신', 'O', 617, 'Y', ''),
('IODR', '생성형 AI', 'OpenCode AI', '수신', 'I', 618, 'Y', ''),
('ITNS', '생성형 AI', 'Tunee AI', '발신', 'O', 619, 'Y', ''),
('ITNR', '생성형 AI', 'Tunee AI', '수신', 'I', 620, 'Y', ''),
('IWES', '생성형 AI', 'WeeAI', '발신', 'O', 621, 'Y', ''),
('IWER', '생성형 AI', 'WeeAI', '수신', 'I', 622, 'Y', ''),
('PDOS', '프로젝트', 'dooray', '발신', 'O', 623, 'Y', ''),
('PGIS', '프로젝트', 'github', '발신', 'O', 624, 'Y', ''),
('PGLS', '프로젝트', 'Glassdoor', '발신', 'O', 625, 'Y', ''),
('PJDS', '프로젝트', '잔디', '발신', 'O', 626, 'Y', ''),
('PITS', '프로젝트', 'Google Issue Tracker', '발신', 'O', 627, 'Y', ''),
('EBDR', '그룹웨어', '게시', '수신', 'I', 628, 'Y', ''),
('EBD-', '그룹웨어', '게시', '발신', 'O', 629, 'Y', ''),
('EBBR', '그룹웨어', '게시판', '수신', 'I', 630, 'Y', ''),
('EBBS', '그룹웨어', '게시판', '발신', 'O', 631, 'Y', ''),
('EBBF', '그룹웨어', '게시판', '파일수신', 'I', 632, 'Y', ''),
('EAAR', '그룹웨어', '결재', '수신', 'I', 633, 'Y', ''),
('EAAS', '그룹웨어', '결재', '발신', 'O', 634, 'Y', ''),
('EAAG', '그룹웨어', '결재', '통보 - 수신', 'I', 635, 'Y', ''),
('EAAP', '그룹웨어', '결재', '통보 - 발신', 'O', 636, 'Y', ''),
('EAAF', '그룹웨어', '결재', '파일수신', 'I', 637, 'Y', ''),
('EMMR', '그룹웨어', '메일', '그룹웨어 수신', 'I', 638, 'Y', ''),
('EMMS', '그룹웨어', '메일', '그룹웨어 발신', 'O', 639, 'Y', ''),
('EMMG', '그룹웨어', '메일', 'OWA 수신', 'I', 640, 'Y', ''),
('EMMP', '그룹웨어', '메일', 'OWA 발신', 'O', 641, 'Y', ''),
('EMMD', '그룹웨어', '메일', 'RPC 수신', 'I', 642, 'Y', ''),
('EMMU', '그룹웨어', '메일', 'RPC 발신', 'O', 643, 'Y', ''),
('EMMC', '그룹웨어', '메일', '수신', 'I', 644, 'Y', ''),
('EMML', '그룹웨어', '메일', '발신', 'O', 645, 'Y', ''),
('EMM1', '그룹웨어', '메일', '보안등급1', 'O', 646, 'Y', ''),
('EMM2', '그룹웨어', '메일', '보안등급2', 'O', 647, 'Y', ''),
('EMM3', '그룹웨어', '메일', '보안등급3', 'O', 648, 'Y', ''),
('EMM4', '그룹웨어', '메일', '보안등급4', 'O', 649, 'Y', ''),
('EMMA', '그룹웨어', '메일', '임시(자동)', 'O', 650, 'Y', ''),
('EMMT', '그룹웨어', '메일', '임시(수동)', 'O', 651, 'Y', ''),
('EMMK', '그룹웨어', '메일', 'Outlook - 수신', 'I', 652, 'Y', ''),
('EMMO', '그룹웨어', '메일', 'Outlook - 발신', 'O', 653, 'Y', ''),
('EMMB', '그룹웨어', '메일', '그룹웨어 예약메일', 'O', 654, 'Y', ''),
('EMBR', '그룹웨어', '모바일', '수신', 'I', 655, 'Y', ''),
('EMB-', '그룹웨어', '모바일', '발신', 'O', 656, 'Y', ''),
('EWSR', '그룹웨어', '웹서비스', '수신', 'I', 657, 'Y', ''),
('EWS-', '그룹웨어', '웹서비스', '발신', 'O', 658, 'Y', ''),
('EPUR', '그룹웨어', '일반', '수신', 'I', 659, 'Y', ''),
('EPU-', '그룹웨어', '일반', '발신', 'O', 660, 'Y', ''),
('EAU-', '그룹웨어', '일반(자동전달)', '자동전달', 'O', 661, 'Y', ''),
('ESCR', '그룹웨어', '일정 명함', '수신', 'I', 662, 'Y', ''),
('ESC-', '그룹웨어', '일정 명함', '발신', 'O', 663, 'Y', ''),
('EMF-', '그룹웨어', '파일 다운로드', '-', 'I', 664, 'Y', ''),
('EMU-', '그룹웨어', '기타', '', 'O', 665, 'Y', ''),
('EMDR', '그룹웨어', '드라이브', '수신', 'I', 666, 'Y', ''),
('EMDS', '그룹웨어', '드라이브', '발신', 'O', 667, 'Y', ''),
('ECIS', '그룹웨어', 'Samsung cic', '발신', 'O', 668, 'Y', ''),
('EMER', '그룹웨어', '메신저', '수신', 'I', 669, 'Y', ''),
('EMES', '그룹웨어', '메신저', '발신', 'O', 670, 'Y', ''),
('EMEC', '그룹웨어', '메신저', '채팅', 'O', 671, 'Y', 'MSG'),
('EZQC', '그룹웨어', 'Zohocliq', '채팅', 'O', 672, 'Y', ''),
('EZQS', '그룹웨어', 'Zohocliq', '캘린더', 'O', 673, 'Y', ''),
('EKWS', '그룹웨어', '카카오워크', '발신', 'O', 674, 'Y', ''),
('ECAS', '그룹웨어', '일정', '발신', 'O', 675, 'Y', ''),
('ETOS', '그룹웨어', 'Tigris', '기타', 'O', 676, 'Y', ''),
('ETOC', '그룹웨어', 'Tigris', '메신저', 'O', 677, 'Y', ''),
('ETOD', '그룹웨어', 'Tigris', '드라이브', 'O', 678, 'Y', ''),
('ETOA', '그룹웨어', 'Tigris', '결재', 'O', 679, 'Y', ''),
('DCCS', '편집기', 'Clip Champ', '발신', 'O', 680, 'Y', ''),
('DFGS', '편집기', 'Figma', '발신', 'O', 681, 'Y', ''),
('DOVS', '편집기', 'Overleaf', '발신', 'O', 682, 'Y', ''),
('DOVR', '편집기', 'Overleaf', '수신', 'I', 683, 'Y', ''),
('DPKS', '편집기', 'Plunker', '발신', 'O', 684, 'Y', ''),
('DNWS', '편집기', 'Namu.wiki', '발신', 'O', 685, 'Y', ''),
('DWKS', '편집기', 'WikiPedia', '발신', 'O', 686, 'Y', ''),
('DAES', '편집기', 'Adobe Express', '발신', 'O', 687, 'Y', ''),
('DSMS', '편집기', 'Sketchmon', '발신', 'O', 688, 'Y', ''),
('DGSS', '편집기', 'Google Site', '발신', 'O', 689, 'Y', ''),
('DCVS', '편집기', 'Canva', '발신', 'O', 690, 'Y', ''),
('DMBS', '편집기', '망고보드', '발신', 'O', 691, 'Y', ''),
('DMTS', '편집기', '망고툰', '발신', 'O', 692, 'Y', ''),
('JBDS', '웹사이트', 'Baidu', '발신', 'O', 693, 'Y', ''),
('JANS', '웹사이트', 'Anthropic', '발신', 'O', 694, 'Y', ''),
('JKAS', '웹사이트', 'Kaggle', '발신', 'O', 695, 'Y', ''),
('JJPS', '웹사이트', 'justpaste.it', '발신', 'O', 696, 'Y', ''),
('JPBS', '웹사이트', 'pastebin.com', '발신', 'O', 697, 'Y', ''),
('JNNS', '웹사이트', 'n8n', '발신', 'O', 698, 'Y', ''),
('JGHS', '웹사이트', 'Google cloud console', '발신', 'O', 699, 'Y', ''),
('JALS', '웹사이트', 'AnessLab', '발신', 'O', 700, 'Y', ''),
('JCCS', '웹사이트', 'CMCC [GUI-AGENT]', '발신', 'O', 701, 'Y', ''),
('JOTS', '웹사이트', 'Otter.ai', '발신', 'O', 702, 'Y', ''),
('JMLS', '웹사이트', 'Menlosecurity', '발신', 'O', 703, 'Y', ''),
('JHFS', '웹사이트', 'Hugging Face', '발신', 'O', 704, 'Y', ''),
('JSNS', '웹사이트', 'AWS SNS', '발신', 'O', 705, 'Y', ''),
('JAGS', '웹사이트', 'AWS API Gateway', '발신', 'O', 706, 'Y', ''),
('JASS', '웹사이트', 'AWS SSM', '발신', 'O', 707, 'Y', ''),
('RGUS', '원격접속', '아파치 과카몰리', '발신', 'O', 708, 'Y', ''),
('RGUR', '원격접속', '아파치 과카몰리', '수신', 'I', 709, 'Y', ''),
('KAAR', '웹서비스(분류)', '웹 수신', '수신', 'I', 710, 'Y', ''),
('KAAS', '웹서비스(분류)', '웹 발신', '발신', 'O', 711, 'Y', '');
