...
('FTFS', '파일전송', 'AWS Transfer Family', '발신', 'O', 337, 'Y', ''),
('NPPS', '노트', 'polarisoffice', '발신', 'O', 338, 'Y', ''),
...
('IGVR', '생성형 AI', 'Google Vertex', '수신', 'I', 489, 'Y', ''),
('IGLS', '생성형 AI', 'Google Colab', '발신', 'O', 490, 'Y', ''),
('ICWS', '생성형 AI', 'CodeWhisperer', '발신', 'O', 491, 'Y', ''),
('IMSS', '생성형 AI', 'Google AI Studio', '발신', 'O', 492, 'Y', ''),
('IOCS', '생성형 AI', 'Clova OCR', '발신', 'O', 493, 'Y', ''),
('IAOS', '생성형 AI', 'Azure OpenAI', '발신', 'O', 494, 'Y', ''),
('IAOR', '생성형 AI', 'Azure OpenAI', '수신', 'I', 495, 'Y', ''),
('ICUS', '생성형 AI', '네이버 CUE:', '발신', 'O', 496, 'Y', ''),
('IMJS', '생성형 AI', 'Midjourney', '발신', 'O', 497, 'Y', ''),
('ISGR', '생성형 AI', 'slidesGPT', '수신', 'I', 498, 'Y', ''),
('ISGS', '생성형 AI', 'SlidesGPT', '발신', 'O', 499, 'Y', ''),
('IDMS', '생성형 AI', 'Ai Docmaker', '발신', 'O', 500, 'Y', ''),
('IRKS', '생성형 AI', 'Reka AI', '발신', 'O', 501, 'Y', ''),
('IRKR', '생성형 AI', 'Reka AI', '수신', 'O', 502, 'Y', ''),
('ICLS', '생성형 AI', 'Claude', '발신', 'O', 503, 'Y', ''),
('ICLR', '생성형 AI', 'Claude', '수신', 'I', 504, 'Y', ''),
('IDMR', '생성형 AI', 'AI Docmaker Attach', '수신', 'I', 505, 'Y', ''),
('IADR', '생성형 AI', 'Adobe firefly login', '수신', 'I', 506, 'Y', ''),
('IWDS', '생성형 AI', 'Dream by WOMBO', '발신', 'O', 507, 'Y', ''),
('IGAS', '생성형 AI', 'GetImg.AI', '발신', 'O', 508, 'Y', ''),
('IWKS', '생성형 AI', 'Wrks.ai', '발신', 'O', 509, 'Y', ''),
('IPSS', '생성형 AI', 'Polaris office ai', '발신', 'O', 510, 'Y', ''),
('IBGS', '생성형 AI', 'Goover AI', '발신', 'O', 511, 'Y', ''),
('IIAS', '생성형 AI', 'iAsk AI', '발신', 'O', 512, 'Y', ''),
('ISNS', '생성형 AI', 'Suno AI', '발신', 'O', 513, 'Y', ''),
('IPES', '생성형 AI', 'Perchance', '발신', 'O', 514, 'Y', ''),
('IPFS', '생성형 AI', 'ChatPDF', '발신', 'O', 515, 'Y', ''),
('IXOS', '생성형 AI', 'Exaone', '발신', 'O', 516, 'Y', ''),
('IXOR', '생성형 AI', 'Exaone', '수신', 'I', 517, 'Y', ''),
('ISOR', '생성형 AI', 'Slidesgo', '수신', 'I', 518, 'Y', ''),
('ISOS', '생성형 AI', 'Slidesgo', '발신', 'O', 519, 'Y', ''),
('IKRS', '생성형 AI', 'KREA', '발신', 'O', 520, 'Y', ''),
('ILMS', '생성형 AI', 'GoogleNotebook LM', '발신', 'O', 521, 'Y', ''),
('ICCS', '생성형 AI', 'Capcut', '발신', 'O', 522, 'Y', ''),
('IMGS', '생성형 AI', 'Magictool', '발신', 'O', 523, 'Y', ''),
('IGSS', '생성형 AI', 'Genspark', '발신', 'O', 524, 'Y', ''),
('IFES', '생성형 AI', 'felo', '발신', 'O', 525, 'Y', ''),
('ITPS', '생성형 AI', 'Tripo3D', '발신', 'O', 526, 'Y', ''),
('ITPR', '생성형 AI', 'Tripo3D', '수신', 'I', 527, 'Y', ''),
('IELS', '생성형 AI', 'Elevenlabs', '발신', 'O', 528, 'Y', ''),
('IELR', '생성형 AI', 'Elevenlabs', '수신', 'I', 529, 'Y', ''),
('IGRS', '생성형 AI', 'Grammarly', '발신', 'O', 530, 'Y', ''),
('IVRS', '생성형 AI', 'Vrew', '발신', 'O', 531, 'Y', ''),
('INIS', '생성형 AI', 'NightCafe', '발신', 'O', 532, 'Y', ''),
('ICAS', '생성형 AI', 'CivitAI', '발신', 'O', 533, 'Y', ''),
('ILIS', '생성형 AI', 'Liner', '발신', 'O', 534, 'Y', ''),
('IBCS', '생성형 AI', 'Bing Image Creator', '발신', 'O', 535, 'Y', ''),
('IDSS', '생성형 AI', 'Deepseek', '발신', 'O', 536, 'Y', ''),
('IBDS', '생성형 AI', 'Baidu Ai', '발신', 'O', 537, 'Y', ''),
('IGIS', '생성형 AI', 'Gemini AI api', '발신', 'O', 538, 'Y', ''),
('IDTS', '생성형 AI', '에이닷', '발신', 'O', 539, 'Y', ''),
('IDTR', '생성형 AI', '에이닷', '수신', 'I', 540, 'Y', ''),
('IQBS', '생성형 AI', 'QuillBot', '발신', 'O', 541, 'Y', ''),
('ICHS', '생성형 AI', 'Character ai', '발신', 'O', 542, 'Y', ''),
('ISRS', '생성형 AI', 'Sora/Openai', '발신', 'O', 543, 'Y', ''),
('ISRR', '생성형 AI', 'Sora/Openai', '수신', 'I', 544, 'Y', ''),
('INNS', '생성형 AI', 'Nano AI', '발신', 'O', 545, 'Y', ''),
('IDBS', '생성형 AI', 'Doubao', '발신', 'O', 546, 'Y', ''),
('ITYS', '생성형 AI', 'Tongyi', '발신', 'O', 547, 'Y', ''),
('IYBS', '생성형 AI', 'Yuanbao', '발신', 'O', 548, 'Y', ''),
('IYYS', '생성형 AI', 'Yiyan', '발신', 'O', 549, 'Y', ''),
('IKMS', '생성형 AI', 'Kimi', '발신', 'O', 550, 'Y', ''),
('IBAS', '생성형 AI', 'Baichuan', '발신', 'O', 551, 'Y', ''),
('ITGS', '생성형 AI', 'Tiangong', '발신', 'O', 552, 'Y', ''),
('ISDS', '생성형 AI', 'Stable Diffusion', '발신', 'O', 553, 'Y', ''),
('IGOS', '생성형 AI', 'Grok', '발신', 'O', 554, 'Y', ''),
('IGOR', '생성형 AI', 'Grok', '수신', 'O', 555, 'Y', ''),
('ICGS', '생성형 AI', 'ChatGLM', '발신', 'O', 556, 'Y', ''),
('INKS', '생성형 AI', 'Napkin AI', '발신', 'O', 557, 'Y', ''),
('IBIR', '생성형 AI', 'Microsoft Copilot(Chat)', '수신', 'I', 558, 'Y', ''),
('IOOS', '생성형 AI', 'AI Goormee', '발신', 'O', 559, 'Y', ''),
('IABS', '생성형 AI', 'Allibee', '발신', 'O', 560, 'Y', ''),
('ILXS', '생성형 AI', 'Lexis+', '발신', 'O', 561, 'Y', ''),
('ILAS', '생성형 AI', 'SuperLawyer', '발신', 'O', 562, 'Y', ''),
('ICOS', '생성형 AI', 'CoCounsel', '발신', 'O', 563, 'Y', ''),
('IANS', '생성형 AI', 'Anthropic', '발신', 'O', 564, 'Y', ''),
('ISIS', '생성형 AI', 'Sider AI', '발신', 'O', 565, 'Y', ''),
('IGMS', '생성형 AI', 'Gamma', '발신', 'O', 566, 'Y', ''),
('IGMR', '생성형 AI', 'Gamma', '수신', 'I', 567, 'Y', ''),
('ICRS', '생성형 AI', 'Cursor', '발신', 'O', 568, 'Y', ''),
('ICRR', '생성형 AI', 'Cursor', '수신', 'O', 569, 'Y', ''),
('IMAS', '생성형 AI', 'ManusAI', '발신', 'O', 570, 'Y', ''),
('IMTS', '생성형 AI', 'Mistral AI', '발신', 'O', 571, 'Y', ''),
('ICBS', '생성형 AI', 'Cline', '발신', 'O', 572, 'Y', ''),
('IWBS', '생성형 AI', 'Weight & Biases', '발신', 'O', 573, 'Y', ''),
('IWBR', '생성형 AI', 'Weight & Biases', '수신', 'I', 574, 'Y', ''),
('ILLS', '생성형 AI', 'Lilys AI', '발신', 'O', 575, 'Y', ''),
('IUKS', '생성형 AI', '기타', '발신', 'O', 576, 'Y', ''),
('IGES', '생성형 AI', 'Gemini Code Assist', '발신', 'O', 577, 'Y', ''),
('IOES', '생성형 AI', 'Codex/OpenAI', '발신', 'O', 578, 'Y', ''),
('IJLS', '생성형 AI', 'Jules', '발신', 'O', 579, 'Y', ''),
('IHVS', '생성형 AI', 'Harvey', '발신', 'O', 580, 'Y', ''),
('IXAS', '생성형 AI', 'x.AI', '발신', 'O', 581, 'Y', ''),
('ICES', '생성형 AI', 'Cohere', '발신', 'O', 582, 'Y', ''),
('IWTR', '생성형 AI', 'wrtn', '수신', 'I', 583, 'Y', ''),
('ICHR', '생성형 AI', 'Character ai', '수신', 'I', 584, 'Y', ''),
('IOWR', '생성형 AI', 'Open WebUi', '수신', 'I', 585, 'Y', ''),
('IOWS', '생성형 AI', 'Open WebUi', '발신', 'O', 586, 'Y', ''),
('ISKS', '생성형 AI', 'Skywork', '발신', 'O', 587, 'Y', ''),
('IVES', '생성형 AI', 'Veo3', '발신', 'O', 588, 'Y', ''),
('IGTS', '생성형 AI', 'Gptoss', '발신', 'O', 589, 'Y', ''),
('ILRS', '생성형 AI', 'LMArena', '발신', 'O', 590, 'Y', ''),
('ILRR', '생성형 AI', 'LMArena', '수신', 'I', 591, 'Y', ''),
('IASS', '생성형 AI', 'Chat & Ask AI', '발신', 'O', 592, 'Y', ''),
('IASR', '생성형 AI', 'Chat & Ask AI', '수신', 'I', 593, 'Y', ''),
('IARR', '생성형 AI', 'Android Studio', '수신', 'O', 594, 'Y', ''),
('IARS', '생성형 AI', 'Android Studio', '발신', 'O', 595, 'Y', ''),
('IORR', '생성형 AI', 'Open Router', '수신', 'O', 596, 'Y', ''),
('IORS', '생성형 AI', 'Open Router', '발신', 'O', 597, 'Y', ''),
('IAMS', '생성형 AI', '구글 AI 모드', '발신', 'O', 598, 'Y', ''),
('IAMR', '생성형 AI', '구글 AI 모드', '수신', 'O', 599, 'Y', ''),
('ITIS', '생성형 AI', 'Timely GPT', '발신', 'O', 600, 'Y', ''),
('ITIR', '생성형 AI', 'Timely GPT', '수신', 'O', 601, 'Y', ''),
('IOTS', '생성형 AI', 'Otter.ai', '발신', 'O', 602, 'Y', ''),
('IOTR', '생성형 AI', 'Otter.ai', '수신', 'O', 603, 'Y', ''),
('IAGS', '생성형 AI', 'Google Agent Space', '발신', 'O', 604, 'Y', ''),
('IAGR', '생성형 AI', 'Google Agent Space', '수신', 'I', 605, 'Y', ''),
('ISPS', '생성형 AI', 'Soda Pdf', '발신', 'O', 606, 'Y', ''),
('ISPR', '생성형 AI', 'Soda Pdf', '수신', 'I', 607, 'Y', ''),
('IFPS', '생성형 AI', 'FreePik', '발신', 'O', 608, 'Y', ''),
('IFPR', '생성형 AI', 'FreePik', '수신', 'I', 609, 'Y', ''),
('PDOS', '프로젝트', 'dooray', '발신', 'O', 610, 'Y', ''),
('PGIS', '프로젝트', 'github', '발신', 'O', 611, 'Y', ''),
('PGLS', '프로젝트', 'Glassdoor', '발신', 'O', 612, 'Y', ''),
('PJDS', '프로젝트', '잔디', '발신', 'O', 613, 'Y', ''),
('PITS', '프로젝트', 'Google Issue Tracker', '발신', 'O', 614, 'Y', ''),
('EBDR', '그룹웨어', '게시', '수신', 'I', 615, 'Y', ''),
('EBD-', '그룹웨어', '게시', '발신', 'O', 616, 'Y', ''),
('EBBR', '그룹웨어', '게시판', '수신', 'I', 617, 'Y', ''),
('EBBS', '그룹웨어', '게시판', '발신', 'O', 618, 'Y', ''),
('EBBF', '그룹웨어', '게시판', '파일수신', 'I', 619, 'Y', ''),
('EAAR', '그룹웨어', '결재', '수신', 'I', 620, 'Y', ''),
('EAAS', '그룹웨어', '결재', '발신', 'O', 621, 'Y', ''),
('EAAG', '그룹웨어', '결재', '통보 - 수신', 'I', 622, 'Y', ''),
('EAAP', '그룹웨어', '결재', '통보 - 발신', 'O', 623, 'Y', ''),
('EAAF', '그룹웨어', '결재', '파일수신', 'I', 624, 'Y', ''),
('EMMR', '그룹웨어', '메일', '그룹웨어 수신', 'I', 625, 'Y', ''),
('EMMS', '그룹웨어', '메일', '그룹웨어 발신', 'O', 626, 'Y', ''),
('EMMG', '그룹웨어', '메일', 'OWA 수신', 'I', 627, 'Y', ''),
('EMMP', '그룹웨어', '메일', 'OWA 발신', 'O', 628, 'Y', ''),
('EMMD', '그룹웨어', '메일', 'RPC 수신', 'I', 629, 'Y', ''),
('EMMU', '그룹웨어', '메일', 'RPC 발신', 'O', 630, 'Y', ''),
('EMMC', '그룹웨어', '메일', '수신', 'I', 631, 'Y', ''),
('EMML', '그룹웨어', '메일', '발신', 'O', 632, 'Y', ''),
('EMM1', '그룹웨어', '메일', '보안등급1', 'O', 633, 'Y', ''),
('EMM2', '그룹웨어', '메일', '보안등급2', 'O', 634, 'Y', ''),
('EMM3', '그룹웨어', '메일', '보안등급3', 'O', 635, 'Y', ''),
('EMM4', '그룹웨어', '메일', '보안등급4', 'O', 636, 'Y', ''),
('EMMA', '그룹웨어', '메일', '임시(자동)', 'O', 637, 'Y', ''),
('EMMT', '그룹웨어', '메일', '임시(수동)', 'O', 638, 'Y', ''),
('EMMK', '그룹웨어', '메일', 'Outlook - 수신', 'I', 639, 'Y', ''),
('EMMO', '그룹웨어', '메일', 'Outlook - 발신', 'O', 640, 'Y', ''),
('EMMB', '그룹웨어', '메일', '그룹웨어 예약메일', 'O', 641, 'Y', ''),
('EMBR', '그룹웨어', '모바일', '수신', 'I', 642, 'Y', ''),
('EMB-', '그룹웨어', '모바일', '발신', 'O', 643, 'Y', ''),
('EWSR', '그룹웨어', '웹서비스', '수신', 'I', 644, 'Y', ''),
('EWS-', '그룹웨어', '웹서비스', '발신', 'O', 645, 'Y', ''),
('EPUR', '그룹웨어', '일반', '수신', 'I', 646, 'Y', ''),
('EPU-', '그룹웨어', '일반', '발신', 'O', 647, 'Y', ''),
('EAU-', '그룹웨어', '일반(자동전달)', '자동전달', 'O', 648, 'Y', ''),
('ESCR', '그룹웨어', '일정 명함', '수신', 'I', 649, 'Y', ''),
('ESC-', '그룹웨어', '일정 명함', '발신', 'O', 650, 'Y', ''),
('EMF-', '그룹웨어', '파일 다운로드', '-', 'I', 651, 'Y', ''),
('EMU-', '그룹웨어', '기타', '', 'O', 652, 'Y', ''),
('EMDR', '그룹웨어', '드라이브', '수신', 'I', 653, 'Y', ''),
('EMDS', '그룹웨어', '드라이브', '발신', 'O', 654, 'Y', ''),
('ECIS', '그룹웨어', 'Samsung cic', '발신', 'O', 655, 'Y', ''),
('EMER', '그룹웨어', '메신저', '수신', 'I', 656, 'Y', ''),
('EMES', '그룹웨어', '메신저', '발신', 'O', 657, 'Y', ''),
('EMEC', '그룹웨어', '메신저', '채팅', 'O', 658, 'Y', 'MSG'),
('EZQC', '그룹웨어', 'Zohocliq', '채팅', 'O', 659, 'Y', ''),
('EZQS', '그룹웨어', 'Zohocliq', '캘린더', 'O', 660, 'Y', ''),
('EKWS', '그룹웨어', '카카오워크', '발신', 'O', 661, 'Y', ''),
('ECAS', '그룹웨어', '일정', '발신', 'O', 662, 'Y', ''),
('DCCS', '편집기', 'Clip Champ', '발신', 'O', 663, 'Y', ''),
('DFGS', '편집기', 'Figma', '발신', 'O', 664, 'Y', ''),
('DOVS', '편집기', 'Overleaf', '발신', 'O', 665, 'Y', ''),
('DOVR', '편집기', 'Overleaf', '수신', 'I', 666, 'Y', ''),
('DPKS', '편집기', 'Plunker', '발신', 'O', 667, 'Y', ''),
('DNWS', '편집기', 'Namu.wiki', '발신', 'O', 668, 'Y', ''),
('DWKS', '편집기', 'WikiPedia', '발신', 'O', 669, 'Y', ''),
('DAES', '편집기', 'Adobe Express', '발신', 'O', 670, 'Y', ''),
('DSMS', '편집기', 'Sketchmon', '발신', 'O', 671, 'Y', ''),
('DGSS', '편집기', 'Google Site', '발신', 'O', 672, 'Y', ''),
('DCVS', '편집기', 'Canva', '발신', 'O', 673, 'Y', ''),
('DMBS', '편집기', '망고보드', '발신', 'O', 674, 'Y', ''),
('DMTS', '편집기', '망고툰', '발신', 'O', 675, 'Y', ''),
('JBDS', '웹사이트', 'Baidu', '발신', 'O', 676, 'Y', ''),
('JANS', '웹사이트', 'Anthropic', '발신', 'O', 677, 'Y', ''),
('JKAS', '웹사이트', 'Kaggle', '발신', 'O', 678, 'Y', ''),
('JJPS', '웹사이트', 'justpaste.it', '발신', 'O', 679, 'Y', ''),
('JPBS', '웹사이트', 'pastebin.com', '발신', 'O', 680, 'Y', ''),
('JNNS', '웹사이트', 'n8n', '발신', 'O', 681, 'Y', ''),
('JGHS', '웹사이트', 'Google cloud console', '발신', 'O', 682, 'Y', ''),
('JALS', '웹사이트', 'AnessLab', '발신', 'O', 683, 'Y', ''),
('JCCS', '웹사이트', 'CMCC [GUI-AGENT]', '발신', 'O', 684, 'Y', ''),
('JOTS', '웹사이트', 'Otter.ai', '발신', 'O', 685, 'Y', ''),
('JMLS', '웹사이트', 'Menlosecurity', '발신', 'O', 686, 'Y', ''),
('JHFS', '웹사이트', 'Hugging Face', '발신', 'O', 687, 'Y', ''),
('JSNS', '웹사이트', 'AWS SNS', '발신', 'O', 688, 'Y', ''),
('JAGS', '웹사이트', 'AWS API Gateway', '발신', 'O', 689, 'Y', ''),
('JASS', '웹사이트', 'AWS SSM', '발신', 'O', 690, 'Y', ''),
('RGUS', '원격접속', '아파치 과카몰리', '발신', 'O', 691, 'Y', ''),
('RGUR', '원격접속', '아파치 과카몰리', '수신', 'I', 692, 'Y', ''),
('KAAR', '웹서비스(분류)', '웹 수신', '수신', 'I', 693, 'Y', ''),
('KAAS', '웹서비스(분류)', '웹 발신', '발신', 'O', 694, 'Y', '');
