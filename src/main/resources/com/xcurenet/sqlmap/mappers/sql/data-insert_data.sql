...
REPLACE INTO UI_REGEXP (CODE, NAME, REGEX,CODE_TYPE) VALUES('STG', '스테가노 그래피', NULL,'A');
...
('ANALYSIS_SEARCH', '웹 검색어 동향 분석', 'DATA_ANALYSIS', 'L', 'M', 'analysis/searchKeyword.do', 'fa fa-cube', 5, 'Y', NULL),
('ANALYSIS_UBA', '사용자 행위 분석', 'DATA_ANALYSIS', 'L', 'M', 'analysis/userProfiling.do', 'fa fa-cube', 4, 'Y', NULL),
('ANALYSIS_SBA', '이상행위 분석', 'DATA_ANALYSIS', 'L', 'M', 'analysis/strangeBehavior.do', 'fa fa-cube', 7, 'N', NULL),
('ANALYSIS_NETWORK', '네트워크 현황 분석', 'DATA_ANALYSIS', 'L', 'M', 'analysis/networkFreedom.do', 'fa fa-cube', 8, 'N', NULL),
('ANALYSIS_MAX', '최대 패킷 분석', 'DATA_ANALYSIS', 'L', 'M', 'analysis/networkMaxPackets.do', 'fa fa-cube', 9, 'N', NULL),
('ANALYSIS_SIMILARITY', '유사도 분석', 'DATA_ANALYSIS', 'L', 'M', 'analysis/similarity.do', 'fa fa-cube', 10, 'Y', NULL),
('ANALYSIS_DOUBTTRAFFIC', '이상 트래픽 분석', 'DATA_ANALYSIS', 'L', 'M', 'analysis/doubtTraffic.do', 'fa fa-cube', 11, 'Y', NULL),
('ANALYSIS_TRAFFIC', '트래픽 분석', 'DATA_ANALYSIS', 'L', 'M', 'analysis/trafficAnalysis.do', 'fa fa-cube', 12, 'Y', NULL),
('ANALYSIS_PATTERN', '패턴 분석', 'DATA_ANALYSIS', 'L', 'M', 'analysis/patternAnalysis.do', 'fa fa-cube', 13, 'Y', NULL),
...
('STAT_GW_ATTACHTYPE','그룹웨어 첨부 파일 통계','STAT_CONTENT','L','M','ems/gwAttachTypeStat.do','fa fa-pie-chart',18,'Y',NULL),
