...
VALUES ('MP3-', '메일', 'POP3', '-', 'I', 1, 'Y', ''),
       ...
       ('NUKS', '노트', '기타', '발신', 'O', 345, 'Y', ''),
       ('AGCR', '일정', '구글캘린더일정', '수신', 'I', 346, 'N', ''),
       ('AGCS', '일정', '구글캘린더일정', '발신', 'O', 347, 'Y', ''),
       ('AGLR', '일정', '구글캘린더메일', '수신', 'I', 348, 'N', ''),
       ('AGLS', '일정', '구글캘린더메일', '발신', 'O', 349, 'Y', ''),
       ('ANCS', '일정', '네이버 캘린더', '발신', 'O', 350, 'Y', ''),
       ('ZTN-', '기타 서비스', 'Telnet', '-', 'O', 351, 'Y', ''),
       ('ZXT-', '기타 서비스', 'Xterm', '-', 'O', 352, 'Y', ''),
       ('ZRL-', '기타 서비스', 'R-Login', '-', 'O', 353, 'Y', ''),
       ('ZNP-', '기타 서비스', 'NNTP', '-', 'O', 354, 'Y', ''),
       ('ZPC-', '기타 서비스', 'PC 보안', '-', 'O', 355, 'N', ''),
       ('ZSH-', '기타 서비스', 'SSH', 'SSH 세션 정보', 'O', 356, 'Y', ''),
       ('XX1R', '모니터링_제외', '미분류_타입1', '수신', 'I', 357, 'Y', ''),
       ('XX1S', '모니터링_제외', '미분류_타입1', '발신', 'O', 358, 'Y', ''),
       ('XX2R', '모니터링_제외', '미분류_타입2', '수신', 'I', 359, 'Y', ''),
       ('XX2S', '모니터링_제외', '미분류_타입2', '발신', 'O', 360, 'Y', ''),
       ('XX3R', '모니터링_제외', '미분류_타입3', '수신', 'I', 361, 'Y', ''),
       ('XX3S', '모니터링_제외', '미분류_타입3', '발신', 'O', 362, 'Y', ''),
       ('XU1R', '모니터링_제외', '웹서비스(미분류)_타입1', '수신', 'I', 363, 'Y', ''),
       ('XU1S', '모니터링_제외', '웹서비스(미분류)_타입1', '발신', 'O', 364, 'Y', ''),
       ('XU2R', '모니터링_제외', '웹서비스(미분류)_타입2', '수신', 'I', 365, 'Y', ''),
       ('XU2S', '모니터링_제외', '웹서비스(미분류)_타입2', '발신', 'O', 366, 'Y', ''),
       ('XU3R', '모니터링_제외', '웹서비스(미분류)_타입3', '수신', 'I', 367, 'Y', ''),
       ('XU3S', '모니터링_제외', '웹서비스(미분류)_타입3', '발신', 'O', 368, 'Y', ''),
       ('UWSD', '웹서비스(미분류)', '웹 발신', '첨부 - 문서타입', 'O', 369, 'Y', ''),
       ('UWSE', '웹서비스(미분류)', '웹 발신', '첨부 - 문서아님', 'O', 370, 'Y', ''),
       ('UWSU', '웹서비스(미분류)', '웹 발신', '첨부 없음', 'O', 371, 'Y', ''),
       ('UWSH', '웹서비스(미분류)', '웹 발신', '중요도(상)', 'O', 372, 'Y', ''),
       ('UWSM', '웹서비스(미분류)', '웹 발신', '중요도(중)', 'O', 373, 'Y', ''),
       ('UWSL', '웹서비스(미분류)', '웹 발신', '중요도(하)', 'O', 374, 'Y', ''),
       ('UX1R', '웹서비스(미분류)', '미분류_타입1', '수신', 'I', 375, 'Y', ''),
       ('UX1S', '웹서비스(미분류)', '미분류_타입1', '발신', 'O', 376, 'Y', ''),
       ('UX2R', '웹서비스(미분류)', '미분류_타입2', '수신', 'I', 377, 'Y', ''),
       ('UX2S', '웹서비스(미분류)', '미분류_타입2', '발신', 'O', 378, 'Y', ''),
       ('UX3R', '웹서비스(미분류)', '미분류_타입3', '수신', 'I', 379, 'Y', ''),
       ('UX3S', '웹서비스(미분류)', '미분류_타입3', '발신', 'O', 380, 'Y', ''),
       ('UWRD', '웹서비스(미분류)', '웹 수신', '첨부 - 문서타입', 'I', 381, 'Y', ''),
       ('UWRE', '웹서비스(미분류)', '웹 수신', '첨부 - 문서아님', 'I', 382, 'Y', ''),
       ('UWRU', '웹서비스(미분류)', '웹 수신', '첨부 없음', 'I', 383, 'Y', ''),
       ('BWSD', '웹서비스(업무)', '업무 발신', '첨부 - 문서타입', 'O', 384, 'Y', ''),
       ('BWSE', '웹서비스(업무)', '업무 발신', '첨부 - 문서아님', 'O', 385, 'Y', ''),
       ('BWSU', '웹서비스(업무)', '업무 발신', '첨부 없음', 'O', 386, 'Y', ''),
       ('BWRD', '웹서비스(업무)', '업무 수신', '첨부 - 문서타입', 'I', 387, 'Y', ''),
       ('BWRE', '웹서비스(업무)', '업무 수신', '첨부 - 문서아님', 'I', 388, 'Y', ''),
       ('BWRU', '웹서비스(업무)', '업무 수신', '첨부 없음', 'I', 389, 'Y', ''),
       ('TWEC', '화상회의', 'Webex', '채팅', 'O', 390, 'Y', 'MSG'),
       ('TWEF', '화상회의', 'Webex', '파일전송', 'O', 391, 'Y', 'MSG'),
       ('TWEJ', '화상회의', 'Webex', '참여', 'O', 392, 'Y', 'MSG'),
       ('TWEL', '화상회의', 'Webex', '떠남', 'O', 393, 'Y', 'MSG'),
       ('TZOC', '화상회의', 'Zoom', '채팅', 'O', 394, 'Y', 'MSG'),
       ('TZOF', '화상회의', 'Zoom', '파일전송', 'O', 395, 'Y', 'MSG'),
       ('TZOJ', '화상회의', 'Zoom', '참여', 'O', 396, 'Y', 'MSG'),
       ('TZOL', '화상회의', 'Zoom', '떠남', 'O', 397, 'Y', 'MSG'),
       ('TTMC', '화상회의', 'Teams', '채팅', 'O', 398, 'Y', 'MSG'),
       ('TTMF', '화상회의', 'Teams', '파일전송', 'O', 399, 'Y', 'MSG'),
       ('TTMJ', '화상회의', 'Teams', '참여', 'O', 400, 'Y', 'MSG'),
       ('TTML', '화상회의', 'Teams', '떠남', 'O', 401, 'Y', 'MSG'),
       ('TSKC', '화상회의', 'Skype', '채팅', 'O', 402, 'Y', 'MSG'),
       ('TSKF', '화상회의', 'Skype', '파일전송', 'O', 403, 'Y', 'MSG'),
       ('TSKJ', '화상회의', 'Skype', '참여', 'O', 404, 'Y', 'MSG'),
       ('TSKL', '화상회의', 'Skype', '떠남', 'O', 405, 'Y', 'MSG'),
       ('TJMC', '화상회의', 'JoinME', '채팅', 'O', 406, 'Y', 'MSG'),
       ('TJMF', '화상회의', 'JoinME', '파일전송', 'O', 407, 'Y', 'MSG'),
       ('TAMC', '화상회의', 'Amazon Chime', '채팅', 'O', 408, 'Y', 'MSG'),
       ('TAMF', '화상회의', 'Amazon Chime', '파일전송', 'O', 409, 'Y', 'MSG'),
       ('TBJC', '화상회의', 'BlueJeans', '채팅', 'O', 410, 'Y', 'MSG'),
       ('TTDS', '화상회의', 'Tl;dv', '채팅', 'O', 411, 'Y', 'MSG'),
       ('LNVS', '번역기', '파파고 번역', '발신', 'O', 412, 'Y', ''),
       ('LGGS', '번역기', '구글 번역', '발신', 'O', 413, 'Y', ''),
       ('LGPS', '번역기', '구글 번역 플러그인', '발신', 'O', 414, 'Y', ''),
       ('LDES', '번역기', 'Deepl', '발신', 'O', 415, 'Y', ''),
       ('LBIS', '번역기', 'Bing 번역', '발신', 'O', 416, 'Y', ''),
       ('LYMS', '번역기', 'Yandex 번역', '발신', 'O', 417, 'Y', ''),
       ('LUKS', '번역기', '기타', '발신', 'I', 418, 'Y', ''),
       ('IGBS', '생성형 AI', '구글 Gemini', '발신', 'O', 419, 'Y', ''),
       ('IBIS', '생성형 AI', ' Microsoft Copilot', '발신', 'O', 420, 'Y', ''),
       ('IWTS', '생성형 AI', 'Wrtn', '발신', 'O', 421, 'Y', ''),
       ('IGPS', '생성형 AI', 'ChatGPT', '발신', 'O', 422, 'Y', ''),
       ('IDAS', '생성형 AI', 'Dall-E', '발신', 'O', 423, 'Y', ''),
       ('IGCS', '생성형 AI', 'Github Copilot', '발신', 'I', 424, 'Y', ''),
       ('IYCS', '생성형 AI', 'YouChat', '발신', 'I', 425, 'Y', ''),
       ('ICSS', '생성형 AI', 'Chatsonic', '발신', 'I', 426, 'Y', ''),
       ('IRPS', '생성형 AI', 'Replika', '발신', 'I', 427, 'Y', ''),
       ('IPPS', '생성형 AI', 'Perplexity', '발신', 'I', 428, 'Y', ''),
       ('ITCS', '생성형 AI', 'TextCortex', '발신', 'I', 429, 'Y', ''),
       ('IPHS', '생성형 AI', 'Phind', '발신', 'I', 430, 'Y', ''),
       ('IPOS', '생성형 AI', 'Poe', '발신', 'I', 431, 'Y', ''),
       ('IHFS', '생성형 AI', 'Hugging Face', '발신', 'I', 432, 'Y', ''),
       ('ICPS', '생성형 AI', 'Copy.AI', '발신', 'I', 433, 'Y', ''),
       ('IHWS', '생성형 AI', 'HyperWrite', '발신', 'I', 434, 'Y', ''),
       ('IDPS', '생성형 AI', 'DeepAI', '발신', 'I', 435, 'Y', ''),
       ('IACS', '생성형 AI', 'AskCodi', '발신', 'I', 436, 'Y', ''),
       ('INAS', '생성형 AI', 'Native', '발신', 'I', 437, 'Y', ''),
       ('INFS', '생성형 AI', 'NeuroFlash', '발신', 'I', 438, 'Y', ''),
       ('INOS', '생성형 AI', 'Notion AI', '발신', 'I', 439, 'Y', ''),
       ('IMES', '생성형 AI', 'Merlin', '발신', 'I', 440, 'Y', ''),
       ('ICXS', '생성형 AI', 'CLOVA-X', '발신', 'I', 441, 'Y', ''),
       ('IADS', '생성형 AI', 'Adobe AI', '발신', 'I', 442, 'Y', ''),
       ('ICDS', '생성형 AI', 'ClipDrop', '발신', 'I', 443, 'Y', ''),
       ('ISBS', '생성형 AI', 'Stability.Ai', '발신', 'I', 444, 'Y', ''),
       ('IRMS', '생성형 AI', 'Runwayml', '발신', 'I', 445, 'Y', ''),
       ('IGVS', '생성형 AI', 'Google Vertex', '발신', 'I', 446, 'Y', ''),
       ('IGLS', '생성형 AI', 'Google Colab', '발신', 'I', 447, 'Y', ''),
       ('ICWS', '생성형 AI', 'CodeWhisperer', '발신', 'I', 448, 'Y', ''),
       ('IMSS', '생성형 AI', 'MakerSuite', '발신', 'I', 449, 'Y', ''),
       ('IOCS', '생성형 AI', 'Clova OCR', '발신', 'I', 450, 'Y', ''),
       ('IAOS', '생성형 AI', 'Azure OpenAI', '발신', 'I', 451, 'Y', ''),
       ('ICUS', '생성형 AI', '네이버 CUE:', '발신', 'I', 452, 'Y', ''),
       ('IMJS', '생성형 AI', 'Midjourney', '발신', 'I', 453, 'Y', ''),
       ('ISGR', '생성형 AI', 'slidesGPT', '수신', 'I', 454, 'Y', ''),
       ('ISGS', '생성형 AI', 'SlidesGPT', '발신', 'I', 455, 'Y', ''),
       ('IDMS', '생성형 AI', 'AiDocmaker', '발신', 'I', 456, 'Y', ''),
       ('IRKS', '생성형 AI', 'Reka AI', '발신', 'I', 457, 'Y', ''),
       ('ICLS', '생성형 AI', 'Claude', '발신', 'I', 458, 'Y', ''),
       ('IDMR', '생성형 AI', 'Ai Docker Attach', '수신', 'I', 459, 'Y', ''),
       ('IADR', '생성형 AI', 'Adobe firefly login', '수신', 'I', 460, 'Y', ''),
       ('IWDS', '생성형 AI', 'Dream by WOMBO', '발신', 'I', 461, 'Y', ''),
       ('IGAS', '생성형 AI', 'GetImg.AI', '발신', 'I', 462, 'Y', ''),
       ('IWKS', '생성형 AI', 'Wrks.ai', '발신', 'I', 463, 'Y', ''),
       ('IPSS', '생성형 AI', 'Polaris office ai', '발신', 'I', 464, 'Y', ''),
       ('IBGS', '생성형 AI', 'Goover AI', '발신', 'I', 465, 'Y', ''),
       ('IIAS', '생성형 AI', 'iAsk AI', '발신', 'I', 466, 'Y', ''),
       ('ISNS', '생성형 AI', 'Suno AI', '발신', 'I', 467, 'Y', ''),
       ('IPES', '생성형 AI', 'Perchance', '발신', 'I', 468, 'Y', ''),
       ('IPFS', '생성형 AI', 'ChatPDF', '발신', 'I', 469, 'Y', ''),
       ('IXOS', '생성형 AI', 'Exaone', '발신', 'I', 470, 'Y', ''),
       ('ISOR', '생성형 AI', 'Slidesgo', '수신', 'I', 471, 'Y', ''),
       ('ISOS', '생성형 AI', 'Slidesgo', '발신', 'I', 472, 'Y', ''),
       ('IKRS', '생성형 AI', 'KREA', '발신', 'I', 473, 'Y', ''),
       ('ILMS', '생성형 AI', 'GoogleNotebook LM', '발신', 'I', 474, 'Y', ''),
       ('IUKS', '생성형 AI', '기타', '발신', 'I', 475, 'Y', ''),
       ('PDOS', '프로젝트', 'Dooray', '발신', 'O', 476, 'Y', ''),
       ('PGIS', '프로젝트', 'Github', '발신', 'O', 477, 'Y', ''),
       ('PGLS', '프로젝트', 'Glassdoor', '발신', 'O', 478, 'Y', ''),
       ('EBDR', '그룹웨어', '게시', '수신', 'I', 479, 'Y', ''),
       ('EBD-', '그룹웨어', '게시', '발신', 'O', 480, 'Y', ''),
       ('EBBR', '그룹웨어', '게시판', '수신', 'I', 481, 'Y', ''),
       ('EBBS', '그룹웨어', '게시판', '발신', 'O', 482, 'Y', ''),
       ('EBBF', '그룹웨어', '게시판', '파일수신', 'I', 483, 'Y', ''),
       ('EAAR', '그룹웨어', '결재', '수신', 'I', 484, 'Y', ''),
       ('EAAS', '그룹웨어', '결재', '발신', 'O', 485, 'Y', ''),
       ('EAAG', '그룹웨어', '결재', '통보 - 수신', 'I', 486, 'Y', ''),
       ('EAAP', '그룹웨어', '결재', '통보 - 발신', 'O', 487, 'Y', ''),
       ('EAAF', '그룹웨어', '결재', '파일수신', 'I', 488, 'Y', ''),
       ('EMMR', '그룹웨어', '메일', '그룹웨어 수신', 'I', 489, 'Y', ''),
       ('EMMS', '그룹웨어', '메일', '그룹웨어 발신', 'O', 490, 'Y', ''),
       ('EMMG', '그룹웨어', '메일', 'OWA 수신', 'I', 491, 'Y', ''),
       ('EMMP', '그룹웨어', '메일', 'OWA 발신', 'O', 492, 'Y', ''),
       ('EMMD', '그룹웨어', '메일', 'RPC 수신', 'I', 493, 'Y', ''),
       ('EMMU', '그룹웨어', '메일', 'RPC 발신', 'O', 494, 'Y', ''),
       ('EMMC', '그룹웨어', '메일', '수신', 'I', 495, 'Y', ''),
       ('EMML', '그룹웨어', '메일', '발신', 'O', 496, 'Y', ''),
       ('EMM1', '그룹웨어', '메일', '보안등급1', 'O', 497, 'Y', ''),
       ('EMM2', '그룹웨어', '메일', '보안등급2', 'O', 498, 'Y', ''),
       ('EMM3', '그룹웨어', '메일', '보안등급3', 'O', 499, 'Y', ''),
       ('EMM4', '그룹웨어', '메일', '보안등급4', 'O', 500, 'Y', ''),
       ('EMMA', '그룹웨어', '메일', '임시(자동)', 'O', 501, 'Y', ''),
       ('EMMT', '그룹웨어', '메일', '임시(수동)', 'O', 502, 'Y', ''),
       ('EMMK', '그룹웨어', '메일', 'Outlook - 수신', 'I', 503, 'Y', ''),
       ('EMMO', '그룹웨어', '메일', 'Outlook - 발신', 'O', 504, 'Y', ''),
       ('EMMB', '그룹웨어', '메일', '그룹웨어 예약메일', 'O', 505, 'Y', ''),
       ('EMBR', '그룹웨어', '모바일', '수신', 'I', 506, 'Y', ''),
       ('EMB-', '그룹웨어', '모바일', '발신', 'O', 507, 'Y', ''),
       ('EWSR', '그룹웨어', '웹서비스', '수신', 'I', 508, 'Y', ''),
       ('EWS-', '그룹웨어', '웹서비스', '발신', 'O', 509, 'Y', ''),
       ('EPUR', '그룹웨어', '일반', '수신', 'I', 510, 'Y', ''),
       ('EPU-', '그룹웨어', '일반', '발신', 'O', 511, 'Y', ''),
       ('EAU-', '그룹웨어', '일반(자동전달)', '자동전달', 'O', 512, 'Y', ''),
       ('ESCR', '그룹웨어', '일정 명함', '수신', 'I', 513, 'Y', ''),
       ('ESC-', '그룹웨어', '일정 명함', '발신', 'O', 514, 'Y', ''),
       ('EMF-', '그룹웨어', '파일 다운로드', '-', 'I', 515, 'Y', ''),
       ('EMU-', '그룹웨어', '기타', '', 'O', 516, 'Y', ''),
       ('EMDR', '그룹웨어', '드라이브', '수신', 'I', 517, 'Y', ''),
       ('EMDS', '그룹웨어', '드라이브', '발신', 'O', 518, 'Y', ''),
       ('ECIS', '그룹웨어', 'Samsung cic', '발신', 'O', 519, 'Y', ''),
       ('EMER', '그룹웨어', '메신저', '수신', 'O', 520, 'Y', ''),
       ('EMES', '그룹웨어', '메신저', '발신', 'O', 521, 'Y', ''),
       ('DCCS', '편집기', 'Clip Champ', '발신', 'O', 522, 'Y', ''),
       ('DFGS', '편집기', 'Figma', '발신', 'O', 523, 'Y', ''),
       ('DOVS', '편집기', 'Overleaf', '발신', 'O', 524, 'Y', ''),
       ('DOVR', '편집기', 'Overleaf', '수신', 'O', 525, 'Y', ''),
       ('DPKS', '편집기', 'Plunker', '발신', 'O', 526, 'Y', ''),
       ('DNWS', '편집기', 'Namu.wiki', '발신', 'O', 527, 'Y', ''),
       ('DWKS', '편집기', 'WikiPedia', '발신', 'O', 528, 'Y', '');
