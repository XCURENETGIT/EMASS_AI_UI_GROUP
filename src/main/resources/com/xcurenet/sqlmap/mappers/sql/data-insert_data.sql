...
('IPFS', '생성형 AI', 'ChatPDF', '발신', 'O', 522, 'Y', ''),
('IXOS', '생성형 AI', 'Exaone', '발신', 'O', 523, 'Y', ''),
('IXOR', '생성형 AI', 'Exaone', '수신', 'I', 524, 'Y', ''),
('ISOR', '생성형 AI', 'Slidesgo', '수신', 'I', 525, 'Y', ''),
('ISOS', '생성형 AI', 'Slidesgo', '발신', 'O', 526, 'Y', ''),
('IKRS', '생성형 AI', 'KREA', '발신', 'O', 527, 'Y', ''),
('ILMS', '생성형 AI', 'GoogleNotebook LM', '발신', 'O', 528, 'Y', ''),
('ICCS', '생성형 AI', 'Capcut', '발신', 'O', 529, 'Y', ''),
('IMGS', '생성형 AI', 'Magictool', '발신', 'O', 530, 'Y', ''),
('IGSS', '생성형 AI', 'Genspark', '발신', 'O', 531, 'Y', ''),
('IGSR', '생성형 AI', 'Genspark', '수신', 'I', 532, 'Y', ''),
('IFES', '생성형 AI', 'felo', '발신', 'O', 533, 'Y', ''),
('ITPS', '생성형 AI', 'Tripo3D', '발신', 'O', 534, 'Y', ''),
('ITPR', '생성형 AI', 'Tripo3D', '수신', 'I', 535, 'Y', ''),
('IELS', '생성형 AI', 'Elevenlabs', '발신', 'O', 536, 'Y', ''),
('IELR', '생성형 AI', 'Elevenlabs', '수신', 'I', 537, 'Y', ''),
('IGRS', '생성형 AI', 'Grammarly', '발신', 'O', 538, 'Y', ''),
('IVRS', '생성형 AI', 'Vrew', '발신', 'O', 539, 'Y', ''),
('INIS', '생성형 AI', 'NightCafe', '발신', 'O', 540, 'Y', ''),
('ICAS', '생성형 AI', 'CivitAI', '발신', 'O', 541, 'Y', ''),
('ILIS', '생성형 AI', 'Liner', '발신', 'O', 542, 'Y', ''),
('IBCS', '생성형 AI', 'Bing Image Creator', '발신', 'O', 543, 'Y', ''),
('IDSS', '생성형 AI', 'Deepseek', '발신', 'O', 544, 'Y', ''),
('IBDS', '생성형 AI', 'Baidu Ai', '발신', 'O', 545, 'Y', ''),
('IGIS', '생성형 AI', 'Gemini AI api', '발신', 'O', 546, 'Y', ''),
('IGIR', '생성형 AI', 'Gemini AI api', '수신', 'I', 547, 'Y', ''),
('IDTS', '생성형 AI', '에이닷', '발신', 'O', 548, 'Y', ''),
('IDTR', '생성형 AI', '에이닷', '수신', 'I', 549, 'Y', ''),
('IQBS', '생성형 AI', 'QuillBot', '발신', 'O', 550, 'Y', ''),
('ICHS', '생성형 AI', 'Character ai', '발신', 'O', 551, 'Y', ''),
('ISRS', '생성형 AI', 'Sora/Openai', '발신', 'O', 552, 'Y', ''),
('ISRR', '생성형 AI', 'Sora/Openai', '수신', 'I', 553, 'Y', ''),
('INNS', '생성형 AI', 'Nano AI', '발신', 'O', 554, 'Y', ''),
('IDBS', '생성형 AI', 'Doubao', '발신', 'O', 555, 'Y', ''),
('ITYS', '생성형 AI', 'Tongyi', '발신', 'O', 556, 'Y', ''),
('IYBS', '생성형 AI', 'Yuanbao', '발신', 'O', 557, 'Y', ''),
('IYYS', '생성형 AI', 'Yiyan', '발신', 'O', 558, 'Y', ''),
('IKMS', '생성형 AI', 'Kimi', '발신', 'O', 559, 'Y', ''),
('IBAS', '생성형 AI', 'Baichuan', '발신', 'O', 560, 'Y', ''),
('ITGS', '생성형 AI', 'Tiangong', '발신', 'O', 561, 'Y', ''),
('ISDS', '생성형 AI', 'Stable Diffusion', '발신', 'O', 562, 'Y', ''),
('IGOS', '생성형 AI', 'Grok', '발신', 'O', 563, 'Y', ''),
('IGOR', '생성형 AI', 'Grok', '수신', 'O', 564, 'Y', ''),
('ICGS', '생성형 AI', 'ChatGLM', '발신', 'O', 565, 'Y', ''),
('INKS', '생성형 AI', 'Napkin AI', '발신', 'O', 566, 'Y', ''),
('IBIR', '생성형 AI', 'Microsoft Copilot(Chat)', '수신', 'I', 567, 'Y', ''),
('IOOS', '생성형 AI', 'AI Goormee', '발신', 'O', 568, 'Y', ''),
('IABS', '생성형 AI', 'Allibee', '발신', 'O', 569, 'Y', ''),
('ILXS', '생성형 AI', 'Lexis+', '발신', 'O', 570, 'Y', ''),
('ILAS', '생성형 AI', 'SuperLawyer', '발신', 'O', 571, 'Y', ''),
('ICOS', '생성형 AI', 'CoCounsel', '발신', 'O', 572, 'Y', ''),
('IANS', '생성형 AI', 'Anthropic', '발신', 'O', 573, 'Y', ''),
('IANR', '생성형 AI', 'Anthropic', '수신', 'I', 574, 'Y', ''),
('ISIS', '생성형 AI', 'Sider AI', '발신', 'O', 575, 'Y', ''),
('IGMS', '생성형 AI', 'Gamma', '발신', 'O', 576, 'Y', ''),
('IGMR', '생성형 AI', 'Gamma', '수신', 'I', 577, 'Y', ''),
('ICRS', '생성형 AI', 'Cursor', '발신', 'O', 578, 'Y', ''),
('ICRR', '생성형 AI', 'Cursor', '수신', 'O', 579, 'Y', ''),
('IMAS', '생성형 AI', 'ManusAI', '발신', 'O', 580, 'Y', ''),
('IMTS', '생성형 AI', 'Mistral AI', '발신', 'O', 581, 'Y', ''),
('ICBS', '생성형 AI', 'Cline', '발신', 'O', 582, 'Y', ''),
('IWBS', '생성형 AI', 'Weight & Biases', '발신', 'O', 583, 'Y', ''),
('IWBR', '생성형 AI', 'Weight & Biases', '수신', 'I', 584, 'Y', ''),
('ILLS', '생성형 AI', 'Lilys AI', '발신', 'O', 585, 'Y', ''),
('IUKS', '생성형 AI', '기타', '발신', 'O', 586, 'Y', ''),
('IGES', '생성형 AI', 'Gemini Code Assist', '발신', 'O', 587, 'Y', ''),
('IOES', '생성형 AI', 'Codex/OpenAI', '발신', 'O', 588, 'Y', ''),
('IOER', '생성형 AI', 'Codex/OpenAI', '수신', 'I', 589, 'Y', ''),
('IJLS', '생성형 AI', 'Jules', '발신', 'O', 590, 'Y', ''),
('IHVS', '생성형 AI', 'Harvey', '발신', 'O', 591, 'Y', ''),
('IXAS', '생성형 AI', 'x.AI', '발신', 'O', 592, 'Y', ''),
('ICES', '생성형 AI', 'Cohere', '발신', 'O', 593, 'Y', ''),
('IWTR', '생성형 AI', 'wrtn', '수신', 'I', 594, 'Y', ''),
('ICHR', '생성형 AI', 'Character ai', '수신', 'I', 595, 'Y', ''),
('IOWR', '생성형 AI', 'Open WebUi', '수신', 'I', 596, 'Y', ''),
('IOWS', '생성형 AI', 'Open WebUi', '발신', 'O', 597, 'Y', ''),
('ISKS', '생성형 AI', 'Skywork', '발신', 'O', 598, 'Y', ''),
('IVES', '생성형 AI', 'Veo3', '발신', 'O', 599, 'Y', ''),
('IGTS', '생성형 AI', 'Gptoss', '발신', 'O', 600, 'Y', ''),
('ILRS', '생성형 AI', 'LMArena', '발신', 'O', 601, 'Y', ''),
('ILRR', '생성형 AI', 'LMArena', '수신', 'I', 602, 'Y', ''),
('IASS', '생성형 AI', 'Chat & Ask AI', '발신', 'O', 603, 'Y', ''),
('IASR', '생성형 AI', 'Chat & Ask AI', '수신', 'I', 604, 'Y', ''),
('IARR', '생성형 AI', 'Android Studio', '수신', 'O', 605, 'Y', ''),
('IARS', '생성형 AI', 'Android Studio', '발신', 'O', 606, 'Y', ''),
('IORR', '생성형 AI', 'Open Router', '수신', 'O', 607, 'Y', ''),
('IORS', '생성형 AI', 'Open Router', '발신', 'O', 608, 'Y', ''),
('IAMS', '생성형 AI', '구글 AI 모드', '발신', 'O', 609, 'Y', ''),
('IAMR', '생성형 AI', '구글 AI 모드', '수신', 'O', 610, 'Y', ''),
('ITIS', '생성형 AI', 'Timely GPT', '발신', 'O', 611, 'Y', ''),
('ITIR', '생성형 AI', 'Timely GPT', '수신', 'O', 612, 'Y', ''),
('IOTS', '생성형 AI', 'Otter.ai', '발신', 'O', 613, 'Y', ''),
('IOTR', '생성형 AI', 'Otter.ai', '수신', 'O', 614, 'Y', ''),
('IAGS', '생성형 AI', 'Google Agent Space', '발신', 'O', 615, 'Y', ''),
('IAGR', '생성형 AI', 'Google Agent Space', '수신', 'I', 616, 'Y', ''),
('ISPS', '생성형 AI', 'Soda Pdf', '발신', 'O', 617, 'Y', ''),
('ISPR', '생성형 AI', 'Soda Pdf', '수신', 'I', 618, 'Y', ''),
('IFPS', '생성형 AI', 'FreePik', '발신', 'O', 619, 'Y', ''),
('IFPR', '생성형 AI', 'FreePik', '수신', 'I', 620, 'Y', ''),
('ITOS', '생성형 AI', 'Tigris AI+', '발신', 'O', 621, 'Y', ''),
('IATS', '생성형 AI', 'Antigravity', '발신', 'O', 622, 'Y', ''),
('IATR', '생성형 AI', 'Antigravity', '수신', 'I', 623, 'Y', ''),
('IODS', '생성형 AI', 'OpenCode AI', '발신', 'O', 624, 'Y', ''),
('IODR', '생성형 AI', 'OpenCode AI', '수신', 'I', 625, 'Y', ''),
('ITNS', '생성형 AI', 'Tunee AI', '발신', 'O', 626, 'Y', ''),
('ITNR', '생성형 AI', 'Tunee AI', '수신', 'I', 627, 'Y', ''),
('IWES', '생성형 AI', 'WeeAI', '발신', 'O', 628, 'Y', ''),
('IWER', '생성형 AI', 'WeeAI', '수신', 'I', 629, 'Y', ''),
('IHAS', '생성형 AI', 'Hailuo AI', '발신', 'O', 630, 'Y', ''),
('IHAR', '생성형 AI', 'Hailuo AI', '수신', 'I', 631, 'Y', ''),
('IHIS', '생성형 AI', 'Higgsfield', '발신', 'O', 632, 'Y', ''),
('IKLS', '생성형 AI', 'Kling AI', '발신', 'O', 633, 'Y', ''),
('IKLR', '생성형 AI', 'Kling AI', '수신', 'I', 634, 'Y', ''),
('IOAS', '생성형 AI', 'OpenAI API', '발신', 'O', 635, 'Y', ''),
('IOAR', '생성형 AI', 'OpenAI API', '수신', 'I', 636, 'Y', ''),
('PDOS', '프로젝트', 'dooray', '발신', 'O', 637, 'Y', ''),
('PGIS', '프로젝트', 'github', '발신', 'O', 638, 'Y', ''),
('PGLS', '프로젝트', 'Glassdoor', '발신', 'O', 639, 'Y', ''),
('PJDS', '프로젝트', '잔디', '발신', 'O', 640, 'Y', ''),
('PITS', '프로젝트', 'Google Issue Tracker', '발신', 'O', 641, 'Y', ''),
('EBDR', '그룹웨어', '게시', '수신', 'I', 642, 'Y', ''),
('EBD-', '그룹웨어', '게시', '발신', 'O', 643, 'Y', ''),
('EBBR', '그룹웨어', '게시판', '수신', 'I', 644, 'Y', ''),
('EBBS', '그룹웨어', '게시판', '발신', 'O', 645, 'Y', ''),
('EBBF', '그룹웨어', '게시판', '파일수신', 'I', 646, 'Y', ''),
('EAAR', '그룹웨어', '결재', '수신', 'I', 647, 'Y', ''),
('EAAS', '그룹웨어', '결재', '발신', 'O', 648, 'Y', ''),
('EAAG', '그룹웨어', '결재', '통보 - 수신', 'I', 649, 'Y', ''),
('EAAP', '그룹웨어', '결재', '통보 - 발신', 'O', 650, 'Y', ''),
('EAAF', '그룹웨어', '결재', '파일수신', 'I', 651, 'Y', ''),
('EMMR', '그룹웨어', '메일', '그룹웨어 수신', 'I', 652, 'Y', ''),
('EMMS', '그룹웨어', '메일', '그룹웨어 발신', 'O', 653, 'Y', ''),
('EMMG', '그룹웨어', '메일', 'OWA 수신', 'I', 654, 'Y', ''),
('EMMP', '그룹웨어', '메일', 'OWA 발신', 'O', 655, 'Y', ''),
('EMMD', '그룹웨어', '메일', 'RPC 수신', 'I', 656, 'Y', ''),
('EMMU', '그룹웨어', '메일', 'RPC 발신', 'O', 657, 'Y', ''),
('EMMC', '그룹웨어', '메일', '수신', 'I', 658, 'Y', ''),
('EMML', '그룹웨어', '메일', '발신', 'O', 659, 'Y', ''),
('EMM1', '그룹웨어', '메일', '보안등급1', 'O', 660, 'Y', ''),
('EMM2', '그룹웨어', '메일', '보안등급2', 'O', 661, 'Y', ''),
('EMM3', '그룹웨어', '메일', '보안등급3', 'O', 662, 'Y', ''),
('EMM4', '그룹웨어', '메일', '보안등급4', 'O', 663, 'Y', ''),
('EMMA', '그룹웨어', '메일', '임시(자동)', 'O', 664, 'Y', ''),
('EMMT', '그룹웨어', '메일', '임시(수동)', 'O', 665, 'Y', ''),
('EMMK', '그룹웨어', '메일', 'Outlook - 수신', 'I', 666, 'Y', ''),
('EMMO', '그룹웨어', '메일', 'Outlook - 발신', 'O', 667, 'Y', ''),
('EMMB', '그룹웨어', '메일', '그룹웨어 예약메일', 'O', 668, 'Y', ''),
('EMBR', '그룹웨어', '모바일', '수신', 'I', 669, 'Y', ''),
('EMB-', '그룹웨어', '모바일', '발신', 'O', 670, 'Y', ''),
('EWSR', '그룹웨어', '웹서비스', '수신', 'I', 671, 'Y', ''),
('EWS-', '그룹웨어', '웹서비스', '발신', 'O', 672, 'Y', ''),
('EPUR', '그룹웨어', '일반', '수신', 'I', 673, 'Y', ''),
('EPU-', '그룹웨어', '일반', '발신', 'O', 674, 'Y', ''),
('EAU-', '그룹웨어', '일반(자동전달)', '자동전달', 'O', 675, 'Y', ''),
('ESCR', '그룹웨어', '일정 명함', '수신', 'I', 676, 'Y', ''),
('ESC-', '그룹웨어', '일정 명함', '발신', 'O', 677, 'Y', ''),
('EMF-', '그룹웨어', '파일 다운로드', '-', 'I', 678, 'Y', ''),
('EMU-', '그룹웨어', '기타', '', 'O', 679, 'Y', ''),
('EMDR', '그룹웨어', '드라이브', '수신', 'I', 680, 'Y', ''),
('EMDS', '그룹웨어', '드라이브', '발신', 'O', 681, 'Y', ''),
('ECIS', '그룹웨어', 'Samsung cic', '발신', 'O', 682, 'Y', ''),
('EMER', '그룹웨어', '메신저', '수신', 'I', 683, 'Y', ''),
('EMES', '그룹웨어', '메신저', '발신', 'O', 684, 'Y', ''),
('EMEC', '그룹웨어', '메신저', '채팅', 'O', 685, 'Y', 'MSG'),
('EZQC', '그룹웨어', 'Zohocliq', '채팅', 'O', 686, 'Y', ''),
('EZQS', '그룹웨어', 'Zohocliq', '캘린더', 'O', 687, 'Y', ''),
('EKWS', '그룹웨어', '카카오워크', '발신', 'O', 688, 'Y', ''),
('ECAS', '그룹웨어', '일정', '발신', 'O', 689, 'Y', ''),
('ETOS', '그룹웨어', 'Tigris', '기타', 'O', 690, 'Y', ''),
('ETOC', '그룹웨어', 'Tigris', '메신저', 'O', 691, 'Y', ''),
('ETOD', '그룹웨어', 'Tigris', '드라이브', 'O', 692, 'Y', ''),
('ETOA', '그룹웨어', 'Tigris', '결재', 'O', 693, 'Y', ''),
('DCCS', '편집기', 'Clip Champ', '발신', 'O', 694, 'Y', ''),
('DFGS', '편집기', 'Figma', '발신', 'O', 695, 'Y', ''),
('DOVS', '편집기', 'Overleaf', '발신', 'O', 696, 'Y', ''),
('DOVR', '편집기', 'Overleaf', '수신', 'I', 697, 'Y', ''),
('DPKS', '편집기', 'Plunker', '발신', 'O', 698, 'Y', ''),
('DNWS', '편집기', 'Namu.wiki', '발신', 'O', 699, 'Y', ''),
('DWKS', '편집기', 'WikiPedia', '발신', 'O', 700, 'Y', ''),
('DAES', '편집기', 'Adobe Express', '발신', 'O', 701, 'Y', ''),
('DSMS', '편집기', 'Sketchmon', '발신', 'O', 702, 'Y', ''),
('DGSS', '편집기', 'Google Site', '발신', 'O', 703, 'Y', ''),
('DCVS', '편집기', 'Canva', '발신', 'O', 704, 'Y', ''),
('DMBS', '편집기', '망고보드', '발신', 'O', 705, 'Y', ''),
('DMTS', '편집기', '망고툰', '발신', 'O', 706, 'Y', ''),
('JBDS', '웹사이트', 'Baidu', '발신', 'O', 707, 'Y', ''),
('JANS', '웹사이트', 'Anthropic', '발신', 'O', 708, 'Y', ''),
('JKAS', '웹사이트', 'Kaggle', '발신', 'O', 709, 'Y', ''),
('JJPS', '웹사이트', 'justpaste.it', '발신', 'O', 710, 'Y', ''),
('JPBS', '웹사이트', 'pastebin.com', '발신', 'O', 711, 'Y', ''),
('JNNS', '웹사이트', 'n8n', '발신', 'O', 712, 'Y', ''),
('JGHS', '웹사이트', 'Google cloud console', '발신', 'O', 713, 'Y', ''),
('JALS', '웹사이트', 'AnessLab', '발신', 'O', 714, 'Y', ''),
('JCCS', '웹사이트', 'CMCC [GUI-AGENT]', '발신', 'O', 715, 'Y', ''),
('JOTS', '웹사이트', 'Otter.ai', '발신', 'O', 716, 'Y', ''),
('JMLS', '웹사이트', 'Menlosecurity', '발신', 'O', 717, 'Y', ''),
('JHFS', '웹사이트', 'Hugging Face', '발신', 'O', 718, 'Y', ''),
('JSNS', '웹사이트', 'AWS SNS', '발신', 'O', 719, 'Y', ''),
('JAGS', '웹사이트', 'AWS API Gateway', '발신', 'O', 720, 'Y', ''),
('JASS', '웹사이트', 'AWS SSM', '발신', 'O', 721, 'Y', ''),
('RGUS', '원격접속', '아파치 과카몰리', '발신', 'O', 722, 'Y', ''),
('RGUR', '원격접속', '아파치 과카몰리', '수신', 'I', 723, 'Y', ''),
('KAAR', '웹서비스(분류)', '웹 수신', '수신', 'I', 724, 'Y', ''),
('KAAS', '웹서비스(분류)', '웹 발신', '발신', 'O', 725, 'Y', '');
