...
INSERT IGNORE INTO UI_CONF (CONF_ID, VAL, DEFAULT_VAL, UPDATE_DT) VALUES ('message.epmsg.val', '', '', NOW());
INSERT IGNORE INTO UI_CONF (CONF_ID, VAL, DEFAULT_VAL, UPDATE_DT) VALUES ('info.feedback.used', 'true', 'true', NOW());
...
INSERT IGNORE INTO UI_CONF (CONF_ID, VAL, DEFAULT_VAL, UPDATE_DT) VALUES ('message.user.format', '#name#/#email#/#businm#/#deptnm#/#jikgubnm#/#ip#/#sabun#', '#name#/#email#/#businm#/#deptnm#/#jikgubnm#/#ip#/#sabun#', NOW());
...
INSERT IGNORE INTO UI_CONF (CONF_ID, VAL, DEFAULT_VAL, UPDATE_DT) VALUES ('chrony.server.used', 'true', 'true', NOW());
INSERT IGNORE INTO UI_CONF (CONF_ID, VAL, DEFAULT_VAL, UPDATE_DT) VALUES ('llm.single', 'false', 'false', NOW());
INSERT IGNORE INTO UI_CONF (CONF_ID, VAL, DEFAULT_VAL, UPDATE_DT) VALUES ('asta.used', 'false', 'false', NOW());
INSERT IGNORE INTO UI_CONF (CONF_ID, VAL, DEFAULT_VAL, UPDATE_DT) VALUES ('dashboard.period', 'T', 'T', NOW());
INSERT IGNORE INTO UI_CONF (CONF_ID, VAL, DEFAULT_VAL, UPDATE_DT) VALUES ('device.snmp.check', '5', '5', NOW());
INSERT IGNORE INTO UI_CONF (CONF_ID, VAL, DEFAULT_VAL, UPDATE_DT) VALUES ('query.type.dept', 'A', 'A', NOW());
INSERT IGNORE INTO UI_CONF (CONF_ID, VAL, DEFAULT_VAL, UPDATE_DT) VALUES ('samsung.mfa.used', 'false', 'false', NOW());
INSERT IGNORE INTO UI_CONF (CONF_ID, VAL, DEFAULT_VAL, UPDATE_DT) VALUES ('samsung.mfa.consumerKey', '2da81af0-fa1b-4ec2-ac4b-c41c2c1b5586', '2da81af0-fa1b-4ec2-ac4b-c41c2c1b5586', NOW());
INSERT IGNORE INTO UI_CONF (CONF_ID, VAL, DEFAULT_VAL, UPDATE_DT) VALUES ('samsung.mfa.secretKey', 'VaxDmwn3AHHZtO6Nh3OMW0lDINmXZNK2648UYLQI48M=', 'VaxDmwn3AHHZtO6Nh3OMW0lDINmXZNK2648UYLQI48M=', NOW());
...
INSERT IGNORE INTO UI_CONF (CONF_ID, VAL, DEFAULT_VAL, UPDATE_DT) VALUES ('knox.alarm.use', 'false', 'false', NOW());
INSERT IGNORE INTO UI_CONF (CONF_ID, VAL, DEFAULT_VAL, UPDATE_DT) VALUES ('sso_type', '', '', NOW());
INSERT IGNORE INTO UI_CONF (CONF_ID, VAL, DEFAULT_VAL, UPDATE_DT) VALUES ('samsung.poc', 'false', 'false', NOW());
INSERT IGNORE INTO UI_CONF (CONF_ID, VAL, DEFAULT_VAL, UPDATE_DT) VALUES ('sender.receiver.asta', 'true', 'false', NOW());
...
INSERT IGNORE INTO UI_ADMIN_MENU (ADMIN_ID, AUTH_ID) VALUES ('sysadmin', 'NER');
...
INSERT IGNORE INTO UI_LLM(LLM_CONF,LLM_PROMPT,LLM_MODEL,LLM_CONTENT) VALUES ('content.transfer','위에 있는 내용을 한글로 번역해죠','gemma3:4b','상세보기 - 번역');
INSERT IGNORE INTO UI_LLM(LLM_CONF,LLM_PROMPT,LLM_MODEL,LLM_CONTENT) VALUES ('content.keyword','위에 내용에서 주제키워드 단어로 10개 추출해죠','gemma3:4b','상세보기 - 키워드요약');
INSERT IGNORE INTO UI_LLM(LLM_CONF,LLM_PROMPT,LLM_MODEL,LLM_CONTENT) VALUES ('content.summary','위에 있는 내용을 최대 500자이내로 한글로 요약해죠','gemma3:4b','상세보기 - 내용요약');
INSERT IGNORE INTO UI_LLM(LLM_CONF,LLM_PROMPT,LLM_MODEL,LLM_CONTENT) VALUES ('content.analysis','분석 요청을 할게 인터넷 전송된 POST 데이터인데 데이터 형식은 항목,값 로 되어있어 해당 내용이 무슨 기능인지 확인해줘 그리고 해당 내용의 사용자가 직접행위로 작성한 부분이 있으면 분석해서 짧게 요약해줘. 답변은 한글로 해죠','gemma3:12b','상세보기 - 내용분석');
INSERT IGNORE INTO UI_LLM(LLM_CONF,LLM_PROMPT,LLM_MODEL,LLM_CONTENT) VALUES ('report.summary','위에 있는 내용으로 통계 분석, 이상징후, 보안관점 3분류로 분석해서 응답해죠.그리고 응답에서 "*","#" 같은 특수 문자를 사용하지 말고 답변해죠','exaone3.5:7.8b-instruct-fp16','보고서 - 요약');
INSERT IGNORE INTO UI_LLM(LLM_CONF,LLM_PROMPT,LLM_MODEL,LLM_CONTENT) VALUES ('value.analysis','분석 요청을 할게 {{path_prompt}}  <- 주소에서  {{trans_type}}  타입으로 전송된 데이터인데 데이터 형식은 {{key_prompt}}:{{value_prompt}} 이렇게돼  해당 내용이 무슨 기능인지 확인해줘 그리고 해당 내용의 보안취약점도 분석해서 짧게 요약해줘','gemma2:27b','값 분석');
INSERT IGNORE INTO UI_LLM(LLM_CONF,LLM_PROMPT,LLM_MODEL,LLM_CONTENT) VALUES ('messenger.analysis','위에 있는 내용 메신저 대화 내용인데 한국어로 분석해서 요약 해주라. 그리고 응답에서 "*","#" 같은 특수 문자를 사용하지 말고 답변해죠','gemma3:4b','메신저 서비스 - 대화 분석');
...
INSERT IGNORE INTO UI_ATTACH (ATTACH_TYPE, ATTACH_NAME, ATTACH_DESC) VALUES('BZ', '압축', '압축');
INSERT IGNORE INTO UI_ATTACH (ATTACH_TYPE, ATTACH_NAME, ATTACH_DESC) VALUES('BZ2', '압축', '압축');
INSERT IGNORE INTO UI_ATTACH (ATTACH_TYPE, ATTACH_NAME, ATTACH_DESC) VALUES('BZIP', '압축', '압축');
INSERT IGNORE INTO UI_ATTACH (ATTACH_TYPE, ATTACH_NAME, ATTACH_DESC) VALUES('C', '소스코드', '소스코드');
INSERT IGNORE INTO UI_ATTACH (ATTACH_TYPE, ATTACH_NAME, ATTACH_DESC) VALUES('CC', '소스코드', '소스코드');
INSERT IGNORE INTO UI_ATTACH (ATTACH_TYPE, ATTACH_NAME, ATTACH_DESC) VALUES('CPP', '소스코드', '소스코드');
...
INSERT IGNORE INTO UI_ATTACH (ATTACH_TYPE, ATTACH_NAME, ATTACH_DESC) VALUES('DTD', '텍스트', '텍스트');
...
INSERT IGNORE INTO UI_ATTACH (ATTACH_TYPE, ATTACH_NAME, ATTACH_DESC) VALUES('GO', '소스코드', '소스코드');
...
INSERT IGNORE INTO UI_ATTACH (ATTACH_TYPE, ATTACH_NAME, ATTACH_DESC) VALUES('ICON', '그림', '그림');
...
INSERT IGNORE INTO UI_ATTACH (ATTACH_TYPE, ATTACH_NAME, ATTACH_DESC) VALUES('JFIF', '그림', '그림');
...
INSERT IGNORE INTO UI_ATTACH (ATTACH_TYPE, ATTACH_NAME, ATTACH_DESC) VALUES('M4V', '동영상', '동영상');
...
INSERT IGNORE INTO UI_ATTACH (ATTACH_TYPE, ATTACH_NAME, ATTACH_DESC) VALUES('MHT', 'HTML', 'HTML');
...
INSERT IGNORE INTO UI_ATTACH (ATTACH_TYPE, ATTACH_NAME, ATTACH_DESC) VALUES('NUMBER', 'MS-OFFICE', 'MS-OFFICE');
INSERT IGNORE INTO UI_ATTACH (ATTACH_TYPE, ATTACH_NAME, ATTACH_DESC) VALUES('NUMBERS', 'MS-OFFICE', 'MS-OFFICE');
...
INSERT IGNORE INTO UI_ATTACH (ATTACH_TYPE, ATTACH_NAME, ATTACH_DESC) VALUES('OFT', 'E-Mail', 'E-Mail');
...
INSERT IGNORE INTO UI_ATTACH (ATTACH_TYPE, ATTACH_NAME, ATTACH_DESC) VALUES('OVA', '압축', '압축');
INSERT IGNORE INTO UI_ATTACH (ATTACH_TYPE, ATTACH_NAME, ATTACH_DESC) VALUES('OVF', '이미지굽기', '이미지굽기');
INSERT IGNORE INTO UI_ATTACH (ATTACH_TYPE, ATTACH_NAME, ATTACH_DESC) VALUES('PAK', '압축', '압축');
INSERT IGNORE INTO UI_ATTACH (ATTACH_TYPE, ATTACH_NAME, ATTACH_DESC) VALUES('PAGE', 'MS-OFFICE', 'MS-OFFICE');
INSERT IGNORE INTO UI_ATTACH (ATTACH_TYPE, ATTACH_NAME, ATTACH_DESC) VALUES('PAGES', 'MS-OFFICE', 'MS-OFFICE');
...
INSERT IGNORE INTO UI_ATTACH (ATTACH_TYPE, ATTACH_NAME, ATTACH_DESC) VALUES('PY', '소스코드', '소스코드');
...
INSERT IGNORE INTO UI_ATTACH (ATTACH_TYPE, ATTACH_NAME, ATTACH_DESC) VALUES('RB', '소스코드', '소스코드');
...
INSERT IGNORE INTO UI_ATTACH (ATTACH_TYPE, ATTACH_NAME, ATTACH_DESC) VALUES('SH', '소스코드', '소스코드');
...
INSERT IGNORE INTO UI_ATTACH (ATTACH_TYPE, ATTACH_NAME, ATTACH_DESC) VALUES('SVG', '그림', '그림');
INSERT IGNORE INTO UI_ATTACH (ATTACH_TYPE, ATTACH_NAME, ATTACH_DESC) VALUES('SWF', '동영상', '동영상');
INSERT IGNORE INTO UI_ATTACH (ATTACH_TYPE, ATTACH_NAME, ATTACH_DESC) VALUES('SXC', 'MS-OFFICE', 'MS-OFFICE');
INSERT IGNORE INTO UI_ATTACH (ATTACH_TYPE, ATTACH_NAME, ATTACH_DESC) VALUES('SXI', 'MS-OFFICE', 'MS-OFFICE');
INSERT IGNORE INTO UI_ATTACH (ATTACH_TYPE, ATTACH_NAME, ATTACH_DESC) VALUES('SXW', 'MS-OFFICE', 'MS-OFFICE');
INSERT IGNORE INTO UI_ATTACH (ATTACH_TYPE, ATTACH_NAME, ATTACH_DESC) VALUES('TAR', '압축', '압축');
INSERT IGNORE INTO UI_ATTACH (ATTACH_TYPE, ATTACH_NAME, ATTACH_DESC) VALUES('TBZ', '압축', '압축');
INSERT IGNORE INTO UI_ATTACH (ATTACH_TYPE, ATTACH_NAME, ATTACH_DESC) VALUES('TFW', '그림', '그림');
INSERT IGNORE INTO UI_ATTACH (ATTACH_TYPE, ATTACH_NAME, ATTACH_DESC) VALUES('TGA', '그림', '그림');
INSERT IGNORE INTO UI_ATTACH (ATTACH_TYPE, ATTACH_NAME, ATTACH_DESC) VALUES('TGZ', '압축', '압축');
...
INSERT IGNORE INTO UI_ATTACH (ATTACH_TYPE, ATTACH_NAME, ATTACH_DESC) VALUES('WEBP', '그림', '그림');
...
INSERT IGNORE INTO UI_ATTACH (ATTACH_TYPE, ATTACH_NAME, ATTACH_DESC) VALUES('XML', '텍스트', '텍스트');
...
INSERT IGNORE INTO UI_ATTACH (ATTACH_TYPE, ATTACH_NAME, ATTACH_DESC) VALUES('OFFICE_ZIP', 'MS-OFFICE', 'MS-OFFICE');
...
INSERT IGNORE INTO UI_REGEXP (CODE, NAME, REGEX,CODE_TYPE) VALUES('SSN', '사회 보장번호', NULL,'N');
 ...
 /* 이상행위의심*/
INSERT IGNORE INTO UI_REGEXP (CODE, NAME, REGEX,CODE_TYPE) VALUES('EC', '예상 확장자 다름', NULL,'A');
INSERT IGNORE INTO UI_REGEXP (CODE, NAME, REGEX,CODE_TYPE) VALUES('EF', '암호 설정 파일', NULL,'A');
...
INSERT IGNORE INTO UI_REGEXP (CODE, NAME, REGEX,CODE_TYPE) VALUES('DRM', 'DRM 파일', NULL,'A');

REPLACE INTO UI_REGEXP (CODE, NAME, REGEX, CODE_TYPE) SELECT 'STG','스테가노 그래피',NULL,'A' FROM UI_CONF WHERE CONF_ID = 'samsung.poc' AND VAL = 'true';
REPLACE INTO UI_REGEXP (CODE, NAME, REGEX, CODE_TYPE) SELECT 'MAL','멀웨어 파일 탐지',NULL,'A' FROM UI_CONF WHERE CONF_ID = 'samsung.poc' AND VAL = 'true';
...
('MESSAGE', '컨텐츠', 'DATA_MONITOR', 'L', 'M', '', 'fa fa-envelope', 3, 'Y', NULL),
...
('RETENTION_PERIOD', '보존 기간 설정', 'POLICY_SETUP', 'L', 'S', 'commons/netmonixDeletionPolicy.do', 'fa fa-desktop', 4, 'Y', NULL),
('PCAP_PERIOD', '수집 정책 설정', 'RETENTION_PERIOD', 'L', 'S', 'commons/netmonixDeletionPolicy.do', 'fa fa-desktop', 1, 'Y', NULL),
...
INSERT IGNORE INTO UI_EPMSG_TYPE (EPMSG_TYPE_CODE, EPMSG_TYPE_NAME, EPMSG_TYPE_COLOR) VALUES('confidential', '대외비', 'orange');
INSERT IGNORE INTO UI_EPMSG_TYPE (EPMSG_TYPE_CODE, EPMSG_TYPE_NAME, EPMSG_TYPE_COLOR) VALUES('confidential_rcpt', '대외비', 'orange');
INSERT IGNORE INTO UI_EPMSG_TYPE (EPMSG_TYPE_CODE, EPMSG_TYPE_NAME, EPMSG_TYPE_COLOR) VALUES('confidential_strict', '극비', 'red');
INSERT IGNORE INTO UI_EPMSG_TYPE (EPMSG_TYPE_CODE, EPMSG_TYPE_NAME, EPMSG_TYPE_COLOR) VALUES('official', '공문', 'green');
INSERT IGNORE INTO UI_EPMSG_TYPE (EPMSG_TYPE_CODE, EPMSG_TYPE_NAME, EPMSG_TYPE_COLOR) VALUES('personal', '일반', 'black');
...
INSERT IGNORE INTO UI_CUSTOM_DASHBOARD_DEFAULT(DASH_KEY,DASH_NAME,DASH_TYPE,DASH_MULTI_X,DASH_MULTI_Y,DASH_CHART,DASH_CHART_X,DASH_CHART_Y,DASH_ICON,DASH_COLOR,DASH_HTML,DASH_CONDITION,DASH_COMMENT,USEYN) values (1,'패턴(개인정보)메시지','S','unread','total','P','svc1','total','tit01','blueBg','
	...
	','{"searchStr":"","searchField":"","serviceType":"","serviceTypeNm":"서비스 전체","interGroup":"","interGroupNm":"-관심 사용자 그룹-","userGroupSeq":"","userGroupName":"-사용자 그룹-","startDateSelect":"T","startTimeSelect":"00","endDateSelect":"T","endTimeSelect":"23","senders":"","receivers":"","allOfus":"","busi":"","busiNm":"사업장 전체","dept":"","deptNm":"","readYn":"","receiveSend":"","ctimeWork":"","attachYn":"","attachVal":"","attachStr":"","keywordYn":"","keywordVal":"","keywordStr":"","regexpYn":"Y","regexpVal":"N%PN%L@1|N%FN%L@1|N%DN%L@1|N%SN%L@1|N%CN%L@1","regexpStr":"여권번호(1건 이상), 외국인 등록번호(1건 이상), 운전면허번호(1건 이상), 주민번호(1건 이상), 카드번호(1건 이상)","drmYn":"","sizeStartVal":"0","sizeEndVal":"0","sizeOption":"L","sizeType":""}','미열람/전체','Y');
INSERT IGNORE INTO UI_CUSTOM_DASHBOARD_DEFAULT(DASH_KEY,DASH_NAME,DASH_TYPE,DASH_MULTI_X,DASH_MULTI_Y,DASH_CHART,DASH_CHART_X,DASH_CHART_Y,DASH_ICON,DASH_COLOR,DASH_HTML,DASH_CONDITION,DASH_COMMENT,USEYN) values (2,'패턴(이상행위)메시지','S','unread','total','P','svc1','total','tit02','grayBg','
		<div class="grid-stack-item ui-draggable-handle">
			<div style="display:none;" class="gridValues" data-dashMultiLeft="total" data-dashMultiRight="unread"></div>
			<div class="grid-stack-item-content ">
				<div class="xcn_maincon panel singleBorder">
					...
					<div class="grayBg bornone panel-heading click xcn_maincon_box" data-value="reserved">
						<span class="tit02">패턴(이상행위)메시지</span>
						<p class="rightValue">-<span>건</span><span class="tit13"></span></p>
					</div>
...
INSERT INTO UI_CUSTOM_DASHBOARD_MENU(MENU_KEY, MENU_NAME, MENU_ICON, ADMIN_ID, USEYN, DEFAULT_MENU, DEFAULT_DASHBOARD, UPDATE_DT)
SELECT @ROWNUM := @ROWNUM + 1 AS MENU_KEY, 'ML Dashboard', 'fa fa-laptop', A.ADMIN_ID, 'Y', 'N', 'M', NOW()
FROM (SELECT * FROM UI_ADMIN ORDER BY ADMIN_ID) A
WHERE NOT EXISTS (SELECT * FROM UI_CUSTOM_DASHBOARD_MENU WHERE DEFAULT_DASHBOARD = 'M' AND ADMIN_ID = A.ADMIN_ID);
