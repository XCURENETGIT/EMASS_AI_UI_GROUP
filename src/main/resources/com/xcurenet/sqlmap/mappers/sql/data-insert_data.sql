...
('ISIS', '생성형 AI', 'Sider AI', '발신', 'O', 567, 'Y', ''),
('IGMS', '생성형 AI', 'Gamma', '발신', 'O', 568, 'Y', ''),
('IGMR', '생성형 AI', 'Gamma', '수신', 'I', 569, 'Y', ''),
('ICRS', '생성형 AI', 'Cursor', '발신', 'O', 570, 'Y', ''),
('ICRR', '생성형 AI', 'Cursor', '수신', 'O', 571, 'Y', ''),
('IMAS', '생성형 AI', 'ManusAI', '발신', 'O', 572, 'Y', ''),
('IMTS', '생성형 AI', 'Mistral AI', '발신', 'O', 573, 'Y', ''),
('ICBS', '생성형 AI', 'Cline', '발신', 'O', 574, 'Y', ''),
('IWBS', '생성형 AI', 'Weight & Biases', '발신', 'O', 575, 'Y', ''),
('IWBR', '생성형 AI', 'Weight & Biases', '수신', 'I', 576, 'Y', ''),
('ILLS', '생성형 AI', 'Lilys AI', '발신', 'O', 577, 'Y', ''),
('IUKS', '생성형 AI', '기타', '발신', 'O', 578, 'Y', ''),
('IGES', '생성형 AI', 'Gemini Code Assist', '발신', 'O', 579, 'Y', ''),
('IOES', '생성형 AI', 'Codex/OpenAI', '발신', 'O', 580, 'Y', ''),
('IJLS', '생성형 AI', 'Jules', '발신', 'O', 581, 'Y', ''),
('IHVS', '생성형 AI', 'Harvey', '발신', 'O', 582, 'Y', ''),
('IXAS', '생성형 AI', 'x.AI', '발신', 'O', 583, 'Y', ''),
('ICES', '생성형 AI', 'Cohere', '발신', 'O', 584, 'Y', ''),
('IWTR', '생성형 AI', 'wrtn', '수신', 'I', 585, 'Y', ''),
('ICHR', '생성형 AI', 'Character ai', '수신', 'I', 586, 'Y', ''),
('IOWR', '생성형 AI', 'Open WebUi', '수신', 'I', 587, 'Y', ''),
('IOWS', '생성형 AI', 'Open WebUi', '발신', 'O', 588, 'Y', ''),
('ISKS', '생성형 AI', 'Skywork', '발신', 'O', 589, 'Y', ''),
('IVES', '생성형 AI', 'Veo3', '발신', 'O', 590, 'Y', ''),
('IGTS', '생성형 AI', 'Gptoss', '발신', 'O', 591, 'Y', ''),
('ILRS', '생성형 AI', 'LMArena', '발신', 'O', 592, 'Y', ''),
('ILRR', '생성형 AI', 'LMArena', '수신', 'I', 593, 'Y', ''),
('IASS', '생성형 AI', 'Chat & Ask AI', '발신', 'O', 594, 'Y', ''),
('IASR', '생성형 AI', 'Chat & Ask AI', '수신', 'I', 595, 'Y', ''),
('IARR', '생성형 AI', 'Android Studio', '수신', 'O', 596, 'Y', ''),
('IARS', '생성형 AI', 'Android Studio', '발신', 'O', 597, 'Y', ''),
('IORR', '생성형 AI', 'Open Router', '수신', 'O', 598, 'Y', ''),
('IORS', '생성형 AI', 'Open Router', '발신', 'O', 599, 'Y', ''),
('IAMS', '생성형 AI', '구글 AI 모드', '발신', 'O', 600, 'Y', ''),
('IAMR', '생성형 AI', '구글 AI 모드', '수신', 'O', 601, 'Y', ''),
('ITIS', '생성형 AI', 'Timely GPT', '발신', 'O', 602, 'Y', ''),
('ITIR', '생성형 AI', 'Timely GPT', '수신', 'O', 603, 'Y', ''),
('IOTS', '생성형 AI', 'Otter.ai', '발신', 'O', 604, 'Y', ''),
('IOTR', '생성형 AI', 'Otter.ai', '수신', 'O', 605, 'Y', ''),
('IAGS', '생성형 AI', 'Google Agent Space', '발신', 'O', 606, 'Y', ''),
('IAGR', '생성형 AI', 'Google Agent Space', '수신', 'I', 607, 'Y', ''),
('ISPS', '생성형 AI', 'Soda Pdf', '발신', 'O', 608, 'Y', ''),
('ISPR', '생성형 AI', 'Soda Pdf', '수신', 'I', 609, 'Y', ''),
('IFPS', '생성형 AI', 'FreePik', '발신', 'O', 610, 'Y', ''),
('IFPR', '생성형 AI', 'FreePik', '수신', 'I', 611, 'Y', ''),
('ITOS', '생성형 AI', 'Tigris AI+', '발신', 'O', 612, 'Y', ''),
('IATS', '생성형 AI', 'Antigravity', '발신', 'O', 613, 'Y', ''),
('IATR', '생성형 AI', 'Antigravity', '수신', 'I', 614, 'Y', ''),
('PDOS', '프로젝트', 'dooray', '발신', 'O', 615, 'Y', ''),
('PGIS', '프로젝트', 'github', '발신', 'O', 616, 'Y', ''),
('PGLS', '프로젝트', 'Glassdoor', '발신', 'O', 617, 'Y', ''),
('PJDS', '프로젝트', '잔디', '발신', 'O', 618, 'Y', ''),
('PITS', '프로젝트', 'Google Issue Tracker', '발신', 'O', 619, 'Y', ''),
('EBDR', '그룹웨어', '게시', '수신', 'I', 620, 'Y', ''),
('EBD-', '그룹웨어', '게시', '발신', 'O', 621, 'Y', ''),
('EBBR', '그룹웨어', '게시판', '수신', 'I', 622, 'Y', ''),
('EBBS', '그룹웨어', '게시판', '발신', 'O', 623, 'Y', ''),
('EBBF', '그룹웨어', '게시판', '파일수신', 'I', 624, 'Y', ''),
('EAAR', '그룹웨어', '결재', '수신', 'I', 625, 'Y', ''),
('EAAS', '그룹웨어', '결재', '발신', 'O', 626, 'Y', ''),
('EAAG', '그룹웨어', '결재', '통보 - 수신', 'I', 627, 'Y', ''),
('EAAP', '그룹웨어', '결재', '통보 - 발신', 'O', 628, 'Y', ''),
('EAAF', '그룹웨어', '결재', '파일수신', 'I', 629, 'Y', ''),
('EMMR', '그룹웨어', '메일', '그룹웨어 수신', 'I', 630, 'Y', ''),
('EMMS', '그룹웨어', '메일', '그룹웨어 발신', 'O', 631, 'Y', ''),
('EMMG', '그룹웨어', '메일', 'OWA 수신', 'I', 632, 'Y', ''),
('EMMP', '그룹웨어', '메일', 'OWA 발신', 'O', 633, 'Y', ''),
('EMMD', '그룹웨어', '메일', 'RPC 수신', 'I', 634, 'Y', ''),
('EMMU', '그룹웨어', '메일', 'RPC 발신', 'O', 635, 'Y', ''),
('EMMC', '그룹웨어', '메일', '수신', 'I', 636, 'Y', ''),
('EMML', '그룹웨어', '메일', '발신', 'O', 637, 'Y', ''),
('EMM1', '그룹웨어', '메일', '보안등급1', 'O', 638, 'Y', ''),
('EMM2', '그룹웨어', '메일', '보안등급2', 'O', 639, 'Y', ''),
('EMM3', '그룹웨어', '메일', '보안등급3', 'O', 640, 'Y', ''),
('EMM4', '그룹웨어', '메일', '보안등급4', 'O', 641, 'Y', ''),
('EMMA', '그룹웨어', '메일', '임시(자동)', 'O', 642, 'Y', ''),
('EMMT', '그룹웨어', '메일', '임시(수동)', 'O', 643, 'Y', ''),
('EMMK', '그룹웨어', '메일', 'Outlook - 수신', 'I', 644, 'Y', ''),
('EMMO', '그룹웨어', '메일', 'Outlook - 발신', 'O', 645, 'Y', ''),
('EMMB', '그룹웨어', '메일', '그룹웨어 예약메일', 'O', 646, 'Y', ''),
('EMBR', '그룹웨어', '모바일', '수신', 'I', 647, 'Y', ''),
('EMB-', '그룹웨어', '모바일', '발신', 'O', 648, 'Y', ''),
('EWSR', '그룹웨어', '웹서비스', '수신', 'I', 649, 'Y', ''),
('EWS-', '그룹웨어', '웹서비스', '발신', 'O', 650, 'Y', ''),
('EPUR', '그룹웨어', '일반', '수신', 'I', 651, 'Y', ''),
('EPU-', '그룹웨어', '일반', '발신', 'O', 652, 'Y', ''),
('EAU-', '그룹웨어', '일반(자동전달)', '자동전달', 'O', 653, 'Y', ''),
('ESCR', '그룹웨어', '일정 명함', '수신', 'I', 654, 'Y', ''),
('ESC-', '그룹웨어', '일정 명함', '발신', 'O', 655, 'Y', ''),
('EMF-', '그룹웨어', '파일 다운로드', '-', 'I', 656, 'Y', ''),
('EMU-', '그룹웨어', '기타', '', 'O', 657, 'Y', ''),
('EMDR', '그룹웨어', '드라이브', '수신', 'I', 658, 'Y', ''),
('EMDS', '그룹웨어', '드라이브', '발신', 'O', 659, 'Y', ''),
('ECIS', '그룹웨어', 'Samsung cic', '발신', 'O', 660, 'Y', ''),
('EMER', '그룹웨어', '메신저', '수신', 'I', 661, 'Y', ''),
('EMES', '그룹웨어', '메신저', '발신', 'O', 662, 'Y', ''),
('EMEC', '그룹웨어', '메신저', '채팅', 'O', 663, 'Y', 'MSG'),
('EZQC', '그룹웨어', 'Zohocliq', '채팅', 'O', 664, 'Y', ''),
('EZQS', '그룹웨어', 'Zohocliq', '캘린더', 'O', 665, 'Y', ''),
('EKWS', '그룹웨어', '카카오워크', '발신', 'O', 666, 'Y', ''),
('ECAS', '그룹웨어', '일정', '발신', 'O', 667, 'Y', ''),
('ETOS', '그룹웨어', 'Tigris', '기타', 'O', 668, 'Y', ''),
('ETOC', '그룹웨어', 'Tigris', '메신저', 'O', 669, 'Y', ''),
('ETOD', '그룹웨어', 'Tigris', '드라이브', 'O', 670, 'Y', ''),
('DCCS', '편집기', 'Clip Champ', '발신', 'O', 671, 'Y', ''),
('DFGS', '편집기', 'Figma', '발신', 'O', 672, 'Y', ''),
('DOVS', '편집기', 'Overleaf', '발신', 'O', 673, 'Y', ''),
('DOVR', '편집기', 'Overleaf', '수신', 'I', 674, 'Y', ''),
('DPKS', '편집기', 'Plunker', '발신', 'O', 675, 'Y', ''),
('DNWS', '편집기', 'Namu.wiki', '발신', 'O', 676, 'Y', ''),
('DWKS', '편집기', 'WikiPedia', '발신', 'O', 677, 'Y', ''),
('DAES', '편집기', 'Adobe Express', '발신', 'O', 678, 'Y', ''),
('DSMS', '편집기', 'Sketchmon', '발신', 'O', 679, 'Y', ''),
('DGSS', '편집기', 'Google Site', '발신', 'O', 680, 'Y', ''),
('DCVS', '편집기', 'Canva', '발신', 'O', 681, 'Y', ''),
('DMBS', '편집기', '망고보드', '발신', 'O', 682, 'Y', ''),
('DMTS', '편집기', '망고툰', '발신', 'O', 683, 'Y', ''),
('JBDS', '웹사이트', 'Baidu', '발신', 'O', 684, 'Y', ''),
('JANS', '웹사이트', 'Anthropic', '발신', 'O', 685, 'Y', ''),
('JKAS', '웹사이트', 'Kaggle', '발신', 'O', 686, 'Y', ''),
('JJPS', '웹사이트', 'justpaste.it', '발신', 'O', 687, 'Y', ''),
('JPBS', '웹사이트', 'pastebin.com', '발신', 'O', 688, 'Y', ''),
('JNNS', '웹사이트', 'n8n', '발신', 'O', 689, 'Y', ''),
('JGHS', '웹사이트', 'Google cloud console', '발신', 'O', 690, 'Y', ''),
('JALS', '웹사이트', 'AnessLab', '발신', 'O', 691, 'Y', ''),
('JCCS', '웹사이트', 'CMCC [GUI-AGENT]', '발신', 'O', 692, 'Y', ''),
('JOTS', '웹사이트', 'Otter.ai', '발신', 'O', 693, 'Y', ''),
('JMLS', '웹사이트', 'Menlosecurity', '발신', 'O', 694, 'Y', ''),
('JHFS', '웹사이트', 'Hugging Face', '발신', 'O', 695, 'Y', ''),
('JSNS', '웹사이트', 'AWS SNS', '발신', 'O', 696, 'Y', ''),
('JAGS', '웹사이트', 'AWS API Gateway', '발신', 'O', 697, 'Y', ''),
('JASS', '웹사이트', 'AWS SSM', '발신', 'O', 698, 'Y', ''),
('RGUS', '원격접속', '아파치 과카몰리', '발신', 'O', 699, 'Y', ''),
('RGUR', '원격접속', '아파치 과카몰리', '수신', 'I', 700, 'Y', ''),
('KAAR', '웹서비스(분류)', '웹 수신', '수신', 'I', 701, 'Y', ''),
('KAAS', '웹서비스(분류)', '웹 발신', '발신', 'O', 702, 'Y', '');
