...
INSERT IGNORE INTO UI_SERVICE (`SERVICECD`, `SERVICENM_LV1`, `SERVICENM_LV2`, `SERVICENM_LV3`, `IN_OUT`, `SORT`, `USE_YN`,`MSGGRPCD`)
  VALUES ('MP3-', '메일', 'POP3', '-', 'I', 1, 'Y', ''),
    ...
    ('ICUS', '생성형 AI', '네이버 CUE:', '발신', 'I', 435, 'Y', ''),
    ('IMJS', '생성형 AI', 'Midjourney', '발신', 'I', 436, 'Y', ''),
    ('ISGR', '생성형 AI', 'slidesGPT', '수신', 'I', 437, 'Y', ''),
    ('ISGS', '생성형 AI', 'slidesGPT', '발신', 'I', 438, 'Y', ''),
    ('IDMS', '생성형 AI', 'AiDocmaker', '발신', 'I', 439, 'Y', ''),
    ('IRKS', '생성형 AI', 'Reka AI', '발신', 'I', 440, 'Y', ''),
    ('ICLS', '생성형 AI', 'claude', '발신', 'I', 441, 'Y', ''),
    ('IUKS', '생성형 AI', '기타', '발신', 'I', 442, 'Y', ''),
    ('PDOS', '프로젝트', 'dooray', '발신', 'O', 443, 'Y', ''),
    ('PGIS', '프로젝트', 'github', '발신', 'O', 444, 'Y', ''),
    ('EBDR', '그룹웨어', '게시', '수신', 'I', 445, 'Y', ''),
    ('EBD-', '그룹웨어', '게시', '발신', 'O', 446, 'Y', ''),
    ('EBBR', '그룹웨어', '게시판', '수신', 'I', 447, 'Y', ''),
    ('EBBS', '그룹웨어', '게시판', '발신', 'O', 448, 'Y', ''),
    ('EBBF', '그룹웨어', '게시판', '파일수신', 'I', 449, 'Y', ''),
    ('EAAR', '그룹웨어', '결재', '수신', 'I', 450, 'Y', ''),
    ('EAAS', '그룹웨어', '결재', '발신', 'O', 451, 'Y', ''),
    ('EAAG', '그룹웨어', '결재', '통보 - 수신', 'I', 452, 'Y', ''),
    ('EAAP', '그룹웨어', '결재', '통보 - 발신', 'O', 453, 'Y', ''),
    ('EAAF', '그룹웨어', '결재', '파일수신', 'I', 454, 'Y', ''),
    ('EMMR', '그룹웨어', '메일', '그룹웨어 수신', 'I', 455, 'Y', ''),
    ('EMMS', '그룹웨어', '메일', '그룹웨어 발신', 'O', 456, 'Y', ''),
    ('EMMG', '그룹웨어', '메일', 'OWA 수신', 'I', 457, 'Y', ''),
    ('EMMP', '그룹웨어', '메일', 'OWA 발신', 'O', 458, 'Y', ''),
    ('EMMD', '그룹웨어', '메일', 'RPC 수신', 'I', 459, 'Y', ''),
    ('EMMU', '그룹웨어', '메일', 'RPC 발신', 'O', 460, 'Y', ''),
    ('EMMC', '그룹웨어', '메일', '수신', 'I', 461, 'Y', ''),
    ('EMML', '그룹웨어', '메일', '발신', 'O', 462, 'Y', ''),
    ('EMM1', '그룹웨어', '메일', '보안등급1', 'O', 463, 'Y', ''),
    ('EMM2', '그룹웨어', '메일', '보안등급2', 'O', 464, 'Y', ''),
    ('EMM3', '그룹웨어', '메일', '보안등급3', 'O', 465, 'Y', ''),
    ('EMM4', '그룹웨어', '메일', '보안등급4', 'O', 466, 'Y', ''),
    ('EMMA', '그룹웨어', '메일', '임시(자동)', 'O', 467, 'Y', ''),
    ('EMMT', '그룹웨어', '메일', '임시(수동)', 'O', 468, 'Y', ''),
    ('EMMK', '그룹웨어', '메일', 'Outlook - 수신', 'I', 469, 'Y', ''),
    ('EMMO', '그룹웨어', '메일', 'Outlook - 발신', 'O', 470, 'Y', ''),
    ('EMMB', '그룹웨어', '메일', '그룹웨어 예약메일', 'O', 471, 'Y', ''),
    ('EMBR', '그룹웨어', '모바일', '수신', 'I', 472, 'Y', ''),
    ('EMB-', '그룹웨어', '모바일', '발신', 'O', 473, 'Y', ''),
    ('EWSR', '그룹웨어', '웹서비스', '수신', 'I', 474, 'Y', ''),
    ('EWS-', '그룹웨어', '웹서비스', '발신', 'O', 475, 'Y', ''),
    ('EPUR', '그룹웨어', '일반', '수신', 'I', 476, 'Y', ''),
    ('EPU-', '그룹웨어', '일반', '발신', 'O', 477, 'Y', ''),
    ('ESCR', '그룹웨어', '일정 명함', '수신', 'I', 478, 'Y', ''),
    ('ESC-', '그룹웨어', '일정 명함', '발신', 'O', 479, 'Y', ''),
    ('EMF-', '그룹웨어', '파일 다운로드', '-', 'I', 480, 'Y', ''),
    ('EMU-', '그룹웨어', '기타', '', 'O', 481, 'Y', ''),
    ('EMDR', '그룹웨어', '드라이브', '수신', 'I', 482, 'Y', ''),
    ('EMDS', '그룹웨어', '드라이브', '발신', 'O', 483, 'Y', ''),
    ('ECIS', '그룹웨어', 'Samsung cic', '발신', 'O', 484, 'Y', ''),
    ('DCCS', '편집기', 'Clip Champ', '발신', 'O', 485, 'Y', '');
