...
INSERT IGNORE INTO UI_SERVICE (`SERVICECD`, `SERVICENM_LV1`, `SERVICENM_LV2`, `SERVICENM_LV3`, `IN_OUT`, `SORT`, `USE_YN`,`MSGGRPCD`)
    ...
    ('IDMR', '생성형 AI', 'Ai Docker Attach', '수신', 'I', 442, 'Y', ''),
    ('IADR', '생성형 AI', 'Adobe firefly login', '수신', 'I', 443, 'Y', ''),
    ('IUKS', '생성형 AI', '기타', '발신', 'I', 444, 'Y', ''),
    ('PDOS', '프로젝트', 'dooray', '발신', 'O', 445, 'Y', ''),
    ('PGIS', '프로젝트', 'github', '발신', 'O', 446, 'Y', ''),
    ('EBDR', '그룹웨어', '게시', '수신', 'I', 447, 'Y', ''),
    ('EBD-', '그룹웨어', '게시', '발신', 'O', 448, 'Y', ''),
    ('EBBR', '그룹웨어', '게시판', '수신', 'I', 449, 'Y', ''),
    ('EBBS', '그룹웨어', '게시판', '발신', 'O', 450, 'Y', ''),
    ('EBBF', '그룹웨어', '게시판', '파일수신', 'I', 451, 'Y', ''),
    ('EAAR', '그룹웨어', '결재', '수신', 'I', 452, 'Y', ''),
    ('EAAS', '그룹웨어', '결재', '발신', 'O', 453, 'Y', ''),
    ('EAAG', '그룹웨어', '결재', '통보 - 수신', 'I', 454, 'Y', ''),
    ('EAAP', '그룹웨어', '결재', '통보 - 발신', 'O', 455, 'Y', ''),
    ('EAAF', '그룹웨어', '결재', '파일수신', 'I', 456, 'Y', ''),
    ('EMMR', '그룹웨어', '메일', '그룹웨어 수신', 'I', 457, 'Y', ''),
    ('EMMS', '그룹웨어', '메일', '그룹웨어 발신', 'O', 458, 'Y', ''),
    ('EMMG', '그룹웨어', '메일', 'OWA 수신', 'I', 459, 'Y', ''),
    ('EMMP', '그룹웨어', '메일', 'OWA 발신', 'O', 460, 'Y', ''),
    ('EMMD', '그룹웨어', '메일', 'RPC 수신', 'I', 461, 'Y', ''),
    ('EMMU', '그룹웨어', '메일', 'RPC 발신', 'O', 462, 'Y', ''),
    ('EMMC', '그룹웨어', '메일', '수신', 'I', 463, 'Y', ''),
    ('EMML', '그룹웨어', '메일', '발신', 'O', 464, 'Y', ''),
    ('EMM1', '그룹웨어', '메일', '보안등급1', 'O', 465, 'Y', ''),
    ('EMM2', '그룹웨어', '메일', '보안등급2', 'O', 466, 'Y', ''),
    ('EMM3', '그룹웨어', '메일', '보안등급3', 'O', 467, 'Y', ''),
    ('EMM4', '그룹웨어', '메일', '보안등급4', 'O', 468, 'Y', ''),
    ('EMMA', '그룹웨어', '메일', '임시(자동)', 'O', 469, 'Y', ''),
    ('EMMT', '그룹웨어', '메일', '임시(수동)', 'O', 470, 'Y', ''),
    ('EMMK', '그룹웨어', '메일', 'Outlook - 수신', 'I', 471, 'Y', ''),
    ('EMMO', '그룹웨어', '메일', 'Outlook - 발신', 'O', 472, 'Y', ''),
    ('EMMB', '그룹웨어', '메일', '그룹웨어 예약메일', 'O', 473, 'Y', ''),
    ('EMBR', '그룹웨어', '모바일', '수신', 'I', 474, 'Y', ''),
    ('EMB-', '그룹웨어', '모바일', '발신', 'O', 475, 'Y', ''),
    ('EWSR', '그룹웨어', '웹서비스', '수신', 'I', 476, 'Y', ''),
    ('EWS-', '그룹웨어', '웹서비스', '발신', 'O', 477, 'Y', ''),
    ('EPUR', '그룹웨어', '일반', '수신', 'I', 478, 'Y', ''),
    ('EPU-', '그룹웨어', '일반', '발신', 'O', 479, 'Y', ''),
    ('ESCR', '그룹웨어', '일정 명함', '수신', 'I', 480, 'Y', ''),
    ('ESC-', '그룹웨어', '일정 명함', '발신', 'O', 481, 'Y', ''),
    ('EMF-', '그룹웨어', '파일 다운로드', '-', 'I', 482, 'Y', ''),
    ('EMU-', '그룹웨어', '기타', '', 'O', 483, 'Y', ''),
    ('EMDR', '그룹웨어', '드라이브', '수신', 'I', 484, 'Y', ''),
    ('EMDS', '그룹웨어', '드라이브', '발신', 'O', 485, 'Y', ''),
    ('ECIS', '그룹웨어', 'Samsung cic', '발신', 'O', 486, 'Y', ''),
    ('DCCS', '편집기', 'Clip Champ', '발신', 'O', 487, 'Y', '');
...
('STAT_ATTACHTYPE', '첨부 파일 통계',ONTENT', 'L', 'M', 'ems/infoTypeStat.do', 'fa fa-pie-chart', 11, 'Y', NULL),
...
('STAT_USER', '사용자 통계', 'STAT_CONTENT', 'STAT_CONTENT', 'L', 'M', 'ems/attachTypeStat.do', 'fa fa-pie-chart', 6, 'Y', NULL),
...
('STAT_INFOTYPE', '정보 분류 통계', 'STAT_C 'L', 'M', 'ems/usersStat.do', 'fa fa-pie-chart', 1, 'Y', NULL),
...
('ADMIN_MGMT','운용자 관리','OPERATION_MGMT','L','S','commons/admin.do','fa fa-unlock-alt',4,'Y');
