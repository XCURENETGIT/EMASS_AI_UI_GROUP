...
INSERT IGNORE INTO UI_REGEXP( CODE, NAME, REGEX ) VALUES ('LTO', '대용량 본문내용 사외 발송', null);
...
INSERT IGNORE INTO UI_CUSTOM_DASHBOARD_MENU (MENU_KEY,MENU_NAME,MENU_ICON,ADMIN_ID,USEYN,DEFAULT_MENU,DEFAULT_DASHBOARD,UPDATE_DT) VALUES (0,'Default Dashboard','fa fa-th','sysadmin','Y','Y','Y',NOW());
