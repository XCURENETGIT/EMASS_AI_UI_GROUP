...
VALUES ('MP3-', '메일', 'POP3', '-', 'I', 1, 'Y', ''),
       ...
       ('QGBC', '메신저', '구글 Gemini', '채팅', 'O', 263, 'Y', 'MSG'),
       ...
       ('ZTN-', '기타 서비스', 'Telnet', '-', 'O', 333, 'Y', ''),
       ('ZXT-', '기타 서비스', 'Xterm', '-', 'O', 334, 'Y', ''),
       ('ZRL-', '기타 서비스', 'R-Login', '-', 'O', 335, 'Y', ''),
       ('ZNP-', '기타 서비스', 'NNTP', '-', 'O', 336, 'Y', ''),
       ('ZPC-', '기타 서비스', 'PC 보안', '-', 'O', 337, 'N', ''),
       ('ZSH-', '기타 서비스', 'SSH', 'SSH 세션 정보', 'O', 338, 'Y', ''),
       ('XX1R', '모니터링_제외', '미분류_타입1', '수신', 'I', 339, 'Y', ''),
       ('XX1S', '모니터링_제외', '미분류_타입1', '발신', 'O', 340, 'Y', ''),
       ('XX2R', '모니터링_제외', '미분류_타입2', '수신', 'I', 341, 'Y', ''),
       ('XX2S', '모니터링_제외', '미분류_타입2', '발신', 'O', 342, 'Y', ''),
       ('XX3R', '모니터링_제외', '미분류_타입3', '수신', 'I', 343, 'Y', ''),
       ('XX3S', '모니터링_제외', '미분류_타입3', '발신', 'O', 344, 'Y', ''),
       ('XU1R', '모니터링_제외', '웹서비스(미분류)_타입1', '수신', 'I', 345, 'Y', ''),
       ('XU1S', '모니터링_제외', '웹서비스(미분류)_타입1', '발신', 'O', 346, 'Y', ''),
       ('XU2R', '모니터링_제외', '웹서비스(미분류)_타입2', '수신', 'I', 347, 'Y', ''),
       ('XU2S', '모니터링_제외', '웹서비스(미분류)_타입2', '발신', 'O', 348, 'Y', ''),
       ('XU3R', '모니터링_제외', '웹서비스(미분류)_타입3', '수신', 'I', 349, 'Y', ''),
       ('XU3S', '모니터링_제외', '웹서비스(미분류)_타입3', '발신', 'O', 350, 'Y', ''),
       ('UWSD', '웹서비스(미분류)', '웹 발신', '첨부 - 문서타입', 'O', 351, 'Y', ''),
       ('UWSE', '웹서비스(미분류)', '웹 발신', '첨부 - 문서아님', 'O', 352, 'Y', ''),
       ('UWSU', '웹서비스(미분류)', '웹 발신', '첨부 없음', 'O', 353, 'Y', ''),
       ('UWSH', '웹서비스(미분류)', '웹 발신', '중요도(상)', 'O', 354, 'Y', ''),
       ('UWSM', '웹서비스(미분류)', '웹 발신', '중요도(중)', 'O', 355, 'Y', ''),
       ('UWSL', '웹서비스(미분류)', '웹 발신', '중요도(하)', 'O', 356, 'Y', ''),
       ('UX1R', '웹서비스(미분류)', '미분류_타입1', '수신', 'I', 357, 'Y', ''),
       ('UX1S', '웹서비스(미분류)', '미분류_타입1', '발신', 'O', 358, 'Y', ''),
       ('UX2R', '웹서비스(미분류)', '미분류_타입2', '수신', 'I', 359, 'Y', ''),
       ('UX2S', '웹서비스(미분류)', '미분류_타입2', '발신', 'O', 360, 'Y', ''),
       ('UX3R', '웹서비스(미분류)', '미분류_타입3', '수신', 'I', 361, 'Y', ''),
       ('UX3S', '웹서비스(미분류)', '미분류_타입3', '발신', 'O', 362, 'Y', ''),
       ('UWRD', '웹서비스(미분류)', '웹 수신', '첨부 - 문서타입', 'I', 363, 'Y', ''),
       ('UWRE', '웹서비스(미분류)', '웹 수신', '첨부 - 문서아님', 'I', 364, 'Y', ''),
       ('UWRU', '웹서비스(미분류)', '웹 수신', '첨부 없음', 'I', 365, 'Y', ''),
       ('BWSD', '웹서비스(업무)', '업무 발신', '첨부 - 문서타입', 'O', 366, 'Y', ''),
       ('BWSE', '웹서비스(업무)', '업무 발신', '첨부 - 문서아님', 'O', 367, 'Y', ''),
       ('BWSU', '웹서비스(업무)', '업무 발신', '첨부 없음', 'O', 368, 'Y', ''),
       ('BWRD', '웹서비스(업무)', '업무 수신', '첨부 - 문서타입', 'I', 369, 'Y', ''),
       ('BWRE', '웹서비스(업무)', '업무 수신', '첨부 - 문서아님', 'I', 370, 'Y', ''),
       ('BWRU', '웹서비스(업무)', '업무 수신', '첨부 없음', 'I', 371, 'Y', ''),
       ('TWEC', '화상회의', 'Webex', '채팅', 'O', 372, 'Y', 'MSG'),
       ('TWEF', '화상회의', 'Webex', '파일전송', 'O', 373, 'Y', 'MSG'),
       ('TWEJ', '화상회의', 'Webex', '참여', 'O', 374, 'Y', 'MSG'),
       ('TWEL', '화상회의', 'Webex', '떠남', 'O', 375, 'Y', 'MSG'),
       ('TZOC', '화상회의', 'Zoom', '채팅', 'O', 376, 'Y', 'MSG'),
       ('TZOF', '화상회의', 'Zoom', '파일전송', 'O', 377, 'Y', 'MSG'),
       ('TZOJ', '화상회의', 'Zoom', '참여', 'O', 378, 'Y', 'MSG'),
       ('TZOL', '화상회의', 'Zoom', '떠남', 'O', 379, 'Y', 'MSG'),
       ('TTMC', '화상회의', 'Teams', '채팅', 'O', 380, 'Y', 'MSG'),
       ('TTMF', '화상회의', 'Teams', '파일전송', 'O', 381, 'Y', 'MSG'),
       ('TTMJ', '화상회의', 'Teams', '참여', 'O', 382, 'Y', 'MSG'),
       ('TTML', '화상회의', 'Teams', '떠남', 'O', 383, 'Y', 'MSG'),
       ('TSKC', '화상회의', 'Skype', '채팅', 'O', 384, 'Y', 'MSG'),
       ('TSKF', '화상회의', 'Skype', '파일전송', 'O', 385, 'Y', 'MSG'),
       ('TSKJ', '화상회의', 'Skype', '참여', 'O', 386, 'Y', 'MSG'),
       ('TSKL', '화상회의', 'Skype', '떠남', 'O', 387, 'Y', 'MSG'),
       ('TJMC', '화상회의', 'JoinME', '채팅', 'O', 388, 'Y', 'MSG'),
       ('TJMF', '화상회의', 'JoinME', '파일전송', 'O', 389, 'Y', 'MSG'),
       ('TAMC', '화상회의', 'Amazon Chime', '채팅', 'O', 390, 'Y', 'MSG'),
       ('TAMF', '화상회의', 'Amazon Chime', '파일전송', 'O', 391, 'Y', 'MSG'),
       ('TBJC', '화상회의', 'BlueJeans', '채팅', 'O', 392, 'Y', 'MSG'),
       ('TTDS', '화상회의', 'tl;dv', '채팅', 'O', 393, 'Y', 'MSG'),
       ('LNVS', '번역기', '파파고 번역', '발신', 'O', 394, 'Y', ''),
       ('LGGS', '번역기', '구글 번역', '발신', 'O', 395, 'Y', ''),
       ('LGPS', '번역기', '구글 번역 플러그인', '발신', 'O', 396, 'Y', ''),
       ('LDES', '번역기', 'Deepl', '발신', 'O', 397, 'Y', ''),
       ('LBIS', '번역기', 'Bing 번역', '발신', 'O', 398, 'Y', ''),
       ('LYMS', '번역기', 'Yandex 번역', '발신', 'O', 399, 'Y', ''),
       ('LUKS', '번역기', '기타', '발신', 'I', 400, 'Y', ''),
       ('IGBS', '생성형 AI', '구글 Gemini', '발신', 'O', 401, 'Y', ''),
       ('IBIS', '생성형 AI', 'Microsoft BingAI Chat', '발신', 'O', 402, 'Y', ''),
       ('IWTS', '생성형 AI', 'wrtn', '발신', 'O', 403, 'Y', ''),
       ('IGPS', '생성형 AI', 'chatGPT', '발신', 'O', 404, 'Y', ''),
       ('IDAS', '생성형 AI', 'Dall-E', '발신', 'O', 405, 'Y', ''),
       ('IGCS', '생성형 AI', 'Github Copilot', '발신', 'I', 406, 'Y', ''),
       ('IYCS', '생성형 AI', 'YouChat', '발신', 'I', 407, 'Y', ''),
       ('ICSS', '생성형 AI', 'Chatsonic', '발신', 'I', 408, 'Y', ''),
       ('IRPS', '생성형 AI', 'replika', '발신', 'I', 409, 'Y', ''),
       ('IPPS', '생성형 AI', 'Perplexity', '발신', 'I', 410, 'Y', ''),
       ('ITCS', '생성형 AI', 'TextCortex', '발신', 'I', 411, 'Y', ''),
       ('IPHS', '생성형 AI', 'Phind', '발신', 'I', 412, 'Y', ''),
       ('IPOS', '생성형 AI', 'Poe', '발신', 'I', 413, 'Y', ''),
       ('IHFS', '생성형 AI', 'Hugging Face', '발신', 'I', 414, 'Y', ''),
       ('ICPS', '생성형 AI', 'Copy.AI', '발신', 'I', 415, 'Y', ''),
       ('IHWS', '생성형 AI', 'HyperWrite', '발신', 'I', 416, 'Y', ''),
       ('IDPS', '생성형 AI', 'DeepAI', '발신', 'I', 417, 'Y', ''),
       ('IACS', '생성형 AI', 'AskCodi', '발신', 'I', 418, 'Y', ''),
       ('INAS', '생성형 AI', 'Native', '발신', 'I', 419, 'Y', ''),
       ('INFS', '생성형 AI', 'NeuroFlash', '발신', 'I', 420, 'Y', ''),
       ('INOS', '생성형 AI', 'Notion AI', '발신', 'I', 421, 'Y', ''),
       ('IMES', '생성형 AI', 'Merlin', '발신', 'I', 422, 'Y', ''),
       ('ICXS', '생성형 AI', 'CLOVA-X', '발신', 'I', 423, 'Y', ''),
       ('IADS', '생성형 AI', 'Adobe AI', '발신', 'I', 424, 'Y', ''),
       ('ICDS', '생성형 AI', 'ClipDrop', '발신', 'I', 425, 'Y', ''),
       ('ISBS', '생성형 AI', 'Stability.Ai', '발신', 'I', 426, 'Y', ''),
       ('IRMS', '생성형 AI', 'Runwayml', '발신', 'I', 427, 'Y', ''),
       ('IGVS', '생성형 AI', 'Google Vertex', '발신', 'I', 428, 'Y', ''),
       ('IGLS', '생성형 AI', 'Google Colab', '발신', 'I', 429, 'Y', ''),
       ('ICWS', '생성형 AI', 'CodeWhisperer', '발신', 'I', 430, 'Y', ''),
       ('IMSS', '생성형 AI', 'MakerSuite', '발신', 'I', 431, 'Y', ''),
       ('IOCS', '생성형 AI', 'Clova OCR', '발신', 'I', 432, 'Y', ''),
       ('IAOS', '생성형 AI', 'Azure OpenAI', '발신', 'I', 433, 'Y', ''),
       ('ICUS', '생성형 AI', 'NAVER CUE:', '발신', 'I', 434, 'Y', ''),
       ('IMJS', '생성형 AI', 'Midjourney', '발신', 'I', 435, 'Y', ''),
       ('IUKS', '생성형 AI', '기타', '발신', 'I', 436, 'Y', ''),
       ('PDOS', '프로젝트', 'dooray', '발신', 'O', 437, 'Y', ''),
       ('PGIS', '프로젝트', 'github', '발신', 'O', 438, 'Y', ''),
       ('EBDR', '그룹웨어', '게시', '수신', 'I', 439, 'Y', ''),
       ('EBD-', '그룹웨어', '게시', '발신', 'O', 440, 'Y', ''),
       ('EBBR', '그룹웨어', '게시판', '수신', 'I', 441, 'Y', ''),
       ('EBBS', '그룹웨어', '게시판', '발신', 'O', 442, 'Y', ''),
       ('EBBF', '그룹웨어', '게시판', '파일수신', 'I', 442, 'Y', ''),
       ('EAAR', '그룹웨어', '결재', '수신', 'I', 444, 'Y', ''),
       ('EAAS', '그룹웨어', '결재', '발신', 'O', 445, 'Y', ''),
       ('EAAG', '그룹웨어', '결재', '통보 - 수신', 'I', 446, 'Y', ''),
       ('EAAP', '그룹웨어', '결재', '통보 - 발신', 'O', 447, 'Y', ''),
       ('EAAF', '그룹웨어', '결재', '파일수신', 'I', 448, 'Y', ''),
       ('EMMR', '그룹웨어', '메일', '그룹웨어 수신', 'I', 449, 'Y', ''),
       ('EMMS', '그룹웨어', '메일', '그룹웨어 발신', 'O', 450, 'Y', ''),
       ('EMMG', '그룹웨어', '메일', 'OWA 수신', 'I', 451, 'Y', ''),
       ('EMMP', '그룹웨어', '메일', 'OWA 발신', 'O', 452, 'Y', ''),
       ('EMMD', '그룹웨어', '메일', 'RPC 수신', 'I', 453, 'Y', ''),
       ('EMMU', '그룹웨어', '메일', 'RPC 발신', 'O', 454, 'Y', ''),
       ('EMMC', '그룹웨어', '메일', '수신', 'I', 455, 'Y', ''),
       ('EMML', '그룹웨어', '메일', '발신', 'O', 456, 'Y', ''),
       ('EMM1', '그룹웨어', '메일', '보안등급1', 'O', 457, 'Y', ''),
       ('EMM2', '그룹웨어', '메일', '보안등급2', 'O', 458, 'Y', ''),
       ('EMM3', '그룹웨어', '메일', '보안등급3', 'O', 459, 'Y', ''),
       ('EMM4', '그룹웨어', '메일', '보안등급4', 'O', 460, 'Y', ''),
       ('EMMA', '그룹웨어', '메일', '임시(자동)', 'O', 461, 'Y', ''),
       ('EMMT', '그룹웨어', '메일', '임시(수동)', 'O', 462, 'Y', ''),
       ('EMMK', '그룹웨어', '메일', 'Outlook - 수신', 'I', 463, 'Y', ''),
       ('EMMO', '그룹웨어', '메일', 'Outlook - 발신', 'O', 464, 'Y', ''),
       ('EMMB', '그룹웨어', '메일', '그룹웨어 예약메일', 'O', 465, 'Y', ''),
       ('EMBR', '그룹웨어', '모바일', '수신', 'I', 466, 'Y', ''),
       ('EMB-', '그룹웨어', '모바일', '발신', 'O', 467, 'Y', ''),
       ('EWSR', '그룹웨어', '웹서비스', '수신', 'I', 468, 'Y', ''),
       ('EWS-', '그룹웨어', '웹서비스', '발신', 'O', 469, 'Y', ''),
       ('EPUR', '그룹웨어', '일반', '수신', 'I', 470, 'Y', ''),
       ('EPU-', '그룹웨어', '일반', '발신', 'O', 471, 'Y', ''),
       ('ESCR', '그룹웨어', '일정 명함', '수신', 'I', 472, 'Y', ''),
       ('ESC-', '그룹웨어', '일정 명함', '발신', 'O', 473, 'Y', ''),
       ('EMF-', '그룹웨어', '파일 다운로드', '-', 'I', 474, 'Y', ''),
       ('EMU-', '그룹웨어', '기타', '', 'O', 475, 'Y', ''),
       ('EMDR', '그룹웨어', '드라이브', '수신', 'I', 476, 'Y', ''),
       ('EMDS', '그룹웨어', '드라이브', '발신', 'O', 477, 'Y', '');
