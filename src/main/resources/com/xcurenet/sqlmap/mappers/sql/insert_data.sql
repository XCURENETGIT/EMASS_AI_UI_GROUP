...
VALUES ('AGCR', '일정', '구글캘린더일정', '수신', 'I', 325, 'Y', ''),
('AGCS', '일정', '구글캘린더일정', '발신', 'O', 326, 'Y', ''),
('AGLR', '일정', '구글캘린더메일', '수신', 'I', 327, 'Y', ''),
...
('F2NR', '파일전송', '2nd 드라이브', '수신', 'I', 287, 'Y', ''),
('F2NS', '파일전송', '2nd 드라이브', '발신', 'O', 288, 'Y', ''),
...
('QDSC', '메신저', '대신', '채팅', 'O', 171, 'Y', ''),
('QDSF', '메신저', '대신', '파일전송', 'O', 172, 'Y', ''),
('QDSM', '메신저', '대신', '쪽지', 'O', 173, 'Y', ''),
...
('QNMR', '메신저', '네이버 쪽지', '수신', 'I', 166, 'Y', ''),
('QNMS', '메신저', '네이버 쪽지', '발신', 'O', 167, 'Y', ''),
...
('QNVC', '메신저', '네이버', '채팅', 'O', 164, 'Y', ''),
('QNVF', '메신저', '네이버', '파일전송', 'O', 165, 'Y', ''),
('QSBC', '메신저', 'SK 비즈', '채팅', 'O', 217, 'Y', ''),
('QSBF', '메신저', 'SK 비즈', '파일전송', 'O', 218, 'Y', ''),
('QSBM', '메신저', 'SK 비즈', '쪽지', 'O', 219, 'Y', ''),
...
('QSSC', '메신저', '삼성증권', '채팅', 'O', 204, 'Y', ''),
('QSSF', '메신저', '삼성증권', '파일전송', 'O', 205, 'Y', ''),
('QSSM', '메신저', '삼성증권', '쪽지', 'O', 206, 'Y', ''),
...
('WDUB', '웹메일', '다음', '예약메일', 'O', 10, 'N', ''),
('WDUR', '웹메일', '다음', '수신', 'I', 8, 'N', ''),
('WDUS', '웹메일', '다음', '발신', 'O', 9, 'N', ''),
('WDUT', '웹메일', '다음', '임시저장', 'O', 11, 'N', ''),
...
INSERT IGNORE INTO UI_CUSTOM_DASHBOARD_MENU (MENU_KEY,MENU_NAME,MENU_ICON,ADMIN_ID,USEYN,DEFAULT_MENU,DEFAULT_DASHBOARD,UPDATE_DT) VALUES (0,'Default Dashboard','fa fa-laptop','sysadmin','Y','Y','Y',NOW());
